...
export const preflight = async () => {
  ...
  if (!existsSync(join(root_dir, "v8", "src", "builtins", "builtins-generated"))) missing.push("builtins-generated(需 gn/gclient 同步产物)");
  if (missing.length > 0) {
    console.warn("警告: v8/third_party 缺项: " + missing.join(", ") + " —— 大量 .cc 会因缺头文件转译失败，建议先执行 gclient sync");
  }
