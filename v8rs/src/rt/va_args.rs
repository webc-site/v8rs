...
impl<T: crate::ByteRepr + 'static> From<crate::Ptr<T>> for VaArg {
  fn from(v: crate::Ptr<T>) -> Self {
    VaArg::Ptr(v.to_any())
  }
}
...
impl<T: 'static + crate::ByteRepr> VaArgGet for crate::Ptr<T> {
  fn get(v: &VaArg) -> Self {
    match v {
