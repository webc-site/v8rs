...
thread_local!(
    pub static kMaxSignificantBits_116: Value<i32> = Rc::new(RefCell::new(3584));
);
thread_local!(
    static kChunkSize_117: Value<i32> = Rc::new(RefCell::new(
        (((::std::mem::size_of::<u32>() as usize).wrapping_mul(8_usize)) as i32),
    ));
);
thread_local!(
    static kDoubleChunkSize_118: Value<i32> = Rc::new(RefCell::new(
        (((::std::mem::size_of::<u64>() as usize).wrapping_mul(8_usize)) as i32),
    ));
);
thread_local!(
    static kBigitSize_119: Value<i32> = Rc::new(RefCell::new(28));
);
thread_local!(
    static kBigitMask_120: Value<u32> = Rc::new(RefCell::new(
        (((1 << (*kBigitSize_119.with(Value::clone).borrow())) - 1) as u32),
    ));
);
thread_local!(
    static kBigitCapacity_121: Value<i32> = Rc::new(RefCell::new(
        ((*kMaxSignificantBits_116.with(Value::clone).borrow())
            / (*kBigitSize_119.with(Value::clone).borrow())),
    ));
);
#[derive()]
...
pub fn is_constant_evaluated_125() -> bool {
    return ({ is_constant_evaluated_126() });
}
pub fn compare_result_as_less_than_127(r: std_weak_ordering) -> bool {
...
pub fn compare_result_as_ordering_128(c: std_weak_ordering) -> std_weak_ordering {
...
impl absl_uint128 {
    ...
    pub fn absl_uint1289(v: absl_int128) -> Self {
        ...
        let __this: Value<absl_uint128> = Rc::new(RefCell::new(Self {
            lo_: Rc::new(RefCell::new(({ Int128Low64_129((*v.borrow()).clone()) }))),
            hi_: Rc::new(RefCell::new(
                (({ Int128High64_130((*v.borrow()).clone()) }) as u64),
            )),
        }));
        let this: Ptr<absl_uint128> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
...
pub fn Uint128Max_133() -> absl_uint128 {
    return absl_uint128::absl_uint12810({ <u64>::MAX }, { <u64>::MAX });
}
thread_local!(
    pub static is_specialized_134: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_signed_135: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_integer_136: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_exact_137: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static has_infinity_138: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_quiet_NaN_139: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_signaling_NaN_140: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_denorm_141: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static has_denorm_loss_142: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static round_style_143: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static is_iec559_144: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_bounded_145: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_modulo_146: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static digits_147: Value<i32> = Rc::new(RefCell::new(128));
);
thread_local!(
    pub static digits10_148: Value<i32> = Rc::new(RefCell::new(38));
);
thread_local!(
    pub static max_digits10_149: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static radix_150: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!(
    pub static min_exponent_151: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static min_exponent10_152: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent_153: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent10_154: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static traps_155: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static tinyness_before_156: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
impl absl_int128 {
    ...
    fn absl_int12813(high: i64, low: u64) -> Self {
        ...
        let __this: Value<absl_int128> = Rc::new(RefCell::new(Self {
            v_: Rc::new(RefCell::new(
                (({ BitCastToSigned_157((((*high.borrow()) as u128) << 64)) })
                    | ((*low.borrow()) as i128)),
            )),
        }));
        let this: Ptr<absl_int128> = __this.as_pointer();
...
pub fn Int128Max_160() -> absl_int128 {
    return absl_int128::absl_int12813({ <i64>::MAX }, { <u64>::MAX });
}
pub fn Int128Min_161() -> absl_int128 {
    return absl_int128::absl_int12813({ <i64>::MIN }, { 0_u64 });
}
thread_local!(
    pub static is_specialized_162: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_signed_163: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_integer_164: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_exact_165: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static has_infinity_166: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_quiet_NaN_167: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_signaling_NaN_168: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_denorm_169: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static has_denorm_loss_170: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static round_style_171: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static is_iec559_172: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_bounded_173: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_modulo_174: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static digits_175: Value<i32> = Rc::new(RefCell::new(127));
);
thread_local!(
    pub static digits10_176: Value<i32> = Rc::new(RefCell::new(38));
);
thread_local!(
    pub static max_digits10_177: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static radix_178: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!(
    pub static min_exponent_179: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static min_exponent10_180: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent_181: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent10_182: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static traps_183: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static tinyness_before_184: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
pub struct std_numeric_limits_absl_int128_ {}
impl std_numeric_limits_absl_int128_ {
    pub fn min() -> absl_int128 {
        return ({ Int128Min_161() });
    }
    pub fn lowest() -> absl_int128 {
        return ({ Int128Min_161() });
    }
    pub fn max() -> absl_int128 {
        return ({ Int128Max_160() });
    }
...
pub fn MakeUint128_185(high: u64, low: u64) -> absl_uint128 {
    let high: Value<u64> = Rc::new(RefCell::new(high));
    let low: Value<u64> = Rc::new(RefCell::new(low));
    return absl_uint128::absl_uint12810({ (*high.borrow()) }, { (*low.borrow()) });
}
pub fn Uint128Low64_193(v: absl_uint128) -> u64 {
    let v: Value<absl_uint128> = Rc::new(RefCell::new(v));
    return (*(*v.borrow()).lo_.borrow());
}
pub fn Uint128High64_194(v: absl_uint128) -> u64 {
    let v: Value<absl_uint128> = Rc::new(RefCell::new(v));
    return (*(*v.borrow()).hi_.borrow());
}
pub fn operator_eq_132(lhs: absl_uint128, rhs: absl_uint128) -> bool {
...
pub fn operator_ne_195(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
...
pub fn operator_lt_196(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
        < ({ absl_uint128Impl::operator_unsigned___int128(&rhs.as_pointer()) }));
}
pub fn operator_gt_197(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_uint128 = (*rhs.borrow()).clone();
        operator_lt_196(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_le_198(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_uint128 = (*rhs.borrow()).clone();
...
pub fn operator_ge_199(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_uint128 = (*lhs.borrow()).clone();
        operator_lt_196(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_cmp_131(lhs: absl_uint128, rhs: absl_uint128) -> std::cmp::Ordering {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    {
...
pub fn operator_pos_200(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return (*val.borrow()).clone();
}
pub fn operator_pos_201(val: absl_int128) -> absl_int128 {
    let val: Value<absl_int128> = Rc::new(RefCell::new(val));
    return (*val.borrow()).clone();
}
pub fn operator_neg_202(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return absl_uint128::absl_uint1288({
        -({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) })
    });
}
pub fn operator_not_203(val: absl_uint128) -> bool {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return !(({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) }) != 0);
}
pub fn operator_bitnot_204(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return absl_uint128::absl_uint1288({
        !({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) })
    });
}
pub fn operator_bitor_205(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_bitand_206(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_bitxor_207(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_shl_186(lhs: absl_uint128, amount: i32) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
...
pub fn operator_shr_187(lhs: absl_uint128, amount: i32) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_add_188(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_sub_189(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_mul_190(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_div_191(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_rem_192(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn MakeInt128_208(high: i64, low: u64) -> absl_int128 {
    let high: Value<i64> = Rc::new(RefCell::new(high));
    let low: Value<u64> = Rc::new(RefCell::new(low));
    return absl_int128::absl_int12813({ (*high.borrow()) }, { (*low.borrow()) });
}
pub fn BitCastToSigned_219(v: u64) -> i64 {
    let v: Value<u64> = Rc::new(RefCell::new(v));
...
pub fn BitCastToSigned_157(v: u128) -> i128 {
    let v: Value<u128> = Rc::new(RefCell::new(v));
...
pub fn Int128Low64_129(v: absl_int128) -> u64 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return (((*(*v.borrow()).v_.borrow()) & (!0_u64 as i128)) as u64);
}
pub fn Int128High64_130(v: absl_int128) -> i64 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return ({ BitCastToSigned_219(((((*(*v.borrow()).v_.borrow()) as u128) >> 64) as u64)) });
}
pub fn operator_eq_159(lhs: absl_int128, rhs: absl_int128) -> bool {
...
pub fn operator_ne_220(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        != ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_lt_221(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        < ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_gt_222(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        > ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_le_223(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        <= ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_ge_224(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        >= ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_cmp_158(lhs: absl_int128, rhs: absl_int128) -> std::cmp::Ordering {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    {
...
pub fn operator_neg_225(v: absl_int128) -> absl_int128 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return absl_int128::absl_int1288({
        -({ absl_int128Impl::operator___int128(&v.as_pointer()) })
    });
}
pub fn operator_not_226(v: absl_int128) -> bool {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return !(({ absl_int128Impl::operator___int128(&v.as_pointer()) }) != 0);
}
pub fn operator_bitnot_227(val: absl_int128) -> absl_int128 {
    let val: Value<absl_int128> = Rc::new(RefCell::new(val));
    return absl_int128::absl_int1288({
        !({ absl_int128Impl::operator___int128(&val.as_pointer()) })
    });
}
pub fn operator_add_209(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_sub_210(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_mul_211(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_div_212(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_rem_213(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitor_214(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitand_215(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitxor_216(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_shl_217(lhs: absl_int128, amount: i32) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_int128::absl_int1288({
...
pub fn operator_shr_218(lhs: absl_int128, amount: i32) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) }) >> (*amount.borrow()))
...
thread_local!(
    pub static kSignificandSize_228: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    static kUint64MSB_229: Value<u64> = Rc::new(RefCell::new((1_u64 << 63)));
);
#[derive()]
    ...
    pub fn Times(a: Ptr<v8_base_DiyFp>, b: Ptr<v8_base_DiyFp>) -> v8_base_DiyFp {
        let mul: Value<absl_uint128> = Rc::new(RefCell::new(
            ({
                ...
                operator_mul_190(_lhs, _rhs)
            }),
        ));
        let hi: Value<u64> = Rc::new(RefCell::new(
            ({ Uint128High64_194((*mul.borrow()).clone()) }),
        ));
        let lo: Value<u64> = Rc::new(RefCell::new(
            ({ Uint128Low64_193((*mul.borrow()).clone()) }),
        ));
...
pub fn double_to_uint64_230(d: f64) -> u64 {
    let d: Value<f64> = Rc::new(RefCell::new(d));
    return ({ bit_cast_28(d.as_pointer()) });
}
pub fn uint64_to_double_231(d64: u64) -> f64 {
    let d64: Value<u64> = Rc::new(RefCell::new(d64));
    return ({ bit_cast_30(d64.as_pointer()) });
}
thread_local!(
    pub static kSignMask_232: Value<u64> = Rc::new(RefCell::new(9223372036854775808));
);
thread_local!(
    pub static kExponentMask_233: Value<u64> = Rc::new(RefCell::new(9218868437227405312));
);
thread_local!(
    pub static kSignificandMask_234: Value<u64> = Rc::new(RefCell::new(4503599627370495));
);
thread_local!(
    pub static kHiddenBit_235: Value<u64> = Rc::new(RefCell::new(4503599627370496));
);
thread_local!(
    pub static kPhysicalSignificandSize_236: Value<i32> = Rc::new(RefCell::new(52));
);
thread_local!(
    pub static kSignificandSize_237: Value<i32> = Rc::new(RefCell::new(53));
);
thread_local!(
    static kExponentBias_238: Value<i32> = Rc::new(RefCell::new(1075));
);
thread_local!(
    static kDenormalExponent_239: Value<i32> = Rc::new(RefCell::new(-1074));
);
thread_local!(
    static kMaxExponent_240: Value<i32> = Rc::new(RefCell::new(972));
);
thread_local!(
    static kInfinity_241: Value<u64> = Rc::new(RefCell::new(9218868437227405312));
);
#[derive()]
...
impl v8_base_Double {
    ...
    pub fn v8_base_Double2(d: f64) -> Self {
        let d: Value<f64> = Rc::new(RefCell::new(d));
        let __this: Value<v8_base_Double> = Rc::new(RefCell::new(Self {
            d64_: Rc::new(RefCell::new(({ double_to_uint64_230((*d.borrow())) }))),
        }));
        let this: Ptr<v8_base_Double> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
...
pub fn NormalizedExponent_242(significand: u64, exponent: i32) -> i32 {
    let significand: Value<u64> = Rc::new(RefCell::new(significand));
    let exponent: Value<i32> = Rc::new(RefCell::new(exponent));
    (&(0));
    'loop_: while (((*significand.borrow()) & 4503599627370496) == 0_u64) {
        let __rhs = ((*significand.borrow()) << 1);
        (*significand.borrow_mut()) = __rhs;
        let __rhs = ((*exponent.borrow()) - 1);
        (*exponent.borrow_mut()) = __rhs;
    }
    return (*exponent.borrow());
}
pub fn BignumDtoa_243(
    v: f64,
    mode: v8_base_BignumDtoaMode,
    ...
    let v: Value<f64> = Rc::new(RefCell::new(v));
    let mode: Value<v8_base_BignumDtoaMode> = Rc::new(RefCell::new(mode));
    ...
    let is_even: Value<bool> = Rc::new(RefCell::new((((*significand.borrow()) & 1_u64) == 0_u64)));
    let exponent: Value<i32> = Rc::new(RefCell::new(
        ({
    ...
    let normalized_exponent: Value<i32> = Rc::new(RefCell::new(
        ({ NormalizedExponent_242((*significand.borrow()), (*exponent.borrow())) }),
    ));
    let estimated_power: Value<i32> = Rc::new(RefCell::new(
        ({ EstimatePower_244((*normalized_exponent.borrow())) }),
    ));
    if (((*mode.borrow()) as i32) == (v8_base_BignumDtoaMode_BIGNUM_DTOA_FIXED as i32))
        && ((-(*estimated_power.borrow()) - 1) > (*requested_digits.borrow()))
    {
        ({ v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), 0_usize) })
            .write(('\0' as u8));
        (*length.borrow()).write(0);
        let __rhs = -(*requested_digits.borrow());
        (*decimal_point.borrow()).write(__rhs);
        return;
    }
    let numerator: Value<v8_base_Bignum> = Rc::new(RefCell::new(v8_base_Bignum::v8_base_Bignum()));
    let denominator: Value<v8_base_Bignum> =
        Rc::new(RefCell::new(v8_base_Bignum::v8_base_Bignum()));
    let delta_minus: Value<v8_base_Bignum> =
        Rc::new(RefCell::new(v8_base_Bignum::v8_base_Bignum()));
    let delta_plus: Value<v8_base_Bignum> = Rc::new(RefCell::new(v8_base_Bignum::v8_base_Bignum()));
    (&(0));
    let need_boundary_deltas: Value<bool> = Rc::new(RefCell::new(
        (((*mode.borrow()) as i32) == (v8_base_BignumDtoaMode_BIGNUM_DTOA_SHORTEST as i32)),
    ));
    ({
        InitialScaledStartValues_245(
            (*v.borrow()),
            (*estimated_power.borrow()),
            (*need_boundary_deltas.borrow()),
            (numerator.as_pointer()),
            (denominator.as_pointer()),
            (delta_minus.as_pointer()),
            (delta_plus.as_pointer()),
        )
    });
    ({
        let _estimated_power: i32 = (*estimated_power.borrow());
    ...
    switch!(match ((*mode.borrow()) as i32) {
        ...
        __v if __v == 2 => {
            ({
                let _count: i32 = (*requested_digits.borrow());
                let _decimal_point: Ptr<i32> = (*decimal_point.borrow()).clone();
                let _length: Ptr<i32> = (*length.borrow()).clone();
                GenerateCountedDigits_249(
                    _count,
                    _decimal_point,
                    (numerator.as_pointer()),
                    (denominator.as_pointer()),
...
pub fn GenerateShortestDigits_247(
    numerator: Ptr<v8_base_Bignum>,
    denominator: Ptr<v8_base_Bignum>,
    delta_minus: Ptr<v8_base_Bignum>,
    delta_plus: Ptr<v8_base_Bignum>,
    is_even: bool,
    buffer: v8_base_Vector_char_,
    length: Ptr<i32>,
) {
    let numerator: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(numerator));
    let denominator: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(denominator));
    let delta_minus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_minus));
    let delta_plus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_plus));
    let is_even: Value<bool> = Rc::new(RefCell::new(is_even));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    if ({
        let _a: Ptr<v8_base_Bignum> = (*delta_minus.borrow()).clone();
        let _b: Ptr<v8_base_Bignum> = (*delta_plus.borrow()).clone();
        v8_base_Bignum::Equal(_a, _b)
    }) {
        (*delta_plus.borrow_mut()) = (*delta_minus.borrow()).clone();
    }
    (*length.borrow()).write(0);
    'loop_: while true {
        let digit: Value<u16> = <Value<u16>>::default();
        (*digit.borrow_mut()) = ({
            let _other: Ptr<v8_base_Bignum> = (*denominator.borrow()).clone();
            v8_base_BignumImpl::DivideModuloIntBignum(&(*numerator.borrow()), _other)
        });
        (&(0));
        ({
            v8_base_Vector_char_Impl::operator_index(
                &buffer.as_pointer(),
                ((*length.borrow()).with_mut(|__v| __v.postfix_inc()) as usize),
            )
        })
        .write(((((*digit.borrow()) as i32) + (('0' as u8) as i32)) as u8));
        let in_delta_room_minus: Value<bool> = <Value<bool>>::default();
        let in_delta_room_plus: Value<bool> = <Value<bool>>::default();
        if (*is_even.borrow()) {
            (*in_delta_room_minus.borrow_mut()) = ({
                let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
                let _b: Ptr<v8_base_Bignum> = (*delta_minus.borrow()).clone();
            ...
            (*in_delta_room_minus.borrow_mut()) = ({
                let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
                let _b: Ptr<v8_base_Bignum> = (*delta_minus.borrow()).clone();
                v8_base_Bignum::Less(_a, _b)
            });
        }
        if (*is_even.borrow()) {
            (*in_delta_room_plus.borrow_mut()) = (({
                let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
                let _b: Ptr<v8_base_Bignum> = (*delta_plus.borrow()).clone();
                let _c: Ptr<v8_base_Bignum> = (*denominator.borrow()).clone();
                v8_base_Bignum::PlusCompare(_a, _b, _c)
            }) >= 0);
        } else {
            (*in_delta_room_plus.borrow_mut()) = (({
        ...
        if (!(*in_delta_room_minus.borrow())) && (!(*in_delta_room_plus.borrow())) {
            ({ v8_base_BignumImpl::Times10(&(*numerator.borrow())) });
            ({ v8_base_BignumImpl::Times10(&(*delta_minus.borrow())) });
            if {
                let _lhs = (*delta_minus.borrow()).clone();
                _lhs != (*delta_plus.borrow()).clone()
            } {
                ({ v8_base_BignumImpl::Times10(&(*delta_plus.borrow())) });
            }
        } else if (*in_delta_room_minus.borrow()) && (*in_delta_room_plus.borrow()) {
            let compare: Value<i32> = Rc::new(RefCell::new(
                ({
                    let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
                    let _b: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
                    let _c: Ptr<v8_base_Bignum> = (*denominator.borrow()).clone();
                    v8_base_Bignum::PlusCompare(_a, _b, _c)
                }),
            ));
            if ((*compare.borrow()) < 0) {
            } else if ((*compare.borrow()) > 0) {
                (&(0));
                ({
                    v8_base_Vector_char_Impl::operator_index(
                        &buffer.as_pointer(),
            ...
            return;
        } else if (*in_delta_room_minus.borrow()) {
            return;
        } else {
            (&(0));
            ({
...
pub fn GenerateCountedDigits_249(
    count: i32,
    decimal_point: Ptr<i32>,
    numerator: Ptr<v8_base_Bignum>,
    denominator: Ptr<v8_base_Bignum>,
    ...
    'loop_: while ((*i.borrow()) < ((*count.borrow()) - 1)) {
        let digit: Value<u16> = <Value<u16>>::default();
        (*digit.borrow_mut()) = ({
            let _other: Ptr<v8_base_Bignum> = (*denominator.borrow()).clone();
            v8_base_BignumImpl::DivideModuloIntBignum(&(*numerator.borrow()), _other)
    ...
    {
        (*digit.borrow_mut()).postfix_inc();
    }
    ({
        v8_base_Vector_char_Impl::operator_index(
            &buffer.as_pointer(),
            (((*count.borrow()) - 1) as usize),
        )
    })
    .write(((((*digit.borrow()) as i32) + (('0' as u8) as i32)) as u8));
    let i: Value<i32> = Rc::new(RefCell::new(((*count.borrow()) - 1)));
...
pub fn BignumToFixed_248(
    ...
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    if {
        let _lhs = -((*decimal_point.borrow()).read());
        _lhs > (*requested_digits.borrow())
    } {
        let __rhs = -(*requested_digits.borrow());
        (*decimal_point.borrow()).write(__rhs);
        (*length.borrow()).write(0);
        ...
        (&(0));
        ({ v8_base_BignumImpl::Times10(&(*denominator.borrow())) });
        if (({
            let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
            let _b: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
            let _c: Ptr<v8_base_Bignum> = (*denominator.borrow()).clone();
        ...
        let needed_digits: Value<i32> = Rc::new(RefCell::new({
            let _lhs = ((*decimal_point.borrow()).read());
            _lhs + (*requested_digits.borrow())
        }));
        ({
            let _count: i32 = (*needed_digits.borrow());
            let _decimal_point: Ptr<i32> = (*decimal_point.borrow()).clone();
            let _length: Ptr<i32> = (*length.borrow()).clone();
            GenerateCountedDigits_249(
                _count,
                _decimal_point,
                (*numerator.borrow()).clone(),
                (*denominator.borrow()).clone(),
                (*buffer.borrow()).clone(),
                _length,
            )
        });
...
pub fn EstimatePower_244(exponent: i32) -> i32 {
    let exponent: Value<i32> = Rc::new(RefCell::new(exponent));
    let k1Log10: Value<f64> = Rc::new(RefCell::new(3.010299957E-1));
    let kSignificandSize: Value<i32> = Rc::new(RefCell::new(53));
    let estimate: Value<f64> = Rc::new(RefCell::new(
        ({
            ceil_250(
                ((((((*exponent.borrow()) + (*kSignificandSize.borrow())) - 1) as f64)
                    * (*k1Log10.borrow()))
                    - 1.0E-10),
            )
        }),
    ));
    return ((*estimate.borrow()) as i32);
}
pub fn InitialScaledStartValuesPositiveExponent_251(
    v: f64,
    estimated_power: i32,
    ...
    let v: Value<f64> = Rc::new(RefCell::new(v));
    let estimated_power: Value<i32> = Rc::new(RefCell::new(estimated_power));
    let need_boundary_deltas: Value<bool> = Rc::new(RefCell::new(need_boundary_deltas));
    let numerator: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(numerator));
    let denominator: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(denominator));
    let delta_minus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_minus));
    let delta_plus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_plus));
    ...
    ({
        v8_base_BignumImpl::AssignPowerUInt16(
            &(*denominator.borrow()),
            10_u16,
            (*estimated_power.borrow()),
        )
    });
    if (*need_boundary_deltas.borrow()) {
        ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), 1) });
        ({ v8_base_BignumImpl::ShiftLeft(&(*numerator.borrow()), 1) });
        ({ v8_base_BignumImpl::AssignUInt16(&(*delta_plus.borrow()), 1_u16) });
        ({
            v8_base_BignumImpl::ShiftLeft(
                &(*delta_plus.borrow()),
                ({
        ...
        ({ v8_base_BignumImpl::AssignUInt16(&(*delta_minus.borrow()), 1_u16) });
        ({
            v8_base_BignumImpl::ShiftLeft(
                &(*delta_minus.borrow()),
                ({
        ...
        let v_bits: Value<u64> = Rc::new(RefCell::new(
            ({
                v8_base_DoubleImpl::AsUint64(
                    &Rc::new(RefCell::new(v8_base_Double::v8_base_Double2({
                        (*v.borrow())
                    })))
                    .as_pointer(),
        ...
        if (((*v_bits.borrow()) & 4503599627370495) == 0_u64) {
            ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), 1) });
            ({ v8_base_BignumImpl::ShiftLeft(&(*numerator.borrow()), 1) });
            ({ v8_base_BignumImpl::ShiftLeft(&(*delta_plus.borrow()), 1) });
        }
    }
}
pub fn InitialScaledStartValuesNegativeExponentPositivePower_252(
    v: f64,
    estimated_power: i32,
    need_boundary_deltas: bool,
    numerator: Ptr<v8_base_Bignum>,
    ...
    ({ v8_base_BignumImpl::AssignUInt64(&(*numerator.borrow()), (*significand.borrow())) });
    ({
        v8_base_BignumImpl::AssignPowerUInt16(
            &(*denominator.borrow()),
            10_u16,
    ...
    ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), -(*exponent.borrow())) });
    if (*need_boundary_deltas.borrow()) {
        ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), 1) });
        ({ v8_base_BignumImpl::ShiftLeft(&(*numerator.borrow()), 1) });
        ({ v8_base_BignumImpl::AssignUInt16(&(*delta_plus.borrow()), 1_u16) });
...
pub fn InitialScaledStartValuesNegativeExponentNegativePower_253(
    v: f64,
    estimated_power: i32,
    need_boundary_deltas: bool,
    numerator: Ptr<v8_base_Bignum>,
    ...
    let delta_minus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_minus));
    let delta_plus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_plus));
    let kMinimalNormalizedExponent: Value<u64> = Rc::new(RefCell::new(4503599627370496_u64));
    let significand: Value<u64> = Rc::new(RefCell::new(
        ({
            v8_base_DoubleImpl::Significand(
                &Rc::new(RefCell::new(v8_base_Double::v8_base_Double2({
    ...
    let power_ten: Value<Ptr<v8_base_Bignum>> =
        Rc::new(RefCell::new((*numerator.borrow()).clone()));
    ({
        v8_base_BignumImpl::AssignPowerUInt16(
            &(*power_ten.borrow()),
            10_u16,
    ...
    if (*need_boundary_deltas.borrow()) {
        ({
            let _other: Ptr<v8_base_Bignum> = (*power_ten.borrow()).clone();
            v8_base_BignumImpl::AssignBignum(&(*delta_plus.borrow()), _other)
        });
        ({
            let _other: Ptr<v8_base_Bignum> = (*power_ten.borrow()).clone();
            v8_base_BignumImpl::AssignBignum(&(*delta_minus.borrow()), _other)
        });
    }
    (&(0));
    ({ v8_base_BignumImpl::MultiplyByUInt64(&(*numerator.borrow()), (*significand.borrow())) });
    ({ v8_base_BignumImpl::AssignUInt16(&(*denominator.borrow()), 1_u16) });
    ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), -(*exponent.borrow())) });
    if (*need_boundary_deltas.borrow()) {
        ({ v8_base_BignumImpl::ShiftLeft(&(*numerator.borrow()), 1) });
        ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), 1) });
        ...
        if (((*v_bits.borrow()) & 4503599627370495) == 0_u64)
            && (((*v_bits.borrow()) & 9218868437227405312)
                != (*kMinimalNormalizedExponent.borrow()))
        {
            ({ v8_base_BignumImpl::ShiftLeft(&(*numerator.borrow()), 1) });
            ({ v8_base_BignumImpl::ShiftLeft(&(*denominator.borrow()), 1) });
            ({ v8_base_BignumImpl::ShiftLeft(&(*delta_plus.borrow()), 1) });
...
pub fn InitialScaledStartValues_245(
    v: f64,
    estimated_power: i32,
    need_boundary_deltas: bool,
    numerator: Ptr<v8_base_Bignum>,
    ...
    {
        ({
            InitialScaledStartValuesPositiveExponent_251(
                (*v.borrow()),
                (*estimated_power.borrow()),
                (*need_boundary_deltas.borrow()),
                (*numerator.borrow()).clone(),
                (*denominator.borrow()).clone(),
                (*delta_minus.borrow()).clone(),
                (*delta_plus.borrow()).clone(),
            )
        });
    } else if ((*estimated_power.borrow()) >= 0) {
        ({
            InitialScaledStartValuesNegativeExponentPositivePower_252(
                (*v.borrow()),
                (*estimated_power.borrow()),
                (*need_boundary_deltas.borrow()),
                (*numerator.borrow()).clone(),
        ...
        ({
            InitialScaledStartValuesNegativeExponentNegativePower_253(
                (*v.borrow()),
                (*estimated_power.borrow()),
                (*need_boundary_deltas.borrow()),
                (*numerator.borrow()).clone(),
...
pub fn FixupMultiply10_246(
    ...
    let delta_minus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_minus));
    let delta_plus: Value<Ptr<v8_base_Bignum>> = Rc::new(RefCell::new(delta_plus));
    let in_range: Value<bool> = <Value<bool>>::default();
    if (*is_even.borrow()) {
        (*in_range.borrow_mut()) = (({
            let _a: Ptr<v8_base_Bignum> = (*numerator.borrow()).clone();
            let _b: Ptr<v8_base_Bignum> = (*delta_plus.borrow()).clone();
    ...
    if (*in_range.borrow()) {
        let __rhs = ((*estimated_power.borrow()) + 1);
        (*decimal_point.borrow()).write(__rhs);
    } else {
        let __rhs = (*estimated_power.borrow());
        (*decimal_point.borrow()).write(__rhs);
        ({ v8_base_BignumImpl::Times10(&(*numerator.borrow())) });
        if ({
            let _a: Ptr<v8_base_Bignum> = (*delta_minus.borrow()).clone();
            ...
            ({ v8_base_BignumImpl::Times10(&(*delta_minus.borrow())) });
            ({
                let _other: Ptr<v8_base_Bignum> = (*delta_minus.borrow()).clone();
                v8_base_BignumImpl::AssignBignum(&(*delta_plus.borrow()), _other)
            });
        } else {
            ({ v8_base_BignumImpl::Times10(&(*delta_minus.borrow())) });
...
impl absl_int128Impl for Ptr<absl_int128> {
    ...
    fn operator_add_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                ...
                operator_add_209(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_sub_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_sub_210(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_mul_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_mul_211(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_div_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_div_212(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_rem_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_rem_213(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitor_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitor_214(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitand_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitand_215(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitxor_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitxor_216(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_shl_assign(&self, amount: i32) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_shl_217(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_shr_assign(&self, amount: i32) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_shr_218(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
...
impl absl_uint128Impl for Ptr<absl_uint128> {
    ...
    fn operator_shl_assign(&self, amount: i32) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                ...
                operator_shl_186(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_shr_assign(&self, amount: i32) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_shr_187(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_add_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_add_188(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_sub_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_sub_189(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_mul_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_mul_190(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_div_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_div_191(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_rem_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_rem_192(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    ...
    fn operator_bitor_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitor_205(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitand_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitand_206(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitxor_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitxor_207(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
...
impl v8_base_BignumImpl for Ptr<v8_base_Bignum> {
    ...
    fn EnsureCapacity(&self, size: i32) {
        ...
        if ((*size.borrow()) > (*kBigitCapacity_121.with(Value::clone).borrow())) {
            ({
                V8_Fatal_122(
                    (*kUnreachableCodeMessage_9.with(Value::clone).borrow()).clone(),
                    &[],
...
impl v8_base_DiyFpImpl for Ptr<v8_base_DiyFp> {
    ...
    fn Normalize(&self) {
        ...
        'loop_: while (((*f.borrow()) & (*kUint64MSB_229.with(Value::clone).borrow())) == 0_u64) {
            (*f.borrow_mut()) <<= 1;
...
impl v8_base_DoubleImpl for Ptr<v8_base_Double> {
    ...
    fn AsNormalizedDiyFp(&self) -> v8_base_DiyFp {
        ...
        (*f.borrow_mut()) <<= ((*kSignificandSize_228.with(Value::clone).borrow()) - 53);
        (*e.borrow_mut()) -= ((*kSignificandSize_228.with(Value::clone).borrow()) - 53);
    ...
    fn value(&self) -> f64 {
        return ({ uint64_to_double_231((*(*(*self).upgrade().deref()).d64_.borrow())) });
    }
}
