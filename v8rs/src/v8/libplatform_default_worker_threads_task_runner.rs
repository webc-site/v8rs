...
impl v8_base_Use {
    pub fn v8_base_Use2(_a0: Ptr<bool>) -> Self {
        let __this: Value<v8_base_Use> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_Use> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
...
pub fn saturated_cast_309(value: f64) -> i64 {
    ...
    return if ((!({ is_constant_evaluated_17() })) && (false)) && (true) {
...
pub type anon_335 = u32;
pub const anon_335_kTask: anon_335 = 0;
pub const anon_335_kWaitIndefinite: anon_335 = 1;
pub const anon_335_kWaitDelayed: anon_335 = 2;
pub const anon_335_kTerminated: anon_335 = 3;
#[derive(Default)]
pub struct v8_platform_DelayedTaskQueue_MaybeNextTask {
    pub state: Value<anon_335>,
    pub task: Value<Option<Value<v8_Task>>>,
    pub wait_time: Value<v8_base_TimeDelta>,
}
impl v8_platform_DelayedTaskQueue_MaybeNextTask {
    pub fn MaybeNextTask_pmutv8_platform_DelayedTaskQueue_MaybeNextTask(
        _a0: Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask>,
    ) -> Self {
        let __this: Value<v8_platform_DelayedTaskQueue_MaybeNextTask> =
            Rc::new(RefCell::new(Self {
                state: Rc::new(RefCell::new((*(*_a0.upgrade().deref()).state.borrow()))),
                task: Rc::new(RefCell::new(
                    (*(*_a0.upgrade().deref()).task.borrow_mut()).take(),
                )),
                wait_time: Rc::new(RefCell::new(
                    (*(*_a0.upgrade().deref()).wait_time.borrow()).clone(),
                )),
            }));
        let this: Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_platform_DelayedTaskQueue_MaybeNextTask {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.state.borrow()).to_bytes(&mut buf[0..4]);
        (*self.task.borrow()).to_bytes(&mut buf[8..16]);
        (*self.wait_time.borrow()).to_bytes(&mut buf[16..24]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            state: Rc::new(RefCell::new(<anon_335>::from_bytes(&buf[0..4]))),
            task: Rc::new(RefCell::new(<Option<Value<v8_Task>>>::from_bytes(
                &buf[8..16],
            ))),
            wait_time: Rc::new(RefCell::new(<v8_base_TimeDelta>::from_bytes(&buf[16..24]))),
        }
    }
}
#[derive()]
pub struct v8_platform_DelayedTaskQueue {  task_queue_ : Value<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > ,  delayed_task_queue_ : Value<std_multimap_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_less_double___std_allocator_std_pair_const_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > ,  terminated_ : Value<bool > ,  time_function_ : Value<FnPtr<fn() -> f64  > > , }
impl v8_platform_DelayedTaskQueue {}
impl Default for v8_platform_DelayedTaskQueue {
    fn default() -> Self {
        v8_platform_DelayedTaskQueue { task_queue_ : <Value<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > >::default() , delayed_task_queue_ : <Value<std_multimap_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_less_double___std_allocator_std_pair_const_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > >::default() , terminated_ : <Value<bool > >::default() , time_function_ : Rc::new(RefCell::new(FnPtr::<fn() -> f64  >::null())) , }
    }
}
impl ByteRepr for v8_platform_DelayedTaskQueue {
    fn byte_size() -> usize {
        88
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.task_queue_.borrow()).to_bytes(&mut buf[0..48]);
        (*self.delayed_task_queue_.borrow()).to_bytes(&mut buf[48..72]);
        (*self.terminated_.borrow()).to_bytes(&mut buf[72..73]);
        (*self.time_function_.borrow()).to_bytes(&mut buf[80..88]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self { task_queue_: Rc::new(RefCell::new(<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ >::from_bytes(&buf[0..48]))), delayed_task_queue_: Rc::new(RefCell::new(<std_multimap_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_less_double___std_allocator_std_pair_const_double__std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ >::from_bytes(&buf[48..72]))), terminated_: Rc::new(RefCell::new(<bool >::from_bytes(&buf[72..73]))), time_function_: Rc::new(RefCell::new(<FnPtr<fn() -> f64  > >::from_bytes(&buf[80..88]))), }
    }
}
#[derive(Default)]
struct v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread {
    runner_: Value<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner>>,
    condition_var_: Value<v8_base_ConditionVariable>,
}
impl v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread {
    pub fn v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread(
        runner: Ptr<v8_platform_DefaultWorkerThreadsTaskRunner>,
        priority: v8_base_Thread_Priority,
    ) -> Self {
        let runner: Value<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner>> =
            Rc::new(RefCell::new(runner));
        let priority: Value<v8_base_Thread_Priority> = Rc::new(RefCell::new(priority));
        let __this: Value<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread> =
            Rc::new(RefCell::new(Self {
                runner_: Rc::new(RefCell::new((*runner.borrow()).clone())),
                condition_var_: Rc::new(RefCell::new(
                    v8_base_ConditionVariable::v8_base_ConditionVariable(),
                )),
            }));
        let this: Ptr<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread> =
            __this.as_pointer();
        let mut __do_while = true;
        'loop_: while __do_while || (false) {
            __do_while = false;
            if ((!(!(!({ v8_base_ThreadImpl::Start(&this) }))) as i64) != 0) {
                ({
                    V8_Fatal_336(
                        Ptr::from_string_literal(b"Check failed: %s."),
                        &[(Ptr::from_string_literal(b"Start()")).into()],
                    )
                });
            }
        }
...
impl v8_base_Thread for v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread {
    fn Run(&self) {
        let guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
                ((*(*self.runner_.borrow()).upgrade().deref())
                    .lock_
                    .as_pointer())
            }),
        ));
        ...
        'loop_: while true {
            let next_task: Value<v8_platform_DelayedTaskQueue_MaybeNextTask> =
                Rc::new(RefCell::new(
                    ({
                        v8_platform_DelayedTaskQueueImpl::TryGetNext(
                            &(*(*self.runner_.borrow()).upgrade().deref())
                                .queue_
                                .as_pointer(),
                        )
            ...
            'switch: {
                let __match_cond = ((*(*next_task.borrow()).state.borrow()) as i32);
                match __match_cond {
                    __v if __v == 0 => {
                        ({
                            v8_base_MutexImpl::Unlock(
                                &(*(*self.runner_.borrow()).upgrade().deref())
                                    .lock_
                                    .as_pointer(),
                            )
                    ...
                    __v if __v == 1 => {
                        ...
                        ({
                            ...
                            v8_base_ConditionVariableImpl::Wait(
                                &self.condition_var_.as_pointer(),
                                _mutex,
                            )
                        });
                        continue 'loop_;
                    ...
                    __v if __v == 2 => {
                        (*(*(*self.runner_.borrow()).upgrade().deref())
                            ...
                            .borrow_mut())
                        .push((*self));
                        let notified: Value<bool> = Rc::new(RefCell::new(
                            ({
                                let _mutex: Ptr<v8_base_Mutex> =
                                    ((*(*self.runner_.borrow()).upgrade().deref())
                                        .lock_
                                        .as_pointer());
                                v8_base_ConditionVariableImpl::WaitFor(
                                    &self.condition_var_.as_pointer(),
                                    _mutex,
                                    (*next_task.borrow()).wait_time.as_pointer(),
                                )
                            }),
                        ));
                        let mut __do_while = true;
...
impl ByteRepr for v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread {
    fn byte_size() -> usize {
        64
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.runner_.borrow()).to_bytes(&mut buf[48..56]);
        (*self.condition_var_.borrow()).to_bytes(&mut buf[56..64]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            runner_: Rc::new(RefCell::new(<Ptr<
                v8_platform_DefaultWorkerThreadsTaskRunner,
            >>::from_bytes(&buf[48..56]))),
            condition_var_: Rc::new(RefCell::new(<v8_base_ConditionVariable>::from_bytes(
                &buf[56..64],
            ))),
        }
    }
...
#[derive()]
pub struct v8_platform_DefaultWorkerThreadsTaskRunner {  terminated_ : Value<bool > ,  lock_ : Value<v8_base_Mutex > ,  idle_threads_ : Value<Vec<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>> > ,  thread_pool_ : Value<Vec<Option<Value<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>>> > ,  queue_ : Value<v8_platform_DelayedTaskQueue > ,  task_queue_ : Value<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > ,  time_function_ : Value<FnPtr<fn() -> f64  > > , }
impl v8_platform_DefaultWorkerThreadsTaskRunner {
    pub fn v8_platform_DefaultWorkerThreadsTaskRunner(
        thread_pool_size: u32,
        time_function: FnPtr<fn() -> f64>,
        priority: Option<v8_base_Thread_Priority>,
    ) -> Self {
        let thread_pool_size: Value<u32> = Rc::new(RefCell::new(thread_pool_size));
        let time_function: Value<FnPtr<fn() -> f64>> = Rc::new(RefCell::new(time_function));
        let priority: Value<v8_base_Thread_Priority> = Rc::new(RefCell::new(
            priority.unwrap_or(v8_base_Thread_Priority_kDefault),
        ));
        let __this : Value<v8_platform_DefaultWorkerThreadsTaskRunner> = Rc::new(RefCell::new(Self { terminated_ : Rc::new(RefCell::new(false )) , lock_ : Rc::new(RefCell::new(v8_base_Mutex :: v8_base_Mutex ( ) )) , idle_threads_ : Rc::new(RefCell::new(Vec::new() )) , thread_pool_ : Rc::new(RefCell::new(Vec::new() )) , queue_ : Rc::new(RefCell::new(v8_platform_DelayedTaskQueue :: v8_platform_DelayedTaskQueue ( {  ((*time_function.borrow()) ).clone()  } , ) )) , task_queue_ : Rc::new(RefCell::new(std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ :: std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____1 ( ) )) , time_function_ : Rc::new(RefCell::new(((*time_function.borrow()) ).clone())) , } )) ;
        let this: Ptr<v8_platform_DefaultWorkerThreadsTaskRunner> = __this.as_pointer();
        let i: Value<u32> = Rc::new(RefCell::new(0_u32));
        'loop_: while ((*i.borrow()) < (*thread_pool_size.borrow())) {
            (*(*this.upgrade().deref()).thread_pool_.borrow_mut()).push(
                ({
                    let ___args: Value<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner>> =
                        Rc::new(RefCell::new(this));
                    make_unique_337(___args.as_pointer(), priority.as_pointer())
                }),
            );
            (*i.borrow_mut()).prefix_inc();
        }
...
impl v8_TaskRunner for v8_platform_DefaultWorkerThreadsTaskRunner {
    fn IdleTasksEnabled(&self) -> bool {
        return false;
    }
    fn PostTaskImpl(&self, task: Option<Value<v8_Task>>, location: Ptr<v8_SourceLocation>) {
        ...
        let guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
                (self.lock_.as_pointer())
            }),
        ));
        let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
        if (*self.terminated_.borrow()) {
            return;
        }
        ({
            v8_platform_DelayedTaskQueueImpl::Append(
                &self.queue_.as_pointer(),
                (*task.borrow_mut()).take(),
            )
        });
        if !((*self.idle_threads_.borrow()).is_empty()) {
            ({
                v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThreadImpl::Notify(
                    &((self.idle_threads_.as_pointer()
                        as Ptr<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>>)
                        .to_last()
                        .read()),
                )
            });
            (*self.idle_threads_.borrow_mut()).pop();
        }
    }
    fn PostDelayedTaskImpl(
        &self,
        ...
        ({
            v8_platform_DelayedTaskQueueImpl::AppendDelayed(
                &self.queue_.as_pointer(),
                (*task.borrow_mut()).take(),
                (*delay_in_seconds.borrow()),
            )
    ...
    fn PostIdleTaskImpl(&self, task: Option<Value<v8_IdleTask>>, location: Ptr<v8_SourceLocation>) {
        ...
        ({
            V8_Fatal_336(
                (*kUnreachableCodeMessage_221.with(Value::clone).borrow()).clone(),
                &[],
            )
        });
    }
}
impl Default for v8_platform_DefaultWorkerThreadsTaskRunner {
    fn default() -> Self {
        v8_platform_DefaultWorkerThreadsTaskRunner { terminated_ : <Value<bool > >::default() , lock_ : <Value<v8_base_Mutex > >::default() , idle_threads_ : Rc::new(RefCell::new(Default::default())) , thread_pool_ : Rc::new(RefCell::new(Default::default())) , queue_ : <Value<v8_platform_DelayedTaskQueue > >::default() , task_queue_ : <Value<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ > >::default() , time_function_ : Rc::new(RefCell::new(FnPtr::<fn() -> f64  >::null())) , }
    }
}
impl ByteRepr for v8_platform_DefaultWorkerThreadsTaskRunner {
    fn byte_size() -> usize {
        216
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.terminated_.borrow()).to_bytes(&mut buf[8..9]);
        (*self.lock_.borrow()).to_bytes(&mut buf[16..24]);
        (*self.idle_threads_.borrow()).to_bytes(&mut buf[24..48]);
        (*self.thread_pool_.borrow()).to_bytes(&mut buf[48..72]);
        (*self.queue_.borrow()).to_bytes(&mut buf[72..160]);
        (*self.task_queue_.borrow()).to_bytes(&mut buf[160..208]);
        (*self.time_function_.borrow()).to_bytes(&mut buf[208..216]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self { terminated_: Rc::new(RefCell::new(<bool >::from_bytes(&buf[8..9]))), lock_: Rc::new(RefCell::new(<v8_base_Mutex >::from_bytes(&buf[16..24]))), idle_threads_: Rc::new(RefCell::new(<Vec<Ptr<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>> >::from_bytes(&buf[24..48]))), thread_pool_: Rc::new(RefCell::new(<Vec<Option<Value<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>>> >::from_bytes(&buf[48..72]))), queue_: Rc::new(RefCell::new(<v8_platform_DelayedTaskQueue >::from_bytes(&buf[72..160]))), task_queue_: Rc::new(RefCell::new(<std_queue_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_deque_std_unique_ptr_v8_Task__std_default_delete_v8_Task____std_allocator_std_unique_ptr_v8_Task__std_default_delete_v8_Task_____ >::from_bytes(&buf[160..208]))), time_function_: Rc::new(RefCell::new(<FnPtr<fn() -> f64  > >::from_bytes(&buf[208..216]))), }
    }
}
...
pub trait v8_platform_DefaultWorkerThreadsTaskRunnerImpl {
    fn Terminate(&self);
    fn MonotonicallyIncreasingTime(&self) -> f64;
}
impl v8_platform_DefaultWorkerThreadsTaskRunnerImpl
    for Ptr<v8_platform_DefaultWorkerThreadsTaskRunner>
{
    fn MonotonicallyIncreasingTime(&self) -> f64 {
        return ({ (*(*(*(*self).upgrade().deref()).time_function_.borrow()))() });
    }
    fn Terminate(&self) {
        {
            let guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            ...
            ({
                v8_platform_DelayedTaskQueueImpl::Terminate(
                    &(*(*self).upgrade().deref()).queue_.as_pointer(),
                )
            });
            (*(*(*self).upgrade().deref()).idle_threads_.borrow_mut()).clear();
        }
        (*(*(*self).upgrade().deref()).thread_pool_.borrow_mut()).clear();
    }
}
pub trait v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThreadImpl {
    fn Notify(&self);
}
impl v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThreadImpl
    for Ptr<v8_platform_DefaultWorkerThreadsTaskRunner_WorkerThread>
{
    fn Notify(&self) {
        ({
            v8_base_ConditionVariableImpl::NotifyAll(
                &(*(*self).upgrade().deref()).condition_var_.as_pointer(),
            )
        });
    }
}
pub trait v8_platform_DelayedTaskQueue_MaybeNextTaskImpl {
    fn operator_assign_pmutv8_platform_DelayedTaskQueue_MaybeNextTask(
        &self,
        _a0: Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask>,
    ) -> Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask>;
}
impl v8_platform_DelayedTaskQueue_MaybeNextTaskImpl
    for Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask>
{
    fn operator_assign_pmutv8_platform_DelayedTaskQueue_MaybeNextTask(
        &self,
        _a0: Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask>,
    ) -> Ptr<v8_platform_DelayedTaskQueue_MaybeNextTask> {
        let __rhs = (*(*_a0.upgrade().deref()).state.borrow());
        (*(*(*self).upgrade().deref()).state.borrow_mut()) = __rhs;
        ((*(*self).upgrade().deref()).task.as_pointer() as Ptr<Option<Value<v8_Task>>>)
            .write((*(*_a0.upgrade().deref()).task.borrow_mut()).take());
        let __rhs = (*(*_a0.upgrade().deref()).wait_time.borrow()).clone();
        (*(*(*self).upgrade().deref()).wait_time.borrow_mut()) = __rhs;
        return (*self).clone();
    }
}
