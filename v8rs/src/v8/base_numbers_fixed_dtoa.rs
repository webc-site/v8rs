...
pub fn is_constant_evaluated_118() -> bool {
    return ({ is_constant_evaluated_119() });
}
pub fn compare_result_as_less_than_120(r: std_weak_ordering) -> bool {
...
pub fn compare_result_as_ordering_121(c: std_weak_ordering) -> std_weak_ordering {
...
impl absl_uint128 {
    ...
    pub fn absl_uint1289(v: absl_int128) -> Self {
        ...
        let __this: Value<absl_uint128> = Rc::new(RefCell::new(Self {
            lo_: Rc::new(RefCell::new(({ Int128Low64_122((*v.borrow()).clone()) }))),
            hi_: Rc::new(RefCell::new(
                (({ Int128High64_123((*v.borrow()).clone()) }) as u64),
            )),
        }));
        let this: Ptr<absl_uint128> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
...
pub fn Uint128Max_126() -> absl_uint128 {
    return absl_uint128::absl_uint12810({ <u64>::MAX }, { <u64>::MAX });
}
thread_local!(
    pub static is_specialized_127: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_signed_128: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_integer_129: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_exact_130: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static has_infinity_131: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_quiet_NaN_132: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_signaling_NaN_133: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_denorm_134: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static has_denorm_loss_135: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static round_style_136: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static is_iec559_137: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_bounded_138: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_modulo_139: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static digits_140: Value<i32> = Rc::new(RefCell::new(128));
);
thread_local!(
    pub static digits10_141: Value<i32> = Rc::new(RefCell::new(38));
);
thread_local!(
    pub static max_digits10_142: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static radix_143: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!(
    pub static min_exponent_144: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static min_exponent10_145: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent_146: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent10_147: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static traps_148: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static tinyness_before_149: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
impl absl_int128 {
    ...
    fn absl_int12813(high: i64, low: u64) -> Self {
        ...
        let __this: Value<absl_int128> = Rc::new(RefCell::new(Self {
            v_: Rc::new(RefCell::new(
                (({ BitCastToSigned_150((((*high.borrow()) as u128) << 64)) })
                    | ((*low.borrow()) as i128)),
            )),
        }));
        let this: Ptr<absl_int128> = __this.as_pointer();
...
pub fn Int128Max_153() -> absl_int128 {
    return absl_int128::absl_int12813({ <i64>::MAX }, { <u64>::MAX });
}
pub fn Int128Min_154() -> absl_int128 {
    return absl_int128::absl_int12813({ <i64>::MIN }, { 0_u64 });
}
thread_local!(
    pub static is_specialized_155: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_signed_156: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_integer_157: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_exact_158: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static has_infinity_159: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_quiet_NaN_160: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_signaling_NaN_161: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static has_denorm_162: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static has_denorm_loss_163: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static round_style_164: Value = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static is_iec559_165: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static is_bounded_166: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static is_modulo_167: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static digits_168: Value<i32> = Rc::new(RefCell::new(127));
);
thread_local!(
    pub static digits10_169: Value<i32> = Rc::new(RefCell::new(38));
);
thread_local!(
    pub static max_digits10_170: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static radix_171: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!(
    pub static min_exponent_172: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static min_exponent10_173: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent_174: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static max_exponent10_175: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static traps_176: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static tinyness_before_177: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
pub struct std_numeric_limits_absl_int128_ {}
impl std_numeric_limits_absl_int128_ {
    pub fn min() -> absl_int128 {
        return ({ Int128Min_154() });
    }
    pub fn lowest() -> absl_int128 {
        return ({ Int128Min_154() });
    }
    pub fn max() -> absl_int128 {
        return ({ Int128Max_153() });
    }
...
pub fn MakeUint128_178(high: u64, low: u64) -> absl_uint128 {
    let high: Value<u64> = Rc::new(RefCell::new(high));
    let low: Value<u64> = Rc::new(RefCell::new(low));
    return absl_uint128::absl_uint12810({ (*high.borrow()) }, { (*low.borrow()) });
}
pub fn Uint128Low64_186(v: absl_uint128) -> u64 {
    let v: Value<absl_uint128> = Rc::new(RefCell::new(v));
    return (*(*v.borrow()).lo_.borrow());
}
pub fn Uint128High64_187(v: absl_uint128) -> u64 {
    let v: Value<absl_uint128> = Rc::new(RefCell::new(v));
    return (*(*v.borrow()).hi_.borrow());
}
pub fn operator_eq_125(lhs: absl_uint128, rhs: absl_uint128) -> bool {
...
pub fn operator_ne_188(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_uint128 = (*lhs.borrow()).clone();
        operator_eq_125(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_lt_189(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
        < ({ absl_uint128Impl::operator_unsigned___int128(&rhs.as_pointer()) }));
}
pub fn operator_gt_190(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_uint128 = (*rhs.borrow()).clone();
        operator_lt_189(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_le_191(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_uint128 = (*rhs.borrow()).clone();
...
pub fn operator_ge_192(lhs: absl_uint128, rhs: absl_uint128) -> bool {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_uint128 = (*lhs.borrow()).clone();
        operator_lt_189(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_cmp_124(lhs: absl_uint128, rhs: absl_uint128) -> std::cmp::Ordering {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    {
...
pub fn operator_pos_193(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return (*val.borrow()).clone();
}
pub fn operator_pos_194(val: absl_int128) -> absl_int128 {
    let val: Value<absl_int128> = Rc::new(RefCell::new(val));
    return (*val.borrow()).clone();
}
pub fn operator_neg_195(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return absl_uint128::absl_uint1288({
        -({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) })
    });
}
pub fn operator_not_196(val: absl_uint128) -> bool {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return !(({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) }) != 0);
}
pub fn operator_bitnot_197(val: absl_uint128) -> absl_uint128 {
    let val: Value<absl_uint128> = Rc::new(RefCell::new(val));
    return absl_uint128::absl_uint1288({
        !({ absl_uint128Impl::operator_unsigned___int128(&val.as_pointer()) })
    });
}
pub fn operator_bitor_198(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_bitand_199(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_bitxor_200(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_shl_179(lhs: absl_uint128, amount: i32) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
...
pub fn operator_shr_180(lhs: absl_uint128, amount: i32) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_uint128::absl_uint1288({
        (({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_add_181(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_sub_182(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_mul_183(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_div_184(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn operator_rem_185(lhs: absl_uint128, rhs: absl_uint128) -> absl_uint128 {
    let lhs: Value<absl_uint128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_uint128> = Rc::new(RefCell::new(rhs));
    return absl_uint128::absl_uint1288({
        ({ absl_uint128Impl::operator_unsigned___int128(&lhs.as_pointer()) })
...
pub fn MakeInt128_201(high: i64, low: u64) -> absl_int128 {
    let high: Value<i64> = Rc::new(RefCell::new(high));
    let low: Value<u64> = Rc::new(RefCell::new(low));
    return absl_int128::absl_int12813({ (*high.borrow()) }, { (*low.borrow()) });
}
pub fn BitCastToSigned_212(v: u64) -> i64 {
    let v: Value<u64> = Rc::new(RefCell::new(v));
...
pub fn BitCastToSigned_150(v: u128) -> i128 {
    let v: Value<u128> = Rc::new(RefCell::new(v));
...
pub fn Int128Low64_122(v: absl_int128) -> u64 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return (((*(*v.borrow()).v_.borrow()) & (!0_u64 as i128)) as u64);
}
pub fn Int128High64_123(v: absl_int128) -> i64 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return ({ BitCastToSigned_212(((((*(*v.borrow()).v_.borrow()) as u128) >> 64) as u64)) });
}
pub fn operator_eq_152(lhs: absl_int128, rhs: absl_int128) -> bool {
...
pub fn operator_ne_213(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        != ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_lt_214(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        < ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_gt_215(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        > ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_le_216(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        <= ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_ge_217(lhs: absl_int128, rhs: absl_int128) -> bool {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
        >= ({ absl_int128Impl::operator___int128(&rhs.as_pointer()) }));
}
pub fn operator_cmp_151(lhs: absl_int128, rhs: absl_int128) -> std::cmp::Ordering {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    {
...
pub fn operator_neg_218(v: absl_int128) -> absl_int128 {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return absl_int128::absl_int1288({
        -({ absl_int128Impl::operator___int128(&v.as_pointer()) })
    });
}
pub fn operator_not_219(v: absl_int128) -> bool {
    let v: Value<absl_int128> = Rc::new(RefCell::new(v));
    return !(({ absl_int128Impl::operator___int128(&v.as_pointer()) }) != 0);
}
pub fn operator_bitnot_220(val: absl_int128) -> absl_int128 {
    let val: Value<absl_int128> = Rc::new(RefCell::new(val));
    return absl_int128::absl_int1288({
        !({ absl_int128Impl::operator___int128(&val.as_pointer()) })
    });
}
pub fn operator_add_202(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_sub_203(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_mul_204(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_div_205(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_rem_206(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitor_207(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitand_208(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_bitxor_209(lhs: absl_int128, rhs: absl_int128) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_int128> = Rc::new(RefCell::new(rhs));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) })
...
pub fn operator_shl_210(lhs: absl_int128, amount: i32) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_int128::absl_int1288({
...
pub fn operator_shr_211(lhs: absl_int128, amount: i32) -> absl_int128 {
    let lhs: Value<absl_int128> = Rc::new(RefCell::new(lhs));
    let amount: Value<i32> = Rc::new(RefCell::new(amount));
    return absl_int128::absl_int1288({
        (({ absl_int128Impl::operator___int128(&lhs.as_pointer()) }) >> (*amount.borrow()))
...
thread_local!(
    pub static kSignificandSize_221: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    static kUint64MSB_222: Value<u64> = Rc::new(RefCell::new((1_u64 << 63)));
);
#[derive()]
    ...
    pub fn Times(a: Ptr<v8_base_DiyFp>, b: Ptr<v8_base_DiyFp>) -> v8_base_DiyFp {
        let mul: Value<absl_uint128> = Rc::new(RefCell::new(
            ({
                ...
                operator_mul_183(_lhs, _rhs)
            }),
        ));
        let hi: Value<u64> = Rc::new(RefCell::new(
            ({ Uint128High64_187((*mul.borrow()).clone()) }),
        ));
        let lo: Value<u64> = Rc::new(RefCell::new(
            ({ Uint128Low64_186((*mul.borrow()).clone()) }),
        ));
...
pub fn double_to_uint64_223(d: f64) -> u64 {
    let d: Value<f64> = Rc::new(RefCell::new(d));
    return ({ bit_cast_28(d.as_pointer()) });
}
pub fn uint64_to_double_224(d64: u64) -> f64 {
    let d64: Value<u64> = Rc::new(RefCell::new(d64));
    return ({ bit_cast_30(d64.as_pointer()) });
}
thread_local!(
    pub static kSignMask_225: Value<u64> = Rc::new(RefCell::new(9223372036854775808));
);
thread_local!(
    pub static kExponentMask_226: Value<u64> = Rc::new(RefCell::new(9218868437227405312));
);
thread_local!(
    pub static kSignificandMask_227: Value<u64> = Rc::new(RefCell::new(4503599627370495));
);
thread_local!(
    pub static kHiddenBit_228: Value<u64> = Rc::new(RefCell::new(4503599627370496));
);
thread_local!(
    pub static kPhysicalSignificandSize_229: Value<i32> = Rc::new(RefCell::new(52));
);
thread_local!(
    pub static kSignificandSize_230: Value<i32> = Rc::new(RefCell::new(53));
);
thread_local!(
    static kExponentBias_231: Value<i32> = Rc::new(RefCell::new(1075));
);
thread_local!(
    static kDenormalExponent_232: Value<i32> = Rc::new(RefCell::new(-1074));
);
thread_local!(
    static kMaxExponent_233: Value<i32> = Rc::new(RefCell::new(972));
);
thread_local!(
    static kInfinity_234: Value<u64> = Rc::new(RefCell::new(9218868437227405312));
);
#[derive()]
...
impl v8_base_Double {
    ...
    pub fn v8_base_Double2(d: f64) -> Self {
        let d: Value<f64> = Rc::new(RefCell::new(d));
        let __this: Value<v8_base_Double> = Rc::new(RefCell::new(Self {
            d64_: Rc::new(RefCell::new(({ double_to_uint64_223((*d.borrow())) }))),
        }));
        let this: Ptr<v8_base_Double> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
...
#[derive()]
pub struct v8_base_UInt128 {
    value_: Value<absl_uint128>,
}
impl v8_base_UInt128 {
    pub fn v8_base_UInt1281() -> Self {
        let __this: Value<v8_base_UInt128> = Rc::new(RefCell::new(Self {
            value_: Rc::new(RefCell::new(absl_uint128::absl_uint1281({ 0 }))),
        }));
        let this: Ptr<v8_base_UInt128> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    pub fn v8_base_UInt1282(high: u64, low: u64) -> Self {
        let high: Value<u64> = Rc::new(RefCell::new(high));
        let low: Value<u64> = Rc::new(RefCell::new(low));
        let __this: Value<v8_base_UInt128> = Rc::new(RefCell::new(Self {
            value_: Rc::new(RefCell::new(
                ({ MakeUint128_178((*high.borrow()), (*low.borrow())) }),
            )),
        }));
        let this: Ptr<v8_base_UInt128> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
...
impl Clone for v8_base_UInt128 {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_UInt128> = Rc::new(RefCell::new(Self {
            value_: Rc::new(RefCell::new((*self.value_.borrow()).clone())),
        }));
        let this: Ptr<v8_base_UInt128> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for v8_base_UInt128 {
    fn default() -> Self {
        { v8_base_UInt128::v8_base_UInt1281() }
    }
}
impl ByteRepr for v8_base_UInt128 {
    fn byte_size() -> usize {
        16
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.value_.borrow()).to_bytes(&mut buf[0..16]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            value_: Rc::new(RefCell::new(<absl_uint128>::from_bytes(&buf[0..16]))),
        }
    }
}
thread_local!(
    pub static kDoubleSignificandSize_235: Value<i32> = Rc::new(RefCell::new(53));
);
pub fn FillDigits32FixedLength_236(
    number: u32,
    ...
    let requested_length: Value<i32> = Rc::new(RefCell::new(requested_length));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let i: Value<i32> = Rc::new(RefCell::new(((*requested_length.borrow()) - 1)));
    'loop_: while ((*i.borrow()) >= 0) {
        ...
        .write(
            (((('0' as u8) as u32).wrapping_add((*number.borrow()).wrapping_rem(10_u32))) as u8),
        );
        {
            let rhs_0 = (*number.borrow()).wrapping_div(10_u32);
            (*number.borrow_mut()) = rhs_0
        };
        (*i.borrow_mut()).prefix_dec();
    }
    let __rhs = (*requested_length.borrow());
    {
        let _ptr = (*length.borrow()).clone();
        _ptr.write(_ptr.read() + __rhs)
    };
}
pub fn FillDigits32_237(number: u32, buffer: v8_base_Vector_char_, length: Ptr<i32>) {
    let number: Value<u32> = Rc::new(RefCell::new(number));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let number_length: Value<i32> = Rc::new(RefCell::new(0));
    'loop_: while ((*number.borrow()) != 0_u32) {
        let digit: Value<i32> = Rc::new(RefCell::new(
            (((*number.borrow()).wrapping_rem(10_u32)) as i32),
        ));
        {
            let rhs_0 = (*number.borrow()).wrapping_div(10_u32);
            (*number.borrow_mut()) = rhs_0
        ...
        ({
            v8_base_Vector_char_Impl::operator_index(
                ...
                (({
                    let _lhs = ((*length.borrow()).read());
                    _lhs + (*number_length.borrow())
                }) as usize),
            )
        })
        .write((((('0' as u8) as i32) + (*digit.borrow())) as u8));
        (*number_length.borrow_mut()).postfix_inc();
    }
    let i: Value<i32> = Rc::new(RefCell::new(((*length.borrow()).read())));
    ...
    'loop_: while ((*i.borrow()) < (*j.borrow())) {
        ...
        let __rhs = (({
            v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), ((*j.borrow()) as usize))
        })
        .read());
        ({
            v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), ((*i.borrow()) as usize))
        })
        .write(__rhs);
        ({
            v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), ((*j.borrow()) as usize))
    ...
    let __rhs = (*number_length.borrow());
    {
        let _ptr = (*length.borrow()).clone();
        _ptr.write(_ptr.read() + __rhs)
    };
}
pub fn FillDigits64FixedLength_238(
    number: u64,
    requested_length: i32,
    buffer: v8_base_Vector_char_,
    length: Ptr<i32>,
) {
    let number: Value<u64> = Rc::new(RefCell::new(number));
    let requested_length: Value<i32> = Rc::new(RefCell::new(requested_length));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let kTen7: Value<u32> = Rc::new(RefCell::new(10000000_u32));
    let part2: Value<u32> = Rc::new(RefCell::new(
        (((*number.borrow()).wrapping_rem(((*kTen7.borrow()) as u64))) as u32),
    ));
    {
        let rhs_0 = (*number.borrow()).wrapping_div(((*kTen7.borrow()) as u64));
        (*number.borrow_mut()) = rhs_0
    };
    let part1: Value<u32> = Rc::new(RefCell::new(
        (((*number.borrow()).wrapping_rem(((*kTen7.borrow()) as u64))) as u32),
    ));
    let part0: Value<u32> = Rc::new(RefCell::new(
        (((*number.borrow()).wrapping_div(((*kTen7.borrow()) as u64))) as u32),
    ));
    ({
        let _length: Ptr<i32> = (*length.borrow()).clone();
        FillDigits32FixedLength_236((*part0.borrow()), 3, (*buffer.borrow()).clone(), _length)
    });
    ({
        let _length: Ptr<i32> = (*length.borrow()).clone();
        FillDigits32FixedLength_236((*part1.borrow()), 7, (*buffer.borrow()).clone(), _length)
    });
    ({
        let _length: Ptr<i32> = (*length.borrow()).clone();
        FillDigits32FixedLength_236((*part2.borrow()), 7, (*buffer.borrow()).clone(), _length)
    });
}
pub fn FillDigits64_239(number: u64, buffer: v8_base_Vector_char_, length: Ptr<i32>) {
    let number: Value<u64> = Rc::new(RefCell::new(number));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let kTen7: Value<u32> = Rc::new(RefCell::new(10000000_u32));
...
pub fn DtoaRoundUp_240(buffer: v8_base_Vector_char_, length: Ptr<i32>, decimal_point: Ptr<i32>) {
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let decimal_point: Value<Ptr<i32>> = Rc::new(RefCell::new(decimal_point));
    if (((*length.borrow()).read()) == 0) {
        ({ v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), 0_usize) })
            .write(('1' as u8));
        (*decimal_point.borrow()).write(1);
    ...
    ({
        v8_base_Vector_char_Impl::operator_index(
            &buffer.as_pointer(),
            ((((*length.borrow()).read()) - 1) as usize),
        )
    })
    .with_mut(|__v| __v.postfix_inc());
    let i: Value<i32> = Rc::new(RefCell::new((((*length.borrow()).read()) - 1)));
    'loop_: while ((*i.borrow()) > 0) {
        if (((({
            v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), ((*i.borrow()) as usize))
        })
        ...
        == ((('0' as u8) as i32) + 10))
    {
        ({ v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), 0_usize) })
            .write(('1' as u8));
        (*decimal_point.borrow()).with_mut(|__v| __v.postfix_inc());
    }
}
pub fn FillFractionals_241(
    fractionals: u64,
    exponent: i32,
    ...
    let fractionals: Value<u64> = Rc::new(RefCell::new(fractionals));
    let exponent: Value<i32> = Rc::new(RefCell::new(exponent));
    let fractional_count: Value<i32> = Rc::new(RefCell::new(fractional_count));
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let decimal_point: Value<Ptr<i32>> = Rc::new(RefCell::new(decimal_point));
    (&(0));
    if (-(*exponent.borrow()) <= 64) {
        (&(0));
        let point: Value<i32> = Rc::new(RefCell::new(-(*exponent.borrow())));
        let i: Value<i32> = Rc::new(RefCell::new(0));
        'loop_: while ((*i.borrow()) < (*fractional_count.borrow())) {
            if ((*fractionals.borrow()) == 0_u64) {
                break;
            }
            {
                let rhs_0 = (*fractionals.borrow()).wrapping_mul(5_u64);
                (*fractionals.borrow_mut()) = rhs_0
            };
            (*point.borrow_mut()).postfix_dec();
            let digit: Value<i32> = Rc::new(RefCell::new(
                (((*fractionals.borrow()) >> (*point.borrow())) as i32),
            ));
            ({
                v8_base_Vector_char_Impl::operator_index(
                    &buffer.as_pointer(),
            ...
            {
                let rhs_0 = (*fractionals.borrow())
                    .wrapping_sub((((*digit.borrow()) as u64) << (*point.borrow())));
                (*fractionals.borrow_mut()) = rhs_0
            };
            (*i.borrow_mut()).prefix_inc();
        }
        if ((*point.borrow()) > 0)
            && ((((*fractionals.borrow()) >> ((*point.borrow()) - 1)) & 1_u64) == 1_u64)
        {
            ({
                DtoaRoundUp_240(
                    (*buffer.borrow()).clone(),
                    (*length.borrow()).clone(),
                    (*decimal_point.borrow()).clone(),
                )
            });
        }
    } else {
        (&(0));
        let fractionals128: Value<v8_base_UInt128> = Rc::new(RefCell::new(
            v8_base_UInt128::v8_base_UInt1282({ (*fractionals.borrow()) }, { 0_u64 }),
        ));
        ({
            v8_base_UInt128Impl::Shift(&fractionals128.as_pointer(), (-(*exponent.borrow()) - 64))
        });
        let point: Value<i32> = Rc::new(RefCell::new(128));
        let i: Value<i32> = Rc::new(RefCell::new(0));
        'loop_: while ((*i.borrow()) < (*fractional_count.borrow())) {
            if ({ v8_base_UInt128Impl::IsZero(&fractionals128.as_pointer()) }) {
                break;
            }
            ({ v8_base_UInt128Impl::Multiply(&fractionals128.as_pointer(), 5_u32) });
            (*point.borrow_mut()).postfix_dec();
            let digit: Value<i32> = Rc::new(RefCell::new(
                ({
                    v8_base_UInt128Impl::DivModPowerOf2(
                        &fractionals128.as_pointer(),
                        (*point.borrow()),
                    )
                }),
            ));
        ...
        if (({ v8_base_UInt128Impl::BitAt(&fractionals128.as_pointer(), ((*point.borrow()) - 1)) })
            == 1)
        {
            ({
                DtoaRoundUp_240(
...
pub fn TrimZeros_242(buffer: v8_base_Vector_char_, length: Ptr<i32>, decimal_point: Ptr<i32>) {
    let buffer: Value<v8_base_Vector_char_> = Rc::new(RefCell::new(buffer));
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let decimal_point: Value<Ptr<i32>> = Rc::new(RefCell::new(decimal_point));
    'loop_: while (((*length.borrow()).read()) > 0)
        && (((({
            v8_base_Vector_char_Impl::operator_index(
                &buffer.as_pointer(),
                ((((*length.borrow()).read()) - 1) as usize),
        ...
        .read()) as i32)
            == (('0' as u8) as i32))
    {
        (*length.borrow()).with_mut(|__v| __v.postfix_dec());
    }
    let first_non_zero: Value<i32> = Rc::new(RefCell::new(0));
    'loop_: while ({
        let _lhs = (*first_non_zero.borrow());
        _lhs < ((*length.borrow()).read())
    }) && (((({
        v8_base_Vector_char_Impl::operator_index(
            &buffer.as_pointer(),
            ((*first_non_zero.borrow()) as usize),
        )
    })
    .read()) as i32)
        == (('0' as u8) as i32))
    {
        (*first_non_zero.borrow_mut()).postfix_inc();
    }
    if ((*first_non_zero.borrow()) != 0) {
        let i: Value<i32> = Rc::new(RefCell::new((*first_non_zero.borrow())));
        'loop_: while {
            let _lhs = (*i.borrow());
            _lhs < ((*length.borrow()).read())
        } {
            ...
            ({
                v8_base_Vector_char_Impl::operator_index(
                    &buffer.as_pointer(),
                    (((*i.borrow()) - (*first_non_zero.borrow())) as usize),
                )
            })
            .write(__rhs);
            (*i.borrow_mut()).prefix_inc();
        }
        let __rhs = (*first_non_zero.borrow());
        {
            let _ptr = (*length.borrow()).clone();
            _ptr.write(_ptr.read() - __rhs)
        };
        let __rhs = (*first_non_zero.borrow());
        {
            let _ptr = (*decimal_point.borrow()).clone();
            _ptr.write(_ptr.read() - __rhs)
        };
    }
}
pub fn FastFixedDtoa_243(
    v: f64,
    fractional_count: i32,
    buffer: v8_base_Vector_char_,
    length: Ptr<i32>,
    ...
    let length: Value<Ptr<i32>> = Rc::new(RefCell::new(length));
    let decimal_point: Value<Ptr<i32>> = Rc::new(RefCell::new(decimal_point));
    let kMaxUInt32: Value<u32> = Rc::new(RefCell::new(4294967295_u32));
    let significand: Value<u64> = Rc::new(RefCell::new(
        ({
    ...
    if ((*exponent.borrow()) > 20) {
        return false;
    }
    if ((*fractional_count.borrow()) > 20) {
        return false;
    }
    (*length.borrow()).write(0);
    if (((*exponent.borrow()) + (*kDoubleSignificandSize_235.with(Value::clone).borrow())) > 64) {
        let kFive17: Value<u64> = Rc::new(RefCell::new(762939453125_u64));
        let divisor: Value<u64> = Rc::new(RefCell::new((*kFive17.borrow())));
        let divisor_power: Value<i32> = Rc::new(RefCell::new(17));
        let dividend: Value<u64> = Rc::new(RefCell::new((*significand.borrow())));
        let quotient: Value<u32> = <Value<u32>>::default();
        let remainder: Value<u64> = <Value<u64>>::default();
        if ((*exponent.borrow()) > (*divisor_power.borrow())) {
            (*dividend.borrow_mut()) <<= ((*exponent.borrow()) - (*divisor_power.borrow()));
            (*quotient.borrow_mut()) =
                (((*dividend.borrow()).wrapping_div((*divisor.borrow()))) as u32);
            (*remainder.borrow_mut()) = (((*dividend.borrow()).wrapping_rem((*divisor.borrow())))
                << (*divisor_power.borrow()));
        } else {
            (*divisor.borrow_mut()) <<= ((*divisor_power.borrow()) - (*exponent.borrow()));
            (*quotient.borrow_mut()) =
                (((*dividend.borrow()).wrapping_div((*divisor.borrow()))) as u32);
            (*remainder.borrow_mut()) =
                (((*dividend.borrow()).wrapping_rem((*divisor.borrow()))) << (*exponent.borrow()));
        }
        ({
            FillDigits32_237(
                (*quotient.borrow()),
        ...
        ({
            let _requested_length: i32 = (*divisor_power.borrow());
            let _length: Ptr<i32> = (*length.borrow()).clone();
            FillDigits64FixedLength_238(
                (*remainder.borrow()),
                _requested_length,
                (*buffer.borrow()).clone(),
                _length,
        ...
        let __rhs = ((*length.borrow()).read());
        (*decimal_point.borrow()).write(__rhs);
    } else if ((*exponent.borrow()) >= 0) {
        (*significand.borrow_mut()) <<= (*exponent.borrow());
        ({
            FillDigits64_239(
                (*significand.borrow()),
                (*buffer.borrow()).clone(),
        ...
        let __rhs = ((*length.borrow()).read());
        (*decimal_point.borrow()).write(__rhs);
    } else if ((*exponent.borrow()) > -(*kDoubleSignificandSize_235.with(Value::clone).borrow())) {
        let integrals: Value<u64> = Rc::new(RefCell::new(
            ((*significand.borrow()) >> -(*exponent.borrow())),
        ));
        let fractionals: Value<u64> = Rc::new(RefCell::new(
            (*significand.borrow()).wrapping_sub(((*integrals.borrow()) << -(*exponent.borrow()))),
        ));
        if ((*integrals.borrow()) > ((*kMaxUInt32.borrow()) as u64)) {
            ({
                FillDigits64_239(
                    (*integrals.borrow()),
                    (*buffer.borrow()).clone(),
        ...
        (*decimal_point.borrow()).write(__rhs);
        ({
            let _exponent: i32 = (*exponent.borrow());
            let _fractional_count: i32 = (*fractional_count.borrow());
            let _length: Ptr<i32> = (*length.borrow()).clone();
            let _decimal_point: Ptr<i32> = (*decimal_point.borrow()).clone();
            FillFractionals_241(
                (*fractionals.borrow()),
                _exponent,
                _fractional_count,
    ...
    } else if ((*exponent.borrow()) < -128_i32) {
        (&(0));
        ({ v8_base_Vector_char_Impl::operator_index(&buffer.as_pointer(), 0_usize) })
            .write(('\0' as u8));
        (*length.borrow()).write(0);
        let __rhs = -(*fractional_count.borrow());
        (*decimal_point.borrow()).write(__rhs);
    } else {
        (*decimal_point.borrow()).write(0);
        ({
            let _exponent: i32 = (*exponent.borrow());
            let _fractional_count: i32 = (*fractional_count.borrow());
            let _length: Ptr<i32> = (*length.borrow()).clone();
...
impl absl_int128Impl for Ptr<absl_int128> {
    ...
    fn operator_add_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                ...
                operator_add_202(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_sub_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_sub_203(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_mul_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_mul_204(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_div_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_div_205(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_rem_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_rem_206(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitor_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitor_207(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitand_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitand_208(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitxor_assign(&self, other: absl_int128) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_bitxor_209(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_shl_assign(&self, amount: i32) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_shl_210(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_shr_assign(&self, amount: i32) -> Ptr<absl_int128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_int128 = (*(*self).upgrade().deref()).clone();
                operator_shr_211(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
...
impl absl_uint128Impl for Ptr<absl_uint128> {
    ...
    fn operator_shl_assign(&self, amount: i32) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                ...
                operator_shl_179(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_shr_assign(&self, amount: i32) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_shr_180(_lhs, (*amount.borrow()))
            }),
        );
        return (*self).clone();
    }
    fn operator_add_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_add_181(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_sub_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_sub_182(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_mul_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_mul_183(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_div_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_div_184(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_rem_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_rem_185(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    ...
    fn operator_bitor_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitor_198(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitand_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitand_199(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
    fn operator_bitxor_assign(&self, other: absl_uint128) -> Ptr<absl_uint128> {
        ...
        (*self).write(
            ({
                let _lhs: absl_uint128 = (*(*self).upgrade().deref()).clone();
                operator_bitxor_200(_lhs, (*other.borrow()).clone())
            }),
        );
        return (*self).clone();
    }
...
impl v8_base_DiyFpImpl for Ptr<v8_base_DiyFp> {
    ...
    fn Normalize(&self) {
        ...
        'loop_: while (((*f.borrow()) & (*kUint64MSB_222.with(Value::clone).borrow())) == 0_u64) {
            (*f.borrow_mut()) <<= 1;
...
impl v8_base_DoubleImpl for Ptr<v8_base_Double> {
    ...
    fn AsNormalizedDiyFp(&self) -> v8_base_DiyFp {
        ...
        (*f.borrow_mut()) <<= ((*kSignificandSize_221.with(Value::clone).borrow()) - 53);
        (*e.borrow_mut()) -= ((*kSignificandSize_221.with(Value::clone).borrow()) - 53);
    ...
    fn value(&self) -> f64 {
        return ({ uint64_to_double_224((*(*(*self).upgrade().deref()).d64_.borrow())) });
    }
}
...
pub trait v8_base_UInt128Impl {
    fn Multiply(&self, multiplicand: u32);
    fn Shift(&self, shift_amount: i32);
    fn DivModPowerOf2(&self, power: i32) -> i32;
    fn IsZero(&self) -> bool;
    fn BitAt(&self, position: i32) -> i32;
}
impl v8_base_UInt128Impl for Ptr<v8_base_UInt128> {
    fn Multiply(&self, multiplicand: u32) {
        let multiplicand: Value<u32> = Rc::new(RefCell::new(multiplicand));
        ({
            absl_uint128Impl::operator_mul_assign(
                &(*(*self).upgrade().deref()).value_.as_pointer(),
                absl_uint128::absl_uint1282({ (*multiplicand.borrow()) }),
            )
        });
    }
    fn Shift(&self, shift_amount: i32) {
        ...
        ({
            absl_uint128Impl::operator_shr_assign(
                &(*(*self).upgrade().deref()).value_.as_pointer(),
                (*shift_amount.borrow()),
            )
        });
    ...
    fn DivModPowerOf2(&self, power: i32) -> i32 {
        let power: Value<i32> = Rc::new(RefCell::new(power));
        let result: Value<absl_uint128> = Rc::new(RefCell::new(
            ({
                let _lhs: absl_uint128 = (*(*(*self).upgrade().deref()).value_.borrow()).clone();
                operator_shr_180(_lhs, (*power.borrow()))
            }),
        ));
        ({
            absl_uint128Impl::operator_sub_assign(
                &(*(*self).upgrade().deref()).value_.as_pointer(),
                ({
                    let _lhs: absl_uint128 = (*result.borrow()).clone();
                    operator_shl_179(_lhs, (*power.borrow()))
                }),
            )
        });
        return ({ absl_uint128Impl::operator_int(&result.as_pointer()) });
    }
    fn IsZero(&self) -> bool {
        return ({
            let _lhs: absl_uint128 = (*(*(*self).upgrade().deref()).value_.borrow()).clone();
            operator_eq_125(_lhs, absl_uint128::absl_uint1281({ 0 }))
        });
    }
    fn BitAt(&self, position: i32) -> i32 {
        let position: Value<i32> = Rc::new(RefCell::new(position));
        return (({
            absl_uint128Impl::operator_int(
                &Rc::new(RefCell::new(
                    ({
                        let _lhs: absl_uint128 =
                            (*(*(*self).upgrade().deref()).value_.borrow()).clone();
                        operator_shr_180(_lhs, (*position.borrow()))
                    }),
                ))
                .as_pointer(),
            )
