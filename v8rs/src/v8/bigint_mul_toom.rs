...
pub fn TimesTwo_93(X: v8_bigint_RWDigits) {
    let X: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(X));
    let carry: Value<u64> = Rc::new(RefCell::new(0_u64));
    let i: Value<u32> = Rc::new(RefCell::new(0_u32));
    'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&X.as_pointer()) })) {
        ...
        ({
            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                ...
                .as_pointer(),
                (((*d.borrow()) << 1) | (*carry.borrow())),
            )
        });
        (*carry.borrow_mut()) = ((*d.borrow()) >> (64 - 1));
        (*i.borrow_mut()).postfix_inc();
    }
}
pub fn DivideByTwo_94(X: v8_bigint_RWDigits) {
    let X: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(X));
    let carry: Value<u64> = Rc::new(RefCell::new(0_u64));
    let i: Value<u32> = Rc::new(RefCell::new(
        ({ v8_bigint_DigitsImpl::len(&X.as_pointer()) }),
...
pub fn DivideByThree_95(X: v8_bigint_RWDigits) {
    let X: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(X));
    ...
    'loop_: while ((*i.borrow_mut()).postfix_dec() > 0_u32) {
        ...
        let u_result: Value<u64> = Rc::new(RefCell::new((*upper.borrow()).wrapping_div(3_u64)));
        (*remainder.borrow_mut()) =
            (*upper.borrow()).wrapping_sub((3_u64).wrapping_mul((*u_result.borrow())));
        let lower: Value<u64> = Rc::new(RefCell::new(
            (((*remainder.borrow()) << 32) | ((*d.borrow()) & 4294967295)),
        ));
        let l_result: Value<u64> = Rc::new(RefCell::new((*lower.borrow()).wrapping_div(3_u64)));
        (*remainder.borrow_mut()) =
            (*lower.borrow()).wrapping_sub((3_u64).wrapping_mul((*l_result.borrow())));
        ({
            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                &Rc::new(RefCell::new(
                    ({ v8_bigint_RWDigitsImpl::operator_index(&X.as_pointer(), (*i.borrow())) }),
...
pub trait v8_bigint_ProcessorImplImpl {
    fn MultiplyToomCook(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits);
    fn Toom3Main(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits);
...
impl v8_bigint_ProcessorImplImpl for Ptr<v8_bigint_ProcessorImpl> {
    ...
    fn Toom3Main(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits) {
        ...
        let X1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*X.borrow()).clone() }, { (*i.borrow()) }, {
                (*i.borrow())
            }),
        ));
        let X2: Value<v8_bigint_Digits> =
            Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                { (*X.borrow()).clone() },
                { (2_u32).wrapping_mul((*i.borrow())) },
                { (*i.borrow()) },
            )));
        let Y0: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*Y.borrow()).clone() }, { 0_u32 }, {
                (*i.borrow())
            }),
        ));
        let Y1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*Y.borrow()).clone() }, { (*i.borrow()) }, {
                (*i.borrow())
            }),
        ));
        let Y2: Value<v8_bigint_Digits> =
            Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                { (*Y.borrow()).clone() },
                { (2_u32).wrapping_mul((*i.borrow())) },
                { (*i.borrow()) },
            )));
        let p_len: Value<u32> = Rc::new(RefCell::new((*i.borrow()).wrapping_add(1_u32)));
        let r_len: Value<u32> = Rc::new(RefCell::new((2_u32).wrapping_mul((*p_len.borrow()))));
        let temp_storage: Value<v8_bigint_Storage> = Rc::new(RefCell::new(
            v8_bigint_Storage::v8_bigint_Storage({ (4_u32).wrapping_mul((*r_len.borrow())) }, {
                ({ v8_bigint_ProcessorImpl::platform(self) })
            }),
        ));
        let t: Value<Ptr<u64>> = Rc::new(RefCell::new(
            ({ v8_bigint_StorageImpl::get(&temp_storage.as_pointer()) }),
        ));
        let po: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits1({ (*t.borrow()).clone() }, {
                (*p_len.borrow())
            }),
        ));
        let qo: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                { (*t.borrow()).offset((*p_len.borrow()) as isize) },
                { (*p_len.borrow()) },
            )));
        let p_1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                { (*t.borrow()).offset((*r_len.borrow()) as isize) },
                { (*p_len.borrow()) },
            )));
        let q_1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                {
                    (*t.borrow())
                        .offset((*r_len.borrow()) as isize)
                        .offset((*p_len.borrow()) as isize)
                },
                { (*p_len.borrow()) },
            )));
        let r_1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                { (*t.borrow()).offset(((2_u32).wrapping_mul((*r_len.borrow()))) as isize) },
                { (*r_len.borrow()) },
            )));
        let r_m1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                { (*t.borrow()).offset(((3_u32).wrapping_mul((*r_len.borrow()))) as isize) },
                { (*r_len.borrow()) },
            )));
        (&(0));
        let r_0: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
        ...
        let p_m1: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*po.borrow()).clone()));
        let p_m1_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                SubtractSigned_46(
                    (*p_m1.borrow()).clone(),
                    (*po.borrow()).clone(),
        ...
        let q_m1: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*qo.borrow()).clone()));
        let q_m1_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                SubtractSigned_46(
                    (*q_m1.borrow()).clone(),
                    (*qo.borrow()).clone(),
        ...
        let r_m1_sign: Value<bool> = Rc::new(RefCell::new(
            (((*p_m1_sign.borrow()) as i32) != ((*q_m1_sign.borrow()) as i32)),
        ));
        let p_m2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*p_1.borrow()).clone()));
        (&(0));
        let p_m2_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                AddSigned_45(
                    (*p_m2.borrow()).clone(),
                    (*p_m1.borrow()).clone(),
        ...
        ({ TimesTwo_93((*p_m2.borrow()).clone()) });
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*p_m2.borrow()).clone();
            let _X: v8_bigint_Digits = (*p_m2.borrow()).clone();
            SubtractSigned_46(_Z, _X, (*p_m2_sign.borrow()), (*X0.borrow()).clone(), false)
        });
        (*p_m2_sign.borrow_mut()) = __rhs;
        let q_m2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*q_1.borrow()).clone()));
        (&(0));
        let q_m2_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                AddSigned_45(
                    (*q_m2.borrow()).clone(),
                    (*q_m1.borrow()).clone(),
        ...
        ({ TimesTwo_93((*q_m2.borrow()).clone()) });
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*q_m2.borrow()).clone();
            let _X: v8_bigint_Digits = (*q_m2.borrow()).clone();
            SubtractSigned_46(_Z, _X, (*q_m2_sign.borrow()), (*Y0.borrow()).clone(), false)
        });
        (*q_m2_sign.borrow_mut()) = __rhs;
        let r_m2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits1({ (*t.borrow()).clone() }, {
                (*r_len.borrow())
            }),
        ));
        ...
        let r_m2_sign: Value<bool> = Rc::new(RefCell::new(
            (((*p_m2_sign.borrow()) as i32) != ((*q_m2_sign.borrow()) as i32)),
        ));
        let r_inf: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                { (*t.borrow()).offset((*r_len.borrow()) as isize) },
                { (*r_len.borrow()) },
            )));
        ...
        let R0: Value<v8_bigint_Digits> = Rc::new(RefCell::new((*r_0.borrow()).clone()));
        let R4: Value<v8_bigint_Digits> = Rc::new(RefCell::new((*r_inf.borrow()).clone()));
        let R3: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*r_m2.borrow()).clone()));
        let R3_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                SubtractSigned_46(
                    (*R3.borrow()).clone(),
                    (*r_m2.borrow()).clone(),
        ...
        ({ DivideByThree_95((*R3.borrow()).clone()) });
        let R1: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*r_1.borrow()).clone()));
        let R1_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                SubtractSigned_46(
                    (*R1.borrow()).clone(),
                    (*r_1.borrow()).clone(),
        ...
        ({ DivideByTwo_94((*R1.borrow()).clone()) });
        let R2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*r_m1.borrow()).clone()));
        let R2_sign: Value<bool> = Rc::new(RefCell::new(
            ({
                SubtractSigned_46(
                    (*R2.borrow()).clone(),
                    (*r_m1.borrow()).clone(),
        ...
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*R3.borrow()).clone();
            let _Y: v8_bigint_Digits = (*R3.borrow()).clone();
            SubtractSigned_46(
                _Z,
                (*R2.borrow()).clone(),
                (*R2_sign.borrow()),
        ...
        (*R3_sign.borrow_mut()) = __rhs;
        ({ DivideByTwo_94((*R3.borrow()).clone()) });
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*R3.borrow()).clone();
            let _X: v8_bigint_Digits = (*R3.borrow()).clone();
            AddSigned_45(
                _Z,
                _X,
                (*R3_sign.borrow()),
        ...
        (*R3_sign.borrow_mut()) = __rhs;
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*R2.borrow()).clone();
            let _X: v8_bigint_Digits = (*R2.borrow()).clone();
            AddSigned_45(
                _Z,
                _X,
                (*R2_sign.borrow()),
        ...
        (*R2_sign.borrow_mut()) = __rhs;
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*R2.borrow()).clone();
            let _X: v8_bigint_Digits = (*R2.borrow()).clone();
            SubtractSigned_46(_Z, _X, (*R2_sign.borrow()), (*R4.borrow()).clone(), false)
        });
        (*R2_sign.borrow_mut()) = __rhs;
        let __rhs = ({
            let _Z: v8_bigint_RWDigits = (*R1.borrow()).clone();
            let _X: v8_bigint_Digits = (*R1.borrow()).clone();
            SubtractSigned_46(
                _Z,
                _X,
                (*R1_sign.borrow()),
        ...
        (*R1_sign.borrow_mut()) = __rhs;
        let j: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&R0.as_pointer()) }),
        ));
        'loop_: while ((*j.borrow()) < ({ v8_bigint_DigitsImpl::len(&Z.as_pointer()) })) {
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(&Z.as_pointer(), (*j.borrow()))
                        }),
                    ))
                    .as_pointer(),
                    0_u64,
    ...
    fn MultiplyToomCook(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits) {
        ...
        ({
            v8_bigint_ProcessorImplImpl::Toom3Main(
                self,
                (*Z.borrow()).clone(),
                (*X0.borrow()).clone(),
                (*Y.borrow()).clone(),
