...
pub fn DcheckIntegerPartRange_101(X: v8_bigint_Digits, min: u64, max: u64) {
    let X: Value<v8_bigint_Digits> = Rc::new(RefCell::new(X));
    let min: Value<u64> = Rc::new(RefCell::new(min));
    let max: Value<u64> = Rc::new(RefCell::new(max));
    (&(*X.borrow_mut()));
    (&(*min.borrow_mut()));
    (&(*max.borrow_mut()));
}
...
pub trait v8_bigint_ProcessorImplImpl {
    fn DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits(
        &self,
        Q: v8_bigint_RWDigits,
        R: v8_bigint_RWDigits,
        A: v8_bigint_Digits,
        B: v8_bigint_Digits,
    );
    fn DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_RWDigits(
        &self,
        Q: v8_bigint_RWDigits,
        R: v8_bigint_RWDigits,
        A: v8_bigint_Digits,
    ...
    fn Invert(&self, Z: v8_bigint_RWDigits, V: v8_bigint_Digits, scratch: v8_bigint_RWDigits);
    fn InvertBasecase(
        &self,
        Z: v8_bigint_RWDigits,
        V: v8_bigint_Digits,
    ...
    fn InvertNewton(&self, Z: v8_bigint_RWDigits, V: v8_bigint_Digits, scratch: v8_bigint_RWDigits);
...
impl v8_bigint_ProcessorImplImpl for Ptr<v8_bigint_ProcessorImpl> {
    ...
    fn InvertBasecase(
        ...
        let Z: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(Z));
        let V: Value<v8_bigint_Digits> = Rc::new(RefCell::new(V));
        let scratch: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(scratch));
        (&(0));
        (&(0));
        (&(0));
        let n: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&V.as_pointer()) }),
        ));
        let X: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                (2_u32).wrapping_mul((*n.borrow()))
            }),
        ));
        ...
        'loop_: while ((*i.borrow()) < (2_u32).wrapping_mul((*n.borrow()))) {
            ({
                let _digit: u64 = ({
                    let _borrow_in: u64 = (*borrow.borrow());
                    let _borrow_out: Ptr<u64> = (borrow.as_pointer());
                    digit_sub2_35(
                        ...
                        ({
                            v8_bigint_DigitsImpl::operator_index(
                                &V.as_pointer(),
                                (*i.borrow()).wrapping_sub((*n.borrow())),
                            )
                        }),
                        _borrow_in,
                        _borrow_out,
        ...
        (&(0));
        let R: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
        ...
        if ((*n.borrow()) < 57) {
            ...
            ({
                v8_bigint_ProcessorImplImpl::DivideBurnikelZiegler(
                    self,
                    (*Z.borrow()).clone(),
                    (*R.borrow()).clone(),
                    (*X.borrow()).clone(),
    ...
    fn InvertNewton(
        ...
        let V: Value<v8_bigint_Digits> = Rc::new(RefCell::new(V));
        let scratch: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(scratch));
        let vn: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&V.as_pointer()) }),
        ));
        (&(0));
        (&(0));
        let kSOffset: Value<u32> = Rc::new(RefCell::new(0_u32));
        let kWOffset: Value<u32> = Rc::new(RefCell::new(0_u32));
        let kUOffset: Value<u32> = Rc::new(RefCell::new((*vn.borrow()).wrapping_add(5)));
        (&(0));
        let basecase_precision: Value<u32> = Rc::new(RefCell::new({
            let __tmp_0: Value<u32> = Rc::new(RefCell::new((25).wrapping_sub(1_u32)));
            let __tmp_1: Value<u32> = Rc::new(RefCell::new(
                ((((*vn.borrow()).wrapping_sub(1_u32)).wrapping_div(((2) as u32)))
                    .wrapping_add(1_u32)),
            ));
            (if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                __tmp_0.as_pointer()
        ...
        (&(0));
        (&(0));
        let k: Value<u32> = Rc::new(RefCell::new((*vn.borrow()).wrapping_mul((64 as u32))));
        let target_fraction_bits: Value<Box<[i32]>> = Rc::new(RefCell::new(
            (0..32).map(|_| <i32>::default()).collect::<Box<[i32]>>(),
        ));
        let iteration: Value<i32> = Rc::new(RefCell::new(-1_i32));
        'loop_: while ((*k.borrow()) > (*basecase_precision.borrow()).wrapping_mul((64 as u32))) {
            (*iteration.borrow_mut()).postfix_inc();
            (*target_fraction_bits.borrow_mut())[(*iteration.borrow()) as usize] =
                ((*k.borrow()) as i32);
            let __rhs = ((((*k.borrow()).wrapping_sub(1_u32)).wrapping_div(((2) as u32)))
                .wrapping_add(1_u32));
            (*k.borrow_mut()) = __rhs;
        }
        let initial_digits: Value<u32> = Rc::new(RefCell::new(
            (((((*k.borrow()).wrapping_add(1_u32)).wrapping_sub(1_u32))
                .wrapping_div(((64) as u32)))
            .wrapping_add(1_u32)),
        ));
        let top_part_of_v: Value<v8_bigint_Digits> =
            Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                { (*V.borrow()).clone() },
                { (*vn.borrow()).wrapping_sub((*initial_digits.borrow())) },
                { (*initial_digits.borrow()) },
            )));
        ({
            v8_bigint_ProcessorImplImpl::InvertBasecase(
                self,
                (*Z.borrow()).clone(),
                (*top_part_of_v.borrow()).clone(),
        ...
        ({
            v8_bigint_RWDigitsImpl::set_len(
                &Z.as_pointer(),
                (*initial_digits.borrow()).wrapping_add(1_u32),
            )
        });
        'loop_: while true {
            ({ DcheckIntegerPartRange_101((*Z.borrow()).clone(), 1_u64, 2_u64) });
            let S: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*scratch.borrow()).clone() },
                    { (*kSOffset.borrow()) },
                    { (2_u32).wrapping_mul(({ v8_bigint_DigitsImpl::len(&Z.as_pointer()) })) },
                )));
            ({
                let _X: v8_bigint_Digits = (*Z.borrow()).clone();
                let _Y: v8_bigint_Digits = (*Z.borrow()).clone();
                v8_bigint_ProcessorImplImpl::Multiply(self, (*S.borrow()).clone(), _X, _Y)
            });
            if ({ v8_bigint_ProcessorImplImpl::should_terminate(self) }) {
                return;
            }
            ({ v8_bigint_DigitsImpl::TrimOne(&S.as_pointer()) });
            ({ DcheckIntegerPartRange_101((*S.borrow()).clone(), 1_u64, 4_u64) });
            let fraction_digits: Value<u32> = Rc::new(RefCell::new(
                ((((((2_u32).wrapping_mul((*k.borrow()))).wrapping_add(3_u32))
                    .wrapping_sub(1_u32))
                .wrapping_div(((64) as u32)))
                .wrapping_add(1_u32)),
            ));
            let t_len: Value<u32> = Rc::new(RefCell::new({
                let __tmp_0: Value<u32> = Rc::new(RefCell::new(
                    ({ v8_bigint_DigitsImpl::len(&V.as_pointer()) }),
                ));
                (if __tmp_0.as_pointer().read() <= fraction_digits.as_pointer().read() {
                    __tmp_0.as_pointer()
                } else {
                    fraction_digits.as_pointer()
                }
                .read())
            }));
            let T: Value<v8_bigint_Digits> =
                Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                    { (*V.borrow()).clone() },
                    {
                        ({ v8_bigint_DigitsImpl::len(&V.as_pointer()) })
                            .wrapping_sub((*t_len.borrow()))
                    },
                    { (*t_len.borrow()) },
                )));
            (*fraction_digits.borrow_mut()) = ((((((2_u32).wrapping_mul((*k.borrow())))
                .wrapping_add(1_u32))
            .wrapping_sub(1_u32))
            .wrapping_div(((64) as u32)))
            .wrapping_add(1_u32));
            let U: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    ...
                    { (*kUOffset.borrow()) },
                    {
                        ({ v8_bigint_DigitsImpl::len(&S.as_pointer()) })
                            .wrapping_add(({ v8_bigint_DigitsImpl::len(&T.as_pointer()) }))
                    },
                )));
            (&(0));
            ({
            ...
            let __rhs = ({
                let _i: u32 = (({ v8_bigint_DigitsImpl::len(&U.as_pointer()) })
                    .wrapping_sub(((1_u32).wrapping_add((*fraction_digits.borrow())))));
                v8_bigint_RWDigitsImpl::operator_add(&U.as_pointer(), _i)
            });
            (*U.borrow_mut()) = __rhs;
            ({ DcheckIntegerPartRange_101((*U.borrow()).clone(), 0_u64, 3_u64) });
            (&(0));
            let W: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*scratch.borrow()).clone() },
                    { (*kWOffset.borrow()) },
                    { ({ v8_bigint_DigitsImpl::len(&U.as_pointer()) }) },
                )));
            let padding_digits: Value<u32> = Rc::new(RefCell::new(
                ({ v8_bigint_DigitsImpl::len(&U.as_pointer()) })
                    .wrapping_sub(({ v8_bigint_DigitsImpl::len(&Z.as_pointer()) })),
            ));
            let i: Value<u32> = Rc::new(RefCell::new(0_u32));
            'loop_: while ((*i.borrow()) < (*padding_digits.borrow())) {
                ({
                    v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                        &Rc::new(RefCell::new(
                            ({
            ...
            ({ DcheckIntegerPartRange_101((*W.borrow()).clone(), 2_u64, 4_u64) });
            if (({ v8_bigint_DigitsImpl::len(&U.as_pointer()) }) <= (*vn.borrow())) {
                (&(0));
                ({
                    v8_bigint_RWDigitsImpl::set_len(
                        &Z.as_pointer(),
                ...
                (&(0));
                ({ v8_bigint_RWDigitsImpl::set_len(&Z.as_pointer(), (*vn.borrow())) });
                let W_part: Value<v8_bigint_Digits> =
                    Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                        { (*W.borrow()).clone() },
                        {
                            (({ v8_bigint_DigitsImpl::len(&W.as_pointer()) })
                                .wrapping_sub((*vn.borrow())))
                            .wrapping_sub(1_u32)
                        },
                        { (*vn.borrow()) },
                    )));
                let U_part: Value<v8_bigint_Digits> =
                    Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                        { (*U.borrow()).clone() },
                        {
                            (({ v8_bigint_DigitsImpl::len(&U.as_pointer()) })
                ...
                let integer_part: Value<u64> = Rc::new(RefCell::new(
                    (({ v8_bigint_DigitsImpl::msd(&W.as_pointer()) })
                        .wrapping_sub(({ v8_bigint_DigitsImpl::msd(&U.as_pointer()) })))
                    .wrapping_sub((*borrow.borrow())),
                ));
                (&(0));
                if ((*integer_part.borrow()) == 2_u64) {
                    let i: Value<u32> = Rc::new(RefCell::new(0_u32));
                    'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&Z.as_pointer()) }))
                    {
                        ({
            ...
            (*k.borrow_mut()) =
                ((*target_fraction_bits.borrow())[(*iteration.borrow()) as usize] as u32);
            (*iteration.borrow_mut()).postfix_dec();
        }
    }
    fn Invert(&self, Z: v8_bigint_RWDigits, V: v8_bigint_Digits, scratch: v8_bigint_RWDigits) {
        let Z: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(Z));
        ...
        if ((*vn.borrow()) >= 25) {
            ({
                v8_bigint_ProcessorImplImpl::InvertNewton(
                    self,
                    (*Z.borrow()).clone(),
                    (*V.borrow()).clone(),
                    (*scratch.borrow()).clone(),
        ...
        if ((*vn.borrow()) == 1_u32) {
            let d: Value<u64> = Rc::new(RefCell::new(
                ({ v8_bigint_DigitsImpl::operator_index(&V.as_pointer(), 0_u32) }),
            ));
            let dummy_remainder: Value<u64> = <Value<u64>>::default();
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({ v8_bigint_RWDigitsImpl::operator_index(&Z.as_pointer(), 0_u32) }),
                    ...
                    .as_pointer(),
                    ({
                        let _high: u64 = !(*d.borrow());
                        let _divisor: u64 = (*d.borrow());
                        digit_div_37(_high, !0_u64, _divisor, (dummy_remainder.as_pointer()))
                    }),
                )
            });
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({ v8_bigint_RWDigitsImpl::operator_index(&Z.as_pointer(), 1_u32) }),
                    ))
                    .as_pointer(),
                    0_u64,
                )
            ...
            if (({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_digit_t(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(&Z.as_pointer(), (*vn.borrow()))
                        }),
                    ))
                    .as_pointer(),
                )
            ...
            {
                let i: Value<u32> = Rc::new(RefCell::new(0_u32));
                'loop_: while ((*i.borrow()) < (*vn.borrow())) {
                    ({
                        v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                            &Rc::new(RefCell::new(
                                ({
    ...
    fn DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_RWDigits(
        ...
        let Q: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(Q));
        let R: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(R));
        let A: Value<v8_bigint_Digits> = Rc::new(RefCell::new(A));
        let B: Value<v8_bigint_Digits> = Rc::new(RefCell::new(B));
        let I: Value<v8_bigint_Digits> = Rc::new(RefCell::new(I));
        let scratch: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(scratch));
        (&(0));
        (&(0));
        (&(0));
        ...
        (&(0));
        (&(0));
        let orig_q_len: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&Q.as_pointer()) }),
        ));
        let A1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            ({
                v8_bigint_DigitsImpl::operator_add(
                    &A.as_pointer(),
                    ({ v8_bigint_DigitsImpl::len(&B.as_pointer()) }),
                )
            }),
        ));
        (&(0));
        let K: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                (2_u32).wrapping_mul(({ v8_bigint_DigitsImpl::len(&I.as_pointer()) }))
            }),
        ));
        ({
            v8_bigint_ProcessorImplImpl::Multiply(
        ...
        ({
            v8_bigint_RWDigitsImpl::set_len(
                &Q.as_pointer(),
                ({ v8_bigint_DigitsImpl::len(&I.as_pointer()) }).wrapping_add(1_u32),
            )
        });
        ({
            Add_42(
                ...
                ({
                    v8_bigint_RWDigitsImpl::operator_add(
                        &K.as_pointer(),
                        ({ v8_bigint_DigitsImpl::len(&I.as_pointer()) }),
                    )
                }),
                (*A1.borrow()).clone(),
            )
        });
        let P: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) }).wrapping_add(1_u32)
            }),
        ));
        ({
            v8_bigint_ProcessorImplImpl::Multiply(
        ...
        let borrow: Value<u64> = Rc::new(RefCell::new(
            ({
                SubtractAndReturnBorrow_54(
                    (*R.borrow()).clone(),
                    (*A.borrow()).clone(),
                    v8_bigint_Digits::v8_bigint_Digits3({ (*P.borrow()).clone() }, { 0_u32 }, {
                        ({ v8_bigint_DigitsImpl::len(&B.as_pointer()) })
                    }),
                )
            }),
        ...
        'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&R.as_pointer()) })) {
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(&R.as_pointer(), (*i.borrow()))
                        }),
                    ))
                    .as_pointer(),
                    0_u64,
        ...
        if (((*r_high.borrow()) >> (64 - 1)) == 1_u64) {
            let q_sub: Value<u64> = Rc::new(RefCell::new(0_u64));
            let mut __do_while = true;
            'loop_: while __do_while || ((*r_high.borrow()) != 0_u64) {
                __do_while = false;
                {
                ...
                (*q_sub.borrow_mut()).postfix_inc();
                (&(0));
            }
            ({ Subtract_50((*Q.borrow()).clone(), (*q_sub.borrow())) });
        } else {
            let q_add: Value<u64> = Rc::new(RefCell::new(0_u64));
            'loop_: while ((*r_high.borrow()) != 0_u64)
                || ({ GreaterThanOrEqual_38((*R.borrow()).clone(), (*B.borrow()).clone()) })
            {
                {
                    let rhs_0 = (*r_high.borrow()).wrapping_sub(
                        ({
                            InplaceSubAndReturnBorrow_52(
                                (*R.borrow()).clone(),
                                (*B.borrow()).clone(),
                            )
                        }),
                ...
                (*q_add.borrow_mut()).postfix_inc();
                (&(0));
            }
            ({ Add_49((*Q.borrow()).clone(), (*q_add.borrow())) });
        }
        let final_q_len: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&Q.as_pointer()) }),
        ));
        ({ v8_bigint_RWDigitsImpl::set_len(&Q.as_pointer(), (*orig_q_len.borrow())) });
        let i: Value<u32> = Rc::new(RefCell::new((*final_q_len.borrow())));
        'loop_: while ((*i.borrow()) < (*orig_q_len.borrow())) {
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
    ...
    fn DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits(
        ...
        (&(0));
        (&(0));
        let b_normalized: Value<v8_bigint_ShiftedDigits> = Rc::new(RefCell::new(
        ...
        let a_normalized: Value<v8_bigint_ShiftedDigits> = Rc::new(RefCell::new(
            v8_bigint_ShiftedDigits::v8_bigint_ShiftedDigits1(
                { A.as_pointer() },
                { ({ v8_bigint_ProcessorImpl::platform(self) }) },
                { Some(({ v8_bigint_ShiftedDigitsImpl::shift(&b_normalized.as_pointer()) })) },
                None,
            ),
        ));
        (*B.borrow_mut()) = (*b_normalized.borrow()).clone();
        (*A.borrow_mut()) = (*a_normalized.borrow()).clone();
        let barrett_dividend_length: Value<u32> = Rc::new(RefCell::new(
            if (({ v8_bigint_DigitsImpl::len(&A.as_pointer()) })
                <= (2_u32).wrapping_mul(({ v8_bigint_DigitsImpl::len(&B.as_pointer()) })))
            {
                ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) })
            } else {
                (2_u32).wrapping_mul(({ v8_bigint_DigitsImpl::len(&B.as_pointer()) }))
        ...
        let i_len: Value<u32> = Rc::new(RefCell::new(
            (*barrett_dividend_length.borrow())
                .wrapping_sub(({ v8_bigint_DigitsImpl::len(&B.as_pointer()) })),
        ));
        let I: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits(
                { (*i_len.borrow()).wrapping_add(1_u32) },
                { ({ v8_bigint_ProcessorImpl::platform(self) }) },
            ),
        ));
        let scratch_len: Value<u32> = Rc::new(RefCell::new({
            let __tmp_0: Value<u32> =
                Rc::new(RefCell::new(({ InvertScratchSpace_89((*i_len.borrow())) })));
            let __tmp_1: Value<u32> = Rc::new(RefCell::new(
                ({ DivideBarrettScratchSpace_86((*barrett_dividend_length.borrow())) }),
            ));
            (if __tmp_0.as_pointer().read() >= __tmp_1.as_pointer().read() {
                __tmp_0.as_pointer()
            } else {
        ...
        ({
            v8_bigint_ProcessorImplImpl::Invert(
                self,
                (*I.borrow()).clone(),
                v8_bigint_Digits::v8_bigint_Digits3(
                    { (*B.borrow()).clone() },
                    {
                        ({ v8_bigint_DigitsImpl::len(&B.as_pointer()) })
                            .wrapping_sub((*i_len.borrow()))
                    },
                    { (*i_len.borrow()) },
                ),
                (*scratch.borrow()).clone(),
        ...
        ({ v8_bigint_DigitsImpl::TrimOne(&I.as_pointer()) });
        (&(0));
        if (({ v8_bigint_DigitsImpl::len(&A.as_pointer()) })
            > (2_u32).wrapping_mul(({ v8_bigint_DigitsImpl::len(&B.as_pointer()) })))
        {
            ...
            let t: Value<u32> = Rc::new(RefCell::new(
                (((({ v8_bigint_DigitsImpl::len(&A.as_pointer()) }).wrapping_sub(1_u32))
                    .wrapping_div((*n.borrow())))
                .wrapping_add(1_u32)),
            ));
            (&(0));
            let z_len: Value<u32> = Rc::new(RefCell::new((*n.borrow()).wrapping_mul(2_u32)));
            let Z: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
                v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*z_len.borrow()) }, {
                    ({ v8_bigint_ProcessorImpl::platform(self) })
                }),
            ));
            ({
                PutAt_93(
                    ...
                    ({
                        v8_bigint_DigitsImpl::operator_add(
                            &A.as_pointer(),
                            (*n.borrow()).wrapping_mul(((*t.borrow()).wrapping_sub(2_u32))),
                        )
                    }),
                    (*z_len.borrow()),
                )
            });
            let qi_len: Value<u32> = Rc::new(RefCell::new((*n.borrow()).wrapping_add(1_u32)));
            let Qi: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
                v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*qi_len.borrow()) }, {
                    ({ v8_bigint_ProcessorImpl::platform(self) })
                }),
            ));
            let Ri: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
                v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*n.borrow()) }, {
                    ({ v8_bigint_ProcessorImpl::platform(self) })
                }),
            ));
            {
                let i: Value<u32> = Rc::new(RefCell::new((*t.borrow()).wrapping_sub(2_u32)));
                ({
                    v8_bigint_ProcessorImplImpl :: DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_RWDigits ( self , ((*Qi.borrow()) ).clone()  , ((*Ri.borrow()) ).clone()  , ((*Z.borrow()) ).clone()  , ((*B.borrow()) ).clone()  , ((*I.borrow()) ).clone()  , ((*scratch.borrow()) ).clone()  , )
                });
                if ({ v8_bigint_ProcessorImplImpl::should_terminate(self) }) {
                    return;
                }
                let target: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
                    ({
                        v8_bigint_RWDigitsImpl::operator_add(
                            &Q.as_pointer(),
                            (*n.borrow()).wrapping_mul((*i.borrow())),
                        )
                    }),
                ));
                let to_copy: Value<u32> = Rc::new(RefCell::new({
                    let __tmp_1: Value<u32> = Rc::new(RefCell::new(
                        ({ v8_bigint_DigitsImpl::len(&target.as_pointer()) }),
                    ));
                    (if qi_len.as_pointer().read() <= __tmp_1.as_pointer().read() {
                        qi_len.as_pointer()
                    } else {
                        __tmp_1.as_pointer()
                    }
                ...
                let j: Value<u32> = Rc::new(RefCell::new(0_u32));
                'loop_: while ((*j.borrow()) < (*to_copy.borrow())) {
                    ({
                        ...
                        v8_bigint_RWDigits_WritableDigitReferenceImpl :: operator_assign_pconstv8_bigint_RWDigits_WritableDigitReference ( &Rc::new(RefCell::new((  { v8_bigint_RWDigitsImpl :: operator_index ( &target .as_pointer()  , (*j.borrow())  , ) } ) )) .as_pointer()  , _src.as_pointer() , )
                    });
                    (*j.borrow_mut()).postfix_inc();
                }
                let j: Value<u32> = Rc::new(RefCell::new((*to_copy.borrow())));
            ...
            let i: Value<i32> = Rc::new(RefCell::new((((*t.borrow()).wrapping_sub(3_u32)) as i32)));
            'loop_: while ((*i.borrow()) >= 0) {
                ({
                    let _Z: v8_bigint_RWDigits =
                        ({ v8_bigint_RWDigitsImpl::operator_add(&Z.as_pointer(), (*n.borrow())) });
                    let _count: u32 = (*n.borrow());
                    PutAt_93(_Z, (*Ri.borrow()).clone(), _count)
                });
                ({
                    let _A: v8_bigint_Digits = ({
                        v8_bigint_DigitsImpl::operator_add(
                            &A.as_pointer(),
                            (*n.borrow()).wrapping_mul(((*i.borrow()) as u32)),
                        )
                    });
                    let _count: u32 = (*n.borrow());
                    PutAt_93((*Z.borrow()).clone(), _A, _count)
                });
                ({
                    v8_bigint_ProcessorImplImpl :: DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_RWDigits ( self , ((*Qi.borrow()) ).clone()  , ((*Ri.borrow()) ).clone()  , ((*Z.borrow()) ).clone()  , ((*B.borrow()) ).clone()  , ((*I.borrow()) ).clone()  , ((*scratch.borrow()) ).clone()  , )
                });
                ...
                ({
                    ...
                    let _count: u32 = (*n.borrow());
                    PutAt_93(_Z, (*Qi.borrow()).clone(), _count)
                });
                (*i.borrow_mut()).postfix_dec();
            }
            ({ v8_bigint_DigitsImpl::Normalize(&Ri.as_pointer()) });
            (&(0));
            ({
                RightShift_92(
                    (*R.borrow()).clone(),
                    (*Ri.borrow()).clone(),
                    ({ v8_bigint_ShiftedDigitsImpl::shift(&b_normalized.as_pointer()) }),
                )
            });
        } else {
            ({
                v8_bigint_ProcessorImplImpl :: DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_Digits_v8_bigint_RWDigits ( self , ((*Q.borrow()) ).clone()  , ((*R.borrow()) ).clone()  , ((*A.borrow()) ).clone()  , ((*B.borrow()) ).clone()  , ((*I.borrow()) ).clone()  , ((*scratch.borrow()) ).clone()  , )
            });
            if ({ v8_bigint_ProcessorImplImpl::should_terminate(self) }) {
                return;
            }
            ({
                let _Z: v8_bigint_RWDigits = (*R.borrow()).clone();
                let _X: v8_bigint_Digits = (*R.borrow()).clone();
                RightShift_92(
                    _Z,
                    _X,
                    ({ v8_bigint_ShiftedDigitsImpl::shift(&b_normalized.as_pointer()) }),
