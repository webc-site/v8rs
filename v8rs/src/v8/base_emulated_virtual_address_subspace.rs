...
thread_local!(
    pub static kLowZeroBits_11: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kAlignment_12: Value<i32> = Rc::new(RefCell::new(256));
);
...
thread_local!(
    pub static kToBePaddedSize_13: Value<usize> = Rc::new(RefCell::new(33));
);
#[derive(Default)]
...
pub fn is_constant_evaluated_16() -> bool {
    return ({ is_constant_evaluated_17() });
}
...
pub fn LogSeverities_18() -> Vec<absl_LogSeverity> {
    return vec![
...
thread_local!(
    pub static kLogDebugFatal_19: Value<absl_LogSeverity> = Rc::new(RefCell::new(2));
);
pub fn LogSeverityName_20(s: absl_LogSeverity) -> Ptr<u8> {
...
pub fn NormalizeLogSeverity_21(s: absl_LogSeverity) -> absl_LogSeverity {
    let s: Value<absl_LogSeverity> = Rc::new(RefCell::new(s));
...
pub fn NormalizeLogSeverity_22(s: i32) -> absl_LogSeverity {
    let s: Value<i32> = Rc::new(RefCell::new(s));
    return ({ NormalizeLogSeverity_21(((*s.borrow()) as absl_LogSeverity)) });
}
...
pub fn operator_gt_23(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
...
pub fn operator_lt_24(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
...
pub fn operator_le_25(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) <= (*rhs.borrow()));
}
pub fn operator_ge_26(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) >= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_lt_27(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) < (*rhs.borrow()));
}
pub fn operator_gt_28(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) > ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_ge_29(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) >= (*rhs.borrow()));
}
pub fn operator_le_30(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) <= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn Basename_31(fname: Ptr<u8>, offset: i32) -> Ptr<u8> {
            ...
            == (('\\' as u8) as i32))
    {
        ...
        ({ Basename_31((*fname.borrow()).clone(), ((*offset.borrow()) - 1)) })
    };
}
thread_local!();
pub fn ClippedSubstr_33(s: Vec<u8>, pos: usize, n: Option<usize>) -> Vec<u8> {
...
pub fn NullSafeStringView_34(p: Ptr<u8>) -> Vec<u8> {
...
pub fn days_per_century_37(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (36524 + ((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300)) as i32));
}
pub fn days_per_4years_38(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (1460
        + (((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300))
            || ((((*yi.borrow()) - 1) % 100) < 96)) as i32));
}
pub fn days_per_year_39(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    return if ({ is_leap_year_35(((*y.borrow()) + ((((*m.borrow()) as i32) > 2) as i64))) }) {
        366
    } else {
        365
    };
}
pub fn days_per_month_40(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    ...
    return ((*k_days_per_month.borrow())[(*m.borrow()) as usize]
        + (((((*m.borrow()) as i32) == 2) && ({ is_leap_year_35((*y.borrow())) })) as i32));
}
pub fn n_day_41(
    y: i64,
    m: i8,
    ...
    if ((*d.borrow()) > 0_i64) {
        ...
        if ((*d.borrow()) > (-365_i32 as i64)) {
            (*ey.borrow_mut()) -= 1_i64;
            (*d.borrow_mut()) += (({ days_per_year_39((*ey.borrow()), (*m.borrow())) }) as i64);
        } else {
            (*ey.borrow_mut()) -= 400_i64;
            (*d.borrow_mut()) += 146097_i64;
        }
    ...
    if ((*d.borrow()) > 365_i64) {
        let yi: Value<i32> = Rc::new(RefCell::new(
            ({ year_index_36((*ey.borrow()), (*m.borrow())) }),
        ));
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_century_37((*yi.borrow())) })));
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_4years_38((*yi.borrow())) })));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
            (*d.borrow_mut()) -= ((*n.borrow()) as i64);
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_year_39((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
    ...
    if ((*d.borrow()) > 28_i64) {
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_month_40((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
...
pub fn step_47(
    ...
    return ({
        ...
        n_min_44(_y, _m, _d, _hh, 0_i64, _mm, _ss)
    });
}
pub fn step_48(
    ...
    return ({
        ...
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_hour_43(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_49(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_day_41(_y, _m, _d, (*n.borrow()), _hh, _mm, _ss)
    });
}
pub fn step_50(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_mon_42(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_51(
...
pub fn scale_add_52(v: i64, f: i64, a: i64) -> i64 {
...
pub fn ymd_ord_53(y: i64, m: i8, d: i8) -> i64 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
...
pub fn day_difference_54(y1: i64, m1: i8, d1: i8, y2: i64, m2: i8, d2: i8) -> i64 {
    ...
    let delta: Value<i64> = Rc::new(RefCell::new(
        (({ ymd_ord_53((*a_c4_off.borrow()), (*m1.borrow()), (*d1.borrow())) })
            - ({ ymd_ord_53((*b_c4_off.borrow()), (*m2.borrow()), (*d2.borrow())) })),
    ));
...
pub fn difference_56(
    ...
    return ({
        ...
        scale_add_52(_v, 12_i64, _a)
    });
}
pub fn difference_57(
    _a0: absl_time_internal_cctz_detail_day_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        day_difference_54(_y1, _m1, _d1, _y2, _m2, _d2)
    });
}
pub fn difference_58(
    _a0: absl_time_internal_cctz_detail_hour_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        scale_add_52(_v, 24_i64, _a)
    });
}
pub fn difference_59(
    _a0: absl_time_internal_cctz_detail_minute_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        scale_add_52(_v, 60_i64, _a)
    });
}
pub fn difference_60(
    _a0: absl_time_internal_cctz_detail_second_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
...
pub fn operator_add_67(
    ...
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_49 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , (*n.borrow())  , ) } )    } , )   ;
}
pub fn operator_sub_68(
    a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_,
    n: i64,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ {
    let a: Value<
    ...
    return if ((*n.borrow()) != <i64>::MIN) {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_49 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - (*n.borrow())  , ) } )    } , )
    } else {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_49 ( absl_time_internal_cctz_detail_day_tag { }  , (  { step_49 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - ( ( (*n.borrow()) + 1_i64 ) )  , ) } )   , 1_i64  , ) } )    } , )
    };
}
#[derive()]
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_10(
        ...
        > = Rc::new(RefCell::new(Self {
            f_: Rc::new(RefCell::new(
                ({ align_62(absl_time_internal_minute_tag {}, (*f.borrow()).clone()) }),
            )),
        }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_13(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_63(absl_time_internal_hour_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_17(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_64(absl_time_internal_day_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_20(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_65(absl_time_internal_month_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_23(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_66(absl_time_internal_year_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            __this.as_pointer();
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_forw.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        ...
                        operator_add_67(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
        ...
        if ((*base.borrow()) == (*k_weekdays_back.borrow())[(*i.borrow()) as usize]) {
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_back.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        let _a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_   = ((*cd.borrow()) ).clone()  ;
                        operator_sub_68(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
                (*j.borrow_mut()).prefix_inc();
            }
...
pub fn GetYearDay_76(
    ...
    return ({
        let _cs : Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ > = Rc::new(RefCell::new(absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_5 ( {  cs .as_pointer()   } , None , ) ));
        get_yearday_72(_cs.as_pointer())
    });
}
pub fn operator_eq_77(
...
pub fn operator_ne_78(
    ...
    return !({
        ...
        operator_eq_77(_lhs, (*rhs.borrow()).clone())
    });
}
#[derive(Default)]
...
}pub  fn split_seconds_80 ( tp : Ptr< std_chrono_time_point_std_chrono_system_clock__std_chrono_duration_long_long__std_ratio________  > , ) -> (Value<std_chrono_time_point_std_chrono_steady_clock__std_chrono_duration_long_long__std_ratio________>, Value<std_chrono_duration_long_long__std_ratio_______>){
    return (
        Rc::new(RefCell::new(
            (*tp.upgrade().deref())
                .clone()
...
thread_local!(
    pub static kTicksPerNanosecond_82: Value<i64> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kTicksPerSecond_83: Value<i64> = Rc::new(RefCell::new(4000000000));
);
pub fn FromInt64_84(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    ...
    return ({
        ...
        let _ticks: i64 = (((((((*v.borrow()) % 1000000000_i64) * 4) * 1000_i64) * 1000_i64)
            * 1000_i64)
            / 1000000000_i64);
        MakeNormalizedDuration_85(_sec, _ticks)
    });
}
pub fn FromInt64_86(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn FromInt64_87(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn FromInt64_88(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn operator_gt_91(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    ...
    return ({
        ...
        operator_lt_92(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_93(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_lt_92(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_94(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*rhs.borrow()).clone();
...
pub fn operator_ne_95(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_eq_90(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_add_96(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_sub_97(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_div_98(lhs: absl_Duration, rhs: absl_Duration) -> i64 {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return ({
        let _num: absl_Duration = (*lhs.borrow()).clone();
        let _rem: Ptr<absl_Duration> = (lhs.as_pointer());
        IDivDuration_99(_num, (*rhs.borrow()).clone(), _rem)
    });
}
pub fn operator_rem_100(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn ZeroDuration_101() -> absl_Duration {
    return absl_Duration::absl_Duration1();
}
pub fn AbsDuration_102(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if ({
        let _lhs: absl_Duration = (*d.borrow()).clone();
        operator_lt_92(_lhs, ({ ZeroDuration_101() }))
    }) {
        ({
...
pub fn Nanoseconds_104(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_84(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Nanoseconds_105(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_84((*n.borrow()), std_ratio______ {}) });
}
pub fn Microseconds_106(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_86(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Microseconds_107(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_86((*n.borrow()), std_ratio______ {}) });
}
pub fn Milliseconds_108(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_87(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Milliseconds_109(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_87((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_110(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_88((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_111(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_88((*n.borrow()), std_ratio______ {}) });
}
pub fn Minutes_112(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_113(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Hours_114(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_115(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn operator_shl_116(os: Ptr<std::fs::File>, d: absl_Duration) -> Ptr<std::fs::File> {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return os.write_all(
        &([(&({ FormatDuration_117((*d.borrow()).clone()) })
            .iter()
            .take(({ FormatDuration_117((*d.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
...
pub fn operator_cmp_118(lhs: absl_Time, rhs: absl_Time) -> std::cmp::Ordering {
    ...
    return ({
        ...
        operator_cmp_89(_lhs, _rhs)
    });
}
pub fn operator_lt_120(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_lt_92(_lhs, _rhs)
    });
}
pub fn operator_gt_121(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
        operator_lt_120(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_122(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_lt_120(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_123(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
...
pub fn operator_eq_119(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_eq_90(_lhs, _rhs)
    });
}
pub fn operator_ne_124(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
...
pub fn operator_add_125(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_add_126(lhs: absl_Duration, rhs: absl_Time) -> absl_Time {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_127(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_128(lhs: absl_Time, rhs: absl_Time) -> absl_Duration {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_sub_97(_lhs, _rhs)
    });
}
pub fn UnixEpoch_129() -> absl_Time {
    return <absl_Time>::default();
}
pub fn UniversalEpoch_130() -> absl_Time {
    return absl_Time::absl_Time1({
        ({ MakeDuration_131((((-24_i32 * 719162) as i64) * 3600_i64), 0_u32) })
    });
}
pub fn InfiniteFuture_132() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_131(<i64>::MAX, !0_u32) }) });
}
pub fn InfinitePast_133() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_131(<i64>::MIN, !0_u32) }) });
}
pub fn operator_eq_134(a: absl_TimeZone, b: absl_TimeZone) -> bool {
    ...
    return ({
        ...
        operator_eq_77(_lhs, _rhs)
    });
}
pub fn operator_ne_135(a: absl_TimeZone, b: absl_TimeZone) -> bool {
    let a: Value<absl_TimeZone> = Rc::new(RefCell::new(a));
    let b: Value<absl_TimeZone> = Rc::new(RefCell::new(b));
    return ({
        let _lhs: absl_time_internal_cctz_time_zone = (*(*a.borrow()).cz_.borrow()).clone();
        let _rhs: absl_time_internal_cctz_time_zone = (*(*b.borrow()).cz_.borrow()).clone();
        operator_ne_78(_lhs, _rhs)
    });
}
pub fn operator_shl_136(os: Ptr<std::fs::File>, tz: absl_TimeZone) -> Ptr<std::fs::File> {
...
pub fn LoadTimeZone_137(name: Vec<u8>, tz: Ptr<absl_TimeZone>) -> bool {
    ...
    if (*name.borrow()).clone()
        == Ptr::from_string_literal(b"localtime")
            ...
            .collect::<Vec<u8>>()
    {
        let __rhs = absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_138() }) });
    ...
    let b: Value<bool> = Rc::new(RefCell::new(
        ({
            ...
            load_time_zone_139(_name.as_pointer(), (cz.as_pointer()))
        }),
    ));
...
pub fn FixedTimeZone_140(seconds: i32) -> absl_TimeZone {
    ...
    return absl_TimeZone::absl_TimeZone1({
        ({
            ...
            fixed_time_zone_141(_offset.as_pointer())
        })
    });
}
pub fn UTCTimeZone_142() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ utc_time_zone_143() }) });
}
pub fn LocalTimeZone_144() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_138() }) });
}
pub fn ToCivilSecond_145(
    t: absl_Time,
    tz: absl_TimeZone,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_ {
...
thread_local!();
thread_local!();
pub fn operator_shl_158(os: Ptr<std::fs::File>, t: absl_Time) -> Ptr<std::fs::File> {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return os.write_all(
        &([(&({ FormatTime_159((*t.borrow()).clone()) })
            .iter()
            .take(({ FormatTime_159((*t.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
            .collect::<Vec<u8>>()[..] as &[u8])]
        .concat()),
    );
}
pub fn MakeDuration_131(hi: i64, lo: Option<u32>) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<u32> = Rc::new(RefCell::new(lo.unwrap_or(0_u32)));
    return absl_Duration::absl_Duration2({ (*hi.borrow()) }, { (*lo.borrow()) });
}
pub fn MakeDuration_160(hi: i64, lo: i64) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<i64> = Rc::new(RefCell::new(lo));
    return ({ MakeDuration_131((*hi.borrow()), Some(((*lo.borrow()) as u32))) });
}
pub fn MakePosDoubleDuration_161(n: f64) -> absl_Duration {
    ...
    return if (((*ticks.borrow()) as i64) < 4000000000) {
        ({ MakeDuration_131((*int_secs.borrow()), Some((*ticks.borrow()))) })
    } else {
        ({
            MakeDuration_160(
...
pub fn MakeNormalizedDuration_85(sec: i64, ticks: i64) -> absl_Duration {
    let sec: Value<i64> = Rc::new(RefCell::new(sec));
    let ticks: Value<i64> = Rc::new(RefCell::new(ticks));
    return if ((*ticks.borrow()) < 0_i64) {
        ({ MakeDuration_160(((*sec.borrow()) - 1_i64), ((*ticks.borrow()) + 4000000000)) })
    } else {
        ({ MakeDuration_160((*sec.borrow()), (*ticks.borrow())) })
    };
}
pub fn GetRepHi_162(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return ({ absl_Duration_HiRepImpl::Get(&(*d.borrow()).rep_hi_.as_pointer()) });
}
pub fn GetRepLo_163(d: absl_Duration) -> u32 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (*(*d.borrow()).rep_lo_.borrow());
}
pub fn IsInfiniteDuration_164(d: absl_Duration) -> bool {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (({ GetRepLo_163((*d.borrow()).clone()) }) == !0_u32);
}
pub fn OppositeInfinity_165(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepHi_162((*d.borrow()).clone()) }) < 0_i64) {
        ({ MakeDuration_131(<i64>::MAX, Some(!0_u32)) })
    } else {
        ({ MakeDuration_131(<i64>::MIN, Some(!0_u32)) })
    };
}
pub fn NegateAndSubtractOne_166(n: i64) -> i64 {
    let n: Value<i64> = Rc::new(RefCell::new(n));
...
pub fn FromUnixDuration_167(d: absl_Duration) -> absl_Time {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return absl_Time::absl_Time1({ (*d.borrow()).clone() });
}
pub fn ToUnixDuration_168(t: absl_Time) -> absl_Duration {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
...
pub fn FromInt64_113(v: i64, _a1: std_ratio______) -> absl_Duration {
    ...
    {
        ({ MakeDuration_131(((*v.borrow()) * 60_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_169() })
        } else {
            ({
                let _d: absl_Duration = ({ InfiniteDuration_169() });
                operator_neg_103(_d)
            })
        }
    };
...
pub fn FromInt64_115(v: i64, _a1: std_ratio______) -> absl_Duration {
    ...
    {
        ({ MakeDuration_131(((*v.borrow()) * 3600_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_169() })
        } else {
...
pub fn IsValidRep64_170(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
pub fn IsValidRep64_171(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
pub fn FromChrono_172(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_84(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_173(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_86(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_174(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_87(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_175(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_88(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_176(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_113(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_177(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_115(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn ToInt64_178(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Nanoseconds_179((*d.borrow()).clone()) });
}
pub fn ToInt64_180(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Microseconds_181((*d.borrow()).clone()) });
}
pub fn ToInt64_182(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Milliseconds_183((*d.borrow()).clone()) });
}
pub fn ToInt64_184(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Seconds_185((*d.borrow()).clone()) });
}
pub fn ToInt64_186(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Minutes_187((*d.borrow()).clone()) });
}
pub fn ToInt64_188(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Hours_189((*d.borrow()).clone()) });
}
pub fn operator_lt_92(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return if (({ GetRepHi_162((*lhs.borrow()).clone()) })
        != ({ GetRepHi_162((*rhs.borrow()).clone()) }))
    {
        (({ GetRepHi_162((*lhs.borrow()).clone()) }) < ({ GetRepHi_162((*rhs.borrow()).clone()) }))
    } else {
        if (({ GetRepHi_162((*lhs.borrow()).clone()) }) == <i64>::MIN) {
            (({ GetRepLo_163((*lhs.borrow()).clone()) }).wrapping_add(1_u32)
                < ({ GetRepLo_163((*rhs.borrow()).clone()) }).wrapping_add(1_u32))
        } else {
            (({ GetRepLo_163((*lhs.borrow()).clone()) })
                < ({ GetRepLo_163((*rhs.borrow()).clone()) }))
        }
    };
}
pub fn operator_cmp_89(lhs: absl_Duration, rhs: absl_Duration) -> std::cmp::Ordering {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    let lhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_162((*lhs.borrow()).clone()) })));
    let rhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_162((*rhs.borrow()).clone()) })));
    {
    ...
    let lhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_163((*lhs.borrow()).clone()) })));
    let rhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_163((*rhs.borrow()).clone()) })));
...
pub fn operator_eq_90(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (({ GetRepHi_162((*lhs.borrow()).clone()) })
        == ({ GetRepHi_162((*rhs.borrow()).clone()) }))
        && (({ GetRepLo_163((*lhs.borrow()).clone()) })
            == ({ GetRepLo_163((*rhs.borrow()).clone()) }));
}
pub fn operator_neg_103(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepLo_163((*d.borrow()).clone()) }) == 0_u32) {
        if (({ GetRepHi_162((*d.borrow()).clone()) }) == <i64>::MIN) {
            ({ InfiniteDuration_169() })
        } else {
            ({ MakeDuration_131(-({ GetRepHi_162((*d.borrow()).clone()) }), None) })
        }
    } else {
        if ({ IsInfiniteDuration_164((*d.borrow()).clone()) }) {
            ({ OppositeInfinity_165((*d.borrow()).clone()) })
        } else {
            ({
                let _hi: i64 =
                    ({ NegateAndSubtractOne_166(({ GetRepHi_162((*d.borrow()).clone()) })) });
                let _lo: i64 = (4000000000 - (({ GetRepLo_163((*d.borrow()).clone()) }) as i64));
                MakeDuration_160(_hi, _lo)
            })
        }
    };
}
pub fn InfiniteDuration_169() -> absl_Duration {
    return ({ MakeDuration_131(<i64>::MAX, Some(!0_u32)) });
}
pub fn FromChrono_190(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_172((d).clone()) });
}
pub fn FromChrono_191(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_173((d).clone()) });
}
pub fn FromChrono_192(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_174((d).clone()) });
}
pub fn FromChrono_193(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_175((d).clone()) });
}
pub fn FromChrono_194(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_176((d).clone()) });
}
pub fn FromChrono_195(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_177((d).clone()) });
}
pub fn FromUnixNanos_196(ns: i64) -> absl_Time {
    let ns: Value<i64> = Rc::new(RefCell::new(ns));
    return ({ FromUnixDuration_167(({ Nanoseconds_105((*ns.borrow())) })) });
}
pub fn FromUnixMicros_197(us: i64) -> absl_Time {
    let us: Value<i64> = Rc::new(RefCell::new(us));
    return ({ FromUnixDuration_167(({ Microseconds_107((*us.borrow())) })) });
}
pub fn FromUnixMillis_198(ms: i64) -> absl_Time {
    let ms: Value<i64> = Rc::new(RefCell::new(ms));
    return ({ FromUnixDuration_167(({ Milliseconds_109((*ms.borrow())) })) });
}
pub fn FromUnixSeconds_199(s: i64) -> absl_Time {
    let s: Value<i64> = Rc::new(RefCell::new(s));
    return ({ FromUnixDuration_167(({ Seconds_110((*s.borrow())) })) });
}
pub fn FromTimeT_200(t: i64) -> absl_Time {
    let t: Value<i64> = Rc::new(RefCell::new(t));
    return ({ FromUnixDuration_167(({ Seconds_111((*t.borrow())) })) });
}
pub fn ToInt64Nanoseconds_179(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_162((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_162((*d.borrow()).clone()) }) >> 33) == 0_i64)
    {
        return ((((({ GetRepHi_162((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_163((*d.borrow()).clone()) }) as i64) / 4));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_98(_lhs, ({ Nanoseconds_104(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Microseconds_181(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_162((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_162((*d.borrow()).clone()) }) >> 43) == 0_i64)
    {
        return (((({ GetRepHi_162((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_163((*d.borrow()).clone()) }) as i64) / (4 * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_98(_lhs, ({ Microseconds_106(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Milliseconds_183(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_162((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_162((*d.borrow()).clone()) }) >> 53) == 0_i64)
    {
        return ((({ GetRepHi_162((*d.borrow()).clone()) }) * 1000_i64)
            + ((({ GetRepLo_163((*d.borrow()).clone()) }) as i64) / ((4 * 1000_i64) * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_98(_lhs, ({ Milliseconds_108(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Seconds_185(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_162((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_164((*d.borrow()).clone()) }) {
        return (*hi.borrow());
    }
    if ((*hi.borrow()) < 0_i64) && (({ GetRepLo_163((*d.borrow()).clone()) }) != 0_u32) {
        (*hi.borrow_mut()).prefix_inc();
    }
    return (*hi.borrow());
}
pub fn ToInt64Minutes_187(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_162((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_164((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn ToInt64Hours_189(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_162((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_164((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn SleepFor_201(duration: absl_Duration) {
    let duration: Value<absl_Duration> = Rc::new(RefCell::new(duration));
    ({ AbslInternalSleepFor_202((*duration.borrow()).clone()) });
}
thread_local!(
    static kNoTimeout_203: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
thread_local!(
    static kMaxNanos_204: Value<i64> = Rc::new(RefCell::new(9223372036854775807));
);
#[derive()]
...
pub fn GetOrCreateCurrentThreadIdentity_205() -> Ptr<absl_base_internal_ThreadIdentity> {
    let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
        Rc::new(RefCell::new(({ CurrentThreadIdentityIfPresent_206() })));
    if ((((false) || ((*identity.borrow()).is_null())) as i64) != 0) {
        return ({ CreateThreadIdentity_207() });
    }
...
impl absl_synchronization_internal_PerThreadSem {
    fn Init(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        ...
        ({ AbslInternalPerThreadSemInit_208((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Post(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
            Rc::new(RefCell::new(identity));
        ({ AbslInternalPerThreadSemPost_209((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Wait(t: absl_synchronization_internal_KernelTimeout) -> bool {
        ...
        return ({ AbslInternalPerThreadSemWait_210((*t.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
...
thread_local!();
pub fn ControlledCrashesAreHarmless_213() -> bool {
    return ((*g_abort_mode_212.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_212.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn DcheckFailuresAreIgnored_214() -> bool {
    return ((*g_abort_mode_212.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_212.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn FatalErrorsWithNoSecurityImpactShouldExit_215() -> bool {
    return ((*g_abort_mode_212.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitIfNoSecurityImpact);
}
thread_local!(
    pub static kReturnAddressStackSlotCount_216: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPageSizeBits_217: Value<i32> = Rc::new(RefCell::new(18));
);
thread_local!(
    pub static kRegularPageSize_218: Value<i32> = Rc::new(RefCell::new(262144));
);
thread_local!(
    pub static kMinimumOSPageSize_219: Value<i32> = Rc::new(RefCell::new(16384));
);
#[derive(Default)]
...
thread_local!(
    pub static kUnimplementedCodeMessage_220: Value<Ptr<u8>> = Rc::new(RefCell::new(
        Ptr::from_string_literal(b"unimplemented code"),
    ));
);
thread_local!(
    pub static kUnreachableCodeMessage_221: Value<Ptr<u8>> =
...
thread_local!(
    pub static is_enum_222: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static is_enum_223: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static is_enum_224: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_225: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_226: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static value_227: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_228: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_229: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
pub struct v8_base_is_signed_vs_unsigned_unsigned_long__unsigned_long_ {}
impl Clone for v8_base_is_signed_vs_unsigned_unsigned_long__unsigned_long_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_is_signed_vs_unsigned_unsigned_long__unsigned_long_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_is_signed_vs_unsigned_unsigned_long__unsigned_long_> =
            __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_is_signed_vs_unsigned_unsigned_long__unsigned_long_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_is_unsigned_vs_signed_unsigned_long__unsigned_long_ {}
impl Clone for v8_base_is_unsigned_vs_signed_unsigned_long__unsigned_long_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_is_unsigned_vs_signed_unsigned_long__unsigned_long_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_is_unsigned_vs_signed_unsigned_long__unsigned_long_> =
            __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_is_unsigned_vs_signed_unsigned_long__unsigned_long_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub fn make_uint64_232(high: u32, low: u32) -> u64 {
...
pub fn RoundDown_233(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    return ((*x.borrow()) & (-(*m.borrow()) as u64));
}
pub fn RoundUp_234(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    (&(0));
...
pub fn IsAligned_235(value: u64, alignment: u64) -> bool {
...
pub type anon_236 = u8;
pub const anon_236_ONCE_STATE_UNINITIALIZED: anon_236 = 0;
pub const anon_236_ONCE_STATE_EXECUTING_FUNCTION: anon_236 = 1;
pub const anon_236_ONCE_STATE_DONE: anon_236 = 2;
pub fn CallOnce_237(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_236_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_238((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
thread_local!(
    static kMultiplier_240: Value<i64> = Rc::new(RefCell::new(25214903917_i64));
);
thread_local!(
    static kAddend_241: Value<i64> = Rc::new(RefCell::new(11_i64));
);
thread_local!(
    static kMask_242: Value<i64> = Rc::new(RefCell::new(281474976710655_i64));
);
#[derive()]
...
thread_local!(
    pub static kAllocationFailure_243: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
...
thread_local!(
    pub static kNullAddress_251: Value<u64> = Rc::new(RefCell::new(0));
);
pub trait v8_base_VirtualAddressSpaceBase {
    fn FreeSubspace(&self, subspace: Ptr<v8_base_VirtualAddressSubspace>);
}
#[derive()]
pub struct v8_base_VirtualAddressSpace {}
impl v8_base_VirtualAddressSpace {}
impl v8_base_VirtualAddressSpaceBase for v8_base_VirtualAddressSpace {
    fn SetName(&self, name: Ptr<Vec<u8>>) -> bool {
        return false;
    }
}
impl Clone for v8_base_VirtualAddressSpace {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_VirtualAddressSpace> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_VirtualAddressSpace> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for v8_base_VirtualAddressSpace {
    fn default() -> Self {
        { v8_base_VirtualAddressSpace::v8_base_VirtualAddressSpace() }
    }
}
impl ByteRepr for v8_base_VirtualAddressSpace {
    fn byte_size() -> usize {
        48
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_VirtualAddressSubspace {
    reservation_: Value<v8_base_AddressSpaceReservation>,
    mutex_: Value<v8_base_Mutex>,
    region_allocator_: Value<v8_base_RegionAllocator>,
    rng_: Value<v8_base_RandomNumberGenerator>,
    parent_space_: Value<PtrDyn<dyn v8_base_VirtualAddressSpaceBase>>,
    pkey_: Value<std_optional_int_>,
    name_: Value<Vec<u8>>,
}
impl v8_base_VirtualAddressSubspace {}
impl v8_base_VirtualAddressSpaceBase for v8_base_VirtualAddressSubspace {
    fn CanAllocateSubspaces(&self) -> bool {
        return true;
    }
}
impl ByteRepr for v8_base_VirtualAddressSubspace {
    fn byte_size() -> usize {
        304
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.reservation_.borrow()).to_bytes(&mut buf[48..64]);
        (*self.mutex_.borrow()).to_bytes(&mut buf[64..72]);
        (*self.region_allocator_.borrow()).to_bytes(&mut buf[72..240]);
        (*self.rng_.borrow()).to_bytes(&mut buf[240..264]);
        (*self.parent_space_.borrow()).to_bytes(&mut buf[264..272]);
        (*self.pkey_.borrow()).to_bytes(&mut buf[272..280]);
        (*self.name_.borrow()).to_bytes(&mut buf[280..304]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            reservation_: Rc::new(RefCell::new(<v8_base_AddressSpaceReservation>::from_bytes(
                &buf[48..64],
            ))),
            mutex_: Rc::new(RefCell::new(<v8_base_Mutex>::from_bytes(&buf[64..72]))),
            region_allocator_: Rc::new(RefCell::new(<v8_base_RegionAllocator>::from_bytes(
                &buf[72..240],
            ))),
            rng_: Rc::new(RefCell::new(<v8_base_RandomNumberGenerator>::from_bytes(
                &buf[240..264],
            ))),
            parent_space_: Rc::new(RefCell::new(
                <PtrDyn<dyn v8_base_VirtualAddressSpaceBase>>::from_bytes(&buf[264..272]),
            )),
            pkey_: Rc::new(RefCell::new(<std_optional_int_>::from_bytes(
                &buf[272..280],
            ))),
            name_: Rc::new(RefCell::new(<Vec<u8>>::from_bytes(&buf[280..304]))),
        }
    }
}
#[derive(Default)]
pub struct v8_base_EmulatedVirtualAddressSubspace {
    mapped_size_: Value<usize>,
    parent_space_: Value<PtrDyn<dyn v8_VirtualAddressSpace>>,
    mutex_: Value<v8_base_Mutex>,
    region_allocator_: Value<v8_base_RegionAllocator>,
    rng_: Value<v8_base_RandomNumberGenerator>,
}
impl v8_base_EmulatedVirtualAddressSubspace {
    pub fn v8_base_EmulatedVirtualAddressSubspace(
        parent_space: PtrDyn<dyn v8_VirtualAddressSpace>,
        base: u64,
        mapped_size: usize,
        total_size: usize,
    ) -> Self {
        let parent_space: Value<PtrDyn<dyn v8_VirtualAddressSpace>> =
            Rc::new(RefCell::new(parent_space));
        let base: Value<u64> = Rc::new(RefCell::new(base));
        let mapped_size: Value<usize> = Rc::new(RefCell::new(mapped_size));
        let total_size: Value<usize> = Rc::new(RefCell::new(total_size));
        let __this: Value<v8_base_EmulatedVirtualAddressSubspace> = Rc::new(RefCell::new(Self {
            mapped_size_: Rc::new(RefCell::new((*mapped_size.borrow()))),
            parent_space_: Rc::new(RefCell::new((*parent_space.borrow()).clone())),
            mutex_: Rc::new(RefCell::new(v8_base_Mutex::v8_base_Mutex())),
            region_allocator_: Rc::new(RefCell::new(
                v8_base_RegionAllocator::v8_base_RegionAllocator(
                    { (*base.borrow()) },
                    { (*mapped_size.borrow()) },
                    {
                        ({
                            v8_VirtualAddressSpaceImpl::page_size(
                                &(*(*this.upgrade().deref()).parent_space_.borrow()),
                            )
                        })
                    },
                ),
            )),
            rng_: Rc::new(RefCell::new(
                v8_base_RandomNumberGenerator::v8_base_RandomNumberGenerator2(),
            )),
        }));
        let this: Ptr<v8_base_EmulatedVirtualAddressSubspace> = __this.as_pointer();
        (&(0));
        (&(0));
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_VirtualAddressSpace for v8_base_EmulatedVirtualAddressSubspace {
    fn SetRandomSeed(&self, seed: i64) {
        let seed: Value<i64> = Rc::new(RefCell::new(seed));
        ...
        ({ v8_base_RandomNumberGeneratorImpl::SetSeed(&self.rng_.as_pointer(), (*seed.borrow())) });
    }
    fn RandomPageAddress(&self) -> u64 {
        let guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
        ...
        let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
        let addr: Value<u64> = Rc::new(RefCell::new(
            ({
                v8_VirtualAddressSpaceImpl::base(
                    &((*self).to_strong() as Value<dyn v8_VirtualAddressSpace>).as_pointer_dyn(),
                )
            })
            .wrapping_add(
                ((({ v8_base_RandomNumberGeneratorImpl::NextInt64(&self.rng_.as_pointer()) })
                    as u64)
                    .wrapping_rem(
                        (({
                            v8_VirtualAddressSpaceImpl::size(
                                &((*self).to_strong() as Value<dyn v8_VirtualAddressSpace>)
                                    .as_pointer_dyn(),
                            )
                        }) as u64),
                    )),
        ...
        return ({
            RoundDown_233(
                (*addr.borrow()),
                (({
                    v8_VirtualAddressSpaceImpl::allocation_granularity(
                        &((*self).to_strong() as Value<dyn v8_VirtualAddressSpace>)
                            .as_pointer_dyn(),
                    )
                }) as i64),
    ...
    fn AllocatePages(
        ...
        if ((*hint.borrow()) == 0)
            || ({
                v8_base_EmulatedVirtualAddressSubspaceImpl::MappedRegionContains(
                    &(*self),
                    (*hint.borrow()),
                    (*size.borrow()),
                )
            })
        {
            ...
            let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
            let address: Value<u64> = Rc::new(RefCell::new(
                ({
                    v8_base_RegionAllocatorImpl::AllocateRegion_u64_usize_usize(
                        &self.region_allocator_.as_pointer(),
                        (*hint.borrow()),
                        (*size.borrow()),
                        (*alignment.borrow()),
                    )
            ...
            if ((*address.borrow()) != 18446744073709551615) {
                if ({
                    (*(*self.parent_space_.borrow()).upgrade().deref()).SetPagePermissions(
                        (*address.borrow()),
                        (*size.borrow()),
                        (*permissions.borrow()),
                    )
                    ...
                    let _cmp: Value<bool> = Rc::new(RefCell::new(
                        ({
                            CmpEQImpl_230(
                                ((*size.borrow()) as u64),
                                (({
                                    v8_base_RegionAllocatorImpl::FreeRegion(
                                        &self.region_allocator_.as_pointer(),
                                        (*address.borrow()),
                                    )
                                }) as u64),
                            ...
                            ({
                                V8_Fatal_252(
                                    ...
                                    &[(Ptr::from_string_literal(
                                        b"size == region_allocator_.FreeRegion(address)",
                                    ))
                                    .into()],
                                )
                            });
        ...
        if !({
            v8_base_EmulatedVirtualAddressSubspaceImpl::IsUsableSizeForUnmappedRegion(
                &(*self),
                (*size.borrow()),
            )
        }) {
        ...
        thread_local!(
            static kMaxAttempts_253: Value<i32> = Rc::new(RefCell::new(10));
        );
        let i: Value<i32> = Rc::new(RefCell::new(0));
        'loop_: while ((*i.borrow()) < 10) {
            (&(0));
            'loop_: while !({
                v8_base_EmulatedVirtualAddressSubspaceImpl::UnmappedRegionContains(
                    &(*self),
                    (*hint.borrow()),
                    (*size.borrow()),
                )
            }) {
                (*hint.borrow_mut()) = ({ self.RandomPageAddress() });
            }
            let __rhs = ({ RoundDown_233((*hint.borrow()), ((*alignment.borrow()) as i64)) });
            (*hint.borrow_mut()) = __rhs;
            let result: Value<u64> = Rc::new(RefCell::new(
                ({
                    (*(*self.parent_space_.borrow()).upgrade().deref()).AllocatePages(
                        (*hint.borrow()),
                        (*size.borrow()),
                        (*alignment.borrow()),
                        (*permissions.borrow()),
            ...
            if ({
                ...
                ({
                    (*(*self.parent_space_.borrow()).upgrade().deref())
                        .FreePages((*result.borrow()), (*size.borrow()))
                });
            }
            (*hint.borrow_mut()) = ({ self.RandomPageAddress() });
                    ...
                    != 0)
                {
                    ({
                        V8_Fatal_252(
                            Ptr::from_string_literal(b"Check failed: %s."),
                            &[(Ptr::from_string_literal(
                                b"parent_space_->DecommitPages(address, size)",
                            ))
                            .into()],
                        )
                    });
    ...
    fn AllocateSharedPages(
        ...
        thread_local!(
            static kMaxAttempts_254: Value<i32> = Rc::new(RefCell::new(10));
        );
        let i: Value<i32> = Rc::new(RefCell::new(0));
        'loop_: while ((*i.borrow()) < 10) {
            (&(0));
            ...
            let region: Value<u64> = Rc::new(RefCell::new(
                ({
                    (*(*self.parent_space_.borrow()).upgrade().deref())
                        .AllocateSharedPages_u64_usize_v8_PagePermissions_v8_SharedMemoryHandle_u64(
                            (*hint.borrow()),
            ...
            if ({
                ...
                return (*region.borrow());
            } else if ((*region.borrow()) != 0) {
                ({
                    (*(*self.parent_space_.borrow()).upgrade().deref())
                        .FreeSharedPages((*region.borrow()), (*size.borrow()))
                });
            }
            (*hint.borrow_mut()) = ({ self.RandomPageAddress() });
            (*i.borrow_mut()).postfix_inc();
    ...
    fn AllocateGuardRegion(&self, address: u64, size: usize) -> bool {
        ...
        if ({
            ...
            let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
            return ({
                v8_base_RegionAllocatorImpl::AllocateRegionAt(
                    &self.region_allocator_.as_pointer(),
                    (*address.borrow()),
                    (*size.borrow()),
                    None,
    ...
    fn ActiveMemoryProtectionKey(&self) -> std_optional_int_ {
        return std_optional_int_::std_optional_int_3({
            (*nullopt_3.with(Value::clone).borrow()).clone()
        });
    }
    fn CanAllocateSubspaces(&self) -> bool {
    ...
    fn AllocateSubspace(
        ...
        let handle: Value<std_optional_v8_SharedMemoryHandle_> = Rc::new(RefCell::new(handle));
        ({
            FatalNoSecurityImpact_255(
                (*kUnimplementedCodeMessage_220.with(Value::clone).borrow()).clone(),
                &[],
            )
        });
        panic!("ub: non-void function does not return a value")
    ...
    fn RecommitPages(&self, address: u64, size: usize, permissions: v8_PagePermissions) -> bool {
        ...
        (&(0));
        return ({
            (*(*self.parent_space_.borrow()).upgrade().deref()).RecommitPages(
                (*address.borrow()),
                (*size.borrow()),
                (*permissions.borrow()),
            )
...
impl ByteRepr for v8_base_EmulatedVirtualAddressSubspace {
    fn byte_size() -> usize {
        264
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.mapped_size_.borrow()).to_bytes(&mut buf[48..56]);
        (*self.parent_space_.borrow()).to_bytes(&mut buf[56..64]);
        (*self.mutex_.borrow()).to_bytes(&mut buf[64..72]);
        (*self.region_allocator_.borrow()).to_bytes(&mut buf[72..240]);
        (*self.rng_.borrow()).to_bytes(&mut buf[240..264]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            mapped_size_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[48..56]))),
            parent_space_: Rc::new(RefCell::new(
                <PtrDyn<dyn v8_VirtualAddressSpace>>::from_bytes(&buf[56..64]),
            )),
            mutex_: Rc::new(RefCell::new(<v8_base_Mutex>::from_bytes(&buf[64..72]))),
            region_allocator_: Rc::new(RefCell::new(<v8_base_RegionAllocator>::from_bytes(
                &buf[72..240],
...
pub trait v8_base_EmulatedVirtualAddressSubspaceImpl {
    fn mapped_size(&self) -> usize;
    fn unmapped_size(&self) -> usize;
    fn mapped_base(&self) -> u64;
    fn unmapped_base(&self) -> u64;
    fn Contains_u64_usize_u64_usize_const(
        &self,
        outer_start: u64,
        outer_size: usize,
        inner_start: u64,
    ...
    fn Contains_u64_usize_const(&self, addr: u64, length: usize) -> bool;
    fn MappedRegionContains(&self, addr: u64, length: usize) -> bool;
    fn UnmappedRegionContains(&self, addr: u64, length: usize) -> bool;
    fn IsUsableSizeForUnmappedRegion(&self, size: usize) -> bool;
}
impl v8_base_EmulatedVirtualAddressSubspaceImpl for Ptr<v8_base_EmulatedVirtualAddressSubspace> {
    fn mapped_size(&self) -> usize {
        return (*(*(*self).upgrade().deref()).mapped_size_.borrow());
    }
    fn unmapped_size(&self) -> usize {
        return ({ v8_VirtualAddressSpaceImpl::size(self) })
            .wrapping_sub((*(*(*self).upgrade().deref()).mapped_size_.borrow()));
    }
    fn mapped_base(&self) -> u64 {
        return ({ v8_VirtualAddressSpaceImpl::base(self) });
    }
    fn unmapped_base(&self) -> u64 {
        return ({ v8_VirtualAddressSpaceImpl::base(self) })
            .wrapping_add(((*(*(*self).upgrade().deref()).mapped_size_.borrow()) as u64));
    }
    fn Contains_u64_usize_u64_usize_const(
        &self,
        outer_start: u64,
        ...
        let outer_start: Value<u64> = Rc::new(RefCell::new(outer_start));
        let outer_size: Value<usize> = Rc::new(RefCell::new(outer_size));
        let inner_start: Value<u64> = Rc::new(RefCell::new(inner_start));
        let inner_size: Value<usize> = Rc::new(RefCell::new(inner_size));
        return ((*inner_start.borrow()) >= (*outer_start.borrow()))
            && (((*inner_start.borrow()).wrapping_add(((*inner_size.borrow()) as u64)))
                <= ((*outer_start.borrow()).wrapping_add(((*outer_size.borrow()) as u64))));
    }
    fn Contains_u64_usize_const(&self, addr: u64, length: usize) -> bool {
        let addr: Value<u64> = Rc::new(RefCell::new(addr));
        let length: Value<usize> = Rc::new(RefCell::new(length));
        return ({
            let _outer_start: u64 = ({ v8_VirtualAddressSpaceImpl::base(self) });
            let _outer_size: usize = ({ v8_VirtualAddressSpaceImpl::size(self) });
            v8_base_EmulatedVirtualAddressSubspaceImpl::Contains_u64_usize_u64_usize_const(
                self,
                _outer_start,
                _outer_size,
                (*addr.borrow()),
    ...
    fn MappedRegionContains(&self, addr: u64, length: usize) -> bool {
        ...
        let length: Value<usize> = Rc::new(RefCell::new(length));
        return ({
            let _outer_start: u64 =
                ({ v8_base_EmulatedVirtualAddressSubspaceImpl::mapped_base(self) });
            let _outer_size: usize =
                ({ v8_base_EmulatedVirtualAddressSubspaceImpl::mapped_size(self) });
            v8_base_EmulatedVirtualAddressSubspaceImpl::Contains_u64_usize_u64_usize_const(
                self,
                _outer_start,
                _outer_size,
    ...
    fn UnmappedRegionContains(&self, addr: u64, length: usize) -> bool {
        ...
        return ({
            let _outer_start: u64 =
                ({ v8_base_EmulatedVirtualAddressSubspaceImpl::unmapped_base(self) });
            let _outer_size: usize =
                ({ v8_base_EmulatedVirtualAddressSubspaceImpl::unmapped_size(self) });
            v8_base_EmulatedVirtualAddressSubspaceImpl::Contains_u64_usize_u64_usize_const(
                self,
                _outer_start,
                _outer_size,
