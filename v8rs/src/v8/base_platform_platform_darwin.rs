...
#[derive(Default)]
pub struct v8_base_pass_value_or_ref_void_ptr__true_ {}
impl Clone for v8_base_pass_value_or_ref_void_ptr__true_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_pass_value_or_ref_void_ptr__true_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_pass_value_or_ref_void_ptr__true_> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_pass_value_or_ref_void_ptr__true_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub type v8_base_comparison_underlying_type_void_ptr__Dummy = u32;
thread_local!(
    pub static is_enum_12: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
pub struct v8_base_comparison_underlying_type_void_ptr_ {}
impl Clone for v8_base_comparison_underlying_type_void_ptr_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_comparison_underlying_type_void_ptr_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_comparison_underlying_type_void_ptr_> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_comparison_underlying_type_void_ptr_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_is_signed_vs_unsigned_void_ptr__void_ptr_ {}
impl Clone for v8_base_is_signed_vs_unsigned_void_ptr__void_ptr_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_is_signed_vs_unsigned_void_ptr__void_ptr_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_is_signed_vs_unsigned_void_ptr__void_ptr_> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_is_signed_vs_unsigned_void_ptr__void_ptr_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_is_unsigned_vs_signed_void_ptr__void_ptr_ {}
impl Clone for v8_base_is_unsigned_vs_signed_void_ptr__void_ptr_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_is_unsigned_vs_signed_void_ptr__void_ptr_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_is_unsigned_vs_signed_void_ptr__void_ptr_> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_is_unsigned_vs_signed_void_ptr__void_ptr_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub fn CmpEQImpl_18(lhs: i32, rhs: i32) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) == (*rhs.borrow()));
}
pub fn CmpEQImpl_19(lhs: AnyPtr, rhs: AnyPtr) -> bool {
    let lhs: Value<AnyPtr> = Rc::new(RefCell::new(lhs));
    let rhs: Value<AnyPtr> = Rc::new(RefCell::new(rhs));
    return {
        let _lhs = (*lhs.borrow()).clone();
        _lhs == (*rhs.borrow()).clone()
    };
}
impl v8_base_Use {
...
pub fn SharedMemoryHandleFromMachMemoryEntry_24(handle: u32) -> v8_SharedMemoryHandle {
    let handle: Value<u32> = Rc::new(RefCell::new(handle));
    return ({ v8_SharedMemoryHandle::FromPlatformHandle((*handle.borrow())) });
}
pub fn MachMemoryEntryFromSharedMemoryHandle_25(handle: v8_SharedMemoryHandle) -> u32 {
...
thread_local!(
    pub static kInvalidSharedMemoryHandle_26: Value<std_optional_v8_SharedMemoryHandle_> =
        Rc::new(RefCell::new(
            std_optional_v8_SharedMemoryHandle_::std_optional_v8_SharedMemoryHandle_1({
                (*nullopt_27.with(Value::clone).borrow()).clone()
            }),
        ));
);
...
pub fn operator_bitor_28(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> v8_PagePermissions {
...
pub fn operator_bitand_29(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> v8_PagePermissions {
    let lhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(lhs));
    let rhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(rhs));
    return ((((*lhs.borrow()) as i32) & ((*rhs.borrow()) as i32)) as v8_PagePermissions);
}
pub fn operator_bitor_assign_30(
    ...
    let __rhs = ({
        ...
        operator_bitor_28(_lhs, _rhs)
    });
    lhs.write(__rhs);
    return (lhs).clone();
}
pub fn IsSubset_31(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> bool {
    let lhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(lhs));
    let rhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(rhs));
    return (({
        let _lhs: v8_PagePermissions = (*lhs.borrow());
        operator_bitand_29(_lhs, (*rhs.borrow()))
    }) == (*lhs.borrow()));
}
...
pub trait v8_Platform {
    ...
    fn CurrentClockTimeMilliseconds(&self) -> i64 {
        return (({ floor_32(({ self.CurrentClockTimeMillis() })) }) as i64);
    }
    ...
    fn GetHighAllocationThroughputObserver(&self) -> Ptr<v8_HighAllocationThroughputObserver> {
        thread_local!(
            static default_observer_33: Value<v8_HighAllocationThroughputObserver> = Rc::new(
                RefCell::new(<v8_HighAllocationThroughputObserver>::default()),
            );
        );
        return (default_observer_33.with(Value::clone).as_pointer());
    }
    fn CreateJobImpl(
        &self,
        priority: v8_TaskPriority,
...
pub type anon_34 = u8;
pub const anon_34_ONCE_STATE_UNINITIALIZED: anon_34 = 0;
pub const anon_34_ONCE_STATE_EXECUTING_FUNCTION: anon_34 = 1;
pub const anon_34_ONCE_STATE_DONE: anon_34 = 2;
pub fn CallOnce_35(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_34_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_36((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
thread_local!(
    pub static kStackWalkError_38: Value<i32> = Rc::new(RefCell::new(-1_i32));
);
thread_local!(
    pub static kStackWalkMaxNameLen_39: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    pub static kStackWalkMaxTextLen_40: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    static msPerSecond_41: Value<i32> = Rc::new(RefCell::new(1000));
);
#[derive()]
...
impl v8_base_Stack {
    pub fn GetCurrentFrameAddress(
        ...
        let frame_address: Value<AnyPtr> = Rc::new(RefCell::new(
            frame_address.unwrap_or(({ __builtin_frame_address_43(0_u32) })),
        ));
...
pub type v8_base_TimezoneCache_TimeZoneDetection = i32;
pub const v8_base_TimezoneCache_TimeZoneDetection_kSkip: v8_base_TimezoneCache_TimeZoneDetection =
    0;
pub const v8_base_TimezoneCache_TimeZoneDetection_kRedetect:
    v8_base_TimezoneCache_TimeZoneDetection = 1;
pub trait v8_base_TimezoneCache {
    fn LocalTimezone(&self, time_ms: f64) -> Ptr<u8>;
    fn DaylightSavingsOffset(&self, time_ms: f64) -> f64;
    fn LocalTimeOffset(&self, time_ms: f64, is_utc: bool) -> f64;
    fn Clear(&self, time_zone_detection: v8_base_TimezoneCache_TimeZoneDetection);
}
pub trait v8_base_PosixTimezoneCache {
    fn Clear(&self, _a0: v8_base_TimezoneCache_TimeZoneDetection) {
        let _a0: Value<v8_base_TimezoneCache_TimeZoneDetection> = Rc::new(RefCell::new(_a0));
    }
}
#[derive(Default)]
pub struct v8_base_PosixDefaultTimezoneCache {}
impl v8_base_PosixTimezoneCache for v8_base_PosixDefaultTimezoneCache {}
impl Clone for v8_base_PosixDefaultTimezoneCache {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_PosixDefaultTimezoneCache> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_PosixDefaultTimezoneCache> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_PosixDefaultTimezoneCache {
    fn byte_size() -> usize {
        8
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub fn GetVMProtFromMemoryPermission_44(access: v8_base_OS_MemoryPermission) -> i32 {
    let access: Value<v8_base_OS_MemoryPermission> = Rc::new(RefCell::new(access));
    'switch: {
        let __match_cond = (*access.borrow());
        match __match_cond {
            __v if __v == 0 || __v == 5 => {
                return (0 as i32);
            }
            ...
            __v if __v == 2 => {
                return ((1 as i32) | (2 as i32));
            }
            __v if __v == 3 => {
                return (((1 as i32) | (2 as i32)) | (4 as i32));
            }
            __v if __v == 4 => {
...
pub fn mach_vm_map_wrapper_46(
    ...
    let address: Value<Ptr<u64>> = Rc::new(RefCell::new(address));
    let size: Value<u64> = Rc::new(RefCell::new(size));
    let flags: Value<i32> = Rc::new(RefCell::new(flags));
    let port: Value<u32> = Rc::new(RefCell::new(port));
    let offset: Value<u64> = Rc::new(RefCell::new(offset));
    let prot: Value<i32> = Rc::new(RefCell::new(prot));
    let current_prot: Value<i32> = Rc::new(RefCell::new((*prot.borrow())));
    let maximum_prot: Value<i32> = Rc::new(RefCell::new((*current_prot.borrow())));
    return ({
        let _address: Ptr<u64> = (*address.borrow()).clone();
        let _size: u64 = (*size.borrow());
        let _offset: u64 = (*offset.borrow());
        mach_vm_map_47(
            (*mach_task_self__48.with(Value::clone).borrow()),
            _address,
            _size,
            0_u64,
            (*flags.borrow()),
...
impl v8_base_OS {
    pub fn GetSharedLibraryAddresses() -> Vec<v8_base_OS_SharedLibraryAddress> {
        let result: Value<Vec<v8_base_OS_SharedLibraryAddress>> = Rc::new(RefCell::new(Vec::new()));
        let images_count: Value<u32> = Rc::new(RefCell::new(({ _dyld_image_count_49() })));
        let i: Value<u32> = Rc::new(RefCell::new(0_u32));
        'loop_: while ((*i.borrow()) < (*images_count.borrow())) {
            let header: Value<Ptr<mach_header>> =
                Rc::new(RefCell::new(({ _dyld_get_image_header_50((*i.borrow())) })));
            if (*header.borrow()).is_null() {
                (*i.borrow_mut()).prefix_inc();
                continue 'loop_;
            }
            let size: Value<u64> = <Value<u64>>::default();
            let header64: Value<Ptr<mach_header_64>> = Rc::new(RefCell::new(
                (*header.borrow()).reinterpret_cast::<mach_header_64>(),
            ));
            let code_ptr: Value<Ptr<u8>> = Rc::new(RefCell::new(
                ({
                    getsectiondata_51(
                        (*header64.borrow()).clone(),
                        Ptr::from_string_literal(b"__TEXT"),
                        Ptr::from_string_literal(b"__text"),
                        (size.as_pointer()),
                    )
                }),
            ));
            if (*code_ptr.borrow()).is_null() {
                (*i.borrow_mut()).prefix_inc();
                continue 'loop_;
            }
            let slide: Value<i64> = Rc::new(RefCell::new(
                ({ _dyld_get_image_vmaddr_slide_52((*i.borrow())) }),
            ));
            let start: Value<u64> = Rc::new(RefCell::new((*code_ptr.borrow()).to_int()));
            (*result.borrow_mut()).push(
                v8_base_OS_SharedLibraryAddress::v8_base_OS_SharedLibraryAddress2(
                    {
                        let __tmp_0: Value<Vec<u8>> = Rc::new(RefCell::new(
                            ({ _dyld_get_image_name_53((*i.borrow())) })
                    ...
                    { (*start.borrow()) },
                    { (*start.borrow()).wrapping_add((*size.borrow())) },
                    { (*slide.borrow()) },
                ),
            );
            (*i.borrow_mut()).prefix_inc();
...
impl v8_base_OS {
    pub fn CreateTimezoneCache() -> PtrDyn<dyn v8_base_TimezoneCache> {
        return (Ptr::alloc(<v8_base_PosixDefaultTimezoneCache>::default()).to_strong()
            as Value<dyn v8_base_TimezoneCache>)
            .as_pointer_dyn();
    }
}
impl v8_base_OS {
...
impl v8_base_OS {
    pub fn GetFirstFreeMemoryRangeWithin(
        ...
        minimum_size: usize,
        alignment: usize,
    ) -> std_optional_v8_base_OS_MemoryRange_ {
        let boundary_start: Value<u64> = Rc::new(RefCell::new(boundary_start));
        let boundary_end: Value<u64> = Rc::new(RefCell::new(boundary_end));
        let minimum_size: Value<usize> = Rc::new(RefCell::new(minimum_size));
        let alignment: Value<usize> = Rc::new(RefCell::new(alignment));
        return std_optional_v8_base_OS_MemoryRange_::std_optional_v8_base_OS_MemoryRange_2({
            (*nullopt_27.with(Value::clone).borrow()).clone()
        });
    }
}
impl v8_base_Stack {
    fn ObtainCurrentThreadStackStart() -> v8_base_Stack_StackSlot {
        return v8_base_Stack_StackSlot::v8_base_Stack_StackSlot1({
            ({ pthread_get_stackaddr_np_54(({ pthread_self_55() })) })
        });
    }
}
impl v8_base_Stack {
    fn ObtainCurrentThreadStackReservedLimit() -> v8_base_Stack_StackSlot {
        return v8_base_Stack_StackSlot::v8_base_Stack_StackSlot1({
            (({ pthread_get_stackaddr_np_54(({ pthread_self_55() })) })
                .reinterpret_cast::<u8>()
                .offset(-(({ pthread_get_stacksize_np_56(({ pthread_self_55() })) }) as isize))
                as Ptr<u8>)
                .to_any()
        });
    }
...
impl v8_base_OS {
    pub fn CreateSharedMemoryHandleForTesting(size: usize) -> std_optional_v8_SharedMemoryHandle_ {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let vm_size: Value<u64> = Rc::new(RefCell::new(((*size.borrow()) as u64)));
        let port: Value<u32> = <Value<u32>>::default();
        let kr: Value<i32> = Rc::new(RefCell::new(
            ({
                mach_make_memory_entry_64_57(
                    (*mach_task_self__48.with(Value::clone).borrow()),
                    (vm_size.as_pointer()),
                    0_u64,
                    ((131072 | (1 as i32)) | (2 as i32)),
                    (port.as_pointer()),
                    0_u32,
                )
            }),
        ...
        if ((*kr.borrow()) != 0) {
            return std_optional_v8_SharedMemoryHandle_::std_optional_v8_SharedMemoryHandle_1({
                (*nullopt_27.with(Value::clone).borrow()).clone()
            });
        }
        return ({ v8_SharedMemoryHandle::FromPlatformHandle((*port.borrow())) });
    }
}
impl v8_base_OS {
    pub fn DestroySharedMemoryHandle(handle: v8_SharedMemoryHandle) {
        let handle: Value<v8_SharedMemoryHandle> = Rc::new(RefCell::new(handle));
        let port: Value<u32> = Rc::new(RefCell::new(
            ({ v8_SharedMemoryHandleImpl::GetPlatformHandle(&handle.as_pointer()) }),
        ));
                    ...
                    ({
                        V8_Fatal_45(
                            ...
                            &[(Ptr::from_string_literal(
                                b"0 == mach_port_deallocate(mach_task_self_, port)",
                            ))
                            .into()],
                        )
                    });
...
impl v8_base_OS {
    fn AllocateShared_AnyPtr_usize_v8_base_OS_MemoryPermission_v8_SharedMemoryHandle_u64(
        hint: AnyPtr,
        size: usize,
        access: v8_base_OS_MemoryPermission,
        handle: v8_SharedMemoryHandle,
        offset: u64,
    ) -> AnyPtr {
        ...
        let offset: Value<u64> = Rc::new(RefCell::new(offset));
        (&(0));
        let addr: Value<u64> = Rc::new(RefCell::new((*hint.borrow()).to_int()));
        let prot: Value<i32> = Rc::new(RefCell::new(
            ({ GetVMProtFromMemoryPermission_44((*access.borrow())) }),
        ));
        let shared_mem_port: Value<u32> = Rc::new(RefCell::new(
            ({ v8_SharedMemoryHandleImpl::GetPlatformHandle(&handle.as_pointer()) }),
        ));
        let kr: Value<i32> = Rc::new(RefCell::new(
            ({
                mach_vm_map_wrapper_46(
                    (addr.as_pointer()),
                    ((*size.borrow()) as u64),
                    0,
                    (*shared_mem_port.borrow()),
                    (*offset.borrow()),
                    (*prot.borrow()),
                )
            }),
        ...
        return (*addr.borrow()).reinterpret_cast::<::libc::c_void>();
    }
}
impl v8_base_OS {
    pub fn RemapPages(
        ...
        (&(0));
        (&(0));
        let cur_protection: Value<i32> = Rc::new(RefCell::new(
            ({ GetVMProtFromMemoryPermission_44((*access.borrow())) }),
        ));
        let max_protection: Value<i32> = <Value<i32>>::default();
        let flags: Value<i32> = Rc::new(RefCell::new((0 | 16384)));
        let target: Value<u64> = Rc::new(RefCell::new((*new_address.borrow()).to_int()));
        let ret: Value<i32> = Rc::new(RefCell::new(
            ({
                let _target_task: u32 = (*mach_task_self__48.with(Value::clone).borrow());
                let _src_task: u32 = (*mach_task_self__48.with(Value::clone).borrow());
                mach_vm_remap_59(
                    _target_task,
                    (target.as_pointer()),
                    ((*size.borrow()) as u64),
                    ...
                    (*flags.borrow()),
                    _src_task,
                    (*address.borrow()).to_int(),
                    (DYLD_BOOL_FALSE as i32),
                    (cur_protection.as_pointer()),
                    (max_protection.as_pointer()),
                    (2_u32),
                )
            }),
        ));
            ...
            let _cmp: Value<bool> = Rc::new(RefCell::new(
                ({
                    CmpEQImpl_19(
                        ...
                        ((*target.borrow()).reinterpret_cast::<::libc::c_void>()),
                    )
                }),
            ));
            let mut __do_while = true;
                ...
                if ((!(!(!(*_cmp.borrow()))) as i64) != 0) {
                    ({
                        V8_Fatal_45(
                            Ptr::from_string_literal(b"Check failed: %s."),
                            &[(Ptr::from_string_literal(
                                b"new_address == reinterpret_cast<void*>(target)",
                            ))
                            .into()],
                        )
                    });
...
pub fn SetJitWriteProtected_60(enable: i32) {
    let enable: Value<i32> = Rc::new(RefCell::new(enable));
    ({ pthread_jit_write_protect_np_61((*enable.borrow())) });
}
...
impl v8_base_AddressSpaceReservationImpl for Ptr<v8_base_AddressSpaceReservation> {
    ...
    fn AllocateShared(
        ...
        let addr: Value<u64> = Rc::new(RefCell::new((*address.borrow()).to_int()));
        let shared_mem_port: Value<u32> = Rc::new(RefCell::new(
            ({ v8_SharedMemoryHandleImpl::GetPlatformHandle(&handle.as_pointer()) }),
        ));
        let kr: Value<i32> = Rc::new(RefCell::new(
