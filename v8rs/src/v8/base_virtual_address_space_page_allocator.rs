...
pub fn ConvertPageAllocatorPermission_242(
    permission: v8_PageAllocator_Permission,
) -> v8_PagePermissions {
    let permission: Value<v8_PageAllocator_Permission> = Rc::new(RefCell::new(permission));
    switch!(match ((*permission.borrow()) as i32) {
        __v if __v == 0 => {
            return v8_PagePermissions_kNoAccess;
        }
        __v if __v == 1 => {
            return v8_PagePermissions_kRead;
        }
        __v if __v == 2 => {
            return v8_PagePermissions_kReadWrite;
        }
        __v if __v == 3 => {
            return v8_PagePermissions_kReadWriteExecute;
        }
        __v if __v == 4 => {
            return v8_PagePermissions_kReadExecute;
        }
        __v if __v == 5 => {
            ({
                V8_Fatal_243(
