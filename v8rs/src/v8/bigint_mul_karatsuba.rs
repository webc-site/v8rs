...
pub fn RoundUpLen_93(len: u32) -> u32 {
    let len: Value<u32> = Rc::new(RefCell::new(len));
    if ((*len.borrow()) <= 36_u32) {
        return (({ RoundUp_86(((*len.borrow()) as i32), 2) }) as u32);
    }
    let shift: Value<i32> = Rc::new(RefCell::new(
        (({ BitLength_27(((*len.borrow()) as i32)) }) - 5),
    ));
    if (((*len.borrow()) >> (*shift.borrow())) >= 24_u32) {
        (*shift.borrow_mut()).postfix_inc();
    }
    let additive: Value<u32> = Rc::new(RefCell::new((((1 << (*shift.borrow())) - 1) as u32)));
    if ((*shift.borrow()) >= 2)
        && (((*len.borrow()) & (*additive.borrow())) < ((1 << ((*shift.borrow()) - 2)) as u32))
    {
        return (*len.borrow());
    }
    return ((((*len.borrow()).wrapping_add((*additive.borrow()))) >> (*shift.borrow()))
        << (*shift.borrow()));
}
pub fn KaratsubaLength_94(n: u32) -> u32 {
    let n: Value<u32> = Rc::new(RefCell::new(n));
    let __rhs = ({ RoundUpLen_93((*n.borrow())) });
    (*n.borrow_mut()) = __rhs;
    let i: Value<u32> = Rc::new(RefCell::new(0_u32));
    'loop_: while ((*n.borrow()) > 34) {
        (*n.borrow_mut()) >>= 1;
        (*i.borrow_mut()).postfix_inc();
    }
    return ((*n.borrow()) << (*i.borrow()));
}
pub fn KaratsubaSubtractionHelper_95(
    result: v8_bigint_RWDigits,
    X: v8_bigint_Digits,
    Y: v8_bigint_Digits,
    sign: Ptr<i32>,
) {
    let result: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(result));
    let X: Value<v8_bigint_Digits> = Rc::new(RefCell::new(X));
    let Y: Value<v8_bigint_Digits> = Rc::new(RefCell::new(Y));
    ...
    let borrow: Value<u64> = Rc::new(RefCell::new(0_u64));
    let i: Value<u32> = Rc::new(RefCell::new(0_u32));
    if !({ GreaterThanOrEqual_38((*X.borrow()).clone(), (*Y.borrow()).clone()) }) {
        let __rhs = -((*sign.borrow()).read());
        (*sign.borrow()).write(__rhs);
        {
            let tmp = X.as_pointer().read();
            X.as_pointer().write(Y.as_pointer().read());
            Y.as_pointer().write(tmp);
    ...
    'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) })) {
        ({
            ...
            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                &Rc::new(RefCell::new(
                    ({
                        v8_bigint_RWDigitsImpl::operator_index(&result.as_pointer(), (*i.borrow()))
                    }),
                ))
                .as_pointer(),
                _digit,
    ...
    (&(0));
    'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&result.as_pointer()) })) {
        ({
            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                &Rc::new(RefCell::new(
                    ({
...
pub trait v8_bigint_ProcessorImplImpl {
    fn MultiplyKaratsuba(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits);
    fn KaratsubaStart(
        &self,
        Z: v8_bigint_RWDigits,
        X: v8_bigint_Digits,
...
impl v8_bigint_ProcessorImplImpl for Ptr<v8_bigint_ProcessorImpl> {
    ...
    fn MultiplyKaratsuba(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits) {
        ...
        let k: Value<u32> = Rc::new(RefCell::new(
            ({ KaratsubaLength_94(({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) })) }),
        ));
        let scratch_len: Value<u32> = Rc::new(RefCell::new((4_u32).wrapping_mul((*k.borrow()))));
        ...
        ({
            v8_bigint_ProcessorImplImpl::KaratsubaStart(
                self,
                (*Z.borrow()).clone(),
                (*X.borrow()).clone(),
                (*Y.borrow()).clone(),
    ...
    fn KaratsubaStart(
        ...
        ({
            v8_bigint_ProcessorImplImpl::KaratsubaMain(
                self,
                (*Z.borrow()).clone(),
                (*X.borrow()).clone(),
                (*Y.borrow()).clone(),
        ...
        let i: Value<u32> = Rc::new(RefCell::new((2_u32).wrapping_mul((*k.borrow()))));
        'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&Z.as_pointer()) })) {
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
        ...
        if ((*k.borrow()) < ({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) }))
            || (({ v8_bigint_DigitsImpl::len(&X.as_pointer()) })
                != ({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) }))
        {
            ...
            let Y1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
                ({
                    let _i: u32 = {
                        ...
                        (if k.as_pointer().read() <= __tmp_1.as_pointer().read() {
                            k.as_pointer()
                        } else {
                            __tmp_1.as_pointer()
                        }
                    ...
                    v8_bigint_DigitsImpl::operator_add(&Y.as_pointer(), _i)
                }),
            ));
            if (({ v8_bigint_DigitsImpl::len(&Y1.as_pointer()) }) > 0_u32) {
                ({
                    v8_bigint_ProcessorImplImpl::KaratsubaChunk(
                        self,
                        (*T.borrow()).clone(),
                        (*X0.borrow()).clone(),
                        (*Y1.borrow()).clone(),
                ...
                ({
                    AddAndReturnOverflow_89(
                        ({ v8_bigint_RWDigitsImpl::operator_add(&Z.as_pointer(), (*k.borrow())) }),
                        (*T.borrow()).clone(),
                    )
                });
            }
    ...
    fn KaratsubaMain(
        ...
        if ((*n.borrow()) < 34) {
                ...
                >= ({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) }))
            {
                ({
                    MultiplySchoolbook_56(
                        v8_bigint_RWDigits::v8_bigint_RWDigits2(
                            { (*Z.borrow()).clone() },
                            { 0_u32 },
                            { (2_u32).wrapping_mul((*n.borrow())) },
                        ),
        ...
        (&(0));
        (&(0));
        let n2: Value<u32> = Rc::new(RefCell::new(((*n.borrow()) >> 1)));
        let X0: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*X.borrow()).clone() }, { 0_u32 }, {
                (*n2.borrow())
            }),
        ...
        let X1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*X.borrow()).clone() }, { (*n2.borrow()) }, {
                (*n2.borrow())
            }),
        ));
        let Y0: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
        ...
        let Y1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*Y.borrow()).clone() }, { (*n2.borrow()) }, {
                (*n2.borrow())
            }),
        ));
        let scratch_for_recursion: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*scratch.borrow()).clone() },
                { (2_u32).wrapping_mul((*n.borrow())) },
                { (2_u32).wrapping_mul((*n.borrow())) },
            )));
        let P0: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow())
            }),
        ));
        ({
            v8_bigint_ProcessorImplImpl::KaratsubaMain(
                ...
                (*X0.borrow()).clone(),
                (*Y0.borrow()).clone(),
                (*scratch_for_recursion.borrow()).clone(),
                (*n2.borrow()),
            )
        });
        let i: Value<u32> = Rc::new(RefCell::new(0_u32));
        'loop_: while ((*i.borrow()) < (*n.borrow())) {
            ({
                let _src: Value<v8_bigint_RWDigits_WritableDigitReference> = Rc::new(RefCell::new(
                    ({ v8_bigint_RWDigitsImpl::operator_index(&P0.as_pointer(), (*i.borrow())) }),
                ));
                v8_bigint_RWDigits_WritableDigitReferenceImpl :: operator_assign_pconstv8_bigint_RWDigits_WritableDigitReference ( &Rc::new(RefCell::new((  { v8_bigint_RWDigitsImpl :: operator_index ( &Z .as_pointer()  , (*i.borrow())  , ) } ) )) .as_pointer()  , _src.as_pointer() , )
            });
            (*i.borrow_mut()).postfix_inc();
        }
        let P2: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*scratch.borrow()).clone() },
                { (*n.borrow()) },
                { (*n.borrow()) },
        ...
        let Z2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            ({ v8_bigint_RWDigitsImpl::operator_add(&Z.as_pointer(), (*n.borrow())) }),
        ));
        let end: Value<u32> = Rc::new(RefCell::new({
            let __tmp_0: Value<u32> = Rc::new(RefCell::new(
                ({ v8_bigint_DigitsImpl::len(&Z2.as_pointer()) }),
            ));
            let __tmp_1: Value<u32> = Rc::new(RefCell::new(
                ({ v8_bigint_DigitsImpl::len(&P2.as_pointer()) }),
            ));
            (if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                __tmp_0.as_pointer()
            } else {
        ...
        'loop_: while ((*i.borrow()) < (*end.borrow())) {
            ({
                let _src: Value<v8_bigint_RWDigits_WritableDigitReference> = Rc::new(RefCell::new(
                    ({ v8_bigint_RWDigitsImpl::operator_index(&P2.as_pointer(), (*i.borrow())) }),
                ));
                v8_bigint_RWDigits_WritableDigitReferenceImpl :: operator_assign_pconstv8_bigint_RWDigits_WritableDigitReference ( &Rc::new(RefCell::new((  { v8_bigint_RWDigitsImpl :: operator_index ( &Z2 .as_pointer()  , (*i.borrow())  , ) } ) )) .as_pointer()  , _src.as_pointer() , )
            });
            (*i.borrow_mut()).postfix_inc();
        }
        let overflow: Value<u64> = Rc::new(RefCell::new(
            ({
                AddAndReturnOverflow_89(
                    ({ v8_bigint_RWDigitsImpl::operator_add(&Z.as_pointer(), (*n2.borrow())) }),
                    (*P0.borrow()).clone(),
                )
            }),
        ));
        {
            let rhs_0 = (*overflow.borrow()).wrapping_add(
                ({
                    AddAndReturnOverflow_89(
                        ({ v8_bigint_RWDigitsImpl::operator_add(&Z.as_pointer(), (*n2.borrow())) }),
                        (*P2.borrow()).clone(),
            ...
            (*overflow.borrow_mut()) = rhs_0
        };
        let X_diff: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                (*n2.borrow())
            }),
        ));
        let Y_diff: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*scratch.borrow()).clone() },
                { (*n2.borrow()) },
                { (*n2.borrow()) },
        ...
        let P1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*scratch.borrow()).clone() },
                { (*n.borrow()) },
                { (*n.borrow()) },
        ...
        if ((*sign.borrow()) > 0) {
            ...
            {
                let rhs_0 = (*overflow.borrow()).wrapping_sub(
                    ({
                        SubAndReturnBorrow_90(
                            ({
                                v8_bigint_RWDigitsImpl::operator_add(
                                    &Z.as_pointer(),
                                    (*n2.borrow()),
