...
pub fn Nanoseconds_96(n: u64) -> absl_Duration {
    let n: Value<u64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_74(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Microseconds_97(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_76(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Microseconds_98(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_76((*n.borrow()), std_ratio______ {}) });
}
pub fn Milliseconds_99(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_77(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Milliseconds_100(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
...
pub fn Seconds_102(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_78((*n.borrow()), std_ratio______ {}) });
}
pub fn Minutes_103(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_104(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Hours_105(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_106(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn operator_shl_107(os: Ptr<std::fs::File>, d: absl_Duration) -> Ptr<std::fs::File> {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return os.write_all(
        &([(&({ FormatDuration_108((*d.borrow()).clone()) })
            .iter()
            .take(({ FormatDuration_108((*d.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
...
pub fn operator_cmp_109(lhs: absl_Time, rhs: absl_Time) -> std::cmp::Ordering {
...
pub fn operator_lt_111(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
...
pub fn operator_gt_112(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
        operator_lt_111(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_113(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_lt_111(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_114(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
...
pub fn operator_eq_110(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
...
pub fn operator_ne_115(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
...
pub fn operator_add_116(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_add_117(lhs: absl_Duration, rhs: absl_Time) -> absl_Time {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_118(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_119(lhs: absl_Time, rhs: absl_Time) -> absl_Duration {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
...
pub fn UnixEpoch_120() -> absl_Time {
    return <absl_Time>::default();
}
pub fn UniversalEpoch_121() -> absl_Time {
    return absl_Time::absl_Time1({
        ({ MakeDuration_122((((-24_i32 * 719162) as i64) * 3600_i64), 0_u32) })
    });
}
pub fn InfiniteFuture_123() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_122(<i64>::MAX, !0_u32) }) });
}
pub fn InfinitePast_124() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_122(<i64>::MIN, !0_u32) }) });
}
pub fn operator_eq_125(a: absl_TimeZone, b: absl_TimeZone) -> bool {
...
pub fn operator_ne_126(a: absl_TimeZone, b: absl_TimeZone) -> bool {
    let a: Value<absl_TimeZone> = Rc::new(RefCell::new(a));
    let b: Value<absl_TimeZone> = Rc::new(RefCell::new(b));
    return ({
        let _lhs: absl_time_internal_cctz_time_zone = (*(*a.borrow()).cz_.borrow()).clone();
...
pub fn operator_shl_127(os: Ptr<std::fs::File>, tz: absl_TimeZone) -> Ptr<std::fs::File> {
...
pub fn LoadTimeZone_128(name: Vec<u8>, tz: Ptr<absl_TimeZone>) -> bool {
    ...
    if (*name.borrow()).clone()
        == Ptr::from_string_literal(b"localtime")
            ...
            .collect::<Vec<u8>>()
    {
        let __rhs = absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_129() }) });
    ...
    let b: Value<bool> = Rc::new(RefCell::new(
        ({
            ...
            load_time_zone_130(_name.as_pointer(), (cz.as_pointer()))
        }),
    ));
...
pub fn FixedTimeZone_131(seconds: i32) -> absl_TimeZone {
    ...
    return absl_TimeZone::absl_TimeZone1({
        ({
            ...
            fixed_time_zone_132(_offset.as_pointer())
        })
    });
}
pub fn UTCTimeZone_133() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ utc_time_zone_134() }) });
}
pub fn LocalTimeZone_135() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_129() }) });
}
pub fn ToCivilSecond_136(
    t: absl_Time,
    tz: absl_TimeZone,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_ {
...
thread_local!();
thread_local!();
pub fn operator_shl_149(os: Ptr<std::fs::File>, t: absl_Time) -> Ptr<std::fs::File> {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return os.write_all(
        &([(&({ FormatTime_150((*t.borrow()).clone()) })
            .iter()
            .take(({ FormatTime_150((*t.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
            .collect::<Vec<u8>>()[..] as &[u8])]
        .concat()),
    );
}
pub fn MakeDuration_122(hi: i64, lo: Option<u32>) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<u32> = Rc::new(RefCell::new(lo.unwrap_or(0_u32)));
    return absl_Duration::absl_Duration2({ (*hi.borrow()) }, { (*lo.borrow()) });
}
pub fn MakeDuration_151(hi: i64, lo: i64) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<i64> = Rc::new(RefCell::new(lo));
    return ({ MakeDuration_122((*hi.borrow()), Some(((*lo.borrow()) as u32))) });
}
pub fn MakePosDoubleDuration_152(n: f64) -> absl_Duration {
    ...
    return if (((*ticks.borrow()) as i64) < 4000000000) {
        ({ MakeDuration_122((*int_secs.borrow()), Some((*ticks.borrow()))) })
    } else {
        ({
            MakeDuration_151(
...
pub fn MakeNormalizedDuration_75(sec: i64, ticks: i64) -> absl_Duration {
    ...
    return if ((*ticks.borrow()) < 0_i64) {
        ({ MakeDuration_151(((*sec.borrow()) - 1_i64), ((*ticks.borrow()) + 4000000000)) })
    } else {
        ({ MakeDuration_151((*sec.borrow()), (*ticks.borrow())) })
    };
}
pub fn GetRepHi_153(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return ({ absl_Duration_HiRepImpl::Get(&(*d.borrow()).rep_hi_.as_pointer()) });
}
pub fn GetRepLo_154(d: absl_Duration) -> u32 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (*(*d.borrow()).rep_lo_.borrow());
}
pub fn IsInfiniteDuration_155(d: absl_Duration) -> bool {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (({ GetRepLo_154((*d.borrow()).clone()) }) == !0_u32);
}
pub fn OppositeInfinity_156(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepHi_153((*d.borrow()).clone()) }) < 0_i64) {
        ({ MakeDuration_122(<i64>::MAX, Some(!0_u32)) })
    } else {
        ({ MakeDuration_122(<i64>::MIN, Some(!0_u32)) })
    };
}
pub fn NegateAndSubtractOne_157(n: i64) -> i64 {
    let n: Value<i64> = Rc::new(RefCell::new(n));
...
pub fn FromUnixDuration_158(d: absl_Duration) -> absl_Time {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return absl_Time::absl_Time1({ (*d.borrow()).clone() });
}
pub fn ToUnixDuration_159(t: absl_Time) -> absl_Duration {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
...
pub fn FromInt64_104(v: i64, _a1: std_ratio______) -> absl_Duration {
    ...
    {
        ({ MakeDuration_122(((*v.borrow()) * 60_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_160() })
        } else {
            ({
                let _d: absl_Duration = ({ InfiniteDuration_160() });
                operator_neg_93(_d)
            })
        }
    };
...
pub fn FromInt64_106(v: i64, _a1: std_ratio______) -> absl_Duration {
    ...
    {
        ({ MakeDuration_122(((*v.borrow()) * 3600_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_160() })
        } else {
...
pub fn IsValidRep64_162(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
...
pub fn FromChrono_166(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
...
pub fn FromChrono_168(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_106(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn ToInt64_169(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Nanoseconds_170((*d.borrow()).clone()) });
}
pub fn ToInt64_171(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Microseconds_172((*d.borrow()).clone()) });
}
pub fn ToInt64_173(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Milliseconds_174((*d.borrow()).clone()) });
}
pub fn ToInt64_175(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Seconds_176((*d.borrow()).clone()) });
}
pub fn ToInt64_177(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Minutes_178((*d.borrow()).clone()) });
}
pub fn ToInt64_179(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Hours_180((*d.borrow()).clone()) });
}
pub fn operator_lt_82(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return if (({ GetRepHi_153((*lhs.borrow()).clone()) })
        != ({ GetRepHi_153((*rhs.borrow()).clone()) }))
    {
        (({ GetRepHi_153((*lhs.borrow()).clone()) }) < ({ GetRepHi_153((*rhs.borrow()).clone()) }))
    } else {
        if (({ GetRepHi_153((*lhs.borrow()).clone()) }) == <i64>::MIN) {
            (({ GetRepLo_154((*lhs.borrow()).clone()) }).wrapping_add(1_u32)
                < ({ GetRepLo_154((*rhs.borrow()).clone()) }).wrapping_add(1_u32))
        } else {
            (({ GetRepLo_154((*lhs.borrow()).clone()) })
                < ({ GetRepLo_154((*rhs.borrow()).clone()) }))
        }
    };
}
pub fn operator_cmp_79(lhs: absl_Duration, rhs: absl_Duration) -> std::cmp::Ordering {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    let lhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_153((*lhs.borrow()).clone()) })));
    let rhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_153((*rhs.borrow()).clone()) })));
    {
    ...
    let lhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_154((*lhs.borrow()).clone()) })));
    let rhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_154((*rhs.borrow()).clone()) })));
...
pub fn operator_eq_80(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (({ GetRepHi_153((*lhs.borrow()).clone()) })
        == ({ GetRepHi_153((*rhs.borrow()).clone()) }))
        && (({ GetRepLo_154((*lhs.borrow()).clone()) })
            == ({ GetRepLo_154((*rhs.borrow()).clone()) }));
}
pub fn operator_neg_93(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepLo_154((*d.borrow()).clone()) }) == 0_u32) {
        if (({ GetRepHi_153((*d.borrow()).clone()) }) == <i64>::MIN) {
            ({ InfiniteDuration_160() })
        } else {
            ({ MakeDuration_122(-({ GetRepHi_153((*d.borrow()).clone()) }), None) })
        }
    } else {
        if ({ IsInfiniteDuration_155((*d.borrow()).clone()) }) {
            ({ OppositeInfinity_156((*d.borrow()).clone()) })
        } else {
            ({
                let _hi: i64 =
                    ({ NegateAndSubtractOne_157(({ GetRepHi_153((*d.borrow()).clone()) })) });
                let _lo: i64 = (4000000000 - (({ GetRepLo_154((*d.borrow()).clone()) }) as i64));
                MakeDuration_151(_hi, _lo)
            })
        }
    };
}
pub fn InfiniteDuration_160() -> absl_Duration {
    return ({ MakeDuration_122(<i64>::MAX, Some(!0_u32)) });
}
...
pub fn FromChrono_186(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_168((d).clone()) });
}
pub fn FromUnixNanos_187(ns: i64) -> absl_Time {
    let ns: Value<i64> = Rc::new(RefCell::new(ns));
    return ({ FromUnixDuration_158(({ Nanoseconds_95((*ns.borrow())) })) });
}
pub fn FromUnixMicros_188(us: i64) -> absl_Time {
    let us: Value<i64> = Rc::new(RefCell::new(us));
    return ({ FromUnixDuration_158(({ Microseconds_98((*us.borrow())) })) });
}
pub fn FromUnixMillis_189(ms: i64) -> absl_Time {
    let ms: Value<i64> = Rc::new(RefCell::new(ms));
    return ({ FromUnixDuration_158(({ Milliseconds_100((*ms.borrow())) })) });
}
pub fn FromUnixSeconds_190(s: i64) -> absl_Time {
    let s: Value<i64> = Rc::new(RefCell::new(s));
    return ({ FromUnixDuration_158(({ Seconds_101((*s.borrow())) })) });
}
pub fn FromTimeT_191(t: i64) -> absl_Time {
    let t: Value<i64> = Rc::new(RefCell::new(t));
    return ({ FromUnixDuration_158(({ Seconds_102((*t.borrow())) })) });
}
pub fn ToInt64Nanoseconds_170(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_153((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_153((*d.borrow()).clone()) }) >> 33) == 0_i64)
    {
        return ((((({ GetRepHi_153((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_154((*d.borrow()).clone()) }) as i64) / 4));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
...
pub fn ToInt64Microseconds_172(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_153((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_153((*d.borrow()).clone()) }) >> 43) == 0_i64)
    {
        return (((({ GetRepHi_153((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_154((*d.borrow()).clone()) }) as i64) / (4 * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_88(_lhs, ({ Microseconds_97(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Milliseconds_174(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_153((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_153((*d.borrow()).clone()) }) >> 53) == 0_i64)
    {
        return ((({ GetRepHi_153((*d.borrow()).clone()) }) * 1000_i64)
            + ((({ GetRepLo_154((*d.borrow()).clone()) }) as i64) / ((4 * 1000_i64) * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_88(_lhs, ({ Milliseconds_99(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Seconds_176(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_153((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_155((*d.borrow()).clone()) }) {
        return (*hi.borrow());
    }
    if ((*hi.borrow()) < 0_i64) && (({ GetRepLo_154((*d.borrow()).clone()) }) != 0_u32) {
        (*hi.borrow_mut()).prefix_inc();
    }
    return (*hi.borrow());
}
pub fn ToInt64Minutes_178(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_153((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_155((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn ToInt64Hours_180(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_153((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_155((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn SleepFor_192(duration: absl_Duration) {
    let duration: Value<absl_Duration> = Rc::new(RefCell::new(duration));
    ({ AbslInternalSleepFor_193((*duration.borrow()).clone()) });
}
thread_local!(
    static kNoTimeout_194: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
thread_local!(
    static kMaxNanos_195: Value<i64> = Rc::new(RefCell::new(9223372036854775807));
);
#[derive()]
...
pub fn GetOrCreateCurrentThreadIdentity_196() -> Ptr<absl_base_internal_ThreadIdentity> {
    let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
        Rc::new(RefCell::new(({ CurrentThreadIdentityIfPresent_197() })));
    if ((((false) || ((*identity.borrow()).is_null())) as i64) != 0) {
        return ({ CreateThreadIdentity_198() });
    }
...
impl absl_synchronization_internal_PerThreadSem {
    fn Init(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        ...
        ({ AbslInternalPerThreadSemInit_199((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Post(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
            Rc::new(RefCell::new(identity));
        ({ AbslInternalPerThreadSemPost_200((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Wait(t: absl_synchronization_internal_KernelTimeout) -> bool {
        ...
        return ({ AbslInternalPerThreadSemWait_201((*t.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
...
thread_local!();
pub fn ControlledCrashesAreHarmless_204() -> bool {
    return ((*g_abort_mode_203.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_203.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn DcheckFailuresAreIgnored_205() -> bool {
    return ((*g_abort_mode_203.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_203.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn FatalErrorsWithNoSecurityImpactShouldExit_206() -> bool {
    return ((*g_abort_mode_203.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitIfNoSecurityImpact);
}
thread_local!(
    pub static kReturnAddressStackSlotCount_207: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPageSizeBits_208: Value<i32> = Rc::new(RefCell::new(18));
);
thread_local!(
    pub static kRegularPageSize_209: Value<i32> = Rc::new(RefCell::new(262144));
);
thread_local!(
    pub static kMinimumOSPageSize_210: Value<i32> = Rc::new(RefCell::new(16384));
);
thread_local!(
    pub static kUnimplementedCodeMessage_211: Value<Ptr<u8>> = Rc::new(RefCell::new(
        Ptr::from_string_literal(b"unimplemented code"),
    ));
);
thread_local!(
    pub static kUnreachableCodeMessage_212: Value<Ptr<u8>> =
...
thread_local!(
    pub static is_enum_214: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_215: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_216: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static value_218: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
pub fn make_uint64_219(high: u32, low: u32) -> u64 {
...
pub fn RoundDown_220(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    return ((*x.borrow()) & (-(*m.borrow()) as u64));
}
pub fn RoundUp_221(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    (&(0));
...
pub fn IsAligned_222(value: u64, alignment: u64) -> bool {
...
pub type anon_223 = u8;
pub const anon_223_ONCE_STATE_UNINITIALIZED: anon_223 = 0;
pub const anon_223_ONCE_STATE_EXECUTING_FUNCTION: anon_223 = 1;
pub const anon_223_ONCE_STATE_DONE: anon_223 = 2;
pub fn CallOnce_224(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_223_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_225((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
pub fn CountLeadingZeros_226(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        if (32_u32 == 64_u32) {
            (({ __builtin_clzll_227(((*value.borrow()) as u64)) }) as u32)
        } else {
...
pub fn CountLeadingZeros_228(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
...
pub fn CountLeadingZeros32_229(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_226((*value.borrow())) });
}
pub fn CountLeadingZeros64_230(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_228((*value.borrow())) });
}
pub fn CountTrailingZeros_231(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        (if (32_u32 == 64_u32) {
            ({ __builtin_ctzll_232(((*value.borrow()) as u64)) })
        } else {
            ((*value.borrow()) as u32).trailing_zeros() as i32
        } as u32)
    };
}
pub fn CountTrailingZeros_233(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u64) {
        64_u32
    } else {
...
pub fn CountTrailingZeros32_234(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_231((*value.borrow())) });
}
pub fn CountTrailingZeros64_235(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_233((*value.borrow())) });
}
pub fn RoundUpToPowerOfTwo32_236(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u32 << ((32_u32).wrapping_sub(({ CountLeadingZeros_226((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo64_237(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u64 << ((64_u32).wrapping_sub(({ CountLeadingZeros_228((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo_238(value: usize) -> usize {
    let value: Value<usize> = Rc::new(RefCell::new(value));
    if (::std::mem::size_of::<usize>() == ::std::mem::size_of::<u64>()) {
        return (({ RoundUpToPowerOfTwo64_237(((*value.borrow()) as u64)) }) as usize);
    } else {
        return (({ RoundUpToPowerOfTwo32_236(((*value.borrow()) as u32)) }) as usize);
    }
    panic!("ub: non-void function does not return a value")
}
pub fn RoundDownToPowerOfTwo32_239(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    if ((*value.borrow()) > 2147483648_u32) {
        return 2147483648_u32;
    }
    let result: Value<u32> = Rc::new(RefCell::new(
        ({ RoundUpToPowerOfTwo32_236((*value.borrow())) }),
    ));
...
pub fn RotateRight32_240(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
...
pub fn RotateLeft32_241(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    let shift: Value<u32> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((32_u32).wrapping_sub((*shift.borrow()))) & 31_u32)));
}
pub fn RotateRight64_242(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) >> (*shift.borrow()))
        | ((*value.borrow()) << (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn RotateLeft64_243(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn ClearLsb_244(value: i32) -> i32 {
    let value: Value<i32> = Rc::new(RefCell::new(value));
    return ((*value.borrow()) & ((*value.borrow()) - 1));
}
pub fn SignedAddOverflow32_245(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    ...
    return ({
        ...
        __builtin_sadd_overflow_246(_arg0, _arg1, _arg2)
    });
}
pub fn SignedSubOverflow32_247(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_ssub_overflow_248(_arg0, _arg1, _arg2)
    });
}
pub fn SignedMulOverflow32_249(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_smul_overflow_250(_arg0, _arg1, _arg2)
    });
}
pub fn SignedAddOverflow64_251(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
...
pub fn SignedSubOverflow64_253(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return ({
        __builtin_sub_overflow_254(&[
            (*lhs.borrow()).into(),
            (*rhs.borrow()).into(),
            ((*val.borrow()).clone()).into(),
        ])
...
pub fn SignedMulOverflow64_255(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return {
...
pub fn UnsignedAddOverflow32_256(lhs: u32, rhs: u32, val: Ptr<u32>) -> bool {
    ...
    return ({
        ...
        __builtin_uadd_overflow_257(_arg0, _arg1, _arg2)
    });
}
pub fn UnsignedDiv32_258(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
...
pub fn UnsignedDiv64_259(lhs: u64, rhs: u64) -> u64 {
...
pub fn UnsignedMod32_260(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
...
pub fn UnsignedMod64_261(lhs: u64, rhs: u64) -> u64 {
    let lhs: Value<u64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u64> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
        (*lhs.borrow()).wrapping_rem((*rhs.borrow()))
...
pub fn WraparoundAdd32_262(lhs: i32, rhs: i32) -> i32 {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    return ((((*lhs.borrow()) as u32).wrapping_add(((*rhs.borrow()) as u32))) as i32);
}
pub fn WraparoundNeg32_263(x: i32) -> i32 {
    let x: Value<i32> = Rc::new(RefCell::new(x));
    return (-((*x.borrow()) as u32) as i32);
}
pub fn ByteReverse16_264(value: u16) -> u16 {
    let value: Value<u16> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse32_265(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse64_266(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
thread_local!(
    pub static kMaxExponent_267: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kMaxExponent_268: Value<i32> = Rc::new(RefCell::new(1024));
);
thread_local!(
    pub static kIntegerBitsPlusSign_269: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kIntegerBitsPlusSign_270: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kIntegerBitsPlusSign_271: Value<i32> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kIntegerBitsPlusSign_272: Value<i32> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kIntegerBitsPlusSign_273: Value<i32> = Rc::new(RefCell::new(32));
);
thread_local!(
    pub static kIntegerBitsPlusSign_274: Value<i32> = Rc::new(RefCell::new(32));
);
thread_local!(
    pub static kIntegerBitsPlusSign_275: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kIntegerBitsPlusSign_276: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kIntegerBitsPlusSign_277: Value<i32> = Rc::new(RefCell::new(64));
);
pub fn IsValueNegative_278(value: i64) -> bool {
    let value: Value<i64> = Rc::new(RefCell::new(value));
    if true {
...
pub fn ConditionalNegate_279(x: u64, is_negative: bool) -> i64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
...
pub fn SafeUnsignedAbs_280(value: i64) -> u64 {
    let value: Value<i64> = Rc::new(RefCell::new(value));
    return if ({ IsValueNegative_278((*value.borrow())) }) {
...
thread_local!(
    pub static kEnableAsmCode_281: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static kStaticDstRangeRelationToSrcRange_282: Value<
        v8_base_internal_NumericRangeRepresentation,
    > = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kStaticDstRangeRelationToSrcRange_284: Value<
        v8_base_internal_NumericRangeRepresentation,
    > = Rc::new(RefCell::new(0));
);
#[derive(Default)]
...
thread_local!(
    pub static kShift_285: Value<i32> = Rc::new(RefCell::new(10));
);
#[derive(Default)]
...
impl v8_base_internal_NarrowingRange_long_long__double__v8_base_internal_SaturationDefaultLimits_ {
    ...
    pub fn Adjust_i64__long_long(value: i64) -> i64 {
        ...
        if true {
            return (({
                let _x: u64 = (({ SafeUnsignedAbs_280((*value.borrow())) })
                    & !(((1_u64 << 10) as u64).wrapping_sub((1_u64 as u64))));
                let _is_negative: bool = ({ IsValueNegative_278((*value.borrow())) });
                ConditionalNegate_279(_x, _is_negative)
            }) as i64);
        } else {
        }
        panic!("ub: non-void function does not return a value")
...
pub fn DstRangeRelationToSrcRange_286(value: f64) -> v8_base_internal_RangeCheck {
...
thread_local!(
    pub static kIsCheckedNumeric_287: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static kIsClampedNumeric_288: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static kIsStrictNumeric_289: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static kIsNumeric_290: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
pub fn saturated_cast_impl_291(value: f64, constraint: v8_base_internal_RangeCheck) -> i64 {
    let value: Value<f64> = Rc::new(RefCell::new(value));
...
thread_local!(
    pub static is_supported_292: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
pub fn saturated_cast_293(value: f64) -> i64 {
    let value: Value<f64> = Rc::new(RefCell::new(value));
    ...
    return if ((!({ is_constant_evaluated_7() })) && (false)) && (true) {
        ...
        ({
            ...
            let _constraint: v8_base_internal_RangeCheck =
                ({ DstRangeRelationToSrcRange_286((*underlying_value.borrow())) });
            saturated_cast_impl_291(_value, _constraint)
        })
    };
}
#[derive(Default)]
...
thread_local!(
    pub static kHoursPerDay_296: Value<i64> = Rc::new(RefCell::new(24));
);
thread_local!(
    pub static kMillisecondsPerSecond_297: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kMillisecondsPerDay_298: Value<i64> = Rc::new(RefCell::new(86400000));
);
thread_local!(
    pub static kMicrosecondsPerMillisecond_299: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kMicrosecondsPerSecond_300: Value<i64> = Rc::new(RefCell::new(1000000));
);
thread_local!(
    pub static kMicrosecondsPerMinute_301: Value<i64> = Rc::new(RefCell::new(60000000));
);
thread_local!(
    pub static kMicrosecondsPerHour_302: Value<i64> = Rc::new(RefCell::new(3600000000));
);
thread_local!(
    pub static kMicrosecondsPerDay_303: Value<i64> = Rc::new(RefCell::new(86400000000));
);
thread_local!(
    pub static kMicrosecondsPerWeek_304: Value<i64> = Rc::new(RefCell::new(604800000000));
);
thread_local!(
    pub static kNanosecondsPerMicrosecond_305: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kNanosecondsPerSecond_306: Value<i64> = Rc::new(RefCell::new(1000000000));
);
#[derive(Default)]
...
pub fn swap_307(a: v8_base_TimeDelta, b: v8_base_TimeDelta) {
...
impl v8_base_TimeDelta {
    fn FromDouble(value: f64) -> v8_base_TimeDelta {
        let value: Value<f64> = Rc::new(RefCell::new(value));
        return v8_base_TimeDelta::v8_base_TimeDelta2({
            ({ saturated_cast_293((*value.borrow())) })
        });
    }
}
impl v8_base_TimeDelta {
...
pub fn Nanoseconds_308(nanoseconds: i64) -> v8_base_TimeDelta {
    let nanoseconds: Value<i64> = Rc::new(RefCell::new(nanoseconds));
    return ({ v8_base_TimeDelta::FromNanoseconds((*nanoseconds.borrow())) });
}
pub fn Microseconds_309(microseconds: i64) -> v8_base_TimeDelta {
    let microseconds: Value<i64> = Rc::new(RefCell::new(microseconds));
    return ({ v8_base_TimeDelta::FromMicroseconds((*microseconds.borrow())) });
}
pub fn Milliseconds_310(milliseconds: i64) -> v8_base_TimeDelta {
    let milliseconds: Value<i64> = Rc::new(RefCell::new(milliseconds));
    return ({ v8_base_TimeDelta::FromMilliseconds((*milliseconds.borrow())) });
}
pub fn Milliseconds_311(milliseconds: f64) -> v8_base_TimeDelta {
    let milliseconds: Value<f64> = Rc::new(RefCell::new(milliseconds));
    return ({ v8_base_TimeDelta::FromMillisecondsD((*milliseconds.borrow())) });
}
pub fn Seconds_312(seconds: i64) -> v8_base_TimeDelta {
    let seconds: Value<i64> = Rc::new(RefCell::new(seconds));
    return ({ v8_base_TimeDelta::FromSeconds((*seconds.borrow())) });
}
pub fn Seconds_313(seconds: f64) -> v8_base_TimeDelta {
    let seconds: Value<f64> = Rc::new(RefCell::new(seconds));
    return ({ v8_base_TimeDelta::FromSecondsD((*seconds.borrow())) });
}
pub fn Minutes_314(minutes: i32) -> v8_base_TimeDelta {
    let minutes: Value<i32> = Rc::new(RefCell::new(minutes));
    return ({ v8_base_TimeDelta::FromMinutes((*minutes.borrow())) });
}
pub fn Hours_315(hours: i32) -> v8_base_TimeDelta {
    let hours: Value<i32> = Rc::new(RefCell::new(hours));
    return ({ v8_base_TimeDelta::FromHours((*hours.borrow())) });
}
pub fn FromDays_316(days: i32) -> v8_base_TimeDelta {
    let days: Value<i32> = Rc::new(RefCell::new(days));
...
pub fn operator_add_317(delta: Ptr<v8_base_TimeDelta>, time: Ptr<v8_base_Time>) -> v8_base_Time {
    return ({
...
pub trait v8_base_ConditionVariableImpl {
    fn NotifyOne(&self);
    fn NotifyAll(&self);
    fn Wait(&self, mutex: Ptr<v8_base_Mutex>);
    fn WaitFor(&self, mutex: Ptr<v8_base_Mutex>, rel_time: Ptr<v8_base_TimeDelta>) -> bool;
}
impl v8_base_ConditionVariableImpl for Ptr<v8_base_ConditionVariable> {
    fn NotifyOne(&self) {
        ({ absl_CondVarImpl::Signal(&(*(*self).upgrade().deref()).native_handle_.as_pointer()) });
    }
    fn NotifyAll(&self) {
        ({
            absl_CondVarImpl::SignalAll(&(*(*self).upgrade().deref()).native_handle_.as_pointer())
        });
    }
    fn Wait(&self, mutex: Ptr<v8_base_Mutex>) {
        let mutex: Value<Ptr<v8_base_Mutex>> = Rc::new(RefCell::new(mutex));
        ({ v8_base_MutexImpl::AssertHeldAndUnmark(&(*mutex.borrow())) });
        ({
            absl_CondVarImpl::Wait(
                &(*(*self).upgrade().deref()).native_handle_.as_pointer(),
                ((*(*mutex.borrow()).upgrade().deref())
                    .native_handle_
                    .as_pointer()),
            )
        });
        ({ v8_base_MutexImpl::AssertUnheldAndMark(&(*mutex.borrow())) });
    }
    fn WaitFor(&self, mutex: Ptr<v8_base_Mutex>, rel_time: Ptr<v8_base_TimeDelta>) -> bool {
        let mutex: Value<Ptr<v8_base_Mutex>> = Rc::new(RefCell::new(mutex));
        let time: Value<u64> = Rc::new(RefCell::new(
            (({ v8_base_TimeDeltaImpl::InNanoseconds(&rel_time) }) as u64),
        ));
        let duration: Value<absl_Duration> =
            Rc::new(RefCell::new(({ Nanoseconds_96((*time.borrow())) })));
        ({ v8_base_MutexImpl::AssertHeldAndUnmark(&(*mutex.borrow())) });
        let timed_out: Value<bool> = Rc::new(RefCell::new(
            ({
                absl_CondVarImpl::WaitWithTimeout(
                    &(*(*self).upgrade().deref()).native_handle_.as_pointer(),
                    ((*(*mutex.borrow()).upgrade().deref())
                        .native_handle_
                        .as_pointer()),
                    (*duration.borrow()).clone(),
                )
            }),
        ));
        ({ v8_base_MutexImpl::AssertUnheldAndMark(&(*mutex.borrow())) });
        return !(*timed_out.borrow());
    }
}
