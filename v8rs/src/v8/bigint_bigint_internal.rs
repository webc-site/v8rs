...
pub trait v8_bigint_ProcessorImpl {
    ...
    fn CachedMod_MakeInverse(&self, B: Ptr<v8_bigint_Digits>);
    ...
    fn AllocateCachedInverseFor(&self, divisor: Ptr<v8_bigint_Digits>) -> Ptr<v8_bigint_RWDigits>;
...
impl v8_bigint_ProcessorImpl for Ptr<v8_bigint_Processor> {
    ...
    fn MultiplyLarge(
        ...
        ({
            let _Z: Ptr<v8_bigint_RWDigits> = (Z).clone();
            let _X: Ptr<v8_bigint_Digits> = (X).clone();
            let _Y: Ptr<v8_bigint_Digits> = (Y).clone();
            v8_bigint_ProcessorImplImpl::MultiplyLarge(&(*impl_.borrow()), _Z, _X, _Y)
        });
    ...
    fn DivideLarge(
        ...
        (&(0));
        (&(0));
        let R0: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits1({ Ptr::<u64>::null() }, { 0_u32 }),
        ));
        if {
            let _lhs = ({ v8_bigint_DigitsImpl::len(&B) });
            _lhs < 57
        } {
            ({
                let _Q: Ptr<v8_bigint_RWDigits> = (Q).clone();
                let _R: Ptr<v8_bigint_RWDigits> = R0.as_pointer();
                let _A: Ptr<v8_bigint_Digits> = (A).clone();
                let _B: Ptr<v8_bigint_Digits> = (B).clone();
                v8_bigint_ProcessorImplImpl::DivideSchoolbook(&(*impl_.borrow()), _Q, _R, _A, _B)
            });
            return ({ v8_bigint_ProcessorImplImpl::get_and_clear_status(&(*impl_.borrow())) });
        }
        if !({
            ...
            write!(cerr(), "bigint-internal.cc:{:}: ", 77,);
            write!(
                cerr(),
                "Assertion failed: A.len() <= kMaxNumDigits\n",
            );
            std::process::abort();
        };
        if ({
            ...
            let _lhs = ({ v8_bigint_DigitsImpl::len(&A) });
            _lhs == ({ v8_bigint_DigitsImpl::len(&B) })
        }) {
            ({
                let _Q: v8_bigint_RWDigits = (*Q.upgrade().deref()).clone();
                let _R: v8_bigint_RWDigits = (*R0.borrow()).clone();
                let _A: v8_bigint_Digits = (*A.upgrade().deref()).clone();
                let _B: v8_bigint_Digits = (*B.upgrade().deref()).clone();
            ...
            let R: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
                v8_bigint_ScratchDigits::v8_bigint_ScratchDigits(
                    { ({ v8_bigint_DigitsImpl::len(&B) }) },
                    { ({ v8_bigint_ProcessorImpl::platform(self) }) },
                ),
            ));
            ({
                let _Q: v8_bigint_RWDigits = (*Q.upgrade().deref()).clone();
                let _R: v8_bigint_RWDigits = (*R.borrow()).clone();
                let _A: v8_bigint_Digits = (*A.upgrade().deref()).clone();
                let _B: v8_bigint_Digits = (*B.upgrade().deref()).clone();
                v8_bigint_ProcessorImplImpl :: DivideBarrett_v8_bigint_RWDigits_v8_bigint_RWDigits_v8_bigint_Digits_v8_bigint_Digits ( &(*impl_.borrow())  , _Q , _R , _A , _B , )
            });
        }
        return ({ v8_bigint_ProcessorImplImpl::get_and_clear_status(&(*impl_.borrow())) });
    }
    fn ModuloLarge(
        ...
        if {
            ...
            let Q: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
                v8_bigint_RWDigits::v8_bigint_RWDigits1({ Ptr::<u64>::null() }, { 0_u32 }),
            ));
            ({
                let _Q: Ptr<v8_bigint_RWDigits> = Q.as_pointer();
                let _R: Ptr<v8_bigint_RWDigits> = (R).clone();
                let _A: Ptr<v8_bigint_Digits> = (A).clone();
                let _B: Ptr<v8_bigint_Digits> = (B).clone();
                v8_bigint_ProcessorImplImpl::DivideSchoolbook(&(*impl_.borrow()), _Q, _R, _A, _B)
        ...
        if !({
            ...
            write!(cerr(), "bigint-internal.cc:{:}: ", 101,);
            write!(
                cerr(),
                "Assertion failed: A.len() < kMaxNumDigits\n",
            );
        ...
        let q_len: Value<u32> = Rc::new(RefCell::new(
            ({
                let _A: v8_bigint_Digits = (*A.upgrade().deref()).clone();
                let _B: v8_bigint_Digits = (*B.upgrade().deref()).clone();
                DivideResultLength_66(_A, _B)
            }),
        ));
        let Q: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*q_len.borrow()) }, {
                ({ v8_bigint_ProcessorImpl::platform(self) })
            }),
        ));
        if ({
            ...
            ({
                let _Q: v8_bigint_RWDigits = (*Q.borrow()).clone();
                let _R: v8_bigint_RWDigits = (*R.upgrade().deref()).clone();
                let _A: v8_bigint_Digits = (*A.upgrade().deref()).clone();
                let _B: v8_bigint_Digits = (*B.upgrade().deref()).clone();
                v8_bigint_ProcessorImplImpl::DivideBurnikelZiegler(
                    &(*impl_.borrow()),
    ...
    fn AllocateCachedInverseFor(&self, divisor: Ptr<v8_bigint_Digits>) -> Ptr<v8_bigint_RWDigits> {
        let divisor_len: Value<u32> =
            Rc::new(RefCell::new(({ v8_bigint_DigitsImpl::len(&divisor) })));
        let inverse_len: Value<u32> =
            Rc::new(RefCell::new((*divisor_len.borrow()).wrapping_add(1_u32)));
        let len: Value<u32> = Rc::new(RefCell::new(
            (*divisor_len.borrow()).wrapping_add((*inverse_len.borrow())),
        ));
        if ((*len.borrow())
            > (*(*(*self).upgrade().deref())
                .cached_inverse_allocated_length_
                .borrow()))
        {
            ({
                let ___ptr: Ptr<u64> = ({
                    (*(*(*(*self).upgrade().deref()).platform_.borrow())
                        ...
                        .unwrap()
                        .borrow())
                    .Allocate(((*len.borrow()) as usize))
                });
                (*(*(*self).upgrade().deref())
                    .cached_inverse_storage_
                    .borrow())
                .reset(___ptr)
            });
            (*(*(*self).upgrade().deref())
                .cached_inverse_allocated_length_
                .borrow_mut()) = (*len.borrow());
        }
        (*(*(*self).upgrade().deref()).cached_divisor_.borrow_mut()) =
            v8_bigint_RWDigits::v8_bigint_RWDigits1(
                {
                    ({
                        (*(*(*self).upgrade().deref())
                            .cached_inverse_storage_
        ...
        let i: Value<u32> = Rc::new(RefCell::new(0_u32));
        'loop_: while ((*i.borrow()) < (*divisor_len.borrow())) {
            ({
                let _digit: u64 = ({
                    let _i: u32 = (*i.borrow());
                    v8_bigint_DigitsImpl::operator_index(&divisor, _i)
                });
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(
                                &(*(*self).upgrade().deref()).cached_divisor_.as_pointer(),
                                (*i.borrow()),
                            )
                        }),
                    ))
        ...
        (*(*(*self).upgrade().deref()).cached_inverse_.borrow_mut()) =
            v8_bigint_RWDigits::v8_bigint_RWDigits1(
                {
                    ({
                        (*(*(*self).upgrade().deref())
                    ...
                    .offset((*divisor_len.borrow()) as isize)
                },
                { (*inverse_len.borrow()) },
            );
        return (*(*self).upgrade().deref()).cached_inverse_.as_pointer();
    ...
    fn CachedMod_MakeInverse(&self, B: Ptr<v8_bigint_Digits>) {
        ({
            v8_bigint_ProcessorImplImpl::CachedMod_MakeInverse(
                &(*self).reinterpret_cast::<v8_bigint_ProcessorImpl>(),
                (B).clone(),
            )
        });
...
pub trait v8_bigint_ProcessorImplImpl {
    fn get_and_clear_status(&self) -> v8_bigint_Status;
    fn Multiply(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits);
    fn MultiplyLarge(
        &self,
        Z: Ptr<v8_bigint_RWDigits>,
        X: Ptr<v8_bigint_Digits>,
...
impl v8_bigint_ProcessorImplImpl for Ptr<v8_bigint_ProcessorImpl> {
    ...
    fn get_and_clear_status(&self) -> v8_bigint_Status {
        let result: Value<v8_bigint_Status> = Rc::new(RefCell::new(
            (*(*(*self).upgrade().deref()).status_.borrow()),
        ));
        (*(*(*self).upgrade().deref()).status_.borrow_mut()) = v8_bigint_Status_kOk;
        return (*result.borrow());
    }
    fn Multiply(&self, Z: v8_bigint_RWDigits, X: v8_bigint_Digits, Y: v8_bigint_Digits) {
        let Z: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(Z));
        ...
        if (({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) }) == 1_u32) {
            ({
                MultiplySingle_57(
                    (*Z.borrow()).clone(),
                    (*X.borrow()).clone(),
                    ({ v8_bigint_DigitsImpl::operator_index(&Y.as_pointer(), 0_u32) }),
                )
            });
            ({
                v8_bigint_ProcessorImplImpl::AddWorkEstimate(
                    self,
                    (({ v8_bigint_DigitsImpl::len(&X.as_pointer()) }) as u64),
                )
            });
            return;
        }
        if (({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) }) < 34) {
            ({
                MultiplySchoolbook_58(
                    (*Z.borrow()).clone(),
                    (*X.borrow()).clone(),
                    (*Y.borrow()).clone(),
                )
            ...
            ({
                v8_bigint_ProcessorImplImpl::AddWorkEstimate(
                    self,
                    ((({ v8_bigint_DigitsImpl::len(&X.as_pointer()) })
                        .wrapping_mul(({ v8_bigint_DigitsImpl::len(&Y.as_pointer()) })))
                        as u64),
                )
            });
            return;
        ...
        ({
            v8_bigint_ProcessorImplImpl::MultiplyLarge(
                self,
                Z.as_pointer(),
                X.as_pointer(),
                Y.as_pointer(),
    ...
    fn MultiplyLarge(
        ...
        if !({
            ...
            write!(cerr(), "bigint-internal.cc:{:}: ", 51,);
            write!(
                cerr(),
                "Assertion failed: X.len() <= kMaxNumDigits\n",
            );
            std::process::abort();
        };
        if {
            ...
            ({
                ...
                let _X: v8_bigint_Digits = (*X.upgrade().deref()).clone();
                let _Y: v8_bigint_Digits = (*Y.upgrade().deref()).clone();
                v8_bigint_ProcessorImplImpl::MultiplyKaratsuba(self, _Z, _X, _Y)
            });
            return;
        }
        if {
            ...
            ({
                ...
                let _X: v8_bigint_Digits = (*X.upgrade().deref()).clone();
                let _Y: v8_bigint_Digits = (*Y.upgrade().deref()).clone();
                v8_bigint_ProcessorImplImpl::MultiplyToomCook(self, _Z, _X, _Y)
            });
            return;
        }
        ({
            ...
            let _X: v8_bigint_Digits = (*X.upgrade().deref()).clone();
            let _Y: v8_bigint_Digits = (*Y.upgrade().deref()).clone();
            v8_bigint_ProcessorImplImpl::MultiplyFFT(self, _Z, _X, _Y)
        });
        return;
    }
    fn CachedMod_MakeInverse(&self, B: Ptr<v8_bigint_Digits>) {
        let n: Value<u32> = Rc::new(RefCell::new(({ v8_bigint_DigitsImpl::len(&B) })));
        let Inv: Ptr<v8_bigint_RWDigits> =
            ({ v8_bigint_ProcessorImpl::AllocateCachedInverseFor(self, (B).clone()) });
        let cached_B: Ptr<v8_bigint_Digits> = ({ v8_bigint_ProcessorImpl::GetCachedDivisor(self) });
        if !(({ v8_bigint_DigitsImpl::msd(&cached_B) }) != 0_u64) {
            write!(cerr(), "bigint-internal.cc:{:}: ", 137,);
            write!(cerr(), "Assertion failed: cached_B.msd() != 0\n",);
            std::process::abort();
        };
        ({ v8_bigint_ProcessorImpl::set_cached_mod_fold_factor(self, 0_u64) });
        ({ v8_bigint_ProcessorImpl::GetSmallScratch(self) });
        let scratch: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits(
                {
                    (((*n.borrow()).wrapping_add(1_u32)).wrapping_add(2_u32))
                        .wrapping_add((*n.borrow()))
                },
                { ({ v8_bigint_ProcessorImpl::platform(self) }) },
            ),
        ));
        {
            let T: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*scratch.borrow()).clone() },
                    { 0_u32 },
                    { (*n.borrow()).wrapping_add(1_u32) },
                )));
            ({ v8_bigint_RWDigitsImpl::Clear(&T.as_pointer()) });
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(&T.as_pointer(), (*n.borrow()))
                        }),
                    ))
                    .as_pointer(),
                    1_u64,
            ...
            let Q: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*scratch.borrow()).clone() },
                    { (*n.borrow()).wrapping_add(1_u32) },
                    { 2_u32 },
                )));
            let R: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*scratch.borrow()).clone() },
                    { (*n.borrow()).wrapping_add(3_u32) },
                    { (*n.borrow()) },
                )));
            ({
                let _Q: Ptr<v8_bigint_RWDigits> = Q.as_pointer();
                let _R: Ptr<v8_bigint_RWDigits> = R.as_pointer();
                let _A: Ptr<v8_bigint_Digits> = T.as_pointer();
                let _B: Ptr<v8_bigint_Digits> = (cached_B).clone();
                v8_bigint_ProcessorImplImpl::DivideSchoolbook(self, _Q, _R, _A, _B)
            });
            ({ v8_bigint_DigitsImpl::Normalize(&Q.as_pointer()) });
            ({ v8_bigint_DigitsImpl::Normalize(&R.as_pointer()) });
            let kMaxFoldQuotient: Value<u64> = Rc::new(RefCell::new(4));
            if ((({ v8_bigint_DigitsImpl::len(&Q.as_pointer()) }) == 1_u32)
                && (({
                    v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_digit_t(
                        &Rc::new(RefCell::new(
                ...
                && (({ v8_bigint_DigitsImpl::len(&R.as_pointer()) }) == 1_u32)
            {
                ({
                    v8_bigint_ProcessorImpl::set_cached_mod_fold_factor(
                        self,
                        ({
                            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_digit_t(
                                &Rc::new(RefCell::new(
        ...
        let A: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*scratch.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow()).wrapping_mul(2_u32)
            }),
        ));
        let i: Value<u32> = Rc::new(RefCell::new(0_u32));
        'loop_: while ((*i.borrow()) < (*n.borrow())) {
            ({
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
                            v8_bigint_RWDigitsImpl::operator_index(&A.as_pointer(), (*i.borrow()))
                        }),
                    ))
                    .as_pointer(),
                    !0_u64,
        ...
        'loop_: while ((*i.borrow()) < ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) })) {
            ({
                let _digit: u64 = !({
                    let _i: u32 = (*i.borrow()).wrapping_sub((*n.borrow()));
                    v8_bigint_DigitsImpl::operator_index(&cached_B, _i)
                });
                v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                    &Rc::new(RefCell::new(
                        ({
        ...
        ({
            let _Q: Ptr<v8_bigint_RWDigits> = (Inv).clone();
            let _R: Ptr<v8_bigint_RWDigits> = R.as_pointer();
            let _A: Ptr<v8_bigint_Digits> = A.as_pointer();
            let _B: Ptr<v8_bigint_Digits> = (cached_B).clone();
            v8_bigint_ProcessorImplImpl::DivideSchoolbook(self, _Q, _R, _A, _B)
        });
        ({
            Add_51(
                ({
                    let _i: u32 = (*n.borrow());
                    v8_bigint_RWDigitsImpl::operator_add(&Inv, _i)
                }),
                1_u64,
            )
        });
        if (({
            v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_digit_t(
                &Rc::new(RefCell::new(
                    ({ v8_bigint_RWDigitsImpl::operator_index(&Inv, 0_u32) }),
                ))
                .as_pointer(),
            )
        }) != !0_u64)
            || (({ v8_bigint_DigitsImpl::msd(&Inv) }) != !0_u64)
        {
            ({ Add_51((*Inv.upgrade().deref()).clone(), 1_u64) });
        }
    }
}
