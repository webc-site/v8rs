...
thread_local!(
    pub static value_224: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_225: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static value_226: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
impl v8_base_Use {
    pub fn v8_base_Use2(_a0: Ptr<u32>) -> Self {
        let __this: Value<v8_base_Use> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_Use> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
...
pub fn make_uint64_228(high: u32, low: u32) -> u64 {
...
pub fn RoundDown_229(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    return ((*x.borrow()) & (-(*m.borrow()) as u64));
}
pub fn RoundUp_230(x: u64, m: i64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let m: Value<i64> = Rc::new(RefCell::new(m));
    (&(0));
    (&(0));
...
pub fn IsAligned_231(value: u64, alignment: u64) -> bool {
...
pub type anon_232 = u8;
pub const anon_232_ONCE_STATE_UNINITIALIZED: anon_232 = 0;
pub const anon_232_ONCE_STATE_EXECUTING_FUNCTION: anon_232 = 1;
pub const anon_232_ONCE_STATE_DONE: anon_232 = 2;
pub fn CallOnce_233(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_232_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_234((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
#[derive(Default)]
pub struct v8_base_LazyStaticInstance_v8_base_ConditionVariable__v8_base_DefaultConstructTrait_v8_base_ConditionVariable___v8_base_ThreadSafeInitOnceTrait__v8_base_LeakyInstanceTrait_v8_base_ConditionVariable__
{}
impl Clone for v8_base_LazyStaticInstance_v8_base_ConditionVariable__v8_base_DefaultConstructTrait_v8_base_ConditionVariable___v8_base_ThreadSafeInitOnceTrait__v8_base_LeakyInstanceTrait_v8_base_ConditionVariable__ { fn clone(&self) -> Self { let __this : Value<v8_base_LazyStaticInstance_v8_base_ConditionVariable__v8_base_DefaultConstructTrait_v8_base_ConditionVariable___v8_base_ThreadSafeInitOnceTrait__v8_base_LeakyInstanceTrait_v8_base_ConditionVariable__> = Rc::new(RefCell::new(Self { } )) ;
 let this : Ptr<v8_base_LazyStaticInstance_v8_base_ConditionVariable__v8_base_DefaultConstructTrait_v8_base_ConditionVariable___v8_base_ThreadSafeInitOnceTrait__v8_base_LeakyInstanceTrait_v8_base_ConditionVariable__> = __this.as_pointer() ;
 Rc::try_unwrap(__this).ok().unwrap().into_inner() } }
impl ByteRepr for  v8_base_LazyStaticInstance_v8_base_ConditionVariable__v8_base_DefaultConstructTrait_v8_base_ConditionVariable___v8_base_ThreadSafeInitOnceTrait__v8_base_LeakyInstanceTrait_v8_base_ConditionVariable__ { fn byte_size() -> usize { 1 } fn to_bytes(&self, buf: &mut [u8]) { } fn from_bytes(buf: &[u8]) -> Self { Self { } } }
#[derive()]
...
#[derive()]
pub struct v8_base_ConditionVariable {
    native_handle_: Value<absl_CondVar>,
}
impl v8_base_ConditionVariable {}
impl Default for v8_base_ConditionVariable {
    fn default() -> Self {
        { v8_base_ConditionVariable::v8_base_ConditionVariable() }
    }
}
impl ByteRepr for v8_base_ConditionVariable {
    fn byte_size() -> usize {
        8
    }
    fn to_bytes(&self, buf: &mut [u8]) {
    ...
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            native_handle_: Rc::new(RefCell::new(<absl_CondVar>::from_bytes(&buf[0..8]))),
        }
    }
}
thread_local!(
    static kInvalidTaskId_235: Value<u8> = Rc::new(RefCell::new(255));
);
#[derive(Default)]
pub struct v8_platform_DefaultJobState_JobDelegate {
    outer_: Value<Ptr<v8_platform_DefaultJobState>>,
    task_id_: Value<u8>,
    is_joining_thread_: Value<bool>,
    was_told_to_yield_: Value<bool>,
}
impl v8_platform_DefaultJobState_JobDelegate {
    pub fn v8_platform_DefaultJobState_JobDelegate(
        outer: Ptr<v8_platform_DefaultJobState>,
        is_joining_thread: Option<bool>,
    ) -> Self {
        let outer: Value<Ptr<v8_platform_DefaultJobState>> = Rc::new(RefCell::new(outer));
        let is_joining_thread: Value<bool> =
            Rc::new(RefCell::new(is_joining_thread.unwrap_or(false)));
        let __this: Value<v8_platform_DefaultJobState_JobDelegate> = Rc::new(RefCell::new(Self {
            outer_: Rc::new(RefCell::new((*outer.borrow()).clone())),
            task_id_: Rc::new(RefCell::new(255)),
            is_joining_thread_: Rc::new(RefCell::new((*is_joining_thread.borrow()))),
            was_told_to_yield_: Rc::new(RefCell::new(false)),
        }));
        let this: Ptr<v8_platform_DefaultJobState_JobDelegate> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_JobDelegate for v8_platform_DefaultJobState_JobDelegate {
    fn NotifyConcurrencyIncrease(&self) {
        ({ v8_platform_DefaultJobStateImpl::NotifyConcurrencyIncrease(&(*self.outer_.borrow())) });
    }
    fn ShouldYield(&self) -> bool {
        (&(0));
        {
            let rhs_0 = (((*self.was_told_to_yield_.borrow()) as i32)
                | (({
                    (*(*(*self.outer_.borrow()).upgrade().deref())
                        .is_canceled_
                        .borrow())
                    .load_const(Some(0))
                }) as i32))
                != 0;
            (*self.was_told_to_yield_.borrow_mut()) = rhs_0
        };
        return (*self.was_told_to_yield_.borrow());
    }
    fn GetTaskId(&self) -> u8 {
        if (((*self.task_id_.borrow()) as i32) == (255 as i32)) {
            (*self.task_id_.borrow_mut()) =
                ({ v8_platform_DefaultJobStateImpl::AcquireTaskId(&(*self.outer_.borrow())) });
        }
        return (*self.task_id_.borrow());
    }
    fn IsJoiningThread(&self) -> bool {
        return (*self.is_joining_thread_.borrow());
    }
}
impl Clone for v8_platform_DefaultJobState_JobDelegate {
    fn clone(&self) -> Self {
        let __this: Value<v8_platform_DefaultJobState_JobDelegate> = Rc::new(RefCell::new(Self {
            outer_: Rc::new(RefCell::new((*self.outer_.borrow()).clone())),
            task_id_: Rc::new(RefCell::new((*self.task_id_.borrow()))),
            is_joining_thread_: Rc::new(RefCell::new((*self.is_joining_thread_.borrow()))),
            was_told_to_yield_: Rc::new(RefCell::new((*self.was_told_to_yield_.borrow()))),
        }));
        let this: Ptr<v8_platform_DefaultJobState_JobDelegate> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_platform_DefaultJobState_JobDelegate {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.outer_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.task_id_.borrow()).to_bytes(&mut buf[16..17]);
        (*self.is_joining_thread_.borrow()).to_bytes(&mut buf[17..18]);
        (*self.was_told_to_yield_.borrow()).to_bytes(&mut buf[18..19]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            outer_: Rc::new(RefCell::new(
                <Ptr<v8_platform_DefaultJobState>>::from_bytes(&buf[8..16]),
            )),
            task_id_: Rc::new(RefCell::new(<u8>::from_bytes(&buf[16..17]))),
            is_joining_thread_: Rc::new(RefCell::new(<bool>::from_bytes(&buf[17..18]))),
            was_told_to_yield_: Rc::new(RefCell::new(<bool>::from_bytes(&buf[18..19]))),
        }
    }
}
#[derive(Default)]
pub struct v8_platform_DefaultJobState {
    platform_: Value<PtrDyn<dyn v8_Platform>>,
    job_task_: Value<Option<Value<v8_JobTask>>>,
    mutex_: Value<v8_base_Mutex>,
    priority_: Value<v8_TaskPriority>,
    active_workers_: Value<usize>,
    pending_tasks_: Value<usize>,
    is_canceled_: Value<std_atomic_bool_>,
    num_worker_threads_: Value<usize>,
    worker_released_condition_: Value<v8_base_ConditionVariable>,
    assigned_task_ids_: Value<std_atomic_unsigned_int_>,
}
impl v8_platform_DefaultJobState {
    pub fn v8_platform_DefaultJobState(
        platform: PtrDyn<dyn v8_Platform>,
        job_task: Option<Value<v8_JobTask>>,
        priority: v8_TaskPriority,
        num_worker_threads: usize,
    ) -> Self {
        let platform: Value<PtrDyn<dyn v8_Platform>> = Rc::new(RefCell::new(platform));
        let job_task: Value<Option<Value<v8_JobTask>>> = Rc::new(RefCell::new(job_task));
        let priority: Value<v8_TaskPriority> = Rc::new(RefCell::new(priority));
        let num_worker_threads: Value<usize> = Rc::new(RefCell::new(num_worker_threads));
        let __this: Value<v8_platform_DefaultJobState> = Rc::new(RefCell::new(Self {
            ...
            priority_: Rc::new(RefCell::new((*priority.borrow()))),
            active_workers_: Rc::new(RefCell::new(0_usize)),
            pending_tasks_: Rc::new(RefCell::new(0_usize)),
            is_canceled_: Rc::new(RefCell::new(std_atomic_bool_::std_atomic_bool_2({ false }))),
            num_worker_threads_: Rc::new(RefCell::new(
                ({
                    let __tmp_0: Value<u64> =
                        Rc::new(RefCell::new(((*num_worker_threads.borrow()) as u64)));
                    let __tmp_1: Value<u64> = Rc::new(RefCell::new((32 as u64)));
                    (if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                        __tmp_0.as_pointer()
                    } else {
                        __tmp_1.as_pointer()
            ...
            worker_released_condition_: Rc::new(RefCell::new(
                v8_base_ConditionVariable::v8_base_ConditionVariable(),
            )),
            assigned_task_ids_: Rc::new(RefCell::new(
                std_atomic_unsigned_int_::std_atomic_unsigned_int_3({ 0_u32 }),
            )),
        }));
        let this: Ptr<v8_platform_DefaultJobState> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl std_enable_shared_from_this_v8_platform_DefaultJobState_ for v8_platform_DefaultJobState {}
impl ByteRepr for v8_platform_DefaultJobState {
    fn byte_size() -> usize {
        104
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.platform_.borrow()).to_bytes(&mut buf[24..32]);
        (*self.job_task_.borrow()).to_bytes(&mut buf[32..40]);
        (*self.mutex_.borrow()).to_bytes(&mut buf[40..48]);
        (*self.priority_.borrow()).to_bytes(&mut buf[48..49]);
        (*self.active_workers_.borrow()).to_bytes(&mut buf[56..64]);
        (*self.pending_tasks_.borrow()).to_bytes(&mut buf[64..72]);
        (*self.is_canceled_.borrow()).to_bytes(&mut buf[72..73]);
        (*self.num_worker_threads_.borrow()).to_bytes(&mut buf[80..88]);
        (*self.worker_released_condition_.borrow()).to_bytes(&mut buf[88..96]);
        (*self.assigned_task_ids_.borrow()).to_bytes(&mut buf[96..100]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            platform_: Rc::new(RefCell::new(<PtrDyn<dyn v8_Platform>>::from_bytes(
                &buf[24..32],
            ))),
            job_task_: Rc::new(RefCell::new(<Option<Value<v8_JobTask>>>::from_bytes(
                &buf[32..40],
            ))),
            mutex_: Rc::new(RefCell::new(<v8_base_Mutex>::from_bytes(&buf[40..48]))),
            priority_: Rc::new(RefCell::new(<v8_TaskPriority>::from_bytes(&buf[48..49]))),
            active_workers_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[56..64]))),
            pending_tasks_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[64..72]))),
            is_canceled_: Rc::new(RefCell::new(<std_atomic_bool_>::from_bytes(&buf[72..73]))),
            num_worker_threads_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[80..88]))),
            worker_released_condition_: Rc::new(RefCell::new(
                <v8_base_ConditionVariable>::from_bytes(&buf[88..96]),
            )),
            assigned_task_ids_: Rc::new(RefCell::new(<std_atomic_unsigned_int_>::from_bytes(
                &buf[96..100],
            ))),
        }
    }
...
#[derive(Default)]
pub struct v8_platform_DefaultJobWorker {
    state_: Value<std_weak_ptr_v8_platform_DefaultJobState_>,
    job_task_: Value<PtrDyn<dyn v8_JobTask>>,
}
impl v8_platform_DefaultJobWorker {
    pub fn v8_platform_DefaultJobWorker(
        state: std_weak_ptr_v8_platform_DefaultJobState_,
        job_task: PtrDyn<dyn v8_JobTask>,
    ) -> Self {
        let state: Value<std_weak_ptr_v8_platform_DefaultJobState_> = Rc::new(RefCell::new(state));
        let job_task: Value<PtrDyn<dyn v8_JobTask>> = Rc::new(RefCell::new(job_task));
        let __this: Value<v8_platform_DefaultJobWorker> = Rc::new(RefCell::new(Self {
            state_: Rc::new(RefCell::new((*state.borrow_mut()).clone())),
            job_task_: Rc::new(RefCell::new((*job_task.borrow()).clone())),
        }));
        let this: Ptr<v8_platform_DefaultJobWorker> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_Task for v8_platform_DefaultJobWorker {
    fn Run(&self) {
        let shared_state: Value<std_shared_ptr_v8_platform_DefaultJobState_> =
            Rc::new(RefCell::new(({ (*self.state_.borrow()).lock() })));
        if !({ (*shared_state.borrow())() }) {
            return;
        }
        if !({ v8_platform_DefaultJobStateImpl::CanRunFirstTask(&shared_state.as_pointer()) }) {
            return;
        }
        let mut __do_while = true;
        'loop_: while __do_while
            || ({ v8_platform_DefaultJobStateImpl::DidRunTask(&shared_state.as_pointer()) })
        {
            __do_while = false;
            let delegate: Value<v8_platform_DefaultJobState_JobDelegate> = Rc::new(RefCell::new(
                v8_platform_DefaultJobState_JobDelegate::v8_platform_DefaultJobState_JobDelegate(
                    { ({ (*shared_state.borrow()).get() }) },
                    None,
                ),
            ));
            let _dtor_delegate = ScopedDestructor::new(&delegate, |__p| __p.destructor());
            ({
                (*(*self.job_task_.borrow()).upgrade().deref()).Run(
                    ((delegate.as_pointer()).to_strong() as Value<dyn v8_JobDelegate>)
                        .as_pointer_dyn(),
                )
            });
        }
...
impl ByteRepr for v8_platform_DefaultJobWorker {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.state_.borrow()).to_bytes(&mut buf[8..24]);
        (*self.job_task_.borrow()).to_bytes(&mut buf[24..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            state_: Rc::new(RefCell::new(
                <std_weak_ptr_v8_platform_DefaultJobState_>::from_bytes(&buf[8..24]),
            )),
            job_task_: Rc::new(RefCell::new(<PtrDyn<dyn v8_JobTask>>::from_bytes(
                &buf[24..32],
            ))),
        }
    }
}
pub fn CountLeadingZeros_236(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        if (32_u32 == 64_u32) {
            (({ __builtin_clzll_237(((*value.borrow()) as u64)) }) as u32)
        } else {
...
pub fn CountLeadingZeros_238(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
...
pub fn CountLeadingZeros32_239(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_236((*value.borrow())) });
}
pub fn CountLeadingZeros64_240(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_238((*value.borrow())) });
}
pub fn CountTrailingZeros_241(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        (if (32_u32 == 64_u32) {
            ({ __builtin_ctzll_242(((*value.borrow()) as u64)) })
        } else {
            ((*value.borrow()) as u32).trailing_zeros() as i32
        } as u32)
    };
}
pub fn CountTrailingZeros_243(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u64) {
        64_u32
    } else {
...
pub fn CountTrailingZeros32_244(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_241((*value.borrow())) });
}
pub fn CountTrailingZeros64_245(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_243((*value.borrow())) });
}
pub fn RoundUpToPowerOfTwo32_246(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u32 << ((32_u32).wrapping_sub(({ CountLeadingZeros_236((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo64_247(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u64 << ((64_u32).wrapping_sub(({ CountLeadingZeros_238((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo_248(value: usize) -> usize {
    let value: Value<usize> = Rc::new(RefCell::new(value));
    if (::std::mem::size_of::<usize>() == ::std::mem::size_of::<u64>()) {
        return (({ RoundUpToPowerOfTwo64_247(((*value.borrow()) as u64)) }) as usize);
    } else {
        return (({ RoundUpToPowerOfTwo32_246(((*value.borrow()) as u32)) }) as usize);
    }
    panic!("ub: non-void function does not return a value")
}
pub fn RoundDownToPowerOfTwo32_249(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    if ((*value.borrow()) > 2147483648_u32) {
        return 2147483648_u32;
    }
    let result: Value<u32> = Rc::new(RefCell::new(
        ({ RoundUpToPowerOfTwo32_246((*value.borrow())) }),
    ));
...
pub fn RotateRight32_250(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
...
pub fn RotateLeft32_251(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    let shift: Value<u32> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((32_u32).wrapping_sub((*shift.borrow()))) & 31_u32)));
}
pub fn RotateRight64_252(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) >> (*shift.borrow()))
        | ((*value.borrow()) << (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn RotateLeft64_253(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn ClearLsb_254(value: i32) -> i32 {
    let value: Value<i32> = Rc::new(RefCell::new(value));
    return ((*value.borrow()) & ((*value.borrow()) - 1));
}
pub fn SignedAddOverflow32_255(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    ...
    return ({
        ...
        __builtin_sadd_overflow_256(_arg0, _arg1, _arg2)
    });
}
pub fn SignedSubOverflow32_257(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_ssub_overflow_258(_arg0, _arg1, _arg2)
    });
}
pub fn SignedMulOverflow32_259(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_smul_overflow_260(_arg0, _arg1, _arg2)
    });
}
pub fn SignedAddOverflow64_261(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
...
pub fn SignedSubOverflow64_263(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return ({
        __builtin_sub_overflow_264(&[
            (*lhs.borrow()).into(),
            (*rhs.borrow()).into(),
            ((*val.borrow()).clone()).into(),
        ])
...
pub fn SignedMulOverflow64_265(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return {
...
pub fn UnsignedAddOverflow32_266(lhs: u32, rhs: u32, val: Ptr<u32>) -> bool {
    ...
    return ({
        ...
        __builtin_uadd_overflow_267(_arg0, _arg1, _arg2)
    });
}
pub fn UnsignedDiv32_268(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
...
pub fn UnsignedDiv64_269(lhs: u64, rhs: u64) -> u64 {
...
pub fn UnsignedMod32_270(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
...
pub fn UnsignedMod64_271(lhs: u64, rhs: u64) -> u64 {
    let lhs: Value<u64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u64> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
        (*lhs.borrow()).wrapping_rem((*rhs.borrow()))
...
pub fn WraparoundAdd32_272(lhs: i32, rhs: i32) -> i32 {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    return ((((*lhs.borrow()) as u32).wrapping_add(((*rhs.borrow()) as u32))) as i32);
}
pub fn WraparoundNeg32_273(x: i32) -> i32 {
    let x: Value<i32> = Rc::new(RefCell::new(x));
    return (-((*x.borrow()) as u32) as i32);
}
pub fn ByteReverse16_274(value: u16) -> u16 {
    let value: Value<u16> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse32_275(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse64_276(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
thread_local!(
    pub static kMaxWorkersPerJob_277: Value<usize> = Rc::new(RefCell::new(32));
);
...
pub trait v8_platform_DefaultJobStateImpl {
    fn NotifyConcurrencyIncrease(&self);
    fn AcquireTaskId(&self) -> u8;
    fn ReleaseTaskId(&self, task_id: u8);
    fn Join(&self);
    fn CancelAndWait(&self);
    fn CancelAndDetach(&self);
    fn IsActive(&self) -> bool;
    fn CanRunFirstTask(&self) -> bool;
    fn DidRunTask(&self) -> bool;
    fn UpdatePriority(&self, priority: v8_TaskPriority);
    fn CappedMaxConcurrency(&self, worker_count: usize) -> usize;
    fn CallOnWorkerThread(&self, priority: v8_TaskPriority, task: Option<Value<v8_Task>>);
}
impl v8_platform_DefaultJobStateImpl for Ptr<v8_platform_DefaultJobState> {
    fn NotifyConcurrencyIncrease(&self) {
        if ({ (*(*(*self).upgrade().deref()).is_canceled_.borrow()).load_const(Some(0)) }) {
            return;
        }
        let num_tasks_to_post: Value<usize> = Rc::new(RefCell::new(0_usize));
        let priority: Value<v8_TaskPriority> = <Value<v8_TaskPriority>>::default();
        {
            ...
            let max_concurrency: Value<usize> = Rc::new(RefCell::new(
                ({
                    let _worker_count: usize =
                        (*(*(*self).upgrade().deref()).active_workers_.borrow());
                    v8_platform_DefaultJobStateImpl::CappedMaxConcurrency(self, _worker_count)
                }),
            ));
            if ((*max_concurrency.borrow())
                > (*(*(*self).upgrade().deref()).active_workers_.borrow())
                    .wrapping_add((*(*(*self).upgrade().deref()).pending_tasks_.borrow())))
            {
                (*num_tasks_to_post.borrow_mut()) = ((*max_concurrency.borrow())
                    .wrapping_sub((*(*(*self).upgrade().deref()).active_workers_.borrow())))
                .wrapping_sub((*(*(*self).upgrade().deref()).pending_tasks_.borrow()));
                {
                    let rhs_0 = (*(*(*self).upgrade().deref()).pending_tasks_.borrow())
                        .wrapping_add((*num_tasks_to_post.borrow()));
                    (*(*(*self).upgrade().deref()).pending_tasks_.borrow_mut()) = rhs_0
                };
            }
            (*priority.borrow_mut()) = (*(*(*self).upgrade().deref()).priority_.borrow());
        }
        let i: Value<usize> = Rc::new(RefCell::new(0_usize));
        'loop_: while ((*i.borrow()) < (*num_tasks_to_post.borrow())) {
            ({
                let _task: Option<Value<v8_Task>> = ({
                    let ___args: Value<std_shared_ptr_v8_platform_DefaultJobState_> = Rc::new(
                        RefCell::new(({ (*(*self).upgrade().deref()).shared_from_this() })),
                    );
                    let ___args: Value<PtrDyn<dyn v8_JobTask>> = Rc::new(RefCell::new(
                        (*(*(*self).upgrade().deref()).job_task_.borrow()).as_pointer(),
                    ));
                    make_unique_278(___args.as_pointer(), ___args.as_pointer())
                });
                v8_platform_DefaultJobStateImpl::CallOnWorkerThread(
                    self,
                    (*priority.borrow()),
                    _task,
                )
    ...
    fn AcquireTaskId(&self) -> u8 {
        let assigned_task_ids: Value<u32> = Rc::new(RefCell::new(
            ({ (*(*(*self).upgrade().deref()).assigned_task_ids_.borrow()).load_const(Some(0)) }),
        ));
        (&(0));
        let new_assigned_task_ids: Value<u32> = Rc::new(RefCell::new(0_u32));
        let task_id: Value<u8> = Rc::new(RefCell::new(0_u8));
        let mut __do_while = true;
        'loop_: while __do_while
            || (!({
                (*(*(*self).upgrade().deref()).assigned_task_ids_.borrow())
                    .compare_exchange_weak_pmutu32_u32(
                        assigned_task_ids.as_pointer(),
                        (*new_assigned_task_ids.borrow()),
                        2,
                        0,
                    )
            }))
        {
            __do_while = false;
            (*task_id.borrow_mut()) =
                (({ CountTrailingZeros32_244(!(*assigned_task_ids.borrow())) }) as u8);
            (*new_assigned_task_ids.borrow_mut()) =
                ((*assigned_task_ids.borrow()) | (1_u32 << ((*task_id.borrow()) as i32)));
        }
        return (*task_id.borrow());
    }
    fn ReleaseTaskId(&self, task_id: u8) {
        let task_id: Value<u8> = Rc::new(RefCell::new(task_id));
        let previous_task_ids: Value<u32> = Rc::new(RefCell::new(
            ({
                (*(*(*self).upgrade().deref()).assigned_task_ids_.borrow())
                    .fetch_and_u32(!(1_u32 << ((*task_id.borrow()) as i32)), Some(3))
            }),
        ));
        (&(0));
        let mut __do_while = true;
        'loop_: while __do_while || (false) {
            ...
            let unused_tmp_array_for_use_macro: Value<Box<[v8_base_Use]>> =
                Rc::new(RefCell::new(Box::new([v8_base_Use::v8_base_Use2({
                    previous_task_ids.as_pointer()
                })])));
            &(*unused_tmp_array_for_use_macro.borrow_mut());
        }
    }
    fn Join(&self) {
        let WaitForParticipationOpportunity: Value<_> = Rc::new(RefCell::new(
            (|| {
                let max_concurrency: Value<usize> = Rc::new(RefCell::new(
                    ({
                        let _worker_count: usize =
                            (*self.active_workers_.borrow()).wrapping_sub(1_usize);
                        v8_platform_DefaultJobStateImpl::CappedMaxConcurrency(
                            &(*self),
                            _worker_count,
                        )
                    }),
                ));
                'loop_: while ((*self.active_workers_.borrow()) > (*max_concurrency.borrow()))
                    && ((*self.active_workers_.borrow()) > 1_usize)
                {
                    ({
                        let _mutex: Ptr<v8_base_Mutex> = (self.mutex_.as_pointer());
                        v8_base_ConditionVariableImpl::Wait(
                            &self.worker_released_condition_.as_pointer(),
                            _mutex,
                        )
                    });
                    (*max_concurrency.borrow_mut()) = ({
                        let _worker_count: usize =
                            (*self.active_workers_.borrow()).wrapping_sub(1_usize);
                        v8_platform_DefaultJobStateImpl::CappedMaxConcurrency(
                            &(*self),
                ...
                (&(0));
                if ((*max_concurrency.borrow()) != 0_usize) {
                    return (*max_concurrency.borrow());
                }
                (&(0));
                (*self.active_workers_.borrow_mut()) = 0_usize;
                ({ (*self.is_canceled_.borrow()).store_bool(true, Some(0)) });
                return 0_usize;
            }),
        ));
        let num_tasks_to_post: Value<usize> = Rc::new(RefCell::new(0_usize));
        {
            ...
            let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
            (*(*(*self).upgrade().deref()).priority_.borrow_mut()) = v8_TaskPriority_kUserBlocking;
            (*(*(*self).upgrade().deref())
                .num_worker_threads_
                .borrow_mut())
            .prefix_inc();
            (*(*(*self).upgrade().deref()).active_workers_.borrow_mut()).prefix_inc();
            let max_concurrency: Value<usize> = Rc::new(RefCell::new(
                ({ (*WaitForParticipationOpportunity.borrow_mut())() }).clone(),
            ));
            if ((*max_concurrency.borrow()) == 0_usize) {
                return;
            }
        ...
        'loop_: while true {
            ({
                (*(*(*(*self).upgrade().deref()).job_task_.borrow())
                    .as_ref()
                    .unwrap()
                    .borrow())
                .Run(
            ...
            let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
            if (({ (*WaitForParticipationOpportunity.borrow_mut())() }) == 0_usize) {
                return;
            }
        }
    }
    fn CancelAndWait(&self) {
        {
            ...
            let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
            ({ (*(*(*self).upgrade().deref()).is_canceled_.borrow()).store_bool(true, Some(0)) });
            'loop_: while ((*(*(*self).upgrade().deref()).active_workers_.borrow()) > 0_usize) {
                ({
                    let _mutex: Ptr<v8_base_Mutex> =
                        ((*(*self).upgrade().deref()).mutex_.as_pointer());
                    v8_base_ConditionVariableImpl::Wait(
                        &(*(*self).upgrade().deref())
    ...
    fn IsActive(&self) -> bool {
        ...
        let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
        return (({
            let _worker_count: usize = (*(*(*self).upgrade().deref()).active_workers_.borrow());
            (*(*(*(*(*self).upgrade().deref()).job_task_.borrow())
                .as_ref()
                .unwrap()
                .borrow())
            .upgrade()
            .deref())
            .GetMaxConcurrency(_worker_count)
        }) != 0_usize)
            || ((*(*(*self).upgrade().deref()).active_workers_.borrow()) != 0_usize);
    }
    fn CanRunFirstTask(&self) -> bool {
        let guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
        ...
        let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
        (*(*(*self).upgrade().deref()).pending_tasks_.borrow_mut()).prefix_dec();
        if ({ (*(*(*self).upgrade().deref()).is_canceled_.borrow()).load_const(Some(0)) }) {
            return false;
        }
        if ((*(*(*self).upgrade().deref()).active_workers_.borrow())
            >= ({
                let _worker_count: usize = (*(*(*self).upgrade().deref()).active_workers_.borrow());
                v8_platform_DefaultJobStateImpl::CappedMaxConcurrency(self, _worker_count)
            }))
    ...
    fn DidRunTask(&self) -> bool {
        ...
        let priority: Value<v8_TaskPriority> = <Value<v8_TaskPriority>>::default();
        {
            ...
            if ({ (*(*(*self).upgrade().deref()).is_canceled_.borrow()).load_const(Some(0)) })
                || ((*(*(*self).upgrade().deref()).active_workers_.borrow())
                    > (*max_concurrency.borrow()))
            {
                (*(*(*self).upgrade().deref()).active_workers_.borrow_mut()).prefix_dec();
                ({
                    v8_base_ConditionVariableImpl::NotifyOne(
                        &(*(*self).upgrade().deref())
                            .worker_released_condition_
                            .as_pointer(),
                    )
    ...
    fn CappedMaxConcurrency(&self, worker_count: usize) -> usize {
        ...
        return ({
            ...
            let __tmp_1: Value<u64> = Rc::new(RefCell::new(
                ((*(*(*self).upgrade().deref()).num_worker_threads_.borrow()) as u64),
            ));
            (if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                __tmp_0.as_pointer()
            } else {
    ...
    fn UpdatePriority(&self, priority: v8_TaskPriority) {
        ...
        let _dtor_guard = ScopedDestructor::new(&guard, |__p| __p.destructor());
        (*(*(*self).upgrade().deref()).priority_.borrow_mut()) = (*priority.borrow());
    }
}
pub trait v8_platform_DefaultJobState_JobDelegateImpl {
    fn destructor(&self);
}
impl v8_platform_DefaultJobState_JobDelegateImpl for Ptr<v8_platform_DefaultJobState_JobDelegate> {
    fn destructor(&self) {
        if (((*(*(*self).upgrade().deref()).task_id_.borrow()) as i32) != (255 as i32)) {
            ({
                let _task_id: u8 = (*(*(*self).upgrade().deref()).task_id_.borrow());
                v8_platform_DefaultJobStateImpl::ReleaseTaskId(
                    &(*(*(*self).upgrade().deref()).outer_.borrow()),
                    _task_id,
                )
            });
        }
