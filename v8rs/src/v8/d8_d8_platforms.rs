...
use std::rc::{Rc, Weak};
thread_local!(
    pub static kProcessGlobalPredictablePlatformWorkerTaskQueue_0: Value<Ptr<v8_Isolate>> =
        Rc::new(RefCell::new(Ptr::<v8_Isolate>::null()));
);
#[derive(Default)]
...
thread_local!(
    pub static kTraceMaxNumArgs_11: Value<i32> = Rc::new(RefCell::new(2));
);
...
thread_local!(
    pub static kChunkSize_12: Value<usize> = Rc::new(RefCell::new(64_usize));
);
#[derive()]
...
pub type v8_platform_IdleTaskSupport = i32;
pub const v8_platform_IdleTaskSupport_kDisabled: v8_platform_IdleTaskSupport = 0;
pub const v8_platform_IdleTaskSupport_kEnabled: v8_platform_IdleTaskSupport = 1;
pub type v8_platform_InProcessStackDumping = i32;
pub const v8_platform_InProcessStackDumping_kDisabled: v8_platform_InProcessStackDumping = 0;
pub const v8_platform_InProcessStackDumping_kEnabled: v8_platform_InProcessStackDumping = 1;
pub type v8_platform_MessageLoopBehavior = bool;
pub const v8_platform_MessageLoopBehavior_kDoNotWait: v8_platform_MessageLoopBehavior = 0;
pub const v8_platform_MessageLoopBehavior_kWaitForWork: v8_platform_MessageLoopBehavior = 1;
pub type v8_platform_PriorityMode = bool;
pub const v8_platform_PriorityMode_kDontApply: v8_platform_PriorityMode = 0;
pub const v8_platform_PriorityMode_kApply: v8_platform_PriorityMode = 1;
...
thread_local!();
pub fn ControlledCrashesAreHarmless_14() -> bool {
    return ((*g_abort_mode_13.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_13.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn DcheckFailuresAreIgnored_15() -> bool {
    return ((*g_abort_mode_13.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_13.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn FatalErrorsWithNoSecurityImpactShouldExit_16() -> bool {
    return ((*g_abort_mode_13.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitIfNoSecurityImpact);
}
thread_local!(
    pub static kReturnAddressStackSlotCount_17: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPageSizeBits_18: Value<i32> = Rc::new(RefCell::new(18));
);
thread_local!(
    pub static kRegularPageSize_19: Value<i32> = Rc::new(RefCell::new(262144));
);
thread_local!(
    pub static kMinimumOSPageSize_20: Value<i32> = Rc::new(RefCell::new(16384));
);
thread_local!(
    pub static kUnimplementedCodeMessage_21: Value<Ptr<u8>> = Rc::new(RefCell::new(
        Ptr::from_string_literal(b"unimplemented code"),
    ));
);
thread_local!(
    pub static kUnreachableCodeMessage_22: Value<Ptr<u8>> =
...
thread_local!(
    pub static is_enum_24: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_26: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static value_28: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
pub fn make_uint64_29(high: u32, low: u32) -> u64 {
...
pub fn IsAligned_32(value: u64, alignment: u64) -> bool {
...
thread_local!(
    pub static kLowZeroBits_34: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kAlignment_35: Value<i32> = Rc::new(RefCell::new(256));
);
...
thread_local!(
    pub static kToBePaddedSize_36: Value<usize> = Rc::new(RefCell::new(33));
);
#[derive(Default)]
...
pub fn is_constant_evaluated_39() -> bool {
    return ({ is_constant_evaluated_40() });
}
...
pub fn LogSeverities_41() -> Vec<absl_LogSeverity> {
    return vec![
...
thread_local!(
    pub static kLogDebugFatal_42: Value<absl_LogSeverity> = Rc::new(RefCell::new(2));
);
pub fn LogSeverityName_43(s: absl_LogSeverity) -> Ptr<u8> {
...
pub fn NormalizeLogSeverity_44(s: absl_LogSeverity) -> absl_LogSeverity {
    let s: Value<absl_LogSeverity> = Rc::new(RefCell::new(s));
...
pub fn NormalizeLogSeverity_45(s: i32) -> absl_LogSeverity {
    let s: Value<i32> = Rc::new(RefCell::new(s));
    return ({ NormalizeLogSeverity_44(((*s.borrow()) as absl_LogSeverity)) });
}
...
pub fn operator_gt_46(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
...
pub fn operator_lt_47(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
...
pub fn operator_le_48(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) <= (*rhs.borrow()));
}
pub fn operator_ge_49(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) >= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_lt_50(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) < (*rhs.borrow()));
}
pub fn operator_gt_51(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) > ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_ge_52(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) >= (*rhs.borrow()));
}
pub fn operator_le_53(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) <= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn Basename_54(fname: Ptr<u8>, offset: i32) -> Ptr<u8> {
            ...
            == (('\\' as u8) as i32))
    {
        ...
        ({ Basename_54((*fname.borrow()).clone(), ((*offset.borrow()) - 1)) })
    };
}
thread_local!();
pub fn ClippedSubstr_56(s: Vec<u8>, pos: usize, n: Option<usize>) -> Vec<u8> {
...
pub fn NullSafeStringView_57(p: Ptr<u8>) -> Vec<u8> {
...
pub fn days_per_century_60(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (36524 + ((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300)) as i32));
}
pub fn days_per_4years_61(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (1460
        + (((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300))
            || ((((*yi.borrow()) - 1) % 100) < 96)) as i32));
}
pub fn days_per_year_62(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    return if ({ is_leap_year_58(((*y.borrow()) + ((((*m.borrow()) as i32) > 2) as i64))) }) {
        366
    } else {
        365
    };
}
pub fn days_per_month_63(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    ...
    return ((*k_days_per_month.borrow())[(*m.borrow()) as usize]
        + (((((*m.borrow()) as i32) == 2) && ({ is_leap_year_58((*y.borrow())) })) as i32));
}
pub fn n_day_64(
    y: i64,
    m: i8,
    ...
    if ((*d.borrow()) > 0_i64) {
        ...
        if ((*d.borrow()) > (-365_i32 as i64)) {
            (*ey.borrow_mut()) -= 1_i64;
            (*d.borrow_mut()) += (({ days_per_year_62((*ey.borrow()), (*m.borrow())) }) as i64);
        } else {
            (*ey.borrow_mut()) -= 400_i64;
            (*d.borrow_mut()) += 146097_i64;
        }
    ...
    if ((*d.borrow()) > 365_i64) {
        let yi: Value<i32> = Rc::new(RefCell::new(
            ({ year_index_59((*ey.borrow()), (*m.borrow())) }),
        ));
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_century_60((*yi.borrow())) })));
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_4years_61((*yi.borrow())) })));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
            (*d.borrow_mut()) -= ((*n.borrow()) as i64);
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_year_62((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
    ...
    if ((*d.borrow()) > 28_i64) {
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_month_63((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
...
pub fn step_70(
    ...
    return ({
        ...
        n_min_67(_y, _m, _d, _hh, 0_i64, _mm, _ss)
    });
}
pub fn step_71(
    ...
    return ({
        ...
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_hour_66(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_72(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_day_64(_y, _m, _d, (*n.borrow()), _hh, _mm, _ss)
    });
}
pub fn step_73(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_mon_65(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_74(
...
pub fn scale_add_75(v: i64, f: i64, a: i64) -> i64 {
...
pub fn ymd_ord_76(y: i64, m: i8, d: i8) -> i64 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
...
pub fn day_difference_77(y1: i64, m1: i8, d1: i8, y2: i64, m2: i8, d2: i8) -> i64 {
    ...
    let delta: Value<i64> = Rc::new(RefCell::new(
        (({ ymd_ord_76((*a_c4_off.borrow()), (*m1.borrow()), (*d1.borrow())) })
            - ({ ymd_ord_76((*b_c4_off.borrow()), (*m2.borrow()), (*d2.borrow())) })),
    ));
...
pub fn difference_79(
    ...
    return ({
        ...
        scale_add_75(_v, 12_i64, _a)
    });
}
pub fn difference_80(
    _a0: absl_time_internal_cctz_detail_day_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        day_difference_77(_y1, _m1, _d1, _y2, _m2, _d2)
    });
}
pub fn difference_81(
    _a0: absl_time_internal_cctz_detail_hour_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        scale_add_75(_v, 24_i64, _a)
    });
}
pub fn difference_82(
    _a0: absl_time_internal_cctz_detail_minute_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
    ...
    return ({
        ...
        scale_add_75(_v, 60_i64, _a)
    });
}
pub fn difference_83(
    _a0: absl_time_internal_cctz_detail_second_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
...
pub fn operator_add_90(
    ...
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_72 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , (*n.borrow())  , ) } )    } , )   ;
}
pub fn operator_sub_91(
    a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_,
    n: i64,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ {
    let a: Value<
    ...
    return if ((*n.borrow()) != <i64>::MIN) {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_72 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - (*n.borrow())  , ) } )    } , )
    } else {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_72 ( absl_time_internal_cctz_detail_day_tag { }  , (  { step_72 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - ( ( (*n.borrow()) + 1_i64 ) )  , ) } )   , 1_i64  , ) } )    } , )
    };
}
#[derive()]
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_10(
        ...
        > = Rc::new(RefCell::new(Self {
            f_: Rc::new(RefCell::new(
                ({ align_85(absl_time_internal_minute_tag {}, (*f.borrow()).clone()) }),
            )),
        }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_13(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_86(absl_time_internal_hour_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_17(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_87(absl_time_internal_day_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_20(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_88(absl_time_internal_month_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_23(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_89(absl_time_internal_year_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            __this.as_pointer();
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_forw.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        ...
                        operator_add_90(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
        ...
        if ((*base.borrow()) == (*k_weekdays_back.borrow())[(*i.borrow()) as usize]) {
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_back.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        let _a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_   = ((*cd.borrow()) ).clone()  ;
                        operator_sub_91(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
                (*j.borrow_mut()).prefix_inc();
            }
...
pub fn PrevWeekday_98(
    ...
    let cd: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
        Rc::new(RefCell::new(cd));
    let wd: Value<absl_time_internal_cctz_detail_weekday> = Rc::new(RefCell::new(wd));
    return absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_15 ( { let __tmp_1 : Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ > = Rc::new(RefCell::new((  { prev_weekday_94 ( absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_1 ( {  cd .as_pointer()   } , None , )  , (*wd.borrow())  , ) } )  )); __tmp_1.as_pointer()  } , None , )   ;
}
pub fn GetYearDay_99(
    cs: absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_,
) -> i32 {
    let cs: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_> =
        Rc::new(RefCell::new(cs));
    return ({
        let _cs : Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ > = Rc::new(RefCell::new(absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_5 ( {  cs .as_pointer()   } , None , ) ));
        get_yearday_95(_cs.as_pointer())
    });
}
pub fn operator_eq_100(
...
}pub  fn split_seconds_103 ( tp : Ptr< std_chrono_time_point_std_chrono_system_clock__std_chrono_duration_long_long__std_ratio________  > , ) -> (Value<std_chrono_time_point_std_chrono_steady_clock__std_chrono_duration_long_long__std_ratio________>, Value<std_chrono_duration_long_long__std_ratio_______>){
    return (
        Rc::new(RefCell::new(
            (*tp.upgrade().deref())
                .clone()
...
thread_local!(
    pub static kTicksPerNanosecond_105: Value<i64> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kTicksPerSecond_106: Value<i64> = Rc::new(RefCell::new(4000000000));
);
pub fn FromInt64_107(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    ...
    return ({
        ...
        let _ticks: i64 = (((((((*v.borrow()) % 1000000000_i64) * 4) * 1000_i64) * 1000_i64)
            * 1000_i64)
            / 1000000000_i64);
        MakeNormalizedDuration_108(_sec, _ticks)
    });
}
pub fn FromInt64_109(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn FromInt64_110(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn FromInt64_111(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn operator_gt_114(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    ...
    return ({
        ...
        operator_lt_115(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_116(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_lt_115(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_117(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*rhs.borrow()).clone();
...
pub fn operator_ne_118(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_eq_113(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_add_119(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_sub_120(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_div_121(lhs: absl_Duration, rhs: absl_Duration) -> i64 {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return ({
        let _num: absl_Duration = (*lhs.borrow()).clone();
        let _rem: Ptr<absl_Duration> = (lhs.as_pointer());
        IDivDuration_122(_num, (*rhs.borrow()).clone(), _rem)
    });
}
pub fn operator_rem_123(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn ZeroDuration_124() -> absl_Duration {
    return absl_Duration::absl_Duration1();
}
pub fn AbsDuration_125(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if ({
        let _lhs: absl_Duration = (*d.borrow()).clone();
        operator_lt_115(_lhs, ({ ZeroDuration_124() }))
    }) {
        ({
...
pub fn Nanoseconds_127(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_107(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Nanoseconds_128(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_107((*n.borrow()), std_ratio______ {}) });
}
pub fn Microseconds_129(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_109(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Microseconds_130(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_109((*n.borrow()), std_ratio______ {}) });
}
pub fn Milliseconds_131(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_110(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Milliseconds_132(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_110((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_133(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_111((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_134(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_111((*n.borrow()), std_ratio______ {}) });
}
pub fn Minutes_135(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_136(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Hours_137(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_138(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn operator_shl_139(os: Ptr<std::fs::File>, d: absl_Duration) -> Ptr<std::fs::File> {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return os.write_all(
        &([(&({ FormatDuration_140((*d.borrow()).clone()) })
            .iter()
            .take(({ FormatDuration_140((*d.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
...
pub fn operator_cmp_141(lhs: absl_Time, rhs: absl_Time) -> std::cmp::Ordering {
    ...
    return ({
        ...
        operator_cmp_112(_lhs, _rhs)
    });
}
pub fn operator_lt_143(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_lt_115(_lhs, _rhs)
    });
}
pub fn operator_gt_144(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
        operator_lt_143(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_145(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_lt_143(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_146(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
...
pub fn operator_eq_142(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_eq_113(_lhs, _rhs)
    });
}
pub fn operator_ne_147(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_eq_142(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_add_148(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_add_149(lhs: absl_Duration, rhs: absl_Time) -> absl_Time {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_150(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_151(lhs: absl_Time, rhs: absl_Time) -> absl_Duration {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_sub_120(_lhs, _rhs)
    });
}
pub fn UnixEpoch_152() -> absl_Time {
    return <absl_Time>::default();
}
pub fn UniversalEpoch_153() -> absl_Time {
    return absl_Time::absl_Time1({
        ({ MakeDuration_154((((-24_i32 * 719162) as i64) * 3600_i64), 0_u32) })
    });
}
pub fn InfiniteFuture_155() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_154(<i64>::MAX, !0_u32) }) });
}
pub fn InfinitePast_156() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_154(<i64>::MIN, !0_u32) }) });
}
pub fn operator_eq_157(a: absl_TimeZone, b: absl_TimeZone) -> bool {
...
pub fn operator_ne_158(a: absl_TimeZone, b: absl_TimeZone) -> bool {
    let a: Value<absl_TimeZone> = Rc::new(RefCell::new(a));
    let b: Value<absl_TimeZone> = Rc::new(RefCell::new(b));
    return ({
        let _lhs: absl_time_internal_cctz_time_zone = (*(*a.borrow()).cz_.borrow()).clone();
        let _rhs: absl_time_internal_cctz_time_zone = (*(*b.borrow()).cz_.borrow()).clone();
        operator_ne_101(_lhs, _rhs)
    });
}
pub fn operator_shl_159(os: Ptr<std::fs::File>, tz: absl_TimeZone) -> Ptr<std::fs::File> {
...
pub fn LoadTimeZone_160(name: Vec<u8>, tz: Ptr<absl_TimeZone>) -> bool {
    ...
    if (*name.borrow()).clone()
        == Ptr::from_string_literal(b"localtime")
            ...
            .collect::<Vec<u8>>()
    {
        let __rhs = absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_161() }) });
    ...
    let b: Value<bool> = Rc::new(RefCell::new(
        ({
            ...
            load_time_zone_162(_name.as_pointer(), (cz.as_pointer()))
        }),
    ));
...
pub fn FixedTimeZone_163(seconds: i32) -> absl_TimeZone {
    ...
    return absl_TimeZone::absl_TimeZone1({
        ({
            ...
            fixed_time_zone_164(_offset.as_pointer())
        })
    });
}
pub fn UTCTimeZone_165() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ utc_time_zone_166() }) });
}
pub fn LocalTimeZone_167() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_161() }) });
}
pub fn ToCivilSecond_168(
    t: absl_Time,
    tz: absl_TimeZone,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_ {
...
thread_local!();
thread_local!();
pub fn operator_shl_181(os: Ptr<std::fs::File>, t: absl_Time) -> Ptr<std::fs::File> {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return os.write_all(
        &([(&({ FormatTime_182((*t.borrow()).clone()) })
            .iter()
            .take(({ FormatTime_182((*t.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
            .collect::<Vec<u8>>()[..] as &[u8])]
        .concat()),
    );
}
pub fn MakeDuration_154(hi: i64, lo: Option<u32>) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<u32> = Rc::new(RefCell::new(lo.unwrap_or(0_u32)));
    return absl_Duration::absl_Duration2({ (*hi.borrow()) }, { (*lo.borrow()) });
}
pub fn MakeDuration_183(hi: i64, lo: i64) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<i64> = Rc::new(RefCell::new(lo));
    return ({ MakeDuration_154((*hi.borrow()), Some(((*lo.borrow()) as u32))) });
}
pub fn MakePosDoubleDuration_184(n: f64) -> absl_Duration {
    ...
    return if (((*ticks.borrow()) as i64) < 4000000000) {
        ({ MakeDuration_154((*int_secs.borrow()), Some((*ticks.borrow()))) })
    } else {
        ({
            MakeDuration_183(
...
pub fn MakeNormalizedDuration_108(sec: i64, ticks: i64) -> absl_Duration {
    let sec: Value<i64> = Rc::new(RefCell::new(sec));
    let ticks: Value<i64> = Rc::new(RefCell::new(ticks));
    return if ((*ticks.borrow()) < 0_i64) {
        ({ MakeDuration_183(((*sec.borrow()) - 1_i64), ((*ticks.borrow()) + 4000000000)) })
    } else {
        ({ MakeDuration_183((*sec.borrow()), (*ticks.borrow())) })
    };
}
pub fn GetRepHi_185(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return ({ absl_Duration_HiRepImpl::Get(&(*d.borrow()).rep_hi_.as_pointer()) });
}
pub fn GetRepLo_186(d: absl_Duration) -> u32 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (*(*d.borrow()).rep_lo_.borrow());
}
pub fn IsInfiniteDuration_187(d: absl_Duration) -> bool {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (({ GetRepLo_186((*d.borrow()).clone()) }) == !0_u32);
}
pub fn OppositeInfinity_188(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepHi_185((*d.borrow()).clone()) }) < 0_i64) {
        ({ MakeDuration_154(<i64>::MAX, Some(!0_u32)) })
    } else {
        ({ MakeDuration_154(<i64>::MIN, Some(!0_u32)) })
    };
}
pub fn NegateAndSubtractOne_189(n: i64) -> i64 {
    let n: Value<i64> = Rc::new(RefCell::new(n));
...
pub fn FromUnixDuration_190(d: absl_Duration) -> absl_Time {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return absl_Time::absl_Time1({ (*d.borrow()).clone() });
}
pub fn ToUnixDuration_191(t: absl_Time) -> absl_Duration {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return (*(*t.borrow()).rep_.borrow()).clone();
}
pub fn FromInt64_136(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return if (((*v.borrow()) <= (<i64>::MAX / 60_i64)) && ((*v.borrow()) >= (<i64>::MIN / 60_i64)))
    {
        ({ MakeDuration_154(((*v.borrow()) * 60_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_192() })
        } else {
            ({
                let _d: absl_Duration = ({ InfiniteDuration_192() });
                operator_neg_126(_d)
            })
        }
    };
}
pub fn FromInt64_138(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return if (((*v.borrow()) <= (<i64>::MAX / 3600_i64))
        && ((*v.borrow()) >= (<i64>::MIN / 3600_i64)))
    {
        ({ MakeDuration_154(((*v.borrow()) * 3600_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_192() })
        } else {
...
pub fn IsValidRep64_193(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
pub fn IsValidRep64_194(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
pub fn FromChrono_195(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_107(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_196(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_109(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_197(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_110(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_198(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_111(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_199(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_136(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_200(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_138(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn ToInt64_201(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Nanoseconds_202((*d.borrow()).clone()) });
}
pub fn ToInt64_203(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Microseconds_204((*d.borrow()).clone()) });
}
pub fn ToInt64_205(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Milliseconds_206((*d.borrow()).clone()) });
}
pub fn ToInt64_207(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Seconds_208((*d.borrow()).clone()) });
}
pub fn ToInt64_209(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Minutes_210((*d.borrow()).clone()) });
}
pub fn ToInt64_211(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Hours_212((*d.borrow()).clone()) });
}
pub fn operator_lt_115(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return if (({ GetRepHi_185((*lhs.borrow()).clone()) })
        != ({ GetRepHi_185((*rhs.borrow()).clone()) }))
    {
        (({ GetRepHi_185((*lhs.borrow()).clone()) }) < ({ GetRepHi_185((*rhs.borrow()).clone()) }))
    } else {
        if (({ GetRepHi_185((*lhs.borrow()).clone()) }) == <i64>::MIN) {
            (({ GetRepLo_186((*lhs.borrow()).clone()) }).wrapping_add(1_u32)
                < ({ GetRepLo_186((*rhs.borrow()).clone()) }).wrapping_add(1_u32))
        } else {
            (({ GetRepLo_186((*lhs.borrow()).clone()) })
                < ({ GetRepLo_186((*rhs.borrow()).clone()) }))
        }
    };
}
pub fn operator_cmp_112(lhs: absl_Duration, rhs: absl_Duration) -> std::cmp::Ordering {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    let lhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_185((*lhs.borrow()).clone()) })));
    let rhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_185((*rhs.borrow()).clone()) })));
    {
    ...
    let lhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_186((*lhs.borrow()).clone()) })));
    let rhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_186((*rhs.borrow()).clone()) })));
...
pub fn operator_eq_113(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (({ GetRepHi_185((*lhs.borrow()).clone()) })
        == ({ GetRepHi_185((*rhs.borrow()).clone()) }))
        && (({ GetRepLo_186((*lhs.borrow()).clone()) })
            == ({ GetRepLo_186((*rhs.borrow()).clone()) }));
}
pub fn operator_neg_126(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepLo_186((*d.borrow()).clone()) }) == 0_u32) {
        if (({ GetRepHi_185((*d.borrow()).clone()) }) == <i64>::MIN) {
            ({ InfiniteDuration_192() })
        } else {
            ({ MakeDuration_154(-({ GetRepHi_185((*d.borrow()).clone()) }), None) })
        }
    } else {
        if ({ IsInfiniteDuration_187((*d.borrow()).clone()) }) {
            ({ OppositeInfinity_188((*d.borrow()).clone()) })
        } else {
            ({
                let _hi: i64 =
                    ({ NegateAndSubtractOne_189(({ GetRepHi_185((*d.borrow()).clone()) })) });
                let _lo: i64 = (4000000000 - (({ GetRepLo_186((*d.borrow()).clone()) }) as i64));
                MakeDuration_183(_hi, _lo)
            })
        }
    };
}
pub fn InfiniteDuration_192() -> absl_Duration {
    return ({ MakeDuration_154(<i64>::MAX, Some(!0_u32)) });
}
pub fn FromChrono_213(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_195((d).clone()) });
}
pub fn FromChrono_214(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_196((d).clone()) });
}
pub fn FromChrono_215(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_197((d).clone()) });
}
pub fn FromChrono_216(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_198((d).clone()) });
}
pub fn FromChrono_217(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_199((d).clone()) });
}
pub fn FromChrono_218(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_200((d).clone()) });
}
pub fn FromUnixNanos_219(ns: i64) -> absl_Time {
    let ns: Value<i64> = Rc::new(RefCell::new(ns));
    return ({ FromUnixDuration_190(({ Nanoseconds_128((*ns.borrow())) })) });
}
pub fn FromUnixMicros_220(us: i64) -> absl_Time {
    let us: Value<i64> = Rc::new(RefCell::new(us));
    return ({ FromUnixDuration_190(({ Microseconds_130((*us.borrow())) })) });
}
pub fn FromUnixMillis_221(ms: i64) -> absl_Time {
    let ms: Value<i64> = Rc::new(RefCell::new(ms));
    return ({ FromUnixDuration_190(({ Milliseconds_132((*ms.borrow())) })) });
}
pub fn FromUnixSeconds_222(s: i64) -> absl_Time {
    let s: Value<i64> = Rc::new(RefCell::new(s));
    return ({ FromUnixDuration_190(({ Seconds_133((*s.borrow())) })) });
}
pub fn FromTimeT_223(t: i64) -> absl_Time {
    let t: Value<i64> = Rc::new(RefCell::new(t));
    return ({ FromUnixDuration_190(({ Seconds_134((*t.borrow())) })) });
}
pub fn ToInt64Nanoseconds_202(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_185((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_185((*d.borrow()).clone()) }) >> 33) == 0_i64)
    {
        return ((((({ GetRepHi_185((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_186((*d.borrow()).clone()) }) as i64) / 4));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_121(_lhs, ({ Nanoseconds_127(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Microseconds_204(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_185((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_185((*d.borrow()).clone()) }) >> 43) == 0_i64)
    {
        return (((({ GetRepHi_185((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_186((*d.borrow()).clone()) }) as i64) / (4 * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_121(_lhs, ({ Microseconds_129(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Milliseconds_206(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_185((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_185((*d.borrow()).clone()) }) >> 53) == 0_i64)
    {
        return ((({ GetRepHi_185((*d.borrow()).clone()) }) * 1000_i64)
            + ((({ GetRepLo_186((*d.borrow()).clone()) }) as i64) / ((4 * 1000_i64) * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_121(_lhs, ({ Milliseconds_131(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Seconds_208(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_185((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_187((*d.borrow()).clone()) }) {
        return (*hi.borrow());
    }
    if ((*hi.borrow()) < 0_i64) && (({ GetRepLo_186((*d.borrow()).clone()) }) != 0_u32) {
        (*hi.borrow_mut()).prefix_inc();
    }
    return (*hi.borrow());
}
pub fn ToInt64Minutes_210(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_185((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_187((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn ToInt64Hours_212(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_185((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_187((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn SleepFor_224(duration: absl_Duration) {
    let duration: Value<absl_Duration> = Rc::new(RefCell::new(duration));
    ({ AbslInternalSleepFor_225((*duration.borrow()).clone()) });
}
thread_local!(
    static kNoTimeout_226: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
thread_local!(
    static kMaxNanos_227: Value<i64> = Rc::new(RefCell::new(9223372036854775807));
);
#[derive()]
...
pub fn GetOrCreateCurrentThreadIdentity_228() -> Ptr<absl_base_internal_ThreadIdentity> {
    let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
        Rc::new(RefCell::new(({ CurrentThreadIdentityIfPresent_229() })));
    if ((((false) || ((*identity.borrow()).is_null())) as i64) != 0) {
        return ({ CreateThreadIdentity_230() });
    }
...
impl absl_synchronization_internal_PerThreadSem {
    fn Init(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        ...
        ({ AbslInternalPerThreadSemInit_231((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Post(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
            Rc::new(RefCell::new(identity));
        ({ AbslInternalPerThreadSemPost_232((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Wait(t: absl_synchronization_internal_KernelTimeout) -> bool {
        ...
        return ({ AbslInternalPerThreadSemWait_233((*t.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
...
pub type anon_235 = u8;
pub const anon_235_ONCE_STATE_UNINITIALIZED: anon_235 = 0;
pub const anon_235_ONCE_STATE_EXECUTING_FUNCTION: anon_235 = 1;
pub const anon_235_ONCE_STATE_DONE: anon_235 = 2;
pub fn CallOnce_236(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_235_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_237((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
thread_local!(
    pub static kStackWalkError_239: Value<i32> = Rc::new(RefCell::new(-1_i32));
);
thread_local!(
    pub static kStackWalkMaxNameLen_240: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    pub static kStackWalkMaxTextLen_241: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    static msPerSecond_242: Value<i32> = Rc::new(RefCell::new(1000));
);
#[derive()]
...
pub fn EnsureConsoleOutput_243() {}
#[derive(Default)]
...
impl v8_base_Stack {
    pub fn GetCurrentFrameAddress(
        ...
        let frame_address: Value<AnyPtr> = Rc::new(RefCell::new(
            frame_address.unwrap_or(({ __builtin_frame_address_244(0_u32) })),
        ));
...
pub fn CountLeadingZeros_245(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        if (32_u32 == 64_u32) {
            (({ __builtin_clzll_246(((*value.borrow()) as u64)) }) as u32)
        } else {
...
pub fn CountLeadingZeros_247(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
...
pub fn CountLeadingZeros32_248(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_245((*value.borrow())) });
}
pub fn CountLeadingZeros64_249(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountLeadingZeros_247((*value.borrow())) });
}
pub fn CountTrailingZeros_250(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u32) {
        32_u32
    } else {
        (if (32_u32 == 64_u32) {
            ({ __builtin_ctzll_251(((*value.borrow()) as u64)) })
        } else {
            ((*value.borrow()) as u32).trailing_zeros() as i32
        } as u32)
    };
}
pub fn CountTrailingZeros_252(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return if ((*value.borrow()) == 0_u64) {
        64_u32
    } else {
...
pub fn CountTrailingZeros32_253(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_250((*value.borrow())) });
}
pub fn CountTrailingZeros64_254(value: u64) -> u32 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return ({ CountTrailingZeros_252((*value.borrow())) });
}
pub fn RoundUpToPowerOfTwo32_255(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u32 << ((32_u32).wrapping_sub(({ CountLeadingZeros_245((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo64_256(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    (&(0));
    if ((*value.borrow()) != 0) {
        (*value.borrow_mut()).prefix_dec();
    }
    return (1_u64 << ((64_u32).wrapping_sub(({ CountLeadingZeros_247((*value.borrow())) }))));
}
pub fn RoundUpToPowerOfTwo_257(value: usize) -> usize {
    let value: Value<usize> = Rc::new(RefCell::new(value));
    if (::std::mem::size_of::<usize>() == ::std::mem::size_of::<u64>()) {
        return (({ RoundUpToPowerOfTwo64_256(((*value.borrow()) as u64)) }) as usize);
    } else {
        return (({ RoundUpToPowerOfTwo32_255(((*value.borrow()) as u32)) }) as usize);
    }
    panic!("ub: non-void function does not return a value")
}
pub fn RoundDownToPowerOfTwo32_258(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    if ((*value.borrow()) > 2147483648_u32) {
        return 2147483648_u32;
    }
    let result: Value<u32> = Rc::new(RefCell::new(
        ({ RoundUpToPowerOfTwo32_255((*value.borrow())) }),
    ));
...
pub fn RotateRight32_259(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
...
pub fn RotateLeft32_260(value: u32, shift: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    let shift: Value<u32> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((32_u32).wrapping_sub((*shift.borrow()))) & 31_u32)));
}
pub fn RotateRight64_261(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) >> (*shift.borrow()))
        | ((*value.borrow()) << (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn RotateLeft64_262(value: u64, shift: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    let shift: Value<u64> = Rc::new(RefCell::new(shift));
    return (((*value.borrow()) << (*shift.borrow()))
        | ((*value.borrow()) >> (((64_u64).wrapping_sub((*shift.borrow()))) & 63_u64)));
}
pub fn ClearLsb_263(value: i32) -> i32 {
    let value: Value<i32> = Rc::new(RefCell::new(value));
    return ((*value.borrow()) & ((*value.borrow()) - 1));
}
pub fn SignedAddOverflow32_264(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    ...
    return ({
        ...
        __builtin_sadd_overflow_265(_arg0, _arg1, _arg2)
    });
}
pub fn SignedSubOverflow32_266(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_ssub_overflow_267(_arg0, _arg1, _arg2)
    });
}
pub fn SignedMulOverflow32_268(lhs: i32, rhs: i32, val: Ptr<i32>) -> bool {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i32>> = Rc::new(RefCell::new(val));
    return ({
        ...
        let _arg1: i32 = (*rhs.borrow());
        let _arg2: Ptr<i32> = (*val.borrow()).clone();
        __builtin_smul_overflow_269(_arg0, _arg1, _arg2)
    });
}
pub fn SignedAddOverflow64_270(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
...
pub fn SignedSubOverflow64_272(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return ({
        __builtin_sub_overflow_273(&[
            (*lhs.borrow()).into(),
            (*rhs.borrow()).into(),
            ((*val.borrow()).clone()).into(),
        ])
...
pub fn SignedMulOverflow64_274(lhs: i64, rhs: i64, val: Ptr<i64>) -> bool {
    let lhs: Value<i64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i64> = Rc::new(RefCell::new(rhs));
    let val: Value<Ptr<i64>> = Rc::new(RefCell::new(val));
    return {
...
pub fn UnsignedAddOverflow32_275(lhs: u32, rhs: u32, val: Ptr<u32>) -> bool {
    ...
    return ({
        ...
        __builtin_uadd_overflow_276(_arg0, _arg1, _arg2)
    });
}
pub fn UnsignedDiv32_277(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
...
pub fn UnsignedDiv64_278(lhs: u64, rhs: u64) -> u64 {
...
pub fn UnsignedMod32_279(lhs: u32, rhs: u32) -> u32 {
    let lhs: Value<u32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u32> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
...
pub fn UnsignedMod64_280(lhs: u64, rhs: u64) -> u64 {
    let lhs: Value<u64> = Rc::new(RefCell::new(lhs));
    let rhs: Value<u64> = Rc::new(RefCell::new(rhs));
    return if ((*rhs.borrow()) != 0) {
        (*lhs.borrow()).wrapping_rem((*rhs.borrow()))
...
pub fn WraparoundAdd32_281(lhs: i32, rhs: i32) -> i32 {
    let lhs: Value<i32> = Rc::new(RefCell::new(lhs));
    let rhs: Value<i32> = Rc::new(RefCell::new(rhs));
    return ((((*lhs.borrow()) as u32).wrapping_add(((*rhs.borrow()) as u32))) as i32);
}
pub fn WraparoundNeg32_282(x: i32) -> i32 {
    let x: Value<i32> = Rc::new(RefCell::new(x));
    return (-((*x.borrow()) as u32) as i32);
}
pub fn ByteReverse16_283(value: u16) -> u16 {
    let value: Value<u16> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse32_284(value: u32) -> u32 {
    let value: Value<u32> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
pub fn ByteReverse64_285(value: u64) -> u64 {
    let value: Value<u64> = Rc::new(RefCell::new(value));
    return (*value.borrow()).swap_bytes();
}
thread_local!(
    pub static kMaxExponent_286: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kMaxExponent_287: Value<i32> = Rc::new(RefCell::new(1024));
);
thread_local!(
    pub static kIntegerBitsPlusSign_288: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kIntegerBitsPlusSign_289: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kIntegerBitsPlusSign_290: Value<i32> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kIntegerBitsPlusSign_291: Value<i32> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kIntegerBitsPlusSign_292: Value<i32> = Rc::new(RefCell::new(32));
);
thread_local!(
    pub static kIntegerBitsPlusSign_293: Value<i32> = Rc::new(RefCell::new(32));
);
thread_local!(
    pub static kIntegerBitsPlusSign_294: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kIntegerBitsPlusSign_295: Value<i32> = Rc::new(RefCell::new(64));
);
thread_local!(
    pub static kIntegerBitsPlusSign_296: Value<i32> = Rc::new(RefCell::new(64));
);
pub fn IsValueNegative_297(value: i64) -> bool {
    let value: Value<i64> = Rc::new(RefCell::new(value));
    if true {
...
pub fn ConditionalNegate_298(x: u64, is_negative: bool) -> i64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
...
pub fn SafeUnsignedAbs_299(value: i64) -> u64 {
    let value: Value<i64> = Rc::new(RefCell::new(value));
    return if ({ IsValueNegative_297((*value.borrow())) }) {
...
thread_local!(
    pub static kEnableAsmCode_300: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static kStaticDstRangeRelationToSrcRange_301: Value<
        v8_base_internal_NumericRangeRepresentation,
    > = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kStaticDstRangeRelationToSrcRange_303: Value<
        v8_base_internal_NumericRangeRepresentation,
    > = Rc::new(RefCell::new(0));
);
#[derive(Default)]
...
thread_local!(
    pub static kShift_304: Value<i32> = Rc::new(RefCell::new(10));
);
#[derive(Default)]
...
impl v8_base_internal_NarrowingRange_long_long__double__v8_base_internal_SaturationDefaultLimits_ {
    ...
    pub fn Adjust_i64__long_long(value: i64) -> i64 {
        ...
        if true {
            return (({
                let _x: u64 = (({ SafeUnsignedAbs_299((*value.borrow())) })
                    & !(((1_u64 << 10) as u64).wrapping_sub((1_u64 as u64))));
                let _is_negative: bool = ({ IsValueNegative_297((*value.borrow())) });
                ConditionalNegate_298(_x, _is_negative)
            }) as i64);
        } else {
        }
        panic!("ub: non-void function does not return a value")
...
pub fn DstRangeRelationToSrcRange_305(value: f64) -> v8_base_internal_RangeCheck {
...
thread_local!(
    pub static kIsCheckedNumeric_306: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static kIsClampedNumeric_307: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!(
    pub static kIsStrictNumeric_308: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static kIsNumeric_309: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
pub fn saturated_cast_impl_310(value: f64, constraint: v8_base_internal_RangeCheck) -> i64 {
    let value: Value<f64> = Rc::new(RefCell::new(value));
...
thread_local!(
    pub static is_supported_311: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
pub fn saturated_cast_312(value: f64) -> i64 {
    let value: Value<f64> = Rc::new(RefCell::new(value));
    let underlying_value: Value<f64> = Rc::new(RefCell::new(((*value.borrow()) as f64)));
    return if ((!({ is_constant_evaluated_40() })) && (false)) && (true) {
        ...
        ({
            ...
            let _constraint: v8_base_internal_RangeCheck =
                ({ DstRangeRelationToSrcRange_305((*underlying_value.borrow())) });
            saturated_cast_impl_310(_value, _constraint)
        })
    };
}
#[derive(Default)]
...
thread_local!(
    pub static kHoursPerDay_315: Value<i64> = Rc::new(RefCell::new(24));
);
thread_local!(
    pub static kMillisecondsPerSecond_316: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kMillisecondsPerDay_317: Value<i64> = Rc::new(RefCell::new(86400000));
);
thread_local!(
    pub static kMicrosecondsPerMillisecond_318: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kMicrosecondsPerSecond_319: Value<i64> = Rc::new(RefCell::new(1000000));
);
thread_local!(
    pub static kMicrosecondsPerMinute_320: Value<i64> = Rc::new(RefCell::new(60000000));
);
thread_local!(
    pub static kMicrosecondsPerHour_321: Value<i64> = Rc::new(RefCell::new(3600000000));
);
thread_local!(
    pub static kMicrosecondsPerDay_322: Value<i64> = Rc::new(RefCell::new(86400000000));
);
thread_local!(
    pub static kMicrosecondsPerWeek_323: Value<i64> = Rc::new(RefCell::new(604800000000));
);
thread_local!(
    pub static kNanosecondsPerMicrosecond_324: Value<i64> = Rc::new(RefCell::new(1000));
);
thread_local!(
    pub static kNanosecondsPerSecond_325: Value<i64> = Rc::new(RefCell::new(1000000000));
);
#[derive(Default)]
...
pub fn swap_326(a: v8_base_TimeDelta, b: v8_base_TimeDelta) {
...
impl v8_base_TimeDelta {
    fn FromDouble(value: f64) -> v8_base_TimeDelta {
        let value: Value<f64> = Rc::new(RefCell::new(value));
        return v8_base_TimeDelta::v8_base_TimeDelta2({
            ({ saturated_cast_312((*value.borrow())) })
        });
    }
}
impl v8_base_TimeDelta {
...
pub fn Nanoseconds_327(nanoseconds: i64) -> v8_base_TimeDelta {
    let nanoseconds: Value<i64> = Rc::new(RefCell::new(nanoseconds));
    return ({ v8_base_TimeDelta::FromNanoseconds((*nanoseconds.borrow())) });
}
pub fn Microseconds_328(microseconds: i64) -> v8_base_TimeDelta {
    let microseconds: Value<i64> = Rc::new(RefCell::new(microseconds));
    return ({ v8_base_TimeDelta::FromMicroseconds((*microseconds.borrow())) });
}
pub fn Milliseconds_329(milliseconds: i64) -> v8_base_TimeDelta {
    let milliseconds: Value<i64> = Rc::new(RefCell::new(milliseconds));
    return ({ v8_base_TimeDelta::FromMilliseconds((*milliseconds.borrow())) });
}
pub fn Milliseconds_330(milliseconds: f64) -> v8_base_TimeDelta {
    let milliseconds: Value<f64> = Rc::new(RefCell::new(milliseconds));
    return ({ v8_base_TimeDelta::FromMillisecondsD((*milliseconds.borrow())) });
}
pub fn Seconds_331(seconds: i64) -> v8_base_TimeDelta {
    let seconds: Value<i64> = Rc::new(RefCell::new(seconds));
    return ({ v8_base_TimeDelta::FromSeconds((*seconds.borrow())) });
}
pub fn Seconds_332(seconds: f64) -> v8_base_TimeDelta {
    let seconds: Value<f64> = Rc::new(RefCell::new(seconds));
    return ({ v8_base_TimeDelta::FromSecondsD((*seconds.borrow())) });
}
pub fn Minutes_333(minutes: i32) -> v8_base_TimeDelta {
    let minutes: Value<i32> = Rc::new(RefCell::new(minutes));
    return ({ v8_base_TimeDelta::FromMinutes((*minutes.borrow())) });
}
pub fn Hours_334(hours: i32) -> v8_base_TimeDelta {
    let hours: Value<i32> = Rc::new(RefCell::new(hours));
    return ({ v8_base_TimeDelta::FromHours((*hours.borrow())) });
}
pub fn FromDays_335(days: i32) -> v8_base_TimeDelta {
    let days: Value<i32> = Rc::new(RefCell::new(days));
...
pub fn operator_add_336(delta: Ptr<v8_base_TimeDelta>, time: Ptr<v8_base_Time>) -> v8_base_Time {
    return ({
...
thread_local!(
    static kMultiplier_338: Value<i64> = Rc::new(RefCell::new(25214903917_i64));
);
thread_local!(
    static kAddend_339: Value<i64> = Rc::new(RefCell::new(11_i64));
);
thread_local!(
    static kMask_340: Value<i64> = Rc::new(RefCell::new(281474976710655_i64));
);
#[derive()]
pub struct v8_base_RandomNumberGenerator {
    initial_seed_: Value<i64>,
    state0_: Value<u64>,
    state1_: Value<u64>,
}
impl v8_base_RandomNumberGenerator {
    pub fn v8_base_RandomNumberGenerator1(seed: i64) -> Self {
        let seed: Value<i64> = Rc::new(RefCell::new(seed));
        let __this: Value<v8_base_RandomNumberGenerator> = Rc::new(RefCell::new(Self {
            initial_seed_: <Value<i64>>::default(),
            state0_: <Value<u64>>::default(),
            state1_: <Value<u64>>::default(),
        }));
        let this: Ptr<v8_base_RandomNumberGenerator> = __this.as_pointer();
        ({ v8_base_RandomNumberGeneratorImpl::SetSeed(&this, (*seed.borrow())) });
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    pub fn ToDouble(random: u64) -> f64 {
        let random: Value<u64> = Rc::new(RefCell::new(random));
        let random_0_to_2_53: Value<f64> =
            Rc::new(RefCell::new((((*random.borrow()) >> 11) as f64)));
        let k2_53: Value<f64> = Rc::new(RefCell::new(((1_u64 << 53) as f64)));
        return ((*random_0_to_2_53.borrow()) / (*k2_53.borrow()));
    }
    pub fn XorShift128(state0: Ptr<u64>, state1: Ptr<u64>) -> u64 {
        let state0: Value<Ptr<u64>> = Rc::new(RefCell::new(state0));
        let state1: Value<Ptr<u64>> = Rc::new(RefCell::new(state1));
        let s1: Value<u64> = Rc::new(RefCell::new(((*state0.borrow()).read())));
        let s0: Value<u64> = Rc::new(RefCell::new(((*state1.borrow()).read())));
        let __rhs = (*s0.borrow());
        (*state0.borrow()).write(__rhs);
        let __rhs = ((*s1.borrow()) << 23);
        (*s1.borrow_mut()) ^= __rhs;
        let __rhs = ((*s1.borrow()) >> 17);
        (*s1.borrow_mut()) ^= __rhs;
        (*s1.borrow_mut()) ^= (*s0.borrow());
        (*s1.borrow_mut()) ^= ((*s0.borrow()) >> 26);
        let __rhs = (*s1.borrow());
        (*state1.borrow()).write(__rhs);
        return (*s0.borrow()).wrapping_add((*s1.borrow()));
    }
    pub fn min() -> u32 {
        return 0_u32;
    }
...
impl Clone for v8_base_RandomNumberGenerator {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_RandomNumberGenerator> = Rc::new(RefCell::new(Self {
            initial_seed_: Rc::new(RefCell::new((*self.initial_seed_.borrow()))),
            state0_: Rc::new(RefCell::new((*self.state0_.borrow()))),
            state1_: Rc::new(RefCell::new((*self.state1_.borrow()))),
        }));
        let this: Ptr<v8_base_RandomNumberGenerator> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for v8_base_RandomNumberGenerator {
    fn default() -> Self {
        { v8_base_RandomNumberGenerator::v8_base_RandomNumberGenerator2() }
    }
}
impl ByteRepr for v8_base_RandomNumberGenerator {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.initial_seed_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.state0_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.state1_.borrow()).to_bytes(&mut buf[16..24]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            initial_seed_: Rc::new(RefCell::new(<i64>::from_bytes(&buf[0..8]))),
            state0_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[8..16]))),
            state1_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[16..24]))),
        }
    }
}
pub type partition_alloc_internal_pool_handle = u32;
pub const partition_alloc_internal_pool_handle_kNullPoolHandle:
    partition_alloc_internal_pool_handle = 0;
pub const partition_alloc_internal_pool_handle_kRegularPoolHandle:
    partition_alloc_internal_pool_handle = 1;
pub const partition_alloc_internal_pool_handle_kBRPPoolHandle:
    partition_alloc_internal_pool_handle = 2;
pub const partition_alloc_internal_pool_handle_kConfigurablePoolHandle:
    partition_alloc_internal_pool_handle = 3;
pub const partition_alloc_internal_pool_handle_kMaxPoolHandle:
    partition_alloc_internal_pool_handle = 4;
pub fn PageAllocationGranularityShift_341() -> usize {
    return ((*vm_page_shift_342.with(Value::clone).borrow()) as usize);
}
pub fn PageAllocationGranularity_343() -> usize {
    return ((*vm_page_size_344.with(Value::clone).borrow()) as usize);
}
pub fn PageAllocationGranularityOffsetMask_345() -> usize {
    return ({ PageAllocationGranularity_343() }).wrapping_sub(1_usize);
}
pub fn PageAllocationGranularityBaseMask_346() -> usize {
    return !({ PageAllocationGranularityOffsetMask_345() });
}
pub fn SystemPageShift_347() -> usize {
    return ({ PageAllocationGranularityShift_341() });
}
pub fn SystemPageSize_348() -> usize {
    return ({ PageAllocationGranularity_343() });
}
pub fn SystemPageOffsetMask_349() -> usize {
    return ({ SystemPageSize_348() }).wrapping_sub(1_usize);
}
pub fn SystemPageBaseMask_350() -> usize {
    return !({ SystemPageOffsetMask_349() });
}
thread_local!(
    pub static kPageMetadataShift_351: Value<usize> = Rc::new(RefCell::new(5));
);
thread_local!(
    pub static kPageMetadataSize_352: Value<usize> = Rc::new(RefCell::new(32));
);
pub fn SystemPageSize_353() -> usize {
    return ({ SystemPageSize_348() });
}
#[derive()]
pub struct partition_alloc_internal_base_ScopedClearLastErrorBase {
    last_errno_: Value<i32>,
}
impl partition_alloc_internal_base_ScopedClearLastErrorBase {
    pub fn partition_alloc_internal_base_ScopedClearLastErrorBase() -> Self {
        let __this: Value<partition_alloc_internal_base_ScopedClearLastErrorBase> =
            Rc::new(RefCell::new(Self {
                last_errno_: Rc::new(RefCell::new((cpp2rust_errno().read()))),
            }));
        let this: Ptr<partition_alloc_internal_base_ScopedClearLastErrorBase> = __this.as_pointer();
        cpp2rust_errno().write(0);
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for partition_alloc_internal_base_ScopedClearLastErrorBase {
    fn default() -> Self {
        {
            partition_alloc_internal_base_ScopedClearLastErrorBase :: partition_alloc_internal_base_ScopedClearLastErrorBase ( )
        }
    }
}
impl ByteRepr for partition_alloc_internal_base_ScopedClearLastErrorBase {
    fn byte_size() -> usize {
        4
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.last_errno_.borrow()).to_bytes(&mut buf[0..4]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            last_errno_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[0..4]))),
        }
    }
}
thread_local!(
    pub static kBufferSize_354: Value<usize> = Rc::new(RefCell::new(256));
);
#[derive()]
pub struct partition_alloc_internal_base_strings_CStringBuilder {
    buffer_: Value<Box<[u8]>>,
    ptr_: Value<Ptr<u8>>,
}
impl partition_alloc_internal_base_strings_CStringBuilder {
    pub fn partition_alloc_internal_base_strings_CStringBuilder() -> Self {
        let __this: Value<partition_alloc_internal_base_strings_CStringBuilder> =
            Rc::new(RefCell::new(Self {
                buffer_: Rc::new(RefCell::new(
                    (0..256).map(|_| <u8>::default()).collect::<Box<[u8]>>(),
                )),
                ptr_: Rc::new(RefCell::new(
                    ((*this.upgrade().deref()).buffer_.as_pointer() as Ptr<u8>),
                )),
            }));
        let this: Ptr<partition_alloc_internal_base_strings_CStringBuilder> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Clone for partition_alloc_internal_base_strings_CStringBuilder {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_base_strings_CStringBuilder> =
            Rc::new(RefCell::new(Self {
                buffer_: Rc::new(RefCell::new(Box::new(std::array::from_fn::<_, 256, _>(
                    |__i: usize| (*self.buffer_.borrow())[(__i) as usize],
                )))),
...
impl Default for partition_alloc_internal_base_strings_CStringBuilder {
    fn default() -> Self {
        {
            partition_alloc_internal_base_strings_CStringBuilder :: partition_alloc_internal_base_strings_CStringBuilder ( )
        }
    }
}
impl ByteRepr for partition_alloc_internal_base_strings_CStringBuilder {
    fn byte_size() -> usize {
        264
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.buffer_.borrow()).to_bytes(&mut buf[0..256]);
        (*self.ptr_.borrow()).to_bytes(&mut buf[256..264]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            buffer_: Rc::new(RefCell::new(<Box<[u8]>>::from_bytes(&buf[0..256]))),
            ptr_: Rc::new(RefCell::new(<Ptr<u8>>::from_bytes(&buf[256..264]))),
        }
    }
}
thread_local!(
    pub static LOGGING_VERBOSE_355: Value<i32> = Rc::new(RefCell::new(-1));
);
thread_local!(
    pub static LOGGING_INFO_356: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static LOGGING_WARNING_357: Value<i32> = Rc::new(RefCell::new(1));
);
thread_local!(
    pub static LOGGING_ERROR_358: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!(
    pub static LOGGING_FATAL_359: Value<i32> = Rc::new(RefCell::new(3));
);
thread_local!(
    pub static LOGGING_NUM_SEVERITIES_360: Value<i32> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static LOGGING_DFATAL_361: Value<i32> = Rc::new(RefCell::new(2));
);
thread_local!();
#[derive(Default)]
pub struct partition_alloc_internal_logging_LogMessage {
    severity_: Value<i32>,
    stream_: Value<partition_alloc_internal_base_strings_CStringBuilder>,
    message_start_: Value<usize>,
    file_: Value<Ptr<u8>>,
    line_: Value<i32>,
    last_error_: Value<partition_alloc_internal_base_ScopedClearLastErrorBase>,
}
impl partition_alloc_internal_logging_LogMessage {}
impl ByteRepr for partition_alloc_internal_logging_LogMessage {
    fn byte_size() -> usize {
        304
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.severity_.borrow()).to_bytes(&mut buf[8..12]);
        (*self.stream_.borrow()).to_bytes(&mut buf[16..280]);
        (*self.message_start_.borrow()).to_bytes(&mut buf[280..288]);
        (*self.file_.borrow()).to_bytes(&mut buf[288..296]);
        (*self.line_.borrow()).to_bytes(&mut buf[296..300]);
        (*self.last_error_.borrow()).to_bytes(&mut buf[300..304]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            severity_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[8..12]))),
            stream_: Rc::new(RefCell::new(
                <partition_alloc_internal_base_strings_CStringBuilder>::from_bytes(&buf[16..280]),
            )),
            message_start_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[280..288]))),
            file_: Rc::new(RefCell::new(<Ptr<u8>>::from_bytes(&buf[288..296]))),
            line_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[296..300]))),
            last_error_: Rc::new(RefCell::new(
                <partition_alloc_internal_base_ScopedClearLastErrorBase>::from_bytes(
                    &buf[300..304],
                ),
            )),
        }
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_LogMessageVoidify {}
impl Clone for partition_alloc_internal_logging_LogMessageVoidify {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_logging_LogMessageVoidify> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_internal_logging_LogMessageVoidify> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_internal_logging_LogMessageVoidify {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_ErrnoLogMessage {
    err_: Value<i32>,
}
impl partition_alloc_internal_logging_ErrnoLogMessage {}
impl partition_alloc_internal_logging_LogMessage
    for partition_alloc_internal_logging_ErrnoLogMessage
{
}
impl ByteRepr for partition_alloc_internal_logging_ErrnoLogMessage {
    fn byte_size() -> usize {
        312
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.err_.borrow()).to_bytes(&mut buf[304..308]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            err_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[304..308]))),
        }
    }
}
#[derive(Default)]
pub struct partition_alloc_internal_logging_VoidifyStream {}
impl partition_alloc_internal_logging_VoidifyStream {
    pub fn partition_alloc_internal_logging_VoidifyStream1(ignored: bool) -> Self {
        let ignored: Value<bool> = Rc::new(RefCell::new(ignored));
        let __this: Value<partition_alloc_internal_logging_VoidifyStream> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_internal_logging_VoidifyStream> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Clone for partition_alloc_internal_logging_VoidifyStream {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_logging_VoidifyStream> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_internal_logging_VoidifyStream> = __this.as_pointer();
...
impl ByteRepr for partition_alloc_internal_logging_VoidifyStream {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
impl anon_363 {
    pub fn log_message_(&self) -> Ptr<partition_alloc_internal_logging_LogMessage> {
        (self.__bytes.as_pointer() as Ptr<u8>).reinterpret_cast()
    }
    pub fn errno_log_message_(&self) -> Ptr<partition_alloc_internal_logging_ErrnoLogMessage> {
        (self.__bytes.as_pointer() as Ptr<u8>).reinterpret_cast()
    }
}
impl Clone for anon_363 {
    fn clone(&self) -> Self {
        anon_363 {
            __bytes: Rc::new(RefCell::new(self.__bytes.borrow().clone())),
        }
...
impl Default for anon_363 {
    fn default() -> Self {
        anon_363 {
            __bytes: Rc::new(RefCell::new(Box::from([0u8; 312]))),
        }
    }
}
impl ByteRepr for anon_363 {
    fn byte_size() -> usize {
        312
    }
    fn to_bytes(&self, buf: &mut [u8]) {
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_CheckError {
    anon_363: Value<anon_363>,
    has_errno: Value<bool>,
}
impl partition_alloc_internal_logging_CheckError {}
impl ByteRepr for partition_alloc_internal_logging_CheckError {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.anon_363.borrow()).to_bytes(&mut buf[0..312]);
        (*self.has_errno.borrow()).to_bytes(&mut buf[312..313]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            anon_363: Rc::new(RefCell::new(<anon_363>::from_bytes(&buf[0..312]))),
            has_errno: Rc::new(RefCell::new(<bool>::from_bytes(&buf[312..313]))),
        }
    }
}
#[derive(Default)]
pub struct partition_alloc_internal_logging_check_error_Check {}
impl partition_alloc_internal_logging_check_error_Check {}
impl ByteRepr for partition_alloc_internal_logging_check_error_Check {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_check_error_DCheck {}
impl partition_alloc_internal_logging_check_error_DCheck {}
impl ByteRepr for partition_alloc_internal_logging_check_error_DCheck {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_check_error_PCheck {}
impl partition_alloc_internal_logging_check_error_PCheck {}
impl ByteRepr for partition_alloc_internal_logging_check_error_PCheck {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_check_error_DPCheck {}
impl partition_alloc_internal_logging_check_error_DPCheck {}
impl ByteRepr for partition_alloc_internal_logging_check_error_DPCheck {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct partition_alloc_internal_logging_check_error_NotImplemented {}
impl partition_alloc_internal_logging_check_error_NotImplemented {}
impl ByteRepr for partition_alloc_internal_logging_check_error_NotImplemented {
    fn byte_size() -> usize {
        320
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
thread_local!(
    pub static kDebugKeyMaxLength_364: Value<usize> = Rc::new(RefCell::new(8));
);
#[derive()]
pub struct partition_alloc_internal_DebugKv {
    pub k: Value<Vec<u8>>,
    pub v: Value<u64>,
}
impl partition_alloc_internal_DebugKv {
    pub fn partition_alloc_internal_DebugKv(key: Vec<u8>, value: u64) -> Self {
        let key: Value<Vec<u8>> = Rc::new(RefCell::new(key));
        let value: Value<u64> = Rc::new(RefCell::new(value));
        let __this: Value<partition_alloc_internal_DebugKv> = Rc::new(RefCell::new(Self {
            k: Rc::new(RefCell::new(
                std::array::from_fn::<_, 8, _>(|_| Default::default()).to_vec(),
            )),
            v: Rc::new(RefCell::new((*value.borrow()))),
        }));
        let this: Ptr<partition_alloc_internal_DebugKv> = __this.as_pointer();
        'loop_: for mut c in (*this.upgrade().deref()).k.as_pointer() as Ptr<u8> {
            c.write((' ' as u8));
        }
        let index: Value<usize> = Rc::new(RefCell::new(0_usize));
        'loop_: while ((*index.borrow()) < (*(*this.upgrade().deref()).k.borrow()).len())
            && ((*index.borrow()) < (*key.borrow()).len())
        {
            let __rhs = ((*key.borrow())[(*index.borrow()) as usize].read());
            ((*this.upgrade().deref()).k.as_pointer() as Ptr<u8>)
                .offset((*index.borrow()))
                .write(__rhs);
            if ((((*key.borrow())[(*index.borrow()) as usize].read()) as i32)
                == (('\0' as u8) as i32))
            {
                break;
            }
...
impl Clone for partition_alloc_internal_DebugKv {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_DebugKv> = Rc::new(RefCell::new(Self {
...
impl Default for partition_alloc_internal_DebugKv {
    fn default() -> Self {
        partition_alloc_internal_DebugKv {
            k: Rc::new(RefCell::new(
                std::array::from_fn::<_, 8, _>(|_| Default::default()).to_vec(),
            )),
            v: <Value<u64>>::default(),
...
impl ByteRepr for partition_alloc_internal_DebugKv {
    fn byte_size() -> usize {
        16
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.k.borrow()).to_bytes(&mut buf[0..8]);
        (*self.v.borrow()).to_bytes(&mut buf[8..16]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            k: Rc::new(RefCell::new(<Vec<u8>>::from_bytes(&buf[0..8]))),
            v: Rc::new(RefCell::new(<u64>::from_bytes(&buf[8..16]))),
        }
    }
}
thread_local!(
    pub static kUseLazyCommit_365: Value<bool> = Rc::new(RefCell::new(false));
);
thread_local!(
    pub static kUseFewerMemoryRegions_366: Value<bool> = Rc::new(RefCell::new(false));
);
pub fn AlignDown_367(size: u64, alignment: u64) -> u64 {
    ...
    if true {
        ...
        ({
            let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
            partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( (  { has_single_bit_368 ( (*alignment.borrow())  , ) } )  ) )   } , )  , _arg0 , )
        })
    };
    return ((*size.borrow()) & !((*alignment.borrow()).wrapping_sub(1_u64)));
}
pub fn AlignUp_369(size: u64, alignment: u64) -> u64 {
    let size: Value<u64> = Rc::new(RefCell::new(size));
    let alignment: Value<u64> = Rc::new(RefCell::new(alignment));
    if true {
        &(0)
    ...
    return ((((*size.borrow()).wrapping_add((*alignment.borrow()))).wrapping_sub(1_u64))
        & !((*alignment.borrow()).wrapping_sub(1_u64)));
}
pub fn Log2Ceiling_370(n: u32) -> i32 {
    let n: Value<u32> = Rc::new(RefCell::new(n));
    return ((if ((*n.borrow()) != 0) { 32 } else { -1_i32 })
        - ({ countl_zero_371((*n.borrow()).wrapping_sub(1_u32)) }));
}
pub fn RotR_372(x: u64, s: u64) -> u64 {
    let x: Value<u64> = Rc::new(RefCell::new(x));
    let s: Value<u64> = Rc::new(RefCell::new(s));
    let n: Value<i32> = Rc::new(RefCell::new(64));
    if false {}
    return ({ __builtin_rotateright64_373((*x.borrow()), (*s.borrow())) });
}
thread_local!(
    pub static kAlignment_374: Value<usize> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kAlignmentIndex_375: Value<usize> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kBitsPerSizeT_376: Value<usize> = Rc::new(RefCell::new(64));
);
#[derive(Default)]
pub struct partition_alloc_PurgeState {
    pub generation: Value<u16>,
    pub next_bucket_index: Value<u16>,
}
impl Clone for partition_alloc_PurgeState {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_PurgeState> = Rc::new(RefCell::new(Self {
            generation: Rc::new(RefCell::new((*self.generation.borrow()))),
            next_bucket_index: Rc::new(RefCell::new((*self.next_bucket_index.borrow()))),
        }));
        let this: Ptr<partition_alloc_PurgeState> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_PurgeState {
    fn byte_size() -> usize {
        4
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.generation.borrow()).to_bytes(&mut buf[0..2]);
        (*self.next_bucket_index.borrow()).to_bytes(&mut buf[2..4]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            generation: Rc::new(RefCell::new(<u16>::from_bytes(&buf[0..2]))),
            next_bucket_index: Rc::new(RefCell::new(<u16>::from_bytes(&buf[2..4]))),
        }
    }
}
#[derive(Default)]
pub struct partition_alloc_PurgeResult {
    pub decommitted_empty_slot_spans_bytes: Value<usize>,
}
impl Clone for partition_alloc_PurgeResult {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_PurgeResult> = Rc::new(RefCell::new(Self {
            decommitted_empty_slot_spans_bytes: Rc::new(RefCell::new(
                (*self.decommitted_empty_slot_spans_bytes.borrow()),
            )),
        }));
        let this: Ptr<partition_alloc_PurgeResult> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_PurgeResult {
    fn byte_size() -> usize {
        8
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.decommitted_empty_slot_spans_bytes.borrow()).to_bytes(&mut buf[0..8]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            decommitted_empty_slot_spans_bytes: Rc::new(RefCell::new(<usize>::from_bytes(
                &buf[0..8],
            ))),
        }
    }
...
thread_local!(
    pub static kStep_377: Value<usize> = Rc::new(RefCell::new(16));
);
#[derive(Default)]
pub struct partition_alloc_internal_LinearBucketMapping {}
impl partition_alloc_internal_LinearBucketMapping {
    pub fn GetIndex(size: usize) -> usize {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        return if ((*size.borrow()) == 0_usize) {
            0_usize
        } else {
            ((*size.borrow()).wrapping_sub(1_usize)).wrapping_div(16)
        };
    }
    pub fn GetSize(index: u16) -> usize {
        let index: Value<u16> = Rc::new(RefCell::new(index));
        return (((*index.borrow()) as usize).wrapping_add(1_usize)).wrapping_mul(16);
    }
}
impl Clone for partition_alloc_internal_LinearBucketMapping {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_LinearBucketMapping> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_internal_LinearBucketMapping> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_internal_LinearBucketMapping {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
thread_local!(
    pub static kNumBucketsPerOrderBits_378: Value<usize> = Rc::new(RefCell::new(3));
);
thread_local!(
    pub static kNumBucketsPerOrder_379: Value<usize> = Rc::new(RefCell::new(8));
);
#[derive(Default)]
pub struct partition_alloc_internal_ExponentialBucketMapping {}
impl partition_alloc_internal_ExponentialBucketMapping {
    pub fn GetIndex(size: usize) -> usize {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let order: Value<usize> = Rc::new(RefCell::new(
            (64).wrapping_sub((({ countl_zero_380(((*size.borrow()) as u64)) }) as usize)),
        ));
        let rot: Value<usize> = Rc::new(RefCell::new(
            (({
                RotR_372(
                    ((*size.borrow()) as u64),
                    ((((*order.borrow()).wrapping_sub(3)).wrapping_add(64)).wrapping_sub(1_usize)
                        as u64),
                )
            }) as usize),
        ));
        let kIndexMask: Value<usize> = Rc::new(RefCell::new(7));
        let order_index: Value<usize> = Rc::new(RefCell::new(((*rot.borrow()) & 7)));
        let kSubIndexMask: Value<usize> = Rc::new(RefCell::new(18446744073709551600));
        let sub_order_index: Value<usize> = Rc::new(RefCell::new(
            (!(!(((*rot.borrow()) & 18446744073709551600) != 0)) as usize),
        ));
        return (((*order.borrow()).wrapping_mul(8)).wrapping_add((*order_index.borrow())))
            .wrapping_add((*sub_order_index.borrow()));
    }
    pub fn GetSize(index: u16) -> usize {
        let index: Value<u16> = Rc::new(RefCell::new(index));
        let order: Value<usize> =
            Rc::new(RefCell::new(((*index.borrow()) as usize).wrapping_div(8)));
        let order_index: Value<usize> =
            Rc::new(RefCell::new(((*index.borrow()) as usize).wrapping_rem(8)));
        let size: Value<usize> = Rc::new(RefCell::new((8 | (*order_index.borrow()))));
        (*size.borrow_mut()) <<= if ((*order.borrow()) == 0_usize) {
            0_usize
        } else {
            ((*order.borrow()).wrapping_sub(1_usize)).wrapping_sub(3)
        };
        return (*size.borrow());
    }
}
impl Clone for partition_alloc_internal_ExponentialBucketMapping {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_ExponentialBucketMapping> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_internal_ExponentialBucketMapping> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_internal_ExponentialBucketMapping {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
thread_local!(
    static kMinExponential_381: Value<usize> = Rc::new(RefCell::new(128));
);
thread_local!(
    static kMaxLinear_382: Value<usize> = Rc::new(RefCell::new(256));
);
thread_local!(
    static kExponentialIndexOffset_383: Value<usize> = Rc::new(RefCell::new(57));
);
thread_local!(
    pub static kMinBucketSize_384: Value<usize> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kMaxBucketSize_385: Value<usize> = Rc::new(RefCell::new(983040));
);
thread_local!(
    pub static kNumBuckets_386: Value<u16> = Rc::new(RefCell::new(111));
);
thread_local!();
#[derive(Default)]
pub struct partition_alloc_BucketIndexLookup {}
impl partition_alloc_BucketIndexLookup {
    pub fn GetIndexForDenserBuckets(size: usize) -> u16 {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let index_if_linear: Value<usize> = Rc::new(RefCell::new(
            ({ partition_alloc_internal_LinearBucketMapping::GetIndex((*size.borrow())) }),
        ));
        let index_if_exponential: Value<usize> = Rc::new(RefCell::new(
            ({
                let __tmp_0: Value<u64> = Rc::new(RefCell::new(
                    (({
                        partition_alloc_internal_ExponentialBucketMapping::GetIndex(
                            (*size.borrow()),
                        )
                    })
                    .wrapping_sub(57) as u64),
                ));
                let __tmp_1: Value<u64> = Rc::new(RefCell::new(((111 as usize) as u64)));
                (if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                    __tmp_0.as_pointer()
                } else {
                    __tmp_1.as_pointer()
        ...
        let index: Value<usize> = Rc::new(RefCell::new(if ((*size.borrow()) <= 256) {
            (*index_if_linear.borrow())
        } else {
            (*index_if_exponential.borrow())
        }));
        if true {
            &(0)
        } else {
            ({
                let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                    (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
                partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( ( (*index.borrow()) <= ( ( 111 as usize ) ) ) ) )   } , )  , _arg0 , )
            })
        };
        return ((*index.borrow()) as u16);
    }
    pub fn GetIndexForNeutralBuckets(size: usize) -> u16 {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let index: Value<u16> = Rc::new(RefCell::new(
            ({ partition_alloc_BucketIndexLookup::GetIndexForDenserBuckets((*size.borrow())) }),
        ));
        if ((*size.borrow()) >= 256) && ((((*index.borrow()) as i32) + 1) < (111 as i32)) {
            {
                let rhs_0 = (((*index.borrow()) as i32)
                    + (((((*index.borrow()) as i32) % 2) == 0) as i32))
                    as u16;
    ...
    pub fn GetBucketSize(index: u16) -> usize {
        let index: Value<u16> = Rc::new(RefCell::new(index));
        if true {
            &(0)
        } else {
            ({
                let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                    (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
                partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( ( ( ( (*index.borrow()) as i32 ) ) < ( ( 111 as i32 ) ) ) ) )   } , )  , _arg0 , )
            })
        };
        let kMaxLinearIndex: Value<usize> = Rc::new(RefCell::new(15));
        let size_if_linear: Value<usize> = Rc::new(RefCell::new(
            ({ partition_alloc_internal_LinearBucketMapping::GetSize((*index.borrow())) }),
        ));
        let size_if_exponential: Value<usize> = Rc::new(RefCell::new(
            ({
                partition_alloc_internal_ExponentialBucketMapping::GetSize(
                    ((((*index.borrow()) as usize).wrapping_add(57)) as u16),
                )
            }),
        ));
        return if (((*index.borrow()) as usize) <= 15) {
            (*size_if_linear.borrow())
        } else {
            (*size_if_exponential.borrow())
        };
    }
}
impl Clone for partition_alloc_BucketIndexLookup {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_BucketIndexLookup> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_BucketIndexLookup> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_BucketIndexLookup {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
thread_local!(
    pub static kAllFlags_388: Value = Rc::new(RefCell::new(255));
);
thread_local!(
    pub static kAllFlags_389: Value = Rc::new(RefCell::new(511));
);
thread_local!(
    pub static kAllFlags_390: Value = Rc::new(RefCell::new(7));
);
pub type partition_alloc_internal_AllocFlags = i32;
pub const partition_alloc_internal_AllocFlags_kNone: partition_alloc_internal_AllocFlags = 0;
pub const partition_alloc_internal_AllocFlags_kReturnNull: partition_alloc_internal_AllocFlags = 1;
pub const partition_alloc_internal_AllocFlags_kZeroFill: partition_alloc_internal_AllocFlags = 2;
pub const partition_alloc_internal_AllocFlags_kNoOverrideHooks:
    partition_alloc_internal_AllocFlags = 4;
pub const partition_alloc_internal_AllocFlags_kNoMemoryToolOverride:
    partition_alloc_internal_AllocFlags = 8;
pub const partition_alloc_internal_AllocFlags_kNoHooks: partition_alloc_internal_AllocFlags = 16;
pub const partition_alloc_internal_AllocFlags_kFastPathOrReturnNull:
    partition_alloc_internal_AllocFlags = 32;
pub const partition_alloc_internal_AllocFlags_kMemoryShouldBeTaggedForMte:
    partition_alloc_internal_AllocFlags = 64;
pub const partition_alloc_internal_AllocFlags_kAlignedAlloc: partition_alloc_internal_AllocFlags =
    128;
pub const partition_alloc_internal_AllocFlags_kMaxValue: partition_alloc_internal_AllocFlags = 128;
pub fn operator_bitand_391(
    lhs: Ptr<partition_alloc_internal_AllocFlags>,
    rhs: Ptr<partition_alloc_internal_AllocFlags>,
) -> partition_alloc_internal_AllocFlags {
    return (({
        let _lhs = ((lhs.read()) as i32);
        _lhs & ((rhs.read()) as i32)
    }) as partition_alloc_internal_AllocFlags);
}
pub fn operator_bitand_assign_392(
    lhs: Ptr<partition_alloc_internal_AllocFlags>,
    rhs: Ptr<partition_alloc_internal_AllocFlags>,
) -> Ptr<partition_alloc_internal_AllocFlags> {
    let __rhs = ({
        let _lhs: Ptr<partition_alloc_internal_AllocFlags> = (lhs).clone();
        let _rhs: Ptr<partition_alloc_internal_AllocFlags> = (rhs).clone();
        operator_bitand_391(_lhs, _rhs)
    });
    lhs.write(__rhs);
    return (lhs).clone();
}
pub fn operator_bitnot_393(
    val: Ptr<partition_alloc_internal_AllocFlags>,
) -> partition_alloc_internal_AllocFlags {
    return (({
        let _lhs = (255 as i32);
        _lhs & !((val.read()) as i32)
    }) as partition_alloc_internal_AllocFlags);
}
pub type partition_alloc_internal_FreeFlags = i32;
pub const partition_alloc_internal_FreeFlags_kNone: partition_alloc_internal_FreeFlags = 0;
pub const partition_alloc_internal_FreeFlags_kNoMemoryToolOverride:
    partition_alloc_internal_FreeFlags = 1;
pub const partition_alloc_internal_FreeFlags_kNoHooks: partition_alloc_internal_FreeFlags = 2;
pub const partition_alloc_internal_FreeFlags_kSchedulerLoopQuarantine:
    partition_alloc_internal_FreeFlags = 4;
pub const partition_alloc_internal_FreeFlags_kSchedulerLoopQuarantineForAdvancedMemorySafetyChecks: partition_alloc_internal_FreeFlags = 8;
pub const partition_alloc_internal_FreeFlags_kWithSizeHint: partition_alloc_internal_FreeFlags = 16;
pub const partition_alloc_internal_FreeFlags_kWithAlignmentHint:
    partition_alloc_internal_FreeFlags = 32;
pub const partition_alloc_internal_FreeFlags_kWithTypeIdHint: partition_alloc_internal_FreeFlags =
    64;
pub const partition_alloc_internal_FreeFlags_kAlignedFreeForMemoryTool:
    partition_alloc_internal_FreeFlags = 128;
pub const partition_alloc_internal_FreeFlags_kIntendedLeak: partition_alloc_internal_FreeFlags =
    256;
pub const partition_alloc_internal_FreeFlags_kMaxValue: partition_alloc_internal_FreeFlags = 256;
pub fn operator_bitand_394(
    lhs: Ptr<partition_alloc_internal_FreeFlags>,
    rhs: Ptr<partition_alloc_internal_FreeFlags>,
) -> partition_alloc_internal_FreeFlags {
    return (({
        let _lhs = ((lhs.read()) as i32);
        _lhs & ((rhs.read()) as i32)
    }) as partition_alloc_internal_FreeFlags);
}
pub fn operator_bitand_assign_395(
    lhs: Ptr<partition_alloc_internal_FreeFlags>,
    rhs: Ptr<partition_alloc_internal_FreeFlags>,
) -> Ptr<partition_alloc_internal_FreeFlags> {
    let __rhs = ({
        let _lhs: Ptr<partition_alloc_internal_FreeFlags> = (lhs).clone();
        let _rhs: Ptr<partition_alloc_internal_FreeFlags> = (rhs).clone();
        operator_bitand_394(_lhs, _rhs)
    });
    lhs.write(__rhs);
    return (lhs).clone();
}
pub fn operator_bitnot_396(
    val: Ptr<partition_alloc_internal_FreeFlags>,
) -> partition_alloc_internal_FreeFlags {
    return (({
        let _lhs = (511 as i32);
        _lhs & !((val.read()) as i32)
...
thread_local!(
    pub static kPartitionCachelineSize_397: Value<usize> = Rc::new(RefCell::new(128));
);
pub fn PartitionPageShift_398() -> usize {
    return ({ PageAllocationGranularityShift_341() }).wrapping_add(2_usize);
}
pub fn PartitionPageSize_399() -> usize {
    return ((1 << ({ PartitionPageShift_398() })) as usize);
}
pub fn PartitionPageBaseMask_400() -> usize {
    return !({ PartitionPageOffsetMask_401() });
}
thread_local!(
    pub static kMaxPartitionPagesPerRegularSlotSpan_402: Value<usize> = Rc::new(RefCell::new(4));
);
pub fn NumSystemPagesPerPartitionPage_403() -> usize {
    return (({ PartitionPageSize_399() }) >> ({ SystemPageShift_347() }));
}
pub fn MaxSystemPagesPerRegularSlotSpan_404() -> usize {
    return ({ NumSystemPagesPerPartitionPage_403() }).wrapping_mul(4);
}
pub fn MaxRegularSlotSpanSize_405() -> usize {
    return (4 << ({ PartitionPageShift_398() }));
}
thread_local!(
    pub static kGiB_406: Value<usize> = Rc::new(RefCell::new(1073741824));
);
thread_local!(
    pub static kSuperPageShift_407: Value<usize> = Rc::new(RefCell::new(21));
);
thread_local!(
    pub static kSuperPageSize_408: Value<usize> = Rc::new(RefCell::new(2097152));
);
thread_local!(
    pub static kSuperPageAlignment_409: Value<usize> = Rc::new(RefCell::new(2097152));
);
thread_local!(
    pub static kSuperPageOffsetMask_410: Value<usize> = Rc::new(RefCell::new(2097151));
);
thread_local!(
    pub static kSuperPageBaseMask_411: Value<usize> = Rc::new(RefCell::new(18446744073707454464));
);
thread_local!(
    pub static kNumPools_412: Value<usize> = Rc::new(RefCell::new(3));
);
pub type partition_alloc_internal_PoolHandleMask = i32;
pub const partition_alloc_internal_PoolHandleMask_kNone: partition_alloc_internal_PoolHandleMask =
    0;
pub const partition_alloc_internal_PoolHandleMask_kRegular:
    partition_alloc_internal_PoolHandleMask = 1;
pub const partition_alloc_internal_PoolHandleMask_kBRP: partition_alloc_internal_PoolHandleMask = 2;
pub const partition_alloc_internal_PoolHandleMask_kConfigurable:
    partition_alloc_internal_PoolHandleMask = 4;
pub const partition_alloc_internal_PoolHandleMask_kMaxValue:
    partition_alloc_internal_PoolHandleMask = 4;
pub fn operator_bitand_413(
    lhs: Ptr<partition_alloc_internal_PoolHandleMask>,
    rhs: Ptr<partition_alloc_internal_PoolHandleMask>,
) -> partition_alloc_internal_PoolHandleMask {
    return (({
        let _lhs = ((lhs.read()) as i32);
        _lhs & ((rhs.read()) as i32)
    }) as partition_alloc_internal_PoolHandleMask);
}
pub fn operator_bitand_assign_414(
    lhs: Ptr<partition_alloc_internal_PoolHandleMask>,
    rhs: Ptr<partition_alloc_internal_PoolHandleMask>,
) -> Ptr<partition_alloc_internal_PoolHandleMask> {
    let __rhs = ({
        let _lhs: Ptr<partition_alloc_internal_PoolHandleMask> = (lhs).clone();
        let _rhs: Ptr<partition_alloc_internal_PoolHandleMask> = (rhs).clone();
        operator_bitand_413(_lhs, _rhs)
    });
    lhs.write(__rhs);
    return (lhs).clone();
}
pub fn operator_bitnot_415(
    val: Ptr<partition_alloc_internal_PoolHandleMask>,
) -> partition_alloc_internal_PoolHandleMask {
    return (({
        let _lhs = (7 as i32);
        _lhs & !((val.read()) as i32)
...
thread_local!(
    pub static kPoolMaxSize_416: Value<usize> = Rc::new(RefCell::new(17179869184));
);
thread_local!(
    pub static kMaxSuperPagesInPool_417: Value<usize> = Rc::new(RefCell::new(8192));
);
thread_local!(
    pub static kMaxMemoryTaggingSize_418: Value<usize> = Rc::new(RefCell::new(1024));
);
pub fn NumPartitionPagesPerSuperPage_419() -> usize {
    return (2097152 >> ({ PartitionPageShift_398() }));
}
pub fn MaxSuperPagesInPool_420() -> usize {
    return 8192;
}
pub fn DirectMapAllocationGranularity_421() -> usize {
    return 2097152;
}
pub fn DirectMapAllocationGranularityShift_422() -> usize {
    return 21;
}
pub fn DirectMapAllocationGranularityOffsetMask_423() -> usize {
    return (({ DirectMapAllocationGranularity_421() }) as usize).wrapping_sub(1_usize);
}
thread_local!(
    pub static kMinDirectMappedDownsize_424: Value<usize> = Rc::new(RefCell::new(983041));
);
thread_local!(
    pub static kMaxSupportedAlignment_425: Value<usize> = Rc::new(RefCell::new(1048576));
);
pub type partition_alloc_internal_SlotSpanRingMaxSize = i16;
pub const partition_alloc_internal_SlotSpanRingMaxSize_kSmall:
    partition_alloc_internal_SlotSpanRingMaxSize = 16;
pub const partition_alloc_internal_SlotSpanRingMaxSize_kMedium:
    partition_alloc_internal_SlotSpanRingMaxSize = 128;
pub const partition_alloc_internal_SlotSpanRingMaxSize_kLarge:
    partition_alloc_internal_SlotSpanRingMaxSize = 1024;
thread_local!(
    pub static kDefaultEmptySlotSpanRingSize_426: Value<usize> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kMaxEmptySlotSpanRingSize_427: Value<usize> = Rc::new(RefCell::new(1024));
);
thread_local!(
    pub static kReasonableSizeOfUnusedPages_428: Value<usize> = Rc::new(RefCell::new(1073741824));
);
thread_local!(
    pub static kUninitializedByte_429: Value<u8> = Rc::new(RefCell::new(171));
);
thread_local!(
    pub static kFreedByte_430: Value<u8> = Rc::new(RefCell::new(205));
);
thread_local!(
    pub static kQuarantinedByte_431: Value<u8> = Rc::new(RefCell::new(239));
);
thread_local!(
    pub static kIntendedLeakQuarantineMarker_432: Value<u64> =
        Rc::new(RefCell::new(16983074194814140416));
);
thread_local!(
    pub static kIntendedLeakQuarantineMask_433: Value<u64> =
        Rc::new(RefCell::new(18446742974197923840));
);
thread_local!(
    pub static kIntendedLeakQuarantineRemainder_434: Value<u8> = Rc::new(RefCell::new(235));
);
thread_local!(
    pub static kIntendedLeakUnknownTypeId_435: Value<u32> = Rc::new(RefCell::new(0));
);
pub fn MaxAllocationSize_436() -> usize {
    return (((1_u64 << 31) as u64).wrapping_sub((2097152 as u64)) as usize);
}
thread_local!(
    pub static kThreadCacheDefaultSizeThreshold_437: Value<usize> = Rc::new(RefCell::new(512));
);
thread_local!(
    pub static kThreadCacheLargeSizeThreshold_438: Value<usize> = Rc::new(RefCell::new(32768));
);
thread_local!(
    pub static kNumPartitions_439: Value<usize> = Rc::new(RefCell::new(1));
);
pub type partition_alloc_TagViolationReportingMode = i32;
pub const partition_alloc_TagViolationReportingMode_kUndefined:
    partition_alloc_TagViolationReportingMode = 0;
pub const partition_alloc_TagViolationReportingMode_kDisabled:
    partition_alloc_TagViolationReportingMode = 1;
pub const partition_alloc_TagViolationReportingMode_kSynchronous:
    partition_alloc_TagViolationReportingMode = 2;
pub const partition_alloc_TagViolationReportingMode_kAsynchronous:
    partition_alloc_TagViolationReportingMode = 3;
thread_local!(
    pub static kMemTagGranuleSize_440: Value<u64> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kPtrTagMask_441: Value<u64> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPtrTagShift_442: Value<usize> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPtrUntagMask_443: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
pub fn TagMemoryRangeIncrement_444(ptr: AnyPtr, size: usize) -> AnyPtr {
    let ptr: Value<AnyPtr> = Rc::new(RefCell::new(ptr));
    let size: Value<usize> = Rc::new(RefCell::new(size));
    return (*ptr.borrow()).clone();
}
pub fn TagMemoryRangeIncrement_445(address: u64, size: usize) -> AnyPtr {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    let size: Value<usize> = Rc::new(RefCell::new(size));
    return ({
        TagMemoryRangeIncrement_444(
            (*address.borrow()).reinterpret_cast::<::libc::c_void>(),
            (*size.borrow()),
        )
    });
}
pub fn TagMemoryRangeRandomly_446(ptr: AnyPtr, size: usize, mask: Option<u64>) -> AnyPtr {
    let ptr: Value<AnyPtr> = Rc::new(RefCell::new(ptr));
    let size: Value<usize> = Rc::new(RefCell::new(size));
    let mask: Value<u64> = Rc::new(RefCell::new(mask.unwrap_or(0_u64)));
    return (*ptr.borrow()).clone();
}
pub fn TagMemoryRangeRandomly_447(address: u64, size: usize, mask: Option<u64>) -> AnyPtr {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    let size: Value<usize> = Rc::new(RefCell::new(size));
    let mask: Value<u64> = Rc::new(RefCell::new(mask.unwrap_or(0_u64)));
    return ({
        TagMemoryRangeRandomly_446(
            (*address.borrow()).reinterpret_cast::<::libc::c_void>(),
            (*size.borrow()),
            Some((*mask.borrow())),
        )
...
pub fn TagPtr_448(ptr: AnyPtr) -> AnyPtr {
    let ptr: Value<AnyPtr> = Rc::new(RefCell::new(ptr));
    return (*ptr.borrow()).clone();
}
pub fn TagAddr_449(address: u64) -> AnyPtr {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    return ({ TagPtr_448((*address.borrow()).reinterpret_cast::<::libc::c_void>()) });
}
pub fn UntagAddr_450(address: u64) -> u64 {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    return (*address.borrow());
}
#[derive()]
pub struct partition_alloc_SuspendTagCheckingScope {}
impl partition_alloc_SuspendTagCheckingScope {}
impl Clone for partition_alloc_SuspendTagCheckingScope {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_SuspendTagCheckingScope> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<partition_alloc_SuspendTagCheckingScope> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for partition_alloc_SuspendTagCheckingScope {
    fn default() -> Self {
        { partition_alloc_SuspendTagCheckingScope::partition_alloc_SuspendTagCheckingScope() }
    }
}
impl ByteRepr for partition_alloc_SuspendTagCheckingScope {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive()]
pub struct partition_alloc_internal_PoolOffsetLookup {
    base_address_: Value<u64>,
    base_mask_: Value<u64>,
}
impl partition_alloc_internal_PoolOffsetLookup {
    pub fn partition_alloc_internal_PoolOffsetLookup1() -> Self {
        let __this: Value<partition_alloc_internal_PoolOffsetLookup> =
            Rc::new(RefCell::new(Self {
                base_address_: Rc::new(RefCell::new(0_u64)),
                base_mask_: Rc::new(RefCell::new((-1_i32 as u64))),
            }));
        let this: Ptr<partition_alloc_internal_PoolOffsetLookup> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    fn partition_alloc_internal_PoolOffsetLookup2(base_address: u64, base_mask: u64) -> Self {
        let base_address: Value<u64> = Rc::new(RefCell::new(base_address));
        let base_mask: Value<u64> = Rc::new(RefCell::new(base_mask));
        let __this: Value<partition_alloc_internal_PoolOffsetLookup> =
            Rc::new(RefCell::new(Self {
                base_address_: Rc::new(RefCell::new((*base_address.borrow()))),
                base_mask_: Rc::new(RefCell::new((*base_mask.borrow()))),
            }));
        let this: Ptr<partition_alloc_internal_PoolOffsetLookup> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Clone for partition_alloc_internal_PoolOffsetLookup {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_PoolOffsetLookup> =
            Rc::new(RefCell::new(Self {
                base_address_: Rc::new(RefCell::new((*self.base_address_.borrow()))),
                base_mask_: Rc::new(RefCell::new((*self.base_mask_.borrow()))),
            }));
        let this: Ptr<partition_alloc_internal_PoolOffsetLookup> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for partition_alloc_internal_PoolOffsetLookup {
    fn default() -> Self {
        { partition_alloc_internal_PoolOffsetLookup::partition_alloc_internal_PoolOffsetLookup1() }
    }
}
impl ByteRepr for partition_alloc_internal_PoolOffsetLookup {
    fn byte_size() -> usize {
        16
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.base_address_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.base_mask_.borrow()).to_bytes(&mut buf[8..16]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            base_address_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[0..8]))),
            base_mask_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[8..16]))),
        }
    }
}
thread_local!(
    static kCorePoolSize_451: Value<usize> = Rc::new(RefCell::new(17179869184));
);
thread_local!(
    static kConfigurablePoolMaxSize_452: Value<usize> = Rc::new(RefCell::new(17179869184));
);
thread_local!(
    static kConfigurablePoolMinSize_453: Value<usize> = Rc::new(RefCell::new(1073741824));
);
thread_local!(
    static kCorePoolOffsetMask_454: Value<u64> = Rc::new(RefCell::new(17179869183));
);
thread_local!(
    static kCorePoolBaseMask_455: Value<u64> = Rc::new(RefCell::new(18446744056529682432));
);
thread_local!(
    static kUninitializedPoolBaseAddress_456: Value<u64> =
        Rc::new(RefCell::new(18446744073709551615));
);
thread_local!();
thread_local!();
#[derive(Default)]
pub struct partition_alloc_internal_PartitionAddressSpace_PoolInfo {
    pub handle: Value<partition_alloc_internal_pool_handle>,
    pub base: Value<u64>,
    pub base_mask: Value<u64>,
    pub offset: Value<u64>,
}
impl Clone for partition_alloc_internal_PartitionAddressSpace_PoolInfo {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_PartitionAddressSpace_PoolInfo> =
            Rc::new(RefCell::new(Self {
                handle: Rc::new(RefCell::new((*self.handle.borrow()))),
                base: Rc::new(RefCell::new((*self.base.borrow()))),
                base_mask: Rc::new(RefCell::new((*self.base_mask.borrow()))),
                offset: Rc::new(RefCell::new((*self.offset.borrow()))),
            }));
        let this: Ptr<partition_alloc_internal_PartitionAddressSpace_PoolInfo> =
            __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for partition_alloc_internal_PartitionAddressSpace_PoolInfo {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.handle.borrow()).to_bytes(&mut buf[0..4]);
        (*self.base.borrow()).to_bytes(&mut buf[8..16]);
        (*self.base_mask.borrow()).to_bytes(&mut buf[16..24]);
        (*self.offset.borrow()).to_bytes(&mut buf[24..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            handle: Rc::new(RefCell::new(
                <partition_alloc_internal_pool_handle>::from_bytes(&buf[0..4]),
            )),
            base: Rc::new(RefCell::new(<u64>::from_bytes(&buf[8..16]))),
            base_mask: Rc::new(RefCell::new(<u64>::from_bytes(&buf[16..24]))),
            offset: Rc::new(RefCell::new(<u64>::from_bytes(&buf[24..32]))),
        }
    }
}
#[derive()]
struct partition_alloc_internal_PartitionAddressSpace_PoolSetup {
    pub regular_pool_base_address_: Value<u64>,
    pub brp_pool_base_address_: Value<u64>,
    pub configurable_pool_base_address_: Value<u64>,
    pub configurable_pool_base_mask_: Value<u64>,
    pub offsets_to_metadata_: Value<Vec<i64>>,
    pub metadata_region_start_: Value<u64>,
}
impl Clone for partition_alloc_internal_PartitionAddressSpace_PoolSetup {
    fn clone(&self) -> Self {
        let __this: Value<partition_alloc_internal_PartitionAddressSpace_PoolSetup> =
            Rc::new(RefCell::new(Self {
                regular_pool_base_address_: Rc::new(RefCell::new(
                    (*self.regular_pool_base_address_.borrow()),
                )),
                brp_pool_base_address_: Rc::new(RefCell::new(
                    (*self.brp_pool_base_address_.borrow()),
                )),
                configurable_pool_base_address_: Rc::new(RefCell::new(
                    (*self.configurable_pool_base_address_.borrow()),
                )),
                configurable_pool_base_mask_: Rc::new(RefCell::new(
                    (*self.configurable_pool_base_mask_.borrow()),
                )),
                offsets_to_metadata_: Rc::new(RefCell::new(
                    (*self.offsets_to_metadata_.borrow()).clone(),
                )),
                metadata_region_start_: Rc::new(RefCell::new(
                    (*self.metadata_region_start_.borrow()),
                )),
            }));
        let this: Ptr<partition_alloc_internal_PartitionAddressSpace_PoolSetup> =
            __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for partition_alloc_internal_PartitionAddressSpace_PoolSetup {
    fn default() -> Self {
        partition_alloc_internal_PartitionAddressSpace_PoolSetup {
            regular_pool_base_address_: <Value<u64>>::default(),
            brp_pool_base_address_: <Value<u64>>::default(),
            configurable_pool_base_address_: <Value<u64>>::default(),
            configurable_pool_base_mask_: <Value<u64>>::default(),
            offsets_to_metadata_: Rc::new(RefCell::new(
                std::array::from_fn::<_, 4, _>(|_| Default::default()).to_vec(),
            )),
            metadata_region_start_: <Value<u64>>::default(),
        }
    }
}
impl ByteRepr for partition_alloc_internal_PartitionAddressSpace_PoolSetup {
    fn byte_size() -> usize {
        128
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.regular_pool_base_address_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.brp_pool_base_address_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.configurable_pool_base_address_.borrow()).to_bytes(&mut buf[16..24]);
        (*self.configurable_pool_base_mask_.borrow()).to_bytes(&mut buf[24..32]);
        (*self.offsets_to_metadata_.borrow()).to_bytes(&mut buf[32..64]);
        (*self.metadata_region_start_.borrow()).to_bytes(&mut buf[64..72]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            regular_pool_base_address_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[0..8]))),
            brp_pool_base_address_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[8..16]))),
            configurable_pool_base_address_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[16..24]))),
            configurable_pool_base_mask_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[24..32]))),
            offsets_to_metadata_: Rc::new(RefCell::new(<Vec<i64>>::from_bytes(&buf[32..64]))),
            metadata_region_start_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[64..72]))),
        }
    }
}
#[derive(Default)]
pub struct partition_alloc_internal_PartitionAddressSpace {}
impl partition_alloc_internal_PartitionAddressSpace {
    pub fn CorePoolBaseMask() -> u64 {
        return 18446744056529682432;
    }
    pub fn ConfigurablePoolMaxSize() -> usize {
        return 17179869184;
    }
    pub fn ConfigurablePoolMinSize() -> usize {
        return 1073741824;
    }
    pub fn GetZeroSegmentSize() -> usize {
        return (*zero_segment_size__458.with(Value::clone).borrow());
    }
    pub fn IsInRegularPool(address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let regular_pool_base_mask: Value<u64> = Rc::new(RefCell::new(18446744056529682432));
        return (((*address.borrow()) & 18446744056529682432)
            == (*(*setup__457.with(Value::clone).borrow())
                .regular_pool_base_address_
                .borrow()));
    }
    pub fn IsInBRPPool(address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let brp_pool_base_mask: Value<u64> = Rc::new(RefCell::new(18446744056529682432));
        return (((*address.borrow()) & 18446744056529682432)
            == (*(*setup__457.with(Value::clone).borrow())
                .brp_pool_base_address_
                .borrow()));
    }
    pub fn IsInCorePools(address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let core_pools_base_mask: Value<u64> = Rc::new(RefCell::new(18446744039349813248));
        let ret: Value<bool> = Rc::new(RefCell::new(
            (((*address.borrow()) & 18446744039349813248)
                == (*(*setup__457.with(Value::clone).borrow())
                    .regular_pool_base_address_
                    .borrow())),
        ));
        if true {
            ...
            ({
                let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                    (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
                partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( ( ( ( (*ret.borrow()) as i32 ) ) == ( ( ( ( (  { partition_alloc_internal_PartitionAddressSpace::IsInRegularPool ( (*address.borrow())  , ) } )  ) || ( (  { partition_alloc_internal_PartitionAddressSpace::IsInBRPPool ( (*address.borrow())  , ) } )  ) ) as i32 ) ) ) ) )   } , )  , _arg0 , )
            })
        };
        return (*ret.borrow());
    }
    pub fn CorePoolsSize() -> usize {
        return (({ partition_alloc_internal_PartitionAddressSpace::CorePoolSize() }) as usize)
            .wrapping_mul(2_usize);
    }
    pub fn IsInConfigurablePool(address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return (((*address.borrow())
            & (*(*setup__457.with(Value::clone).borrow())
                .configurable_pool_base_mask_
                .borrow()))
            == (*(*setup__457.with(Value::clone).borrow())
                .configurable_pool_base_address_
                .borrow()));
    }
    pub fn CorePoolSize() -> usize {
        return 17179869184;
    }
    pub fn CorePoolMaxSize() -> usize {
        return 17179869184;
    }
}
impl ByteRepr for partition_alloc_internal_PartitionAddressSpace {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub fn IsManagedByPartitionAlloc_459(address: u64) -> bool {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    return ({
        partition_alloc_internal_PartitionAddressSpace::IsInCorePools((*address.borrow()))
    }) || ({
        partition_alloc_internal_PartitionAddressSpace::IsInConfigurablePool((*address.borrow()))
    });
}
pub fn IsManagedByPartitionAllocBRPPool_460(address: u64) -> bool {
    let address: Value<u64> = Rc::new(RefCell::new(address));
    return ({ partition_alloc_internal_PartitionAddressSpace::IsInBRPPool((*address.borrow())) });
}
#[derive(Default)]
pub struct v8_PredictablePlatform {
    synthetic_time_: Value<std_atomic_unsigned_long_long_>,
    platform_: Value<Option<Value<v8_Platform>>>,
}
impl v8_PredictablePlatform {
    pub fn v8_PredictablePlatform(platform: Option<Value<v8_Platform>>) -> Self {
        let platform: Value<Option<Value<v8_Platform>>> = Rc::new(RefCell::new(platform));
        let __this: Value<v8_PredictablePlatform> = Rc::new(RefCell::new(Self {
            synthetic_time_: Rc::new(RefCell::new(
                std_atomic_unsigned_long_long_::std_atomic_unsigned_long_long_2({ 0_u64 }),
            )),
            platform_: Rc::new(RefCell::new((*platform.borrow_mut()).take())),
        }));
        let this: Ptr<v8_PredictablePlatform> = __this.as_pointer();
        (&(0));
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_Platform for v8_PredictablePlatform {
    fn GetPageAllocator(&self) -> PtrDyn<dyn v8_PageAllocator> {
        return ({ (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).GetPageAllocator() });
    }
    fn OnCriticalMemoryPressure(&self) {
        ({ (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).OnCriticalMemoryPressure() });
    }
    fn GetForegroundTaskRunner(
        &self,
        isolate: Ptr<v8_Isolate>,
        priority: v8_TaskPriority,
    ) -> std_shared_ptr_v8_TaskRunner_ {
        ...
        let priority: Value<v8_TaskPriority> = Rc::new(RefCell::new(priority));
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow())
                .GetForegroundTaskRunner_pmutv8_Isolate_v8_TaskPriority(
                    (*isolate.borrow()).clone(),
                    (*priority.borrow()),
                )
        });
    ...
    fn NumberOfWorkerThreads(&self) -> i32 {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).NumberOfWorkerThreads()
        });
    }
    fn PostTaskOnWorkerThreadImpl(
        &self,
        ...
        let task: Value<Option<Value<v8_Task>>> = Rc::new(RefCell::new(task));
        ({
            v8_TaskRunnerImpl::PostTask(
                &Rc::new(RefCell::new(
                    ({
                        (*(*self.platform_.borrow()).as_ref().unwrap().borrow())
                            .GetForegroundTaskRunner_pmutv8_Isolate_v8_TaskPriority(
                                (*kProcessGlobalPredictablePlatformWorkerTaskQueue_0
                                    .with(Value::clone)
                                    .borrow())
                                .clone(),
                                (*priority.borrow()),
    ...
    fn CreateJobImpl(
        ...
        let job_task: Value<Option<Value<v8_JobTask>>> = Rc::new(RefCell::new(job_task));
        return ({
            let _platform: PtrDyn<dyn v8_Platform> =
                ((*self).to_strong() as Value<dyn v8_Platform>).as_pointer_dyn();
            let _num_worker_threads: usize = (({ self.NumberOfWorkerThreads() }) as usize);
            NewDefaultJobHandle_461(
                _platform,
                (*priority.borrow()),
                (*job_task.borrow_mut()).take(),
                _num_worker_threads,
    ...
    fn MonotonicallyIncreasingTime(&self) -> f64 {
        let synthetic_time: Value<u64> = Rc::new(RefCell::new(
            ({ (*self.synthetic_time_.borrow()).fetch_add_u64(1_u64, Some(0)) }),
        ));
        return (1.0E-5 * ((*synthetic_time.borrow()) as f64));
    }
    fn CurrentClockTimeMillis(&self) -> f64 {
        return (({ self.MonotonicallyIncreasingTime() }) * (1000 as f64));
    }
    fn GetTracingController(&self) -> Ptr<v8_TracingController> {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).GetTracingController()
        });
    }
    fn GetThreadIsolatedAllocator(&self) -> PtrDyn<dyn v8_ThreadIsolatedAllocator> {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).GetThreadIsolatedAllocator()
        });
    }
    fn GetZeroSegmentSize(&self) -> usize {
        return ({ partition_alloc_internal_PartitionAddressSpace::GetZeroSegmentSize() });
    }
}
impl ByteRepr for v8_PredictablePlatform {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.synthetic_time_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.platform_.borrow()).to_bytes(&mut buf[16..24]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            synthetic_time_: Rc::new(RefCell::new(<std_atomic_unsigned_long_long_>::from_bytes(
                &buf[8..16],
            ))),
            platform_: Rc::new(RefCell::new(<Option<Value<v8_Platform>>>::from_bytes(
                &buf[16..24],
            ))),
        }
    }
}
pub fn MakePredictablePlatform_462(
    platform: Option<Value<v8_Platform>>,
) -> Option<Value<v8_Platform>> {
    let platform: Value<Option<Value<v8_Platform>>> = Rc::new(RefCell::new(platform));
    return Some(Rc::new(RefCell::new((*platform.borrow()).clone())));
}
#[derive(Default)]
struct v8_DelayedTasksPlatform_DelayedTaskRunner {
    task_runner_: Value<std_shared_ptr_v8_TaskRunner_>,
    platform_: Value<Ptr<v8_DelayedTasksPlatform>>,
}
impl v8_DelayedTasksPlatform_DelayedTaskRunner {
    pub fn v8_DelayedTasksPlatform_DelayedTaskRunner(
        task_runner: std_shared_ptr_v8_TaskRunner_,
        platform: Ptr<v8_DelayedTasksPlatform>,
    ) -> Self {
        let task_runner: Value<std_shared_ptr_v8_TaskRunner_> = Rc::new(RefCell::new(task_runner));
        let platform: Value<Ptr<v8_DelayedTasksPlatform>> = Rc::new(RefCell::new(platform));
        let __this: Value<v8_DelayedTasksPlatform_DelayedTaskRunner> =
            Rc::new(RefCell::new(Self {
                task_runner_: Rc::new(RefCell::new((*task_runner.borrow()).clone())),
                platform_: Rc::new(RefCell::new((*platform.borrow()).clone())),
            }));
        let this: Ptr<v8_DelayedTasksPlatform_DelayedTaskRunner> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_TaskRunner for v8_DelayedTasksPlatform_DelayedTaskRunner {
    fn IdleTasksEnabled(&self) -> bool {
        return ({ ((*self.task_runner_.borrow()).read()).IdleTasksEnabled() });
    }
    fn NonNestableTasksEnabled(&self) -> bool {
        return ({
            (*((*self.task_runner_.borrow()).read()).upgrade().deref()).NonNestableTasksEnabled()
        });
    }
    fn PostTaskImpl(&self, task: Option<Value<v8_Task>>, location: Ptr<v8_SourceLocation>) {
        let task: Value<Option<Value<v8_Task>>> = Rc::new(RefCell::new(task));
        ({
            let _task: Option<Value<v8_Task>> = ({
                v8_DelayedTasksPlatformImpl::MakeDelayedTask(
                    &(*self.platform_.borrow()),
                    (*task.borrow_mut()).take(),
                )
            });
            let _location: v8_SourceLocation = (*location.upgrade().deref()).clone();
            v8_TaskRunnerImpl::PostTask(&self.task_runner_.as_pointer(), _task, Some(_location))
        });
    }
    fn PostNonNestableTaskImpl(
        &self,
    ...
    fn PostDelayedTaskImpl(
        ...
        ({
            ...
            let _delay_in_seconds: f64 = (*delay_in_seconds.borrow());
            let _location: v8_SourceLocation = (*location.upgrade().deref()).clone();
            v8_TaskRunnerImpl::PostDelayedTask(
                &self.task_runner_.as_pointer(),
                _task,
                _delay_in_seconds,
                Some(_location),
    ...
    fn PostIdleTaskImpl(&self, task: Option<Value<v8_IdleTask>>, location: Ptr<v8_SourceLocation>) {
        let task: Value<Option<Value<v8_IdleTask>>> = Rc::new(RefCell::new(task));
        ({
            let _task: Option<Value<v8_IdleTask>> = ({
                v8_DelayedTasksPlatformImpl::MakeDelayedIdleTask(
                    &(*self.platform_.borrow()),
                    (*task.borrow_mut()).take(),
                )
            });
            let _location: v8_SourceLocation = (*location.upgrade().deref()).clone();
            v8_TaskRunnerImpl::PostIdleTask(&self.task_runner_.as_pointer(), _task, Some(_location))
        });
    }
}
impl ByteRepr for v8_DelayedTasksPlatform_DelayedTaskRunner {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.task_runner_.borrow()).to_bytes(&mut buf[8..24]);
        (*self.platform_.borrow()).to_bytes(&mut buf[24..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            task_runner_: Rc::new(RefCell::new(<std_shared_ptr_v8_TaskRunner_>::from_bytes(
                &buf[8..24],
            ))),
            platform_: Rc::new(RefCell::new(<Ptr<v8_DelayedTasksPlatform>>::from_bytes(
                &buf[24..32],
            ))),
        }
    }
...
#[derive(Default)]
struct v8_DelayedTasksPlatform_DelayedTask {
    task_: Value<Option<Value<v8_Task>>>,
    delay_ms_: Value<i32>,
}
impl v8_DelayedTasksPlatform_DelayedTask {
    pub fn v8_DelayedTasksPlatform_DelayedTask(
        task: Option<Value<v8_Task>>,
        delay_ms: i32,
    ) -> Self {
        let task: Value<Option<Value<v8_Task>>> = Rc::new(RefCell::new(task));
        let delay_ms: Value<i32> = Rc::new(RefCell::new(delay_ms));
        let __this: Value<v8_DelayedTasksPlatform_DelayedTask> = Rc::new(RefCell::new(Self {
            task_: Rc::new(RefCell::new((*task.borrow_mut()).take())),
            delay_ms_: Rc::new(RefCell::new((*delay_ms.borrow()))),
        }));
        let this: Ptr<v8_DelayedTasksPlatform_DelayedTask> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_Task for v8_DelayedTasksPlatform_DelayedTask {
    fn Run(&self) {
        ({
            v8_base_OS::Sleep(
                ({ v8_base_TimeDelta::FromMicroseconds(((*self.delay_ms_.borrow()) as i64)) }),
            )
        });
        ({ (*(*self.task_.borrow()).as_ref().unwrap().borrow()).Run() });
    }
}
impl ByteRepr for v8_DelayedTasksPlatform_DelayedTask {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.task_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.delay_ms_.borrow()).to_bytes(&mut buf[16..20]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            task_: Rc::new(RefCell::new(<Option<Value<v8_Task>>>::from_bytes(
                &buf[8..16],
            ))),
            delay_ms_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[16..20]))),
        }
    }
}
#[derive(Default)]
struct v8_DelayedTasksPlatform_DelayedIdleTask {
    task_: Value<Option<Value<v8_IdleTask>>>,
    delay_ms_: Value<i32>,
}
impl v8_DelayedTasksPlatform_DelayedIdleTask {
    pub fn v8_DelayedTasksPlatform_DelayedIdleTask(
        task: Option<Value<v8_IdleTask>>,
        delay_ms: i32,
    ) -> Self {
        let task: Value<Option<Value<v8_IdleTask>>> = Rc::new(RefCell::new(task));
        let delay_ms: Value<i32> = Rc::new(RefCell::new(delay_ms));
        let __this: Value<v8_DelayedTasksPlatform_DelayedIdleTask> = Rc::new(RefCell::new(Self {
            task_: Rc::new(RefCell::new((*task.borrow_mut()).take())),
            delay_ms_: Rc::new(RefCell::new((*delay_ms.borrow()))),
        }));
        let this: Ptr<v8_DelayedTasksPlatform_DelayedIdleTask> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_IdleTask for v8_DelayedTasksPlatform_DelayedIdleTask {
    fn Run(&self, deadline_in_seconds: f64) {
        let deadline_in_seconds: Value<f64> = Rc::new(RefCell::new(deadline_in_seconds));
        ({
            v8_base_OS::Sleep(
                ({ v8_base_TimeDelta::FromMicroseconds(((*self.delay_ms_.borrow()) as i64)) }),
            )
        ...
        ({
            (*(*self.task_.borrow()).as_ref().unwrap().borrow())
                .Run((*deadline_in_seconds.borrow()))
        });
    }
}
impl ByteRepr for v8_DelayedTasksPlatform_DelayedIdleTask {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
    ...
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            task_: Rc::new(RefCell::new(<Option<Value<v8_IdleTask>>>::from_bytes(
                &buf[8..16],
            ))),
            delay_ms_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[16..20]))),
        }
...
#[derive(Default)]
struct v8_DelayedTasksPlatform_DelayedJob {
    job_task_: Value<Option<Value<v8_JobTask>>>,
    delay_ms_: Value<i32>,
}
impl v8_DelayedTasksPlatform_DelayedJob {
    pub fn v8_DelayedTasksPlatform_DelayedJob(
        job_task: Option<Value<v8_JobTask>>,
        delay_ms: i32,
    ) -> Self {
        let job_task: Value<Option<Value<v8_JobTask>>> = Rc::new(RefCell::new(job_task));
        let delay_ms: Value<i32> = Rc::new(RefCell::new(delay_ms));
        let __this: Value<v8_DelayedTasksPlatform_DelayedJob> = Rc::new(RefCell::new(Self {
            job_task_: Rc::new(RefCell::new((*job_task.borrow_mut()).take())),
            delay_ms_: Rc::new(RefCell::new((*delay_ms.borrow()))),
        }));
        let this: Ptr<v8_DelayedTasksPlatform_DelayedJob> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_JobTask for v8_DelayedTasksPlatform_DelayedJob {
    fn Run(&self, delegate: PtrDyn<dyn v8_JobDelegate>) {
        let delegate: Value<PtrDyn<dyn v8_JobDelegate>> = Rc::new(RefCell::new(delegate));
        ({
            v8_base_OS::Sleep(
                ({ v8_base_TimeDelta::FromMicroseconds(((*self.delay_ms_.borrow()) as i64)) }),
            )
        ...
        ({
            (*(*self.job_task_.borrow()).as_ref().unwrap().borrow())
                .Run((*delegate.borrow()).clone())
        });
    }
    fn GetMaxConcurrency(&self, worker_count: usize) -> usize {
        let worker_count: Value<usize> = Rc::new(RefCell::new(worker_count));
        return ({
            (*(*(*self.job_task_.borrow()).as_ref().unwrap().borrow())
                .upgrade()
                .deref())
            .GetMaxConcurrency((*worker_count.borrow()))
        });
    }
}
impl ByteRepr for v8_DelayedTasksPlatform_DelayedJob {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.job_task_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.delay_ms_.borrow()).to_bytes(&mut buf[16..20]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            job_task_: Rc::new(RefCell::new(<Option<Value<v8_JobTask>>>::from_bytes(
                &buf[8..16],
            ))),
            delay_ms_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[16..20]))),
        }
...
#[derive(Default)]
pub struct v8_DelayedTasksPlatform {  platform_ : Value<Option<Value<v8_Platform>> > ,  mutex_ : Value<v8_base_Mutex > ,  rng_ : Value<v8_base_RandomNumberGenerator > ,  delayed_task_runners_ : Value<std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____ > , }
impl v8_DelayedTasksPlatform {
    pub fn v8_DelayedTasksPlatform1(platform: Option<Value<v8_Platform>>) -> Self {
        let platform: Value<Option<Value<v8_Platform>>> = Rc::new(RefCell::new(platform));
        let __this : Value<v8_DelayedTasksPlatform> = Rc::new(RefCell::new(Self { platform_ : Rc::new(RefCell::new((*platform.borrow_mut()) .take() )) , mutex_ : Rc::new(RefCell::new(v8_base_Mutex :: v8_base_Mutex ( ) )) , rng_ : Rc::new(RefCell::new(v8_base_RandomNumberGenerator :: v8_base_RandomNumberGenerator2 ( ) )) , delayed_task_runners_ : Rc::new(RefCell::new(std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____ :: std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____1 ( ) )) , } )) ;
        let this: Ptr<v8_DelayedTasksPlatform> = __this.as_pointer();
        (&(0));
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    pub fn v8_DelayedTasksPlatform2(
        platform: Option<Value<v8_Platform>>,
        random_seed: i64,
    ) -> Self {
        let platform: Value<Option<Value<v8_Platform>>> = Rc::new(RefCell::new(platform));
        let random_seed: Value<i64> = Rc::new(RefCell::new(random_seed));
        let __this : Value<v8_DelayedTasksPlatform> = Rc::new(RefCell::new(Self { platform_ : Rc::new(RefCell::new((*platform.borrow_mut()) .take() )) , mutex_ : Rc::new(RefCell::new(v8_base_Mutex :: v8_base_Mutex ( ) )) , rng_ : Rc::new(RefCell::new(v8_base_RandomNumberGenerator :: v8_base_RandomNumberGenerator1 ( {  (*random_seed.borrow())   } , ) )) , delayed_task_runners_ : Rc::new(RefCell::new(std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____ :: std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____1 ( ) )) , } )) ;
        let this: Ptr<v8_DelayedTasksPlatform> = __this.as_pointer();
        (&(0));
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl v8_Platform for v8_DelayedTasksPlatform {
    fn GetPageAllocator(&self) -> PtrDyn<dyn v8_PageAllocator> {
        return ({ (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).GetPageAllocator() });
    }
    fn OnCriticalMemoryPressure(&self) {
    ...
    fn GetForegroundTaskRunner(
        ...
        let isolate: Value<Ptr<v8_Isolate>> = Rc::new(RefCell::new(isolate));
        let priority: Value<v8_TaskPriority> = Rc::new(RefCell::new(priority));
        let runner: Value<std_shared_ptr_v8_TaskRunner_> = Rc::new(RefCell::new(
            ({
                (*(*self.platform_.borrow()).as_ref().unwrap().borrow())
                    .GetForegroundTaskRunner_pmutv8_Isolate_v8_TaskPriority(
                        (*isolate.borrow()).clone(),
        ...
        let lock_guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
                (self.mutex_.as_pointer())
            }),
        ));
        let _dtor_lock_guard = ScopedDestructor::new(&lock_guard, |__p| __p.destructor());
        let weak_delayed_runner : Ptr< std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner_  > = (self . delayed_task_runners_  .as_pointer()  as Ptr<std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____  >).offset((  { (*runner.borrow()) . get ( ) } )  )  ;
        let delayed_runner: Value<std_shared_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner_> =
            Rc::new(RefCell::new(
                ({ (*weak_delayed_runner.upgrade().deref()).lock() }),
            ));
        if !({ (*delayed_runner.borrow())() }) {
            (*delayed_runner.borrow_mut()) = ({
                let ___args: Value<Ptr<v8_DelayedTasksPlatform>> = Rc::new(RefCell::new((*self)));
                make_shared_466(runner.as_pointer(), ___args.as_pointer())
            });
            let __rhs = (*delayed_runner.borrow()).clone();
            weak_delayed_runner.write(__rhs);
        }
        return (*delayed_runner.borrow_mut()).clone();
    }
    fn NumberOfWorkerThreads(&self) -> i32 {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).NumberOfWorkerThreads()
    ...
    fn PostTaskOnWorkerThreadImpl(
        ...
        let task: Value<Option<Value<v8_Task>>> = Rc::new(RefCell::new(task));
        ({
            let _priority: v8_TaskPriority = (*priority.borrow());
            let _task: Option<Value<v8_Task>> = ({
                v8_DelayedTasksPlatformImpl::MakeDelayedTask(&(*self), (*task.borrow_mut()).take())
            });
            let _location: v8_SourceLocation = (*location.upgrade().deref()).clone();
            v8_PlatformImpl::PostTaskOnWorkerThread(
                &(*self.platform_.borrow()).as_pointer(),
                _priority,
                _task,
                Some(_location),
            )
    ...
    fn PostDelayedTaskOnWorkerThreadImpl(
        ...
        ({
            ...
            let _delay_in_seconds: f64 = (*delay_in_seconds.borrow());
            let _location: v8_SourceLocation = (*location.upgrade().deref()).clone();
            v8_PlatformImpl::PostDelayedTaskOnWorkerThread(
                &(*self.platform_.borrow()).as_pointer(),
                _priority,
                _task,
                _delay_in_seconds,
    ...
    fn IdleTasksEnabled(&self, isolate: Ptr<v8_Isolate>) -> bool {
        ...
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow())
                .IdleTasksEnabled((*isolate.borrow()).clone())
        });
    }
    fn CreateJobImpl(
        &self,
        ...
        return ({
            let _priority: v8_TaskPriority = (*priority.borrow());
            let _job_task: Option<Value<v8_JobTask>> = ({
                v8_DelayedTasksPlatformImpl::MakeDelayedJob(
                    &(*self),
                    (*job_task.borrow_mut()).take(),
                )
            });
    ...
    fn MonotonicallyIncreasingTime(&self) -> f64 {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).MonotonicallyIncreasingTime()
        });
    }
    fn CurrentClockTimeMillis(&self) -> f64 {
        return ({
            (*(*self.platform_.borrow()).as_ref().unwrap().borrow()).CurrentClockTimeMillis()
        });
    }
    fn GetTracingController(&self) -> Ptr<v8_TracingController> {
        return ({
...
impl ByteRepr for v8_DelayedTasksPlatform {
    fn byte_size() -> usize {
        88
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.platform_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.mutex_.borrow()).to_bytes(&mut buf[16..24]);
        (*self.rng_.borrow()).to_bytes(&mut buf[24..48]);
        (*self.delayed_task_runners_.borrow()).to_bytes(&mut buf[48..88]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self { platform_: Rc::new(RefCell::new(<Option<Value<v8_Platform>> >::from_bytes(&buf[8..16]))), mutex_: Rc::new(RefCell::new(<v8_base_Mutex >::from_bytes(&buf[16..24]))), rng_: Rc::new(RefCell::new(<v8_base_RandomNumberGenerator >::from_bytes(&buf[24..48]))), delayed_task_runners_: Rc::new(RefCell::new(<std_unordered_map_v8_TaskRunner_ptr__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner___std_hash_v8_TaskRunner_ptr___std_equal_to_v8_TaskRunner_ptr___std_allocator_std_pair_v8_TaskRunner_ptrconst__std_weak_ptr_v8_DelayedTasksPlatform_DelayedTaskRunner____ >::from_bytes(&buf[48..88]))), }
    }
}
pub fn MakeDelayedTasksPlatform_467(
    platform: Option<Value<v8_Platform>>,
    random_seed: i64,
) -> Option<Value<v8_Platform>> {
    let platform: Value<Option<Value<v8_Platform>>> = Rc::new(RefCell::new(platform));
    let random_seed: Value<i64> = Rc::new(RefCell::new(random_seed));
    if ((*random_seed.borrow()) != 0) {
        return ({ make_unique_468(platform.as_pointer(), random_seed.as_pointer()) });
    }
    return Some(Rc::new(RefCell::new((*platform.borrow()).clone())));
}
...
pub trait partition_alloc_internal_PoolOffsetLookupImpl {
    fn GetOffset(&self, address: u64) -> u64;
    fn GetTaggedOffset(&self, ptr: AnyPtr) -> u64;
    fn GetPointer(&self, tagged_offset: u64) -> AnyPtr;
    fn Includes(&self, address: u64) -> bool;
    fn IsValidTaggedOffset(&self, tagged_offset: u64) -> bool;
}
impl partition_alloc_internal_PoolOffsetLookupImpl
    for Ptr<partition_alloc_internal_PoolOffsetLookup>
{
    fn GetOffset(&self, address: u64) -> u64 {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        if true {
            ...
            ({
                let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                    (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
                partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( (  { partition_alloc_internal_PoolOffsetLookupImpl :: Includes ( self , (*address.borrow())  , ) } )  ) )   } , )  , _arg0 , )
            })
        };
        return ((*address.borrow()) & !(*(*(*self).upgrade().deref()).base_mask_.borrow()));
    }
    fn GetTaggedOffset(&self, ptr: AnyPtr) -> u64 {
        let ptr: Value<AnyPtr> = Rc::new(RefCell::new(ptr));
        let address: Value<u64> = Rc::new(RefCell::new((*ptr.borrow()).to_int()));
        if true {
            &(0)
        } else {
            ({
        ...
        return ((*address.borrow()) & (0 | !(*(*(*self).upgrade().deref()).base_mask_.borrow())));
    }
    fn GetPointer(&self, tagged_offset: u64) -> AnyPtr {
        let tagged_offset: Value<u64> = Rc::new(RefCell::new(tagged_offset));
        if true {
            &(0)
        } else {
            ({
                let _arg0: Ptr<partition_alloc_internal_base_strings_CStringBuilder> =
                    (*g_swallow_stream_362.with(Value::clone).borrow()).clone();
                partition_alloc_internal_logging_VoidifyStreamImpl :: operator_bitand ( &partition_alloc_internal_logging_VoidifyStream :: partition_alloc_internal_logging_VoidifyStream1 ( {  ! ( ( (  { partition_alloc_internal_PoolOffsetLookupImpl :: IsValidTaggedOffset ( self , (*tagged_offset.borrow())  , ) } )  ) )   } , )  , _arg0 , )
            })
        };
        return ((*(*(*self).upgrade().deref()).base_address_.borrow())
            | (*tagged_offset.borrow()))
        .reinterpret_cast::<::libc::c_void>();
    }
    fn Includes(&self, address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return ((({ UntagAddr_450((*address.borrow())) })
            & (*(*(*self).upgrade().deref()).base_mask_.borrow()))
            == (*(*(*self).upgrade().deref()).base_address_.borrow()));
    }
    fn IsValidTaggedOffset(&self, tagged_offset: u64) -> bool {
        let tagged_offset: Value<u64> = Rc::new(RefCell::new(tagged_offset));
        return !((((*tagged_offset.borrow())
            & (*(*(*self).upgrade().deref()).base_mask_.borrow()))
            & !0)
            != 0);
    }
}
pub trait partition_alloc_internal_base_ScopedClearLastErrorBaseImpl {
    fn destructor(&self);
}
impl partition_alloc_internal_base_ScopedClearLastErrorBaseImpl
    for Ptr<partition_alloc_internal_base_ScopedClearLastErrorBase>
{
    fn destructor(&self) {
        cpp2rust_errno().write((*(*(*self).upgrade().deref()).last_errno_.borrow()));
    }
}
pub trait partition_alloc_internal_logging_CheckErrorImpl {
    fn destructor(&self);
}
impl partition_alloc_internal_logging_CheckErrorImpl
    for Ptr<partition_alloc_internal_logging_CheckError>
{
    fn destructor(&self) {
        (*self.upgrade().deref()).anon_363.as_pointer().destructor();
    }
}
pub trait partition_alloc_internal_logging_LogMessageImpl {
    fn stream(&self) -> Ptr<partition_alloc_internal_base_strings_CStringBuilder>;
    fn severity(&self) -> i32;
    fn c_str(&self) -> Ptr<u8>;
    fn destructor(&self);
}
impl partition_alloc_internal_logging_LogMessageImpl
    for Ptr<partition_alloc_internal_logging_LogMessage>
{
    fn stream(&self) -> Ptr<partition_alloc_internal_base_strings_CStringBuilder> {
        return (*(*self).upgrade().deref()).stream_.as_pointer();
    }
    fn severity(&self) -> i32 {
        return (*(*(*self).upgrade().deref()).severity_.borrow());
    }
    fn c_str(&self) -> Ptr<u8> {
        return ({
            partition_alloc_internal_base_strings_CStringBuilderImpl::c_str(
                &(*(*self).upgrade().deref()).stream_.as_pointer(),
            )
        });
    }
    fn destructor(&self) {
...
pub trait partition_alloc_internal_logging_LogMessageVoidifyImpl {
    fn operator_bitand(&self, _a0: Ptr<partition_alloc_internal_base_strings_CStringBuilder>);
}
impl partition_alloc_internal_logging_LogMessageVoidifyImpl
    for Ptr<partition_alloc_internal_logging_LogMessageVoidify>
{
    fn operator_bitand(&self, _a0: Ptr<partition_alloc_internal_base_strings_CStringBuilder>) {}
}
pub trait partition_alloc_internal_logging_VoidifyStreamImpl {
    fn operator_bitand(&self, _a0: Ptr<partition_alloc_internal_base_strings_CStringBuilder>);
}
impl partition_alloc_internal_logging_VoidifyStreamImpl
    for Ptr<partition_alloc_internal_logging_VoidifyStream>
{
    fn operator_bitand(&self, _a0: Ptr<partition_alloc_internal_base_strings_CStringBuilder>) {}
}
pub trait v8_DelayedTasksPlatformImpl {
    fn GetRandomDelayInMilliseconds(&self) -> i32;
    fn MakeDelayedTask(&self, task: Option<Value<v8_Task>>) -> Option<Value<v8_Task>>;
    fn MakeDelayedIdleTask(&self, task: Option<Value<v8_IdleTask>>) -> Option<Value<v8_IdleTask>>;
    fn MakeDelayedJob(&self, task: Option<Value<v8_JobTask>>) -> Option<Value<v8_JobTask>>;
}
impl v8_DelayedTasksPlatformImpl for Ptr<v8_DelayedTasksPlatform> {
    fn GetRandomDelayInMilliseconds(&self) -> i32 {
        let lock_guard: Value<v8_base_LockGuard_v8_base_Mutex_> = Rc::new(RefCell::new(
            v8_base_LockGuard_v8_base_Mutex_::v8_base_LockGuard_v8_base_Mutex_1({
                ((*(*self).upgrade().deref()).mutex_.as_pointer())
            }),
        ));
        let _dtor_lock_guard = ScopedDestructor::new(&lock_guard, |__p| __p.destructor());
        let delay_fraction: Value<f64> = Rc::new(RefCell::new(
            ({
                v8_base_RandomNumberGeneratorImpl::NextDouble(
                    &(*(*self).upgrade().deref()).rng_.as_pointer(),
                )
            }),
        ));
        return ((1.0E+5 * ((*delay_fraction.borrow()) * (*delay_fraction.borrow()))) as i32);
    }
    fn MakeDelayedTask(&self, task: Option<Value<v8_Task>>) -> Option<Value<v8_Task>> {
        let task: Value<Option<Value<v8_Task>>> = Rc::new(RefCell::new(task));
        return ({
            let ___args: Value<i32> = Rc::new(RefCell::new(
                ({ v8_DelayedTasksPlatformImpl::GetRandomDelayInMilliseconds(self) }),
            ));
            make_unique_463(task.as_pointer(), ___args.as_pointer())
        });
    }
    fn MakeDelayedIdleTask(&self, task: Option<Value<v8_IdleTask>>) -> Option<Value<v8_IdleTask>> {
        let task: Value<Option<Value<v8_IdleTask>>> = Rc::new(RefCell::new(task));
        return ({
            ...
            make_unique_464(task.as_pointer(), ___args.as_pointer())
        });
    }
    fn MakeDelayedJob(&self, task: Option<Value<v8_JobTask>>) -> Option<Value<v8_JobTask>> {
        let task: Value<Option<Value<v8_JobTask>>> = Rc::new(RefCell::new(task));
        return ({
            let ___args: Value<i32> = Rc::new(RefCell::new(
                ({ v8_DelayedTasksPlatformImpl::GetRandomDelayInMilliseconds(self) }),
            ));
            make_unique_465(task.as_pointer(), ___args.as_pointer())
        });
    }
}
pub trait v8_PredictablePlatformImpl {
    fn platform(&self) -> PtrDyn<dyn v8_Platform>;
}
impl v8_PredictablePlatformImpl for Ptr<v8_PredictablePlatform> {
    fn platform(&self) -> PtrDyn<dyn v8_Platform> {
...
pub trait v8_base_RandomNumberGeneratorImpl {
    fn NextInt(&self) -> i32;
    fn NextBool(&self) -> bool;
    fn initial_seed(&self) -> i64;
    fn operator_call(&self) -> u32;
}
impl v8_base_RandomNumberGeneratorImpl for Ptr<v8_base_RandomNumberGenerator> {
    fn NextInt(&self) -> i32 {
        return ({ v8_base_RandomNumberGeneratorImpl::Next(self, 32) });
    }
    fn NextBool(&self) -> bool {
        return (({ v8_base_RandomNumberGeneratorImpl::Next(self, 1) }) != 0);
    }
    fn initial_seed(&self) -> i64 {
        return (*(*(*self).upgrade().deref()).initial_seed_.borrow());
    }
    fn operator_call(&self) -> u32 {
        return (({ v8_base_RandomNumberGeneratorImpl::NextInt(self) }) as u32);
    }
}
...
impl v8_platform_tracing_TraceBufferChunkImpl for Ptr<v8_platform_tracing_TraceBufferChunk> {
    fn IsFull(&self) -> bool {
        return ((*(*(*self).upgrade().deref()).next_free_.borrow())
            == (*kChunkSize_12.with(Value::clone).borrow()));
    }
    fn GetEventAt(&self, index: usize) -> Ptr<v8_platform_tracing_TraceObject> {
