...
pub fn CmpLEImpl_16(lhs: i32, rhs: i32) -> bool {
...
thread_local!(
    static kInvalidId_21: Value<i32> = Rc::new(RefCell::new(-1));
);
#[derive()]
pub struct v8_internal_ThreadId {
    id_: Value<i32>,
}
impl v8_internal_ThreadId {
    pub fn v8_internal_ThreadId1() -> Self {
        let __this: Value<v8_internal_ThreadId> = Rc::new(RefCell::new(Self {
            id_: <Value<i32>>::default(),
        }));
        let this: Ptr<v8_internal_ThreadId> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    pub fn Current() -> v8_internal_ThreadId {
        return v8_internal_ThreadId::v8_internal_ThreadId2({
            ({ v8_internal_ThreadId::GetCurrentThreadId() })
        });
    }
    pub fn Invalid() -> v8_internal_ThreadId {
        return v8_internal_ThreadId::v8_internal_ThreadId2({ -1 });
    }
    pub fn FromInteger(id: i32) -> v8_internal_ThreadId {
        let id: Value<i32> = Rc::new(RefCell::new(id));
        return v8_internal_ThreadId::v8_internal_ThreadId2({ (*id.borrow()) });
    }
    fn v8_internal_ThreadId2(id: i32) -> Self {
        let id: Value<i32> = Rc::new(RefCell::new(id));
        let __this: Value<v8_internal_ThreadId> = Rc::new(RefCell::new(Self {
            id_: Rc::new(RefCell::new((*id.borrow()))),
        }));
        let this: Ptr<v8_internal_ThreadId> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl std::cmp::PartialEq for v8_internal_ThreadId {
    fn eq(&self, other: &Self) -> bool {
        {
            v8_internal_ThreadIdImpl::operator_eq(
                &Rc::new(RefCell::new(v8_internal_ThreadId {
                    id_: self.id_.clone(),
                }))
                .as_pointer(),
                Rc::new(RefCell::new(v8_internal_ThreadId {
...
impl std::cmp::Eq for v8_internal_ThreadId {}
impl Clone for v8_internal_ThreadId {
    fn clone(&self) -> Self {
        let __this: Value<v8_internal_ThreadId> = Rc::new(RefCell::new(Self {
            id_: Rc::new(RefCell::new((*self.id_.borrow()))),
        }));
        let this: Ptr<v8_internal_ThreadId> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Default for v8_internal_ThreadId {
    fn default() -> Self {
        { v8_internal_ThreadId::v8_internal_ThreadId1() }
    }
}
impl ByteRepr for v8_internal_ThreadId {
    fn byte_size() -> usize {
        4
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.id_.borrow()).to_bytes(&mut buf[0..4]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            id_: Rc::new(RefCell::new(<i32>::from_bytes(&buf[0..4]))),
        }
    }
}
pub type anon_22 = u8;
pub const anon_22_ONCE_STATE_UNINITIALIZED: anon_22 = 0;
pub const anon_22_ONCE_STATE_EXECUTING_FUNCTION: anon_22 = 1;
pub const anon_22_ONCE_STATE_DONE: anon_22 = 2;
pub fn CallOnce_23(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_22_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_24((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
pub fn SharedMemoryHandleFromMachMemoryEntry_25(handle: u32) -> v8_SharedMemoryHandle {
    let handle: Value<u32> = Rc::new(RefCell::new(handle));
    return ({ v8_SharedMemoryHandle::FromPlatformHandle((*handle.borrow())) });
}
pub fn MachMemoryEntryFromSharedMemoryHandle_26(handle: v8_SharedMemoryHandle) -> u32 {
...
thread_local!(
    pub static kInvalidSharedMemoryHandle_27: Value<std_optional_v8_SharedMemoryHandle_> =
        Rc::new(RefCell::new(
            std_optional_v8_SharedMemoryHandle_::std_optional_v8_SharedMemoryHandle_1({
                (*nullopt_28.with(Value::clone).borrow()).clone()
            }),
        ));
);
...
pub fn operator_bitor_29(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> v8_PagePermissions {
...
pub fn operator_bitand_30(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> v8_PagePermissions {
    let lhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(lhs));
    let rhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(rhs));
    return ((((*lhs.borrow()) as i32) & ((*rhs.borrow()) as i32)) as v8_PagePermissions);
}
pub fn operator_bitor_assign_31(
    ...
    let __rhs = ({
        ...
        operator_bitor_29(_lhs, _rhs)
    });
    lhs.write(__rhs);
    return (lhs).clone();
}
pub fn IsSubset_32(lhs: v8_PagePermissions, rhs: v8_PagePermissions) -> bool {
    let lhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(lhs));
    let rhs: Value<v8_PagePermissions> = Rc::new(RefCell::new(rhs));
    return (({
        let _lhs: v8_PagePermissions = (*lhs.borrow());
        operator_bitand_30(_lhs, (*rhs.borrow()))
    }) == (*lhs.borrow()));
}
...
pub trait v8_Platform {
    ...
    fn CurrentClockTimeMilliseconds(&self) -> i64 {
        return (({ floor_33(({ self.CurrentClockTimeMillis() })) }) as i64);
    }
    ...
    fn GetHighAllocationThroughputObserver(&self) -> Ptr<v8_HighAllocationThroughputObserver> {
        thread_local!(
            static default_observer_34: Value<v8_HighAllocationThroughputObserver> = Rc::new(
                RefCell::new(<v8_HighAllocationThroughputObserver>::default()),
            );
        );
        return (default_observer_34.with(Value::clone).as_pointer());
    }
    fn CreateJobImpl(
        &self,
        priority: v8_TaskPriority,
...
thread_local!(
    pub static thread_id_42: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static next_thread_id_43: Value<std_atomic_int_> =
        Rc::new(RefCell::new(std_atomic_int_::std_atomic_int_1({ 1 })));
);
impl v8_internal_ThreadId {
    pub fn TryGetCurrent() -> v8_internal_ThreadId {
        return if ((*thread_id_42.with(Value::clone).borrow()) == 0) {
            ({ v8_internal_ThreadId::Invalid() })
        } else {
            v8_internal_ThreadId::v8_internal_ThreadId2({
                (*thread_id_42.with(Value::clone).borrow())
            })
        };
    }
}
impl v8_internal_ThreadId {
    fn GetCurrentThreadId() -> i32 {
        if ((*thread_id_42.with(Value::clone).borrow()) == 0) {
            (*thread_id_42.with(Value::clone).borrow_mut()) =
                ({ (*next_thread_id_43.with(Value::clone).borrow()).fetch_add_i32(1, None) });
            let mut __do_while = true;
            'loop_: while __do_while || (false) {
                __do_while = false;
                let _cmp: Value<bool> = Rc::new(RefCell::new(
                    ({ CmpLEImpl_16((1), (*thread_id_42.with(Value::clone).borrow())) }),
                ));
                let mut __do_while = true;
                'loop_: while __do_while || (false) {
                    __do_while = false;
                    if ((!(!(!(*_cmp.borrow()))) as i64) != 0) {
                        ({
                            V8_Fatal_44(
                                ...
                                &[(Ptr::from_string_literal(b"1 <= thread_id")).into()],
                            )
                        });
                    }
                }
        ...
        return (*thread_id_42.with(Value::clone).borrow());
    }
}
...
pub trait v8_internal_ThreadIdImpl {
    fn operator_eq(&self, other: Ptr<v8_internal_ThreadId>) -> bool;
    fn operator_ne(&self, other: Ptr<v8_internal_ThreadId>) -> bool;
    fn IsValid(&self) -> bool;
    fn ToInteger(&self) -> i32;
}
impl v8_internal_ThreadIdImpl for Ptr<v8_internal_ThreadId> {
    fn operator_eq(&self, other: Ptr<v8_internal_ThreadId>) -> bool {
        return {
            let _lhs = (*(*(*self).upgrade().deref()).id_.borrow());
            _lhs == (*(*other.upgrade().deref()).id_.borrow())
        };
    }
    fn operator_ne(&self, other: Ptr<v8_internal_ThreadId>) -> bool {
        return {
    ...
    fn IsValid(&self) -> bool {
        return ((*(*(*self).upgrade().deref()).id_.borrow()) != -1);
    }
    fn ToInteger(&self) -> i32 {
