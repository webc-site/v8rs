...
pub fn SpecialCompare_101(a_high: u64, A: v8_bigint_Digits, B: v8_bigint_Digits) -> i32 {
    let a_high: Value<u64> = Rc::new(RefCell::new(a_high));
    let A: Value<v8_bigint_Digits> = Rc::new(RefCell::new(A));
    let B: Value<v8_bigint_Digits> = Rc::new(RefCell::new(B));
    ({ v8_bigint_DigitsImpl::Normalize(&B.as_pointer()) });
    let a_len: Value<u32> = <Value<u32>>::default();
    if ((*a_high.borrow()) == 0_u64) {
        ({ v8_bigint_DigitsImpl::Normalize(&A.as_pointer()) });
        (*a_len.borrow_mut()) = ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) });
    } else {
        (*a_len.borrow_mut()) =
            ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) }).wrapping_add(1_u32);
    };
    let diff: Value<i32> = Rc::new(RefCell::new(
        (((*a_len.borrow()).wrapping_sub(({ v8_bigint_DigitsImpl::len(&B.as_pointer()) }))) as i32),
    ));
    if ((*diff.borrow()) != 0) {
        return (*diff.borrow());
    }
    let i: Value<i32> = Rc::new(RefCell::new(
        (((*a_len.borrow()).wrapping_sub(1_u32)) as i32),
    ));
    if ((*a_high.borrow()) != 0_u64) {
        if ((*a_high.borrow())
            > ({ v8_bigint_DigitsImpl::operator_index(&B.as_pointer(), ((*i.borrow()) as u32)) }))
...
pub fn SetOnes_102(X: v8_bigint_RWDigits) {
    let X: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(X));
    {
        (({ v8_bigint_RWDigitsImpl::digits(&X.as_pointer()) }) as Ptr<u64>)
            .to_any()
            .memset(
                (255) as u8,
                (({ v8_bigint_DigitsImpl::len(&X.as_pointer()) }) as usize)
                    .wrapping_mul((::std::mem::size_of::<u64>() as usize)) as usize,
            );
        (({ v8_bigint_RWDigitsImpl::digits(&X.as_pointer()) }) as Ptr<u64>).to_any()
    };
}
#[derive(Default)]
pub struct v8_bigint_BZ {
    proc_: Value<Ptr<v8_bigint_ProcessorImpl>>,
    platform_: Value<PtrDyn<dyn v8_bigint_Platform>>,
    scratch_mem_: Value<v8_bigint_Storage>,
}
impl v8_bigint_BZ {
    pub fn v8_bigint_BZ(proc: Ptr<v8_bigint_ProcessorImpl>, scratch_space: u32) -> Self {
        let proc: Value<Ptr<v8_bigint_ProcessorImpl>> = Rc::new(RefCell::new(proc));
        let scratch_space: Value<u32> = Rc::new(RefCell::new(scratch_space));
        let __this: Value<v8_bigint_BZ> = Rc::new(RefCell::new(Self {
            proc_: Rc::new(RefCell::new((*proc.borrow()).clone())),
            platform_: Rc::new(RefCell::new(
                ({ v8_bigint_ProcessorImpl::platform(&(*proc.borrow())) }),
            )),
            scratch_mem_: Rc::new(RefCell::new(v8_bigint_Storage::v8_bigint_Storage(
                {
                    if ((*scratch_space.borrow()) >= 57) {
                        (*scratch_space.borrow())
                    } else {
                        0_u32
                    }
                },
                { (*(*this.upgrade().deref()).platform_.borrow()).clone() },
            ))),
        }));
        let this: Ptr<v8_bigint_BZ> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
    pub fn BZ_pmutv8_bigint_BZ(_a0: Ptr<v8_bigint_BZ>) -> Self {
        let __this: Value<v8_bigint_BZ> = Rc::new(RefCell::new(Self {
            proc_: Rc::new(RefCell::new(
                (*(*_a0.upgrade().deref()).proc_.borrow()).clone(),
            )),
            platform_: Rc::new(RefCell::new(
                (*(*_a0.upgrade().deref()).platform_.borrow()).clone(),
            )),
            scratch_mem_: Rc::new(RefCell::new(
                v8_bigint_Storage::Storage_pmutv8_bigint_Storage({
                    (*_a0.upgrade().deref()).scratch_mem_.as_pointer()
                }),
            )),
        }));
        let this: Ptr<v8_bigint_BZ> = __this.as_pointer();
...
impl ByteRepr for v8_bigint_BZ {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.proc_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.platform_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.scratch_mem_.borrow()).to_bytes(&mut buf[16..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            proc_: Rc::new(RefCell::new(<Ptr<v8_bigint_ProcessorImpl>>::from_bytes(
                &buf[0..8],
            ))),
            platform_: Rc::new(RefCell::new(<PtrDyn<dyn v8_bigint_Platform>>::from_bytes(
                &buf[8..16],
            ))),
            scratch_mem_: Rc::new(RefCell::new(<v8_bigint_Storage>::from_bytes(&buf[16..32]))),
        }
    }
}
#[derive(Clone, Copy, Default, ByteRepr)]
pub struct v8_bigint_Platform_Deleter;
pub trait v8_bigint_BZImpl {
    fn DivideBasecase(
        &self,
        Q: v8_bigint_RWDigits,
    ...
    fn operator_assign_pmutv8_bigint_BZ(&self, _a0: Ptr<v8_bigint_BZ>) -> Ptr<v8_bigint_BZ>;
}
impl v8_bigint_BZImpl for Ptr<v8_bigint_BZ> {
    fn operator_assign_pmutv8_bigint_BZ(&self, _a0: Ptr<v8_bigint_BZ>) -> Ptr<v8_bigint_BZ> {
        let __rhs = (*(*_a0.upgrade().deref()).proc_.borrow()).clone();
        (*(*(*self).upgrade().deref()).proc_.borrow_mut()) = __rhs;
        let __rhs = (*(*_a0.upgrade().deref()).platform_.borrow()).clone();
        (*(*(*self).upgrade().deref()).platform_.borrow_mut()) = __rhs;
        ({
            let _arg0: Ptr<v8_bigint_Storage> = (*_a0.upgrade().deref()).scratch_mem_.as_pointer();
            v8_bigint_StorageImpl::operator_assign_pmutv8_bigint_Storage(
                &(*(*self).upgrade().deref()).scratch_mem_.as_pointer(),
                _arg0,
            )
        });
        return (*self).clone();
    ...
    fn DivideBasecase(
        ...
        (&(0));
        let cmp: Value<i32> = Rc::new(RefCell::new(
            ({ Compare_39((*A.borrow()).clone(), (*B.borrow()).clone()) }),
        ));
        if ((*cmp.borrow()) <= 0) {
            ({ v8_bigint_RWDigitsImpl::Clear(&Q.as_pointer()) });
            if ((*cmp.borrow()) == 0) {
                ({ v8_bigint_RWDigitsImpl::Clear(&R.as_pointer()) });
                ({
                    v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_assign_u64(
                        &Rc::new(RefCell::new(
                            ({ v8_bigint_RWDigitsImpl::operator_index(&Q.as_pointer(), 0_u32) }),
                        ))
                        .as_pointer(),
                        1_u64,
                    )
                ...
                ({
                    ...
                    let _count: u32 = ({ v8_bigint_DigitsImpl::len(&R.as_pointer()) });
                    PutAt_93(_Z, (*A.borrow()).clone(), _count)
                });
            };
            return;
        }
        if (({ v8_bigint_DigitsImpl::len(&B.as_pointer()) }) == 1_u32) {
            ({
                DivideSingle_60(
                    (*Q.borrow()).clone(),
                    ({ v8_bigint_RWDigitsImpl::digits(&R.as_pointer()) }),
                    (*A.borrow()).clone(),
                    ({ v8_bigint_DigitsImpl::operator_index(&B.as_pointer(), 0_u32) }),
                )
            });
            ({
                v8_bigint_ProcessorImplImpl::AddWorkEstimate(
                    &(*(*(*self).upgrade().deref()).proc_.borrow()),
                    (({ v8_bigint_DigitsImpl::len(&A.as_pointer()) }) as u64),
                )
            });
            return;
        }
    ...
    fn D3n2n(
        ...
        let Q: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(Q));
        let R: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(R));
        let A1A2: Value<v8_bigint_Digits> = Rc::new(RefCell::new(A1A2));
        let A3: Value<v8_bigint_Digits> = Rc::new(RefCell::new(A3));
        let B: Value<v8_bigint_Digits> = Rc::new(RefCell::new(B));
        (&(0));
        let n: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&B.as_pointer()) }).wrapping_div(2_u32),
        ));
        (&(0));
        (&(0));
        (&(0));
        ...
        let A1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*A1A2.borrow()).clone() }, { (*n.borrow()) }, {
                (*n.borrow())
            }),
        ));
        let B1: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*B.borrow()).clone() }, { (*n.borrow()) }, {
                (*n.borrow())
            }),
        ));
        let B2: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*B.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow())
            }),
        ));
        let Qhat: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*Q.borrow()).clone()));
        let R1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*R.borrow()).clone() },
                { (*n.borrow()) },
                { (*n.borrow()) },
            )));
        let r1_high: Value<u64> = Rc::new(RefCell::new(0_u64));
        if (({ Compare_39((*A1.borrow()).clone(), (*B1.borrow()).clone()) }) < 0) {
            ({
                v8_bigint_BZImpl::D2n1n(
                    self,
                    (*Qhat.borrow()).clone(),
                    (*R1.borrow()).clone(),
                    (*A1A2.borrow()).clone(),
            ...
            ({ SetOnes_102((*Qhat.borrow()).clone()) });
            let temp: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new((*R1.borrow()).clone()));
            ({
                SubtractWithNormalization_44(
                    (*temp.borrow()).clone(),
                    (*A1.borrow()).clone(),
                    (*B1.borrow()).clone(),
                )
            });
            ({ v8_bigint_DigitsImpl::Normalize(&temp.as_pointer()) });
            (&(0));
            if (({ v8_bigint_DigitsImpl::len(&temp.as_pointer()) }) > 0_u32) {
                (*r1_high.borrow_mut()) = ({
                    v8_bigint_RWDigits_WritableDigitReferenceImpl::operator_digit_t(
                        &Rc::new(RefCell::new(
                            ({ v8_bigint_RWDigitsImpl::operator_index(&temp.as_pointer(), 0_u32) }),
                        ))
                        .as_pointer(),
                    )
                });
            }
            let A2: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
                v8_bigint_Digits::v8_bigint_Digits3({ (*A1A2.borrow()).clone() }, { 0_u32 }, {
                    (*n.borrow())
                }),
            ));
            {
                let rhs_0 = (*r1_high.borrow()).wrapping_add(
                    ({
                        AddAndReturnCarry_53(
                            (*R1.borrow()).clone(),
                            (*A2.borrow()).clone(),
                            (*B1.borrow()).clone(),
                        )
                ...
                (*r1_high.borrow_mut()) = rhs_0
            };
        }
        let D: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits1(
                {
                    ({
                        v8_bigint_StorageImpl::get(
                            &(*(*self).upgrade().deref()).scratch_mem_.as_pointer(),
                        )
                    })
                },
        ...
        ({ PutAt_93((*R.borrow()).clone(), (*A3.borrow()).clone(), (*n.borrow())) });
        'loop_: while (({
            SpecialCompare_101(
                (*r1_high.borrow()),
                (*R.borrow()).clone(),
        ...
        }) < 0)
        {
            {
                let rhs_0 = (*r1_high.borrow()).wrapping_add(
                    ({ InplaceAddAndReturnCarry_51((*R.borrow()).clone(), (*B.borrow()).clone()) }),
                );
                (*r1_high.borrow_mut()) = rhs_0
            };
            ({ Subtract_50((*Qhat.borrow()).clone(), 1_u64) });
        }
        let borrow: Value<u64> = Rc::new(RefCell::new(
            ({ InplaceSubAndReturnBorrow_52((*R.borrow()).clone(), (*D.borrow()).clone()) }),
        ));
        (&(0));
        (&(0));
        (&(*borrow.borrow_mut()));
    ...
    fn D2n1n(
        ...
        (&(0));
        (&(0));
        if (((*n.borrow()) & 1_u32) == 1_u32) || ((*n.borrow()) < 57) {
            ({
                v8_bigint_BZImpl::DivideBasecase(
                    self,
                    (*Q.borrow()).clone(),
                    (*R.borrow()).clone(),
                    (*A.borrow()).clone(),
        ...
        let A1A2: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*A.borrow()).clone() }, { (*n.borrow()) }, {
                (*n.borrow())
            }),
        ));
        let A3: Value<v8_bigint_Digits> =
            Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                { (*A.borrow()).clone() },
                { (*n.borrow()).wrapping_div(2_u32) },
                { (*n.borrow()).wrapping_div(2_u32) },
            )));
        let A4: Value<v8_bigint_Digits> = Rc::new(RefCell::new(
            v8_bigint_Digits::v8_bigint_Digits3({ (*A.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow()).wrapping_div(2_u32)
            }),
        ));
        let Q1: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*Q.borrow()).clone() },
                { (*n.borrow()).wrapping_div(2_u32) },
                { (*n.borrow()).wrapping_div(2_u32) },
            )));
        let R1: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*n.borrow()) }, {
                (*(*(*self).upgrade().deref()).platform_.borrow()).clone()
            }),
        ));
        ({
            v8_bigint_BZImpl::D3n2n(
                self,
                (*Q1.borrow()).clone(),
                (*R1.borrow()).clone(),
                (*A1A2.borrow()).clone(),
        ...
        let Q2: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*Q.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow()).wrapping_div(2_u32)
            }),
        ));
        ({
...
impl v8_bigint_ProcessorImplImpl for Ptr<v8_bigint_ProcessorImpl> {
    ...
    fn DivideBurnikelZiegler(
        ...
        (&(0));
        (&(0));
        let r: Value<u32> = Rc::new(RefCell::new(
            ({ v8_bigint_DigitsImpl::len(&A.as_pointer()) }),
        ));
        ...
        let m: Value<u32> = Rc::new(RefCell::new(
            ((1 << ({ BitLength_27((((*s.borrow()).wrapping_div(57)) as i32)) })) as u32),
        ));
        let j: Value<u32> = Rc::new(RefCell::new(
            ((((*s.borrow()).wrapping_sub(1_u32)).wrapping_div((*m.borrow()))).wrapping_add(1_u32)),
        ));
        let n: Value<u32> = Rc::new(RefCell::new((*j.borrow()).wrapping_mul((*m.borrow()))));
        let sigma: Value<i32> = Rc::new(RefCell::new(
            ({
                CountLeadingZeros_24(
                    ({
                        v8_bigint_DigitsImpl::operator_index(
                            &B.as_pointer(),
                            (*s.borrow()).wrapping_sub(1_u32),
                        )
                    }),
                )
            }),
        ));
        let digit_shift: Value<u32> =
            Rc::new(RefCell::new((*n.borrow()).wrapping_sub((*s.borrow()))));
        let temp: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits(
                { (*n.borrow()).wrapping_mul(5_u32) },
                { ({ v8_bigint_ProcessorImpl::platform(self) }) },
            ),
        ));
        let B_shifted: Value<v8_bigint_RWDigits> = Rc::new(RefCell::new(
            v8_bigint_RWDigits::v8_bigint_RWDigits2({ (*temp.borrow()).clone() }, { 0_u32 }, {
                (*n.borrow())
            }),
        ));
        ({
        ...
        (*B.borrow_mut()) = (*B_shifted.borrow()).clone();
        let extra_digit: Value<i32> = Rc::new(RefCell::new(
            if (({
                CountLeadingZeros_24(
                    ({
                        v8_bigint_DigitsImpl::operator_index(
                            &A.as_pointer(),
                            (*r.borrow()).wrapping_sub(1_u32),
                        )
                    }),
                )
            }) < ((*sigma.borrow()) + 1))
        ...
        (*r.borrow_mut()) = (({ v8_bigint_DigitsImpl::len(&A.as_pointer()) })
            .wrapping_add((*digit_shift.borrow())))
        .wrapping_add(((*extra_digit.borrow()) as u32));
        let A_shifted: Value<v8_bigint_ScratchDigits> = Rc::new(RefCell::new(
            v8_bigint_ScratchDigits::v8_bigint_ScratchDigits({ (*r.borrow()) }, {
                ({ v8_bigint_ProcessorImpl::platform(self) })
            }),
        ));
        ({
        ...
        (*A.borrow_mut()) = (*A_shifted.borrow()).clone();
        let t: Value<u32> = Rc::new(RefCell::new({
            let __tmp_0: Value<u32> = Rc::new(RefCell::new(
                ((((*r.borrow()).wrapping_sub(1_u32)).wrapping_div((*n.borrow())))
                    .wrapping_add(1_u32)),
            ));
            let __tmp_1: Value<u32> = Rc::new(RefCell::new(2_u32));
            (if __tmp_0.as_pointer().read() >= __tmp_1.as_pointer().read() {
                __tmp_0.as_pointer()
            } else {
                __tmp_1.as_pointer()
        ...
        let Z: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*temp.borrow()).clone() },
                { (*n.borrow()) },
                { (*z_len.borrow()) },
        ...
        let bz: Value<v8_bigint_BZ> = Rc::new(RefCell::new(v8_bigint_BZ::v8_bigint_BZ(
            { (*self).clone() },
            { (*n.borrow()) },
        )));
        let Ri: Value<v8_bigint_RWDigits> =
            Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                { (*temp.borrow()).clone() },
                { (3_u32).wrapping_mul((*n.borrow())) },
                { (*n.borrow()) },
            )));
        {
            let Qi: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*temp.borrow()).clone() },
                    { (4_u32).wrapping_mul((*n.borrow())) },
                    { (*n.borrow()) },
                )));
            ({
                v8_bigint_BZImpl::D2n1n(
            ...
            ({ v8_bigint_DigitsImpl::Normalize(&Qi.as_pointer()) });
            ...
            (&(0));
            ({
                let _Z: v8_bigint_RWDigits = (*target.borrow()).clone();
                let _count: u32 = ({ v8_bigint_DigitsImpl::len(&target.as_pointer()) });
        ...
        'loop_: while ((*i.borrow()) >= 0) {
            ...
            let Qi: Value<v8_bigint_RWDigits> =
                Rc::new(RefCell::new(v8_bigint_RWDigits::v8_bigint_RWDigits2(
                    { (*Q.borrow()).clone() },
                    { ((*i.borrow()) as u32).wrapping_mul((*n.borrow())) },
                    { (*n.borrow()) },
                )));
            ({
                v8_bigint_BZImpl::D2n1n(
        ...
        if (({ v8_bigint_DigitsImpl::len(&R.as_pointer()) }) != 0_u32) {
            let Ri_part: Value<v8_bigint_Digits> =
                Rc::new(RefCell::new(v8_bigint_Digits::v8_bigint_Digits3(
                    { (*Ri.borrow()).clone() },
                    { (*digit_shift.borrow()) },
                    { ({ v8_bigint_DigitsImpl::len(&Ri.as_pointer()) }) },
                )));
            ({ v8_bigint_DigitsImpl::Normalize(&Ri_part.as_pointer()) });
            (&(0));
            ({
                RightShift_92(
                    (*R.borrow()).clone(),
                    (*Ri_part.borrow()).clone(),
                    (*sigma.borrow()),
                )
            });
        }
