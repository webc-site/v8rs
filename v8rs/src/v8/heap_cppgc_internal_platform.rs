...
pub trait cppgc_Platform {
    ...
    fn GetTracingController(&self) -> Ptr<v8_TracingController> {
        thread_local!(
            static  tracing_controller_10 : Value<v8_base_LeakyObject_v8_TracingController_ > = Rc::new(RefCell::new(v8_base_LeakyObject_v8_TracingController_ :: v8_base_LeakyObject_v8_TracingController_ ( ) )) ;
        );
        return ({
            v8_base_LeakyObject_v8_TracingController_Impl::get(
                &tracing_controller_10.with(Value::clone).as_pointer(),
            )
        });
    }
}
...
thread_local!();
pub fn ControlledCrashesAreHarmless_12() -> bool {
    return ((*g_abort_mode_11.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_11.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn DcheckFailuresAreIgnored_13() -> bool {
    return ((*g_abort_mode_11.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitWithSuccessAndIgnoreDcheckFailures)
        || ((*g_abort_mode_11.with(Value::clone).borrow())
            == v8_base_AbortMode_kExitWithFailureAndIgnoreDcheckFailures);
}
pub fn FatalErrorsWithNoSecurityImpactShouldExit_14() -> bool {
    return ((*g_abort_mode_11.with(Value::clone).borrow())
        == v8_base_AbortMode_kExitIfNoSecurityImpact);
}
thread_local!(
    pub static kReturnAddressStackSlotCount_15: Value<i32> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kPageSizeBits_16: Value<i32> = Rc::new(RefCell::new(18));
);
thread_local!(
    pub static kRegularPageSize_17: Value<i32> = Rc::new(RefCell::new(262144));
);
thread_local!(
    pub static kMinimumOSPageSize_18: Value<i32> = Rc::new(RefCell::new(16384));
);
thread_local!(
    pub static kUnimplementedCodeMessage_19: Value<Ptr<u8>> = Rc::new(RefCell::new(
        Ptr::from_string_literal(b"unimplemented code"),
    ));
);
thread_local!(
    pub static kUnreachableCodeMessage_20: Value<Ptr<u8>> =
...
thread_local!(
    pub static value_23: Value<bool> = Rc::new(RefCell::new(false));
);
#[derive(Default)]
...
thread_local!(
    pub static value_24: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
...
thread_local!(
    pub static value_27: Value<bool> = Rc::new(RefCell::new(true));
);
#[derive(Default)]
pub struct v8_base_is_trivially_copyable_v8_base_AddressRegion_ {}
impl Clone for v8_base_is_trivially_copyable_v8_base_AddressRegion_ {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_is_trivially_copyable_v8_base_AddressRegion_> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_is_trivially_copyable_v8_base_AddressRegion_> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_is_trivially_copyable_v8_base_AddressRegion_ {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
pub type anon_32 = u8;
pub const anon_32_ONCE_STATE_UNINITIALIZED: anon_32 = 0;
pub const anon_32_ONCE_STATE_EXECUTING_FUNCTION: anon_32 = 1;
pub const anon_32_ONCE_STATE_DONE: anon_32 = 2;
pub fn CallOnce_33(once: Ptr<std_atomic_unsigned_char_>, init_func: std_function_void____) {
    ...
    if ((({ (*(*once.borrow()).upgrade().deref()).load_const(Some(2)) }) as i32)
        != (anon_32_ONCE_STATE_DONE as i32))
    {
        ({ CallOnceImpl_34((*once.borrow()).clone(), (*init_func.borrow()).clone()) });
    }
}
#[derive(Default)]
...
impl v8_base_LeakyObject_v8_base_PageAllocator_ {
    pub fn v8_base_LeakyObject_v8_base_PageAllocator_() -> Self {
        let __this: Value<v8_base_LeakyObject_v8_base_PageAllocator_> =
            Rc::new(RefCell::new(Self {
                storage_: Rc::new(RefCell::new(
                    (0..24).map(|_| <u8>::default()).collect::<Box<[u8]>>(),
                )),
            }));
        let this: Ptr<v8_base_LeakyObject_v8_base_PageAllocator_> = __this.as_pointer();
        Ptr::alloc(v8_base_PageAllocator::v8_base_PageAllocator());
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
#[derive()]
pub struct v8_base_LeakyObject_v8_base_PageAllocator_ {
    storage_: Value<Box<[u8]>>,
}
impl Default for v8_base_LeakyObject_v8_base_PageAllocator_ {
    fn default() -> Self {
        v8_base_LeakyObject_v8_base_PageAllocator_ {
            storage_: Rc::new(RefCell::new(
                (0..24).map(|_| <u8>::default()).collect::<Box<[u8]>>(),
            )),
        }
...
impl ByteRepr for v8_base_LeakyObject_v8_base_PageAllocator_ {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.storage_.borrow()).to_bytes(&mut buf[0..24]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            storage_: Rc::new(RefCell::new(<Box<[u8]>>::from_bytes(&buf[0..24]))),
        }
    }
}
impl v8_base_LeakyObject_v8_TracingController_ {
    pub fn v8_base_LeakyObject_v8_TracingController_() -> Self {
        let __this: Value<v8_base_LeakyObject_v8_TracingController_> =
            Rc::new(RefCell::new(Self {
                storage_: Rc::new(RefCell::new(
                    (0..8).map(|_| <u8>::default()).collect::<Box<[u8]>>(),
                )),
            }));
        let this: Ptr<v8_base_LeakyObject_v8_TracingController_> = __this.as_pointer();
        Ptr::alloc(<v8_TracingController>::default());
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
#[derive()]
pub struct v8_base_LeakyObject_v8_TracingController_ {
    storage_: Value<Box<[u8]>>,
}
impl Default for v8_base_LeakyObject_v8_TracingController_ {
    fn default() -> Self {
        v8_base_LeakyObject_v8_TracingController_ {
            storage_: Rc::new(RefCell::new(
                (0..8).map(|_| <u8>::default()).collect::<Box<[u8]>>(),
            )),
        }
...
impl ByteRepr for v8_base_LeakyObject_v8_TracingController_ {
    fn byte_size() -> usize {
        8
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.storage_.borrow()).to_bytes(&mut buf[0..8]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            storage_: Rc::new(RefCell::new(<Box<[u8]>>::from_bytes(&buf[0..8]))),
        }
    }
}
#[derive()]
...
thread_local!(
    pub static kStackWalkError_36: Value<i32> = Rc::new(RefCell::new(-1_i32));
);
thread_local!(
    pub static kStackWalkMaxNameLen_37: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    pub static kStackWalkMaxTextLen_38: Value<i32> = Rc::new(RefCell::new(256));
);
thread_local!(
    static msPerSecond_39: Value<i32> = Rc::new(RefCell::new(1000));
);
#[derive()]
...
impl v8_base_Stack {
    pub fn GetCurrentFrameAddress(
        ...
        let frame_address: Value<AnyPtr> = Rc::new(RefCell::new(
            frame_address.unwrap_or(({ __builtin_frame_address_41(0_u32) })),
        ));
...
pub fn NoSanitizeProbeMemory_42(address: u64) {
    let address: Value<u64> = Rc::new(RefCell::new(address));
...
#[derive(Default)]
pub struct v8_base_LsanPageAllocator {
    page_allocator_: Value<PtrDyn<dyn v8_PageAllocator>>,
    allocate_page_size_: Value<usize>,
    commit_page_size_: Value<usize>,
}
impl v8_base_LsanPageAllocator {}
impl v8_PageAllocator for v8_base_LsanPageAllocator {
    fn AllocatePageSize(&self) -> usize {
        return (*self.allocate_page_size_.borrow());
    }
    fn CommitPageSize(&self) -> usize {
    ...
    fn SetRandomMmapSeed(&self, seed: i64) {
        ...
        ({
            (*(*self.page_allocator_.borrow()).upgrade().deref())
                .SetRandomMmapSeed((*seed.borrow()))
        });
        return;
    }
    fn GetRandomMmapAddr(&self) -> AnyPtr {
        return ({ (*(*self.page_allocator_.borrow()).upgrade().deref()).GetRandomMmapAddr() });
    }
    fn SetPermissions(
        &self,
        address: AnyPtr,
        ...
        return ({
            (*(*self.page_allocator_.borrow()).upgrade().deref()).SetPermissions(
    ...
    fn RecommitPages(
        ...
        let access: Value<v8_PageAllocator_Permission> = Rc::new(RefCell::new(access));
        return ({
            (*(*self.page_allocator_.borrow()).upgrade().deref()).RecommitPages(
                (*address.borrow()).clone(),
                (*size.borrow()),
                (*access.borrow()),
            )
    ...
    fn DiscardSystemPages(&self, address: AnyPtr, size: usize) -> bool {
        ...
        return ({
            (*(*self.page_allocator_.borrow()).upgrade().deref())
                .DiscardSystemPages((*address.borrow()).clone(), (*size.borrow()))
        });
    }
    fn DecommitPages(&self, address: AnyPtr, size: usize) -> bool {
        let address: Value<AnyPtr> = Rc::new(RefCell::new(address));
        ...
        return ({
            (*(*self.page_allocator_.borrow()).upgrade().deref())
                .DecommitPages((*address.borrow()).clone(), (*size.borrow()))
        });
    }
}
impl Clone for v8_base_LsanPageAllocator {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_LsanPageAllocator> = Rc::new(RefCell::new(Self {
            page_allocator_: Rc::new(RefCell::new((*self.page_allocator_.borrow()).clone())),
            allocate_page_size_: Rc::new(RefCell::new((*self.allocate_page_size_.borrow()))),
            commit_page_size_: Rc::new(RefCell::new((*self.commit_page_size_.borrow()))),
        }));
        let this: Ptr<v8_base_LsanPageAllocator> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_LsanPageAllocator {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.page_allocator_.borrow()).to_bytes(&mut buf[8..16]);
        (*self.allocate_page_size_.borrow()).to_bytes(&mut buf[16..24]);
        (*self.commit_page_size_.borrow()).to_bytes(&mut buf[24..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            page_allocator_: Rc::new(RefCell::new(<PtrDyn<dyn v8_PageAllocator>>::from_bytes(
                &buf[8..16],
            ))),
            allocate_page_size_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[16..24]))),
            commit_page_size_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[24..32]))),
        }
    }
}
thread_local!(
    pub static IsAnyMemberTypeV_43: Value<bool> = Rc::new(RefCell::new(true));
);
thread_local!();
#[derive(Default)]
...
thread_local!(
    pub static kMaxGCInfoIndex_45: Value<u16> = Rc::new(RefCell::new(16384));
);
thread_local!(
    pub static kMinGCInfoIndex_46: Value<u16> = Rc::new(RefCell::new(1));
);
#[derive()]
...
pub fn GetHiddenName_47(
    ...
    return cppgc_internal_HeapObjectName {
        value: Rc::new(RefCell::new(
            (kHiddenName_48.with(Value::clone).as_pointer() as Ptr<u8>),
        )),
...
impl cppgc_internal_GCInfoTableSection {
    pub fn Index(info: Ptr<cppgc_internal_GCInfo>) -> u16 {
        return ((((info).clone()
            - (__start_gc_info_section_49.with(Value::clone).as_pointer()
    ...
    pub fn GCInfoFromIndex(index: u16) -> Ptr<cppgc_internal_GCInfo> {
        ...
        (&(cppgc_internal_EatParams_const_char__ref_arr_arr_ {}));
        return (__start_gc_info_section_49.with(Value::clone).as_pointer()
...
thread_local!(
    pub static kLowZeroBits_53: Value<i32> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kAlignment_54: Value<i32> = Rc::new(RefCell::new(256));
);
...
thread_local!(
    pub static kToBePaddedSize_55: Value<usize> = Rc::new(RefCell::new(33));
);
#[derive(Default)]
...
pub fn is_constant_evaluated_58() -> bool {
    return ({ is_constant_evaluated_59() });
}
...
pub fn LogSeverities_60() -> Vec<absl_LogSeverity> {
    return vec![
...
thread_local!(
    pub static kLogDebugFatal_61: Value<absl_LogSeverity> = Rc::new(RefCell::new(2));
);
pub fn LogSeverityName_62(s: absl_LogSeverity) -> Ptr<u8> {
...
pub fn NormalizeLogSeverity_63(s: absl_LogSeverity) -> absl_LogSeverity {
    let s: Value<absl_LogSeverity> = Rc::new(RefCell::new(s));
...
pub fn NormalizeLogSeverity_64(s: i32) -> absl_LogSeverity {
    let s: Value<i32> = Rc::new(RefCell::new(s));
    return ({ NormalizeLogSeverity_63(((*s.borrow()) as absl_LogSeverity)) });
}
...
pub fn operator_gt_65(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
...
pub fn operator_lt_66(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
...
pub fn operator_le_67(lhs: absl_LogSeverityAtLeast, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) <= (*rhs.borrow()));
}
pub fn operator_ge_68(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtLeast) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtLeast> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) >= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_lt_69(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) < (*rhs.borrow()));
}
pub fn operator_gt_70(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) > ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn operator_ge_71(lhs: absl_LogSeverityAtMost, rhs: absl_LogSeverity) -> bool {
    let lhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(rhs));
    return (((*lhs.borrow()) as absl_LogSeverity) >= (*rhs.borrow()));
}
pub fn operator_le_72(lhs: absl_LogSeverity, rhs: absl_LogSeverityAtMost) -> bool {
    let lhs: Value<absl_LogSeverity> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_LogSeverityAtMost> = Rc::new(RefCell::new(rhs));
    return ((*lhs.borrow()) <= ((*rhs.borrow()) as absl_LogSeverity));
}
pub fn Basename_73(fname: Ptr<u8>, offset: i32) -> Ptr<u8> {
            ...
            == (('\\' as u8) as i32))
    {
        ...
        ({ Basename_73((*fname.borrow()).clone(), ((*offset.borrow()) - 1)) })
    };
}
thread_local!();
pub fn ClippedSubstr_75(s: Vec<u8>, pos: usize, n: Option<usize>) -> Vec<u8> {
...
pub fn NullSafeStringView_76(p: Ptr<u8>) -> Vec<u8> {
...
pub fn days_per_century_79(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (36524 + ((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300)) as i32));
}
pub fn days_per_4years_80(yi: i32) -> i32 {
    let yi: Value<i32> = Rc::new(RefCell::new(yi));
    return (1460
        + (((((*yi.borrow()) == 0) || ((*yi.borrow()) > 300))
            || ((((*yi.borrow()) - 1) % 100) < 96)) as i32));
}
pub fn days_per_year_81(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    return if ({ is_leap_year_77(((*y.borrow()) + ((((*m.borrow()) as i32) > 2) as i64))) }) {
        366
    } else {
        365
    };
}
pub fn days_per_month_82(y: i64, m: i8) -> i32 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
    ...
    return ((*k_days_per_month.borrow())[(*m.borrow()) as usize]
        + (((((*m.borrow()) as i32) == 2) && ({ is_leap_year_77((*y.borrow())) })) as i32));
}
pub fn n_day_83(
    y: i64,
    m: i8,
    ...
    if ((*d.borrow()) > 0_i64) {
        ...
        if ((*d.borrow()) > (-365_i32 as i64)) {
            (*ey.borrow_mut()) -= 1_i64;
            (*d.borrow_mut()) += (({ days_per_year_81((*ey.borrow()), (*m.borrow())) }) as i64);
        } else {
            (*ey.borrow_mut()) -= 400_i64;
            (*d.borrow_mut()) += 146097_i64;
        }
    ...
    if ((*d.borrow()) > 365_i64) {
        let yi: Value<i32> = Rc::new(RefCell::new(
            ({ year_index_78((*ey.borrow()), (*m.borrow())) }),
        ));
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_century_79((*yi.borrow())) })));
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(({ days_per_4years_80((*yi.borrow())) })));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
            (*d.borrow_mut()) -= ((*n.borrow()) as i64);
        ...
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_year_81((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
    ...
    if ((*d.borrow()) > 28_i64) {
        'loop_: while true {
            let n: Value<i32> = Rc::new(RefCell::new(
                ({ days_per_month_82((*ey.borrow()), (*m.borrow())) }),
            ));
            if ((*d.borrow()) <= ((*n.borrow()) as i64)) {
                break;
            }
...
pub fn step_89(
    ...
    return ({
        ...
        n_min_86(_y, _m, _d, _hh, 0_i64, _mm, _ss)
    });
}
pub fn step_90(
    ...
    return ({
        ...
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_hour_85(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_91(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_day_83(_y, _m, _d, (*n.borrow()), _hh, _mm, _ss)
    });
}
pub fn step_92(
    ...
    return ({
        ...
        let _mm: i8 = (*(*f.borrow()).mm.borrow());
        let _ss: i8 = (*(*f.borrow()).ss.borrow());
        n_mon_84(_y, _m, _d, 0_i64, _hh, _mm, _ss)
    });
}
pub fn step_93(
...
pub fn scale_add_94(v: i64, f: i64, a: i64) -> i64 {
...
pub fn ymd_ord_95(y: i64, m: i8, d: i8) -> i64 {
    let y: Value<i64> = Rc::new(RefCell::new(y));
    let m: Value<i8> = Rc::new(RefCell::new(m));
...
pub fn day_difference_96(y1: i64, m1: i8, d1: i8, y2: i64, m2: i8, d2: i8) -> i64 {
    ...
    let delta: Value<i64> = Rc::new(RefCell::new(
        (({ ymd_ord_95((*a_c4_off.borrow()), (*m1.borrow()), (*d1.borrow())) })
            - ({ ymd_ord_95((*b_c4_off.borrow()), (*m2.borrow()), (*d2.borrow())) })),
    ));
...
pub fn difference_99(
    ...
    return ({
        ...
        day_difference_96(_y1, _m1, _d1, _y2, _m2, _d2)
    });
}
...
pub fn difference_101(
    ...
    return ({
        ...
        scale_add_94(_v, 60_i64, _a)
    });
}
pub fn difference_102(
    _a0: absl_time_internal_cctz_detail_second_tag,
    f1: absl_time_internal_cctz_detail_fields,
    f2: absl_time_internal_cctz_detail_fields,
) -> i64 {
...
pub fn operator_add_109(
    ...
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_91 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , (*n.borrow())  , ) } )    } , )   ;
}
pub fn operator_sub_110(
    a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_,
    n: i64,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ {
    let a: Value<
    ...
    return if ((*n.borrow()) != <i64>::MIN) {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_91 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - (*n.borrow())  , ) } )    } , )
    } else {
        absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_2 ( {  (  { step_91 ( absl_time_internal_cctz_detail_day_tag { }  , (  { step_91 ( absl_time_internal_cctz_detail_day_tag { }  , ((*(*a.borrow()) . f_ .borrow()) ).clone()  , - ( ( (*n.borrow()) + 1_i64 ) )  , ) } )   , 1_i64  , ) } )    } , )
    };
}
#[derive()]
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_10(
        ...
        > = Rc::new(RefCell::new(Self {
            f_: Rc::new(RefCell::new(
                ({ align_104(absl_time_internal_minute_tag {}, (*f.borrow()).clone()) }),
            )),
        }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_minute_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_13(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_105(absl_time_internal_hour_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_hour_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_17(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_106(absl_time_internal_day_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_20(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_107(absl_time_internal_month_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_month_tag_> =
            __this.as_pointer();
...
impl absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_ {
    fn absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_23(
        ...
        let __this: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            Rc::new(RefCell::new(Self {
                f_: Rc::new(RefCell::new(
                    ({ align_108(absl_time_internal_year_tag {}, (*f.borrow()).clone()) }),
                )),
            }));
        let this: Ptr<absl_time_internal_cctz_detail_civil_time_absl_time_internal_year_tag_> =
            __this.as_pointer();
...
pub fn next_weekday_112(
    ...
    let base: Value<absl_time_internal_cctz_detail_weekday> = Rc::new(RefCell::new(
        ({
            ...
            get_weekday_111(_cs.as_pointer())
        }),
    ));
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_forw.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        ...
                        operator_add_109(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
        ...
        if ((*base.borrow()) == (*k_weekdays_back.borrow())[(*i.borrow()) as usize]) {
            ...
            'loop_: while true {
                if ((*wd.borrow()) == (*k_weekdays_back.borrow())[(*j.borrow()) as usize]) {
                    return ({
                        let _a: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_   = ((*cd.borrow()) ).clone()  ;
                        operator_sub_110(_a, (((*j.borrow()) - (*i.borrow())) as i64))
                    });
                }
                (*j.borrow_mut()).prefix_inc();
            }
...
pub fn PrevWeekday_117(
    ...
    let cd: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_> =
        Rc::new(RefCell::new(cd));
    let wd: Value<absl_time_internal_cctz_detail_weekday> = Rc::new(RefCell::new(wd));
    return absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_day_tag_15 ( { let __tmp_1 : Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ > = Rc::new(RefCell::new((  { prev_weekday_113 ( absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_day_tag_1 ( {  cd .as_pointer()   } , None , )  , (*wd.borrow())  , ) } )  )); __tmp_1.as_pointer()  } , None , )   ;
}
pub fn GetYearDay_118(
    cs: absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_,
) -> i32 {
    let cs: Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_> =
        Rc::new(RefCell::new(cs));
    return ({
        let _cs : Value<absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ > = Rc::new(RefCell::new(absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_ :: absl_time_internal_cctz_detail_civil_time_absl_time_internal_cctz_detail_second_tag_5 ( {  cs .as_pointer()   } , None , ) ));
        get_yearday_114(_cs.as_pointer())
    });
}
pub fn operator_eq_119(
...
}pub  fn split_seconds_122 ( tp : Ptr< std_chrono_time_point_std_chrono_system_clock__std_chrono_duration_long_long__std_ratio________  > , ) -> (Value<std_chrono_time_point_std_chrono_steady_clock__std_chrono_duration_long_long__std_ratio________>, Value<std_chrono_duration_long_long__std_ratio_______>){
    return (
        Rc::new(RefCell::new(
            (*tp.upgrade().deref())
                .clone()
...
thread_local!(
    pub static kTicksPerNanosecond_124: Value<i64> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kTicksPerSecond_125: Value<i64> = Rc::new(RefCell::new(4000000000));
);
pub fn FromInt64_126(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    ...
    return ({
        ...
        let _ticks: i64 = (((((((*v.borrow()) % 1000000000_i64) * 4) * 1000_i64) * 1000_i64)
            * 1000_i64)
            / 1000000000_i64);
        MakeNormalizedDuration_127(_sec, _ticks)
    });
}
...
pub fn FromInt64_130(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({
...
pub fn operator_gt_133(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    ...
    return ({
        ...
        operator_lt_134(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_135(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_lt_134(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_136(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*rhs.borrow()).clone();
...
pub fn operator_ne_137(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Duration = (*lhs.borrow()).clone();
        operator_eq_132(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_add_138(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_sub_139(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn operator_div_140(lhs: absl_Duration, rhs: absl_Duration) -> i64 {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return ({
        let _num: absl_Duration = (*lhs.borrow()).clone();
        let _rem: Ptr<absl_Duration> = (lhs.as_pointer());
        IDivDuration_141(_num, (*rhs.borrow()).clone(), _rem)
    });
}
pub fn operator_rem_142(lhs: absl_Duration, rhs: absl_Duration) -> absl_Duration {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (*({
...
pub fn ZeroDuration_143() -> absl_Duration {
    return absl_Duration::absl_Duration1();
}
pub fn AbsDuration_144(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if ({
        let _lhs: absl_Duration = (*d.borrow()).clone();
        operator_lt_134(_lhs, ({ ZeroDuration_143() }))
    }) {
        ({
...
pub fn Nanoseconds_146(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_126(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Nanoseconds_147(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_126((*n.borrow()), std_ratio______ {}) });
}
pub fn Microseconds_148(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_128(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Microseconds_149(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_128((*n.borrow()), std_ratio______ {}) });
}
pub fn Milliseconds_150(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_129(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Milliseconds_151(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_129((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_152(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_130((*n.borrow()), std_ratio______ {}) });
}
pub fn Seconds_153(n: i64) -> absl_Duration {
    let n: Value<i64> = Rc::new(RefCell::new(n));
    return ({ FromInt64_130((*n.borrow()), std_ratio______ {}) });
}
pub fn Minutes_154(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_155(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn Hours_156(n: i32) -> absl_Duration {
    let n: Value<i32> = Rc::new(RefCell::new(n));
    return ({ FromInt64_157(((*n.borrow()) as i64), std_ratio______ {}) });
}
pub fn operator_shl_158(os: Ptr<std::fs::File>, d: absl_Duration) -> Ptr<std::fs::File> {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return os.write_all(
        &([(&({ FormatDuration_159((*d.borrow()).clone()) })
            .iter()
            .take(({ FormatDuration_159((*d.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
...
pub fn operator_cmp_160(lhs: absl_Time, rhs: absl_Time) -> std::cmp::Ordering {
    ...
    return ({
        ...
        operator_cmp_131(_lhs, _rhs)
    });
}
pub fn operator_lt_162(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_lt_134(_lhs, _rhs)
    });
}
pub fn operator_gt_163(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
        operator_lt_162(_lhs, (*lhs.borrow()).clone())
    });
}
pub fn operator_ge_164(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_lt_162(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_le_165(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*rhs.borrow()).clone();
...
pub fn operator_eq_161(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_eq_132(_lhs, _rhs)
    });
}
pub fn operator_ne_166(lhs: absl_Time, rhs: absl_Time) -> bool {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return !({
        let _lhs: absl_Time = (*lhs.borrow()).clone();
        operator_eq_161(_lhs, (*rhs.borrow()).clone())
    });
}
pub fn operator_add_167(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_add_168(lhs: absl_Duration, rhs: absl_Time) -> absl_Time {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_169(lhs: absl_Time, rhs: absl_Duration) -> absl_Time {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
...
pub fn operator_sub_170(lhs: absl_Time, rhs: absl_Time) -> absl_Duration {
    let lhs: Value<absl_Time> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Time> = Rc::new(RefCell::new(rhs));
    return ({
        let _lhs: absl_Duration = (*(*lhs.borrow()).rep_.borrow()).clone();
        let _rhs: absl_Duration = (*(*rhs.borrow()).rep_.borrow()).clone();
        operator_sub_139(_lhs, _rhs)
    });
}
pub fn UnixEpoch_171() -> absl_Time {
    return <absl_Time>::default();
}
pub fn UniversalEpoch_172() -> absl_Time {
    return absl_Time::absl_Time1({
        ({ MakeDuration_173((((-24_i32 * 719162) as i64) * 3600_i64), 0_u32) })
    });
}
pub fn InfiniteFuture_174() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_173(<i64>::MAX, !0_u32) }) });
}
pub fn InfinitePast_175() -> absl_Time {
    return absl_Time::absl_Time1({ ({ MakeDuration_173(<i64>::MIN, !0_u32) }) });
}
pub fn operator_eq_176(a: absl_TimeZone, b: absl_TimeZone) -> bool {
...
pub fn operator_ne_177(a: absl_TimeZone, b: absl_TimeZone) -> bool {
    let a: Value<absl_TimeZone> = Rc::new(RefCell::new(a));
    let b: Value<absl_TimeZone> = Rc::new(RefCell::new(b));
    return ({
        let _lhs: absl_time_internal_cctz_time_zone = (*(*a.borrow()).cz_.borrow()).clone();
        let _rhs: absl_time_internal_cctz_time_zone = (*(*b.borrow()).cz_.borrow()).clone();
        operator_ne_120(_lhs, _rhs)
    });
}
pub fn operator_shl_178(os: Ptr<std::fs::File>, tz: absl_TimeZone) -> Ptr<std::fs::File> {
...
pub fn LoadTimeZone_179(name: Vec<u8>, tz: Ptr<absl_TimeZone>) -> bool {
    ...
    if (*name.borrow()).clone()
        == Ptr::from_string_literal(b"localtime")
            ...
            .collect::<Vec<u8>>()
    {
        let __rhs = absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_180() }) });
    ...
    let b: Value<bool> = Rc::new(RefCell::new(
        ({
            ...
            load_time_zone_181(_name.as_pointer(), (cz.as_pointer()))
        }),
    ));
...
pub fn FixedTimeZone_182(seconds: i32) -> absl_TimeZone {
    ...
    return absl_TimeZone::absl_TimeZone1({
        ({
            ...
            fixed_time_zone_183(_offset.as_pointer())
        })
    });
}
pub fn UTCTimeZone_184() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ utc_time_zone_185() }) });
}
pub fn LocalTimeZone_186() -> absl_TimeZone {
    return absl_TimeZone::absl_TimeZone1({ ({ local_time_zone_180() }) });
}
pub fn ToCivilSecond_187(
    t: absl_Time,
    tz: absl_TimeZone,
) -> absl_time_internal_cctz_detail_civil_time_absl_time_internal_second_tag_ {
...
thread_local!();
thread_local!();
pub fn operator_shl_200(os: Ptr<std::fs::File>, t: absl_Time) -> Ptr<std::fs::File> {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return os.write_all(
        &([(&({ FormatTime_201((*t.borrow()).clone()) })
            .iter()
            .take(({ FormatTime_201((*t.borrow()).clone()) }).len() - 1)
            .map(|&c| c as u8)
            .collect::<Vec<u8>>()[..] as &[u8])]
        .concat()),
    );
}
pub fn MakeDuration_173(hi: i64, lo: Option<u32>) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<u32> = Rc::new(RefCell::new(lo.unwrap_or(0_u32)));
    return absl_Duration::absl_Duration2({ (*hi.borrow()) }, { (*lo.borrow()) });
}
pub fn MakeDuration_202(hi: i64, lo: i64) -> absl_Duration {
    let hi: Value<i64> = Rc::new(RefCell::new(hi));
    let lo: Value<i64> = Rc::new(RefCell::new(lo));
    return ({ MakeDuration_173((*hi.borrow()), Some(((*lo.borrow()) as u32))) });
}
pub fn MakePosDoubleDuration_203(n: f64) -> absl_Duration {
    ...
    return if (((*ticks.borrow()) as i64) < 4000000000) {
        ({ MakeDuration_173((*int_secs.borrow()), Some((*ticks.borrow()))) })
    } else {
        ({
            MakeDuration_202(
...
pub fn MakeNormalizedDuration_127(sec: i64, ticks: i64) -> absl_Duration {
    let sec: Value<i64> = Rc::new(RefCell::new(sec));
    let ticks: Value<i64> = Rc::new(RefCell::new(ticks));
    return if ((*ticks.borrow()) < 0_i64) {
        ({ MakeDuration_202(((*sec.borrow()) - 1_i64), ((*ticks.borrow()) + 4000000000)) })
    } else {
        ({ MakeDuration_202((*sec.borrow()), (*ticks.borrow())) })
    };
}
pub fn GetRepHi_204(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return ({ absl_Duration_HiRepImpl::Get(&(*d.borrow()).rep_hi_.as_pointer()) });
}
pub fn GetRepLo_205(d: absl_Duration) -> u32 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (*(*d.borrow()).rep_lo_.borrow());
}
pub fn IsInfiniteDuration_206(d: absl_Duration) -> bool {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return (({ GetRepLo_205((*d.borrow()).clone()) }) == !0_u32);
}
pub fn OppositeInfinity_207(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepHi_204((*d.borrow()).clone()) }) < 0_i64) {
        ({ MakeDuration_173(<i64>::MAX, Some(!0_u32)) })
    } else {
        ({ MakeDuration_173(<i64>::MIN, Some(!0_u32)) })
    };
}
pub fn NegateAndSubtractOne_208(n: i64) -> i64 {
    let n: Value<i64> = Rc::new(RefCell::new(n));
...
pub fn FromUnixDuration_209(d: absl_Duration) -> absl_Time {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return absl_Time::absl_Time1({ (*d.borrow()).clone() });
}
pub fn ToUnixDuration_210(t: absl_Time) -> absl_Duration {
    let t: Value<absl_Time> = Rc::new(RefCell::new(t));
    return (*(*t.borrow()).rep_.borrow()).clone();
}
pub fn FromInt64_155(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return if (((*v.borrow()) <= (<i64>::MAX / 60_i64)) && ((*v.borrow()) >= (<i64>::MIN / 60_i64)))
    {
        ({ MakeDuration_173(((*v.borrow()) * 60_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_211() })
        } else {
            ({
                let _d: absl_Duration = ({ InfiniteDuration_211() });
                operator_neg_145(_d)
            })
        }
    };
}
pub fn FromInt64_157(v: i64, _a1: std_ratio______) -> absl_Duration {
    let v: Value<i64> = Rc::new(RefCell::new(v));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return if (((*v.borrow()) <= (<i64>::MAX / 3600_i64))
        && ((*v.borrow()) >= (<i64>::MIN / 3600_i64)))
    {
        ({ MakeDuration_173(((*v.borrow()) * 3600_i64), None) })
    } else {
        if ((*v.borrow()) > 0_i64) {
            ({ InfiniteDuration_211() })
        } else {
...
pub fn IsValidRep64_213(_a0: i32) -> bool {
    let _a0: Value<i32> = Rc::new(RefCell::new(_a0));
    return true;
}
pub fn FromChrono_214(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_126(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
...
pub fn FromChrono_217(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_130(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_218(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_155(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn FromChrono_219(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromInt64_157(({ (*d.upgrade().deref()).count() }), std_ratio______ {}) });
}
pub fn ToInt64_220(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Nanoseconds_221((*d.borrow()).clone()) });
}
pub fn ToInt64_222(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Microseconds_223((*d.borrow()).clone()) });
}
pub fn ToInt64_224(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Milliseconds_225((*d.borrow()).clone()) });
}
pub fn ToInt64_226(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Seconds_227((*d.borrow()).clone()) });
}
pub fn ToInt64_228(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Minutes_229((*d.borrow()).clone()) });
}
pub fn ToInt64_230(d: absl_Duration, _a1: std_ratio______) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let _a1: Value<std_ratio______> = Rc::new(RefCell::new(_a1));
    return ({ ToInt64Hours_231((*d.borrow()).clone()) });
}
pub fn operator_lt_134(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return if (({ GetRepHi_204((*lhs.borrow()).clone()) })
        != ({ GetRepHi_204((*rhs.borrow()).clone()) }))
    {
        (({ GetRepHi_204((*lhs.borrow()).clone()) }) < ({ GetRepHi_204((*rhs.borrow()).clone()) }))
    } else {
        if (({ GetRepHi_204((*lhs.borrow()).clone()) }) == <i64>::MIN) {
            (({ GetRepLo_205((*lhs.borrow()).clone()) }).wrapping_add(1_u32)
                < ({ GetRepLo_205((*rhs.borrow()).clone()) }).wrapping_add(1_u32))
        } else {
            (({ GetRepLo_205((*lhs.borrow()).clone()) })
                < ({ GetRepLo_205((*rhs.borrow()).clone()) }))
        }
    };
}
pub fn operator_cmp_131(lhs: absl_Duration, rhs: absl_Duration) -> std::cmp::Ordering {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    let lhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_204((*lhs.borrow()).clone()) })));
    let rhs_hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_204((*rhs.borrow()).clone()) })));
    {
    ...
    let lhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_205((*lhs.borrow()).clone()) })));
    let rhs_lo: Value<u32> = Rc::new(RefCell::new(({ GetRepLo_205((*rhs.borrow()).clone()) })));
...
pub fn operator_eq_132(lhs: absl_Duration, rhs: absl_Duration) -> bool {
    let lhs: Value<absl_Duration> = Rc::new(RefCell::new(lhs));
    let rhs: Value<absl_Duration> = Rc::new(RefCell::new(rhs));
    return (({ GetRepHi_204((*lhs.borrow()).clone()) })
        == ({ GetRepHi_204((*rhs.borrow()).clone()) }))
        && (({ GetRepLo_205((*lhs.borrow()).clone()) })
            == ({ GetRepLo_205((*rhs.borrow()).clone()) }));
}
pub fn operator_neg_145(d: absl_Duration) -> absl_Duration {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    return if (({ GetRepLo_205((*d.borrow()).clone()) }) == 0_u32) {
        if (({ GetRepHi_204((*d.borrow()).clone()) }) == <i64>::MIN) {
            ({ InfiniteDuration_211() })
        } else {
            ({ MakeDuration_173(-({ GetRepHi_204((*d.borrow()).clone()) }), None) })
        }
    } else {
        if ({ IsInfiniteDuration_206((*d.borrow()).clone()) }) {
            ({ OppositeInfinity_207((*d.borrow()).clone()) })
        } else {
            ({
                let _hi: i64 =
                    ({ NegateAndSubtractOne_208(({ GetRepHi_204((*d.borrow()).clone()) })) });
                let _lo: i64 = (4000000000 - (({ GetRepLo_205((*d.borrow()).clone()) }) as i64));
                MakeDuration_202(_hi, _lo)
            })
        }
    };
}
pub fn InfiniteDuration_211() -> absl_Duration {
    return ({ MakeDuration_173(<i64>::MAX, Some(!0_u32)) });
}
...
pub fn FromChrono_235(d: Ptr<std_chrono_duration_long_long__std_ratio_______>) -> absl_Duration {
...
pub fn FromChrono_237(d: Ptr<std_chrono_duration_long__std_ratio_______>) -> absl_Duration {
    return ({ FromChrono_219((d).clone()) });
}
pub fn FromUnixNanos_238(ns: i64) -> absl_Time {
    let ns: Value<i64> = Rc::new(RefCell::new(ns));
    return ({ FromUnixDuration_209(({ Nanoseconds_147((*ns.borrow())) })) });
}
pub fn FromUnixMicros_239(us: i64) -> absl_Time {
    let us: Value<i64> = Rc::new(RefCell::new(us));
    return ({ FromUnixDuration_209(({ Microseconds_149((*us.borrow())) })) });
}
pub fn FromUnixMillis_240(ms: i64) -> absl_Time {
    let ms: Value<i64> = Rc::new(RefCell::new(ms));
    return ({ FromUnixDuration_209(({ Milliseconds_151((*ms.borrow())) })) });
}
pub fn FromUnixSeconds_241(s: i64) -> absl_Time {
    let s: Value<i64> = Rc::new(RefCell::new(s));
    return ({ FromUnixDuration_209(({ Seconds_152((*s.borrow())) })) });
}
pub fn FromTimeT_242(t: i64) -> absl_Time {
    let t: Value<i64> = Rc::new(RefCell::new(t));
    return ({ FromUnixDuration_209(({ Seconds_153((*t.borrow())) })) });
}
pub fn ToInt64Nanoseconds_221(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_204((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_204((*d.borrow()).clone()) }) >> 33) == 0_i64)
    {
        return ((((({ GetRepHi_204((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_205((*d.borrow()).clone()) }) as i64) / 4));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_140(_lhs, ({ Nanoseconds_146(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Microseconds_223(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_204((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_204((*d.borrow()).clone()) }) >> 43) == 0_i64)
    {
        return (((({ GetRepHi_204((*d.borrow()).clone()) }) * 1000_i64) * 1000_i64)
            + ((({ GetRepLo_205((*d.borrow()).clone()) }) as i64) / (4 * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_140(_lhs, ({ Microseconds_148(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Milliseconds_225(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    if (({ GetRepHi_204((*d.borrow()).clone()) }) >= 0_i64)
        && ((({ GetRepHi_204((*d.borrow()).clone()) }) >> 53) == 0_i64)
    {
        return ((({ GetRepHi_204((*d.borrow()).clone()) }) * 1000_i64)
            + ((({ GetRepLo_205((*d.borrow()).clone()) }) as i64) / ((4 * 1000_i64) * 1000_i64)));
    } else {
        return ({
            let _lhs: absl_Duration = (*d.borrow()).clone();
            operator_div_140(_lhs, ({ Milliseconds_150(1) }))
        });
    }
    panic!("ub: non-void function does not return a value")
}
pub fn ToInt64Seconds_227(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_204((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_206((*d.borrow()).clone()) }) {
        return (*hi.borrow());
    }
    if ((*hi.borrow()) < 0_i64) && (({ GetRepLo_205((*d.borrow()).clone()) }) != 0_u32) {
        (*hi.borrow_mut()).prefix_inc();
    }
    return (*hi.borrow());
}
pub fn ToInt64Minutes_229(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_204((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_206((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn ToInt64Hours_231(d: absl_Duration) -> i64 {
    let d: Value<absl_Duration> = Rc::new(RefCell::new(d));
    let hi: Value<i64> = Rc::new(RefCell::new(({ GetRepHi_204((*d.borrow()).clone()) })));
    if ({ IsInfiniteDuration_206((*d.borrow()).clone()) }) {
        return (*hi.borrow());
...
pub fn SleepFor_243(duration: absl_Duration) {
    let duration: Value<absl_Duration> = Rc::new(RefCell::new(duration));
    ({ AbslInternalSleepFor_244((*duration.borrow()).clone()) });
}
thread_local!(
    static kNoTimeout_245: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
thread_local!(
    static kMaxNanos_246: Value<i64> = Rc::new(RefCell::new(9223372036854775807));
);
#[derive()]
...
pub fn GetOrCreateCurrentThreadIdentity_247() -> Ptr<absl_base_internal_ThreadIdentity> {
    let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
        Rc::new(RefCell::new(({ CurrentThreadIdentityIfPresent_248() })));
    if ((((false) || ((*identity.borrow()).is_null())) as i64) != 0) {
        return ({ CreateThreadIdentity_249() });
    }
...
impl absl_synchronization_internal_PerThreadSem {
    fn Init(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        ...
        ({ AbslInternalPerThreadSemInit_250((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Post(identity: Ptr<absl_base_internal_ThreadIdentity>) {
        let identity: Value<Ptr<absl_base_internal_ThreadIdentity>> =
            Rc::new(RefCell::new(identity));
        ({ AbslInternalPerThreadSemPost_251((*identity.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
    fn Wait(t: absl_synchronization_internal_KernelTimeout) -> bool {
        ...
        return ({ AbslInternalPerThreadSemWait_252((*t.borrow()).clone()) });
    }
}
impl absl_synchronization_internal_PerThreadSem {
...
thread_local!(
    pub static kKB_254: Value<usize> = Rc::new(RefCell::new(1024));
);
thread_local!(
    pub static kMB_255: Value<usize> = Rc::new(RefCell::new(1048576));
);
thread_local!(
    pub static kGB_256: Value<usize> = Rc::new(RefCell::new(1073741824));
);
...
thread_local!(
    pub static kAllocationGranularity_257: Value<usize> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kAllocationMask_258: Value<usize> = Rc::new(RefCell::new(7));
);
thread_local!(
    pub static kPageSizeLog2_259: Value<usize> = Rc::new(RefCell::new(17));
);
thread_local!(
    pub static kPageSize_260: Value<usize> = Rc::new(RefCell::new(131072));
);
thread_local!(
    pub static kPageOffsetMask_261: Value<usize> = Rc::new(RefCell::new(131071));
);
thread_local!(
    pub static kPageBaseMask_262: Value<usize> = Rc::new(RefCell::new(18446744073709420544));
);
thread_local!(
    pub static kLargeObjectSizeThreshold_263: Value<usize> = Rc::new(RefCell::new(65536));
);
thread_local!(
    pub static kFreeListGCInfoIndex_264: Value<u16> = Rc::new(RefCell::new(0));
);
thread_local!(
    pub static kFreeListEntrySize_265: Value<usize> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kSlotSize_266: Value<usize> = Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kKB_267: Value<usize> = Rc::new(RefCell::new(1024));
);
thread_local!(
    pub static kMB_268: Value<usize> = Rc::new(RefCell::new(1048576));
);
thread_local!(
    pub static kGB_269: Value<usize> = Rc::new(RefCell::new(1073741824));
);
thread_local!(
    pub static kFullyConstructedBitFieldOffsetFromPayload_270: Value<usize> =
        Rc::new(RefCell::new(4));
);
thread_local!(
    pub static kFullyConstructedBitMask_271: Value<u16> = Rc::new(RefCell::new(32768));
);
thread_local!(
    pub static kPageSizeBits_272: Value<usize> = Rc::new(RefCell::new(17));
);
thread_local!(
    pub static kPageSize_273: Value<usize> = Rc::new(RefCell::new(131072));
);
thread_local!(
    pub static kLargeObjectSizeThreshold_274: Value<usize> = Rc::new(RefCell::new(65536));
);
thread_local!(
    pub static kPointerCompressionShift_275: Value<u32> = Rc::new(RefCell::new(3));
);
thread_local!(
    pub static kCagedHeapDefaultReservationSize_276: Value<usize> =
        Rc::new(RefCell::new(4294967296));
);
thread_local!(
    pub static kCagedHeapMaxReservationSize_277: Value<usize> = Rc::new(RefCell::new(17179869184));
);
thread_local!(
    pub static kCagedHeapReservationAlignment_278: Value<usize> =
        Rc::new(RefCell::new(17179869184));
);
thread_local!(
    pub static kDefaultAlignment_279: Value<usize> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kMaxSupportedAlignment_280: Value<usize> = Rc::new(RefCell::new(16));
);
thread_local!(
    pub static kAllocationGranularity_281: Value<usize> = Rc::new(RefCell::new(8));
);
thread_local!(
    pub static kCachelineSize_282: Value<usize> = Rc::new(RefCell::new(64));
);
#[derive(Default)]
pub struct cppgc_HeapHandle {
    is_incremental_marking_in_progress_: Value<bool>,
    is_young_generation_enabled_: Value<bool>,
}
impl ByteRepr for cppgc_HeapHandle {
    fn byte_size() -> usize {
        2
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.is_incremental_marking_in_progress_.borrow()).to_bytes(&mut buf[0..1]);
        (*self.is_young_generation_enabled_.borrow()).to_bytes(&mut buf[1..2]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            is_incremental_marking_in_progress_: Rc::new(RefCell::new(<bool>::from_bytes(
                &buf[0..1],
            ))),
            is_young_generation_enabled_: Rc::new(RefCell::new(<bool>::from_bytes(&buf[1..2]))),
        }
    }
}
#[derive(Default)]
pub struct cppgc_internal_BasePageHandle {
    heap_handle_: Ptr<cppgc_HeapHandle>,
}
impl cppgc_internal_BasePageHandle {
    pub fn FromPayload_AnyPtr(payload: AnyPtr) -> Ptr<cppgc_internal_BasePageHandle> {
        let payload: Value<AnyPtr> = Rc::new(RefCell::new(payload));
        return {
            let _lhs = (*payload.borrow()).to_int();
            _lhs & (!((131072).wrapping_sub(1_usize)) as u64)
        }
        .reinterpret_cast::<cppgc_internal_BasePageHandle>();
    }
    pub fn FromPayload_AnyPtr(payload: AnyPtr) -> Ptr<cppgc_internal_BasePageHandle> {
        let payload: Value<AnyPtr> = Rc::new(RefCell::new(payload));
        return ({ cppgc_internal_BasePageHandle::FromPayload((*payload.borrow()).clone()) });
    }
    fn cppgc_internal_BasePageHandle(heap_handle: Ptr<cppgc_HeapHandle>) -> Self {
        let __this: Value<cppgc_internal_BasePageHandle> = Rc::new(RefCell::new(Self {
            heap_handle_: (heap_handle).clone(),
        }));
        let this: Ptr<cppgc_internal_BasePageHandle> = __this.as_pointer();
        (&(cppgc_internal_EatParams_const_char__ref_arr_arr_ {}));
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Clone for cppgc_internal_BasePageHandle {
    fn clone(&self) -> Self {
        let __this: Value<cppgc_internal_BasePageHandle> = Rc::new(RefCell::new(Self {
            heap_handle_: (self.heap_handle_).clone(),
        }));
        let this: Ptr<cppgc_internal_BasePageHandle> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for cppgc_internal_BasePageHandle {}
thread_local!();
thread_local!();
#[derive(Default)]
pub struct cppgc_internal_CagedHeapBase {}
impl cppgc_internal_CagedHeapBase {
    pub fn OffsetFromAddress(address: AnyPtr) -> u64 {
        let address: Value<AnyPtr> = Rc::new(RefCell::new(address));
        return {
            let _lhs = (*address.borrow()).to_int();
            _lhs & (((17179869184).wrapping_sub(1_usize)) as u64)
        };
    }
    pub fn IsWithinCage(address: AnyPtr) -> bool {
        let address: Value<AnyPtr> = Rc::new(RefCell::new(address));
        (&(cppgc_internal_EatParams_const_char__ref_arr_arr_ {}));
        return {
            let _lhs = ({
            ...
            _lhs == (*g_heap_base__283.with(Value::clone).borrow())
        };
    }
    pub fn AreWithinCage(addr1: AnyPtr, addr2: AnyPtr) -> bool {
        let addr1: Value<AnyPtr> = Rc::new(RefCell::new(addr1));
        let addr2: Value<AnyPtr> = Rc::new(RefCell::new(addr2));
        thread_local!(
            static kHeapBaseShift_285: Value<usize> = Rc::new(RefCell::new(34));
        );
        (&(cppgc_internal_EatParams_const_char__ref_arr_arr_ {}));
        return !(({
            let _lhs = ({
                let _lhs = ({
                    let _lhs = (*addr1.borrow()).to_int();
                    _lhs ^ (*g_heap_base__283.with(Value::clone).borrow())
                });
                _lhs | ({
                    let _lhs = (*addr2.borrow()).to_int();
                    _lhs ^ (*g_heap_base__283.with(Value::clone).borrow())
                })
            });
            _lhs >> 34
    ...
    pub fn GetBase() -> u64 {
        return (*g_heap_base__283.with(Value::clone).borrow());
    }
    pub fn GetAgeTableSize() -> usize {
        return (*g_age_table_size__284.with(Value::clone).borrow());
    }
}
impl Clone for cppgc_internal_CagedHeapBase {
    fn clone(&self) -> Self {
        let __this: Value<cppgc_internal_CagedHeapBase> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<cppgc_internal_CagedHeapBase> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for cppgc_internal_CagedHeapBase {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_AddressRegion_StartAddressLess {}
impl Clone for v8_base_AddressRegion_StartAddressLess {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_AddressRegion_StartAddressLess> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_AddressRegion_StartAddressLess> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_AddressRegion_StartAddressLess {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_AddressRegion {
    address_: Value<u64>,
    size_: Value<usize>,
}
impl v8_base_AddressRegion {
    pub fn v8_base_AddressRegion1(address: u64, size: usize) -> Self {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let __this: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(Self {
            address_: Rc::new(RefCell::new((*address.borrow()))),
            size_: Rc::new(RefCell::new((*size.borrow()))),
        }));
        let this: Ptr<v8_base_AddressRegion> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl std::cmp::PartialEq for v8_base_AddressRegion {
    fn eq(&self, other: &Self) -> bool {
        {
            v8_base_AddressRegionImpl::operator_eq(
                &Rc::new(RefCell::new(v8_base_AddressRegion {
                    address_: self.address_.clone(),
                    size_: self.size_.clone(),
                }))
                .as_pointer(),
                Rc::new(RefCell::new(v8_base_AddressRegion {
...
impl std::cmp::Eq for v8_base_AddressRegion {}
impl Clone for v8_base_AddressRegion {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(Self {
            address_: Rc::new(RefCell::new((*self.address_.borrow()))),
            size_: Rc::new(RefCell::new((*self.size_.borrow()))),
        }));
        let this: Ptr<v8_base_AddressRegion> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
...
impl ByteRepr for v8_base_AddressRegion {
    fn byte_size() -> usize {
        16
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.address_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.size_.borrow()).to_bytes(&mut buf[8..16]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            address_: Rc::new(RefCell::new(<u64>::from_bytes(&buf[0..8]))),
            size_: Rc::new(RefCell::new(<usize>::from_bytes(&buf[8..16]))),
        }
    }
}
pub fn operator_shl_286(
    out: Ptr<std::fs::File>,
    region: v8_base_AddressRegion,
) -> Ptr<std::fs::File> {
    let region: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(region));
    return write!(
        out,
        "[{:}+{:}]",
        Rc::new(RefCell::new(
            ({ v8_base_AddressRegionImpl::begin(&region.as_pointer(),) })
        ))
        .as_pointer()
        .reinterpret_cast::<::libc::c_void>(),
        Rc::new(RefCell::new(
            ({ v8_base_AddressRegionImpl::size(&region.as_pointer(),) })
        ))
        .as_pointer(),
    );
}
thread_local!(
    static kMultiplier_287: Value<i64> = Rc::new(RefCell::new(25214903917_i64));
);
thread_local!(
    static kAddend_288: Value<i64> = Rc::new(RefCell::new(11_i64));
);
thread_local!(
    static kMask_289: Value<i64> = Rc::new(RefCell::new(281474976710655_i64));
);
#[derive()]
...
thread_local!(
    pub static kAllocationFailure_290: Value<u64> = Rc::new(RefCell::new(18446744073709551615));
);
pub type v8_base_RegionAllocator_RegionState = i32;
pub const v8_base_RegionAllocator_RegionState_kFree: v8_base_RegionAllocator_RegionState = 0;
pub const v8_base_RegionAllocator_RegionState_kExcluded: v8_base_RegionAllocator_RegionState = 1;
pub const v8_base_RegionAllocator_RegionState_kAllocated: v8_base_RegionAllocator_RegionState = 2;
pub type v8_base_RegionAllocator_AllocationStrategy = i32;
pub const v8_base_RegionAllocator_AllocationStrategy_kFirstFit:
    v8_base_RegionAllocator_AllocationStrategy = 0;
pub const v8_base_RegionAllocator_AllocationStrategy_kLargestFit:
    v8_base_RegionAllocator_AllocationStrategy = 1;
#[derive(Default)]
struct v8_base_RegionAllocator_Region {
    state_: Value<v8_base_RegionAllocator_RegionState>,
}
impl v8_base_RegionAllocator_Region {
    pub fn v8_base_RegionAllocator_Region(
        address: u64,
        size: usize,
        state: v8_base_RegionAllocator_RegionState,
    ) -> Self {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let state: Value<v8_base_RegionAllocator_RegionState> = Rc::new(RefCell::new(state));
        let __this: Value<v8_base_RegionAllocator_Region> = Rc::new(RefCell::new(Self {
            state_: Rc::new(RefCell::new((*state.borrow()))),
        }));
        let this: Ptr<v8_base_RegionAllocator_Region> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl Clone for v8_base_RegionAllocator_Region {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_RegionAllocator_Region> = Rc::new(RefCell::new(Self {
...
impl ByteRepr for v8_base_RegionAllocator_Region {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.state_.borrow()).to_bytes(&mut buf[16..20]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            state_: Rc::new(RefCell::new(
                <v8_base_RegionAllocator_RegionState>::from_bytes(&buf[16..20]),
            )),
        }
    }
}
#[derive(Default)]
struct v8_base_RegionAllocator_AddressEndOrder {}
impl Clone for v8_base_RegionAllocator_AddressEndOrder {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_RegionAllocator_AddressEndOrder> = Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_RegionAllocator_AddressEndOrder> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_RegionAllocator_AddressEndOrder {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
struct v8_base_RegionAllocator_SizeAddressOrder {}
impl Clone for v8_base_RegionAllocator_SizeAddressOrder {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_RegionAllocator_SizeAddressOrder> =
            Rc::new(RefCell::new(Self {}));
        let this: Ptr<v8_base_RegionAllocator_SizeAddressOrder> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_RegionAllocator_SizeAddressOrder {
    fn byte_size() -> usize {
        1
    }
    fn to_bytes(&self, buf: &mut [u8]) {}
...
#[derive(Default)]
pub struct v8_base_RegionAllocator {  whole_region_ : Value<v8_base_RegionAllocator_Region > ,  region_size_in_pages_ : Value<usize > ,  max_load_for_randomization_ : Value<usize > ,  free_size_ : Value<usize > ,  page_size_ : Value<usize > ,  all_regions_ : Value<std_set_v8_base_RegionAllocator_Region_ptr__v8_base_RegionAllocator_AddressEndOrder__std_allocator_v8_base_RegionAllocator_Region_ptr__ > ,  free_regions_ : Value<std_set_v8_base_RegionAllocator_Region_ptr__v8_base_RegionAllocator_SizeAddressOrder__std_allocator_v8_base_RegionAllocator_Region_ptr__ > ,  on_split_ : Value<std_function_void__unsigned_long__unsigned_long__ > ,  on_merge_ : Value<std_function_void__unsigned_long__unsigned_long__ > , }
impl v8_base_RegionAllocator {}
impl ByteRepr for v8_base_RegionAllocator {
    fn byte_size() -> usize {
        168
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.whole_region_.borrow()).to_bytes(&mut buf[0..24]);
        (*self.region_size_in_pages_.borrow()).to_bytes(&mut buf[24..32]);
        (*self.max_load_for_randomization_.borrow()).to_bytes(&mut buf[32..40]);
        (*self.free_size_.borrow()).to_bytes(&mut buf[40..48]);
        (*self.page_size_.borrow()).to_bytes(&mut buf[48..56]);
        (*self.all_regions_.borrow()).to_bytes(&mut buf[56..80]);
        (*self.free_regions_.borrow()).to_bytes(&mut buf[80..104]);
        (*self.on_split_.borrow()).to_bytes(&mut buf[104..136]);
        (*self.on_merge_.borrow()).to_bytes(&mut buf[136..168]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self { whole_region_: Rc::new(RefCell::new(<v8_base_RegionAllocator_Region >::from_bytes(&buf[0..24]))), region_size_in_pages_: Rc::new(RefCell::new(<usize >::from_bytes(&buf[24..32]))), max_load_for_randomization_: Rc::new(RefCell::new(<usize >::from_bytes(&buf[32..40]))), free_size_: Rc::new(RefCell::new(<usize >::from_bytes(&buf[40..48]))), page_size_: Rc::new(RefCell::new(<usize >::from_bytes(&buf[48..56]))), all_regions_: Rc::new(RefCell::new(<std_set_v8_base_RegionAllocator_Region_ptr__v8_base_RegionAllocator_AddressEndOrder__std_allocator_v8_base_RegionAllocator_Region_ptr__ >::from_bytes(&buf[56..80]))), free_regions_: Rc::new(RefCell::new(<std_set_v8_base_RegionAllocator_Region_ptr__v8_base_RegionAllocator_SizeAddressOrder__std_allocator_v8_base_RegionAllocator_Region_ptr__ >::from_bytes(&buf[80..104]))), on_split_: Rc::new(RefCell::new(<std_function_void__unsigned_long__unsigned_long__ >::from_bytes(&buf[104..136]))), on_merge_: Rc::new(RefCell::new(<std_function_void__unsigned_long__unsigned_long__ >::from_bytes(&buf[136..168]))), }
    }
}
pub type v8_base_PageInitializationMode = i32;
pub const v8_base_PageInitializationMode_kAllocatedPagesMustBeZeroInitialized:
    v8_base_PageInitializationMode = 0;
pub const v8_base_PageInitializationMode_kAllocatedPagesCanBeUninitialized:
    v8_base_PageInitializationMode = 1;
pub const v8_base_PageInitializationMode_kRecommitOnly: v8_base_PageInitializationMode = 2;
pub type v8_base_PageFreeingMode = i32;
pub const v8_base_PageFreeingMode_kMakeInaccessible: v8_base_PageFreeingMode = 0;
pub const v8_base_PageFreeingMode_kDiscard: v8_base_PageFreeingMode = 1;
pub type v8_base_BoundedPageAllocator_AllocationStatus = i32;
pub const v8_base_BoundedPageAllocator_AllocationStatus_kSuccess:
    v8_base_BoundedPageAllocator_AllocationStatus = 0;
pub const v8_base_BoundedPageAllocator_AllocationStatus_kFailedToCommit:
    v8_base_BoundedPageAllocator_AllocationStatus = 1;
pub const v8_base_BoundedPageAllocator_AllocationStatus_kRanOutOfReservation:
    v8_base_BoundedPageAllocator_AllocationStatus = 2;
pub const v8_base_BoundedPageAllocator_AllocationStatus_kHintedAddressTakenOrNotFound:
    v8_base_BoundedPageAllocator_AllocationStatus = 3;
#[derive(Default)]
pub struct v8_base_BoundedPageAllocator_Stats {
    pub free_size: Value<usize>,
    pub largest_free_region: Value<usize>,
    pub allocation_status: Value<v8_base_BoundedPageAllocator_AllocationStatus>,
}
impl Clone for v8_base_BoundedPageAllocator_Stats {
    fn clone(&self) -> Self {
        let __this: Value<v8_base_BoundedPageAllocator_Stats> = Rc::new(RefCell::new(Self {
            free_size: Rc::new(RefCell::new((*self.free_size.borrow()))),
            largest_free_region: Rc::new(RefCell::new((*self.largest_free_region.borrow()))),
            allocation_status: Rc::new(RefCell::new((*self.allocation_status.borrow()))),
        }));
        let this: Ptr<v8_base_BoundedPageAllocator_Stats> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for v8_base_BoundedPageAllocator_Stats {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.free_size.borrow()).to_bytes(&mut buf[0..8]);
        (*self.largest_free_region.borrow()).to_bytes(&mut buf[8..16]);
        (*self.allocation_status.borrow()).to_bytes(&mut buf[16..20]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            free_size: Rc::new(RefCell::new(<usize>::from_bytes(&buf[0..8]))),
            largest_free_region: Rc::new(RefCell::new(<usize>::from_bytes(&buf[8..16]))),
            allocation_status: Rc::new(RefCell::new(
                <v8_base_BoundedPageAllocator_AllocationStatus>::from_bytes(&buf[16..20]),
            )),
        }
    }
}
#[derive(Default)]
pub struct v8_base_BoundedPageAllocator {
    mutex_: Value<v8_base_Mutex>,
    allocate_page_size_: Value<usize>,
    commit_page_size_: Value<usize>,
    page_allocator_: Value<PtrDyn<dyn v8_PageAllocator>>,
    region_allocator_: Value<v8_base_RegionAllocator>,
    page_initialization_mode_: Value<v8_base_PageInitializationMode>,
    page_freeing_mode_: Value<v8_base_PageFreeingMode>,
    allocation_status_: Value<v8_base_BoundedPageAllocator_AllocationStatus>,
}
impl v8_base_BoundedPageAllocator {}
impl v8_PageAllocator for v8_base_BoundedPageAllocator {
    fn AllocatePageSize(&self) -> usize {
        return (*self.allocate_page_size_.borrow());
    }
    fn CommitPageSize(&self) -> usize {
...
impl ByteRepr for v8_base_BoundedPageAllocator {
    fn byte_size() -> usize {
        224
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        ...
        (*self.allocate_page_size_.borrow()).to_bytes(&mut buf[16..24]);
        (*self.commit_page_size_.borrow()).to_bytes(&mut buf[24..32]);
        (*self.page_allocator_.borrow()).to_bytes(&mut buf[32..40]);
        (*self.region_allocator_.borrow()).to_bytes(&mut buf[40..208]);
        (*self.page_initialization_mode_.borrow()).to_bytes(&mut buf[208..212]);
        (*self.page_freeing_mode_.borrow()).to_bytes(&mut buf[212..216]);
        (*self.allocation_status_.borrow()).to_bytes(&mut buf[216..220]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            mutex_: Rc::new(RefCell::new(<v8_base_Mutex>::from_bytes(&buf[8..16]))),
            ...
            region_allocator_: Rc::new(RefCell::new(<v8_base_RegionAllocator>::from_bytes(
                &buf[40..208],
            ))),
            page_initialization_mode_: Rc::new(RefCell::new(
                <v8_base_PageInitializationMode>::from_bytes(&buf[208..212]),
            )),
            page_freeing_mode_: Rc::new(RefCell::new(<v8_base_PageFreeingMode>::from_bytes(
                &buf[212..216],
            ))),
            allocation_status_: Rc::new(RefCell::new(
                <v8_base_BoundedPageAllocator_AllocationStatus>::from_bytes(&buf[216..220]),
            )),
        }
    }
}
pub fn ToString_291(status: v8_base_BoundedPageAllocator_AllocationStatus) -> Ptr<u8> {
    let status: Value<v8_base_BoundedPageAllocator_AllocationStatus> =
        Rc::new(RefCell::new(status));
    'switch: {
        let __match_cond = (*status.borrow());
        match __match_cond {
            __v if __v == 0 => {
                return Ptr::from_string_literal(b"success");
            }
            __v if __v == 1 => {
                return Ptr::from_string_literal(b"failed to commit");
            }
            __v if __v == 2 => {
                return Ptr::from_string_literal(b"ran out of reservation");
            }
            __v if __v == 3 => {
                return Ptr::from_string_literal(b"hinted address taken or not found");
            }
            _ => {}
        }
    };
    ({
        V8_Fatal_292(
            (*kUnreachableCodeMessage_20.with(Value::clone).borrow()).clone(),
            &[],
        )
    });
    panic!("ub: non-void function does not return a value")
...
#[derive(Default)]
pub struct cppgc_internal_VirtualMemory {
    page_allocator_: Value<PtrDyn<dyn v8_PageAllocator>>,
    start_: Value<AnyPtr>,
    size_: Value<usize>,
}
impl cppgc_internal_VirtualMemory {}
impl ByteRepr for cppgc_internal_VirtualMemory {
    fn byte_size() -> usize {
        24
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.page_allocator_.borrow()).to_bytes(&mut buf[0..8]);
        (*self.start_.borrow()).to_bytes(&mut buf[8..16]);
    ...
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            ...
            start_: Rc::new(RefCell::new(<AnyPtr>::from_bytes(&buf[8..16]))),
...
thread_local!();
#[derive(Default)]
struct cppgc_internal_CagedHeap_Reservation {
    pub memory: Value<cppgc_internal_VirtualMemory>,
    pub offset_into_cage_start: Value<usize>,
}
impl cppgc_internal_CagedHeap_Reservation {
    pub fn Reservation_pmutcppgc_internal_CagedHeap_Reservation(
        _a0: Ptr<cppgc_internal_CagedHeap_Reservation>,
    ) -> Self {
        let __this: Value<cppgc_internal_CagedHeap_Reservation> = Rc::new(RefCell::new(Self {
            memory: Rc::new(RefCell::new(
                (*(*_a0.upgrade().deref()).memory.borrow()).clone(),
            )),
            offset_into_cage_start: Rc::new(RefCell::new(
                (*(*_a0.upgrade().deref()).offset_into_cage_start.borrow()),
            )),
        }));
        let this: Ptr<cppgc_internal_CagedHeap_Reservation> = __this.as_pointer();
        Rc::try_unwrap(__this).ok().unwrap().into_inner()
    }
}
impl ByteRepr for cppgc_internal_CagedHeap_Reservation {
    fn byte_size() -> usize {
        32
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.memory.borrow()).to_bytes(&mut buf[0..24]);
        (*self.offset_into_cage_start.borrow()).to_bytes(&mut buf[24..32]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            memory: Rc::new(RefCell::new(<cppgc_internal_VirtualMemory>::from_bytes(
                &buf[0..24],
            ))),
            offset_into_cage_start: Rc::new(RefCell::new(<usize>::from_bytes(&buf[24..32]))),
        }
    }
}
#[derive(Default)]
pub struct cppgc_internal_CagedHeap {
    reservation_: Value<cppgc_internal_CagedHeap_Reservation>,
    page_bounded_allocator_: Value<Option<Value<v8_base_BoundedPageAllocator>>>,
}
impl cppgc_internal_CagedHeap {
    pub fn BaseFromAddress(address: AnyPtr) -> u64 {
        let address: Value<AnyPtr> = Rc::new(RefCell::new(address));
        return {
            let _lhs = (*address.borrow()).to_int();
            _lhs & (!((17179869184).wrapping_sub(1_usize)) as u64)
...
impl ByteRepr for cppgc_internal_CagedHeap {
    fn byte_size() -> usize {
        40
    }
    fn to_bytes(&self, buf: &mut [u8]) {
        (*self.reservation_.borrow()).to_bytes(&mut buf[0..32]);
        (*self.page_bounded_allocator_.borrow()).to_bytes(&mut buf[32..40]);
    }
    fn from_bytes(buf: &[u8]) -> Self {
        Self {
            reservation_: Rc::new(RefCell::new(
                <cppgc_internal_CagedHeap_Reservation>::from_bytes(&buf[0..32]),
            )),
            page_bounded_allocator_: Rc::new(RefCell::new(<Option<
                Value<v8_base_BoundedPageAllocator>,
            >>::from_bytes(&buf[32..40]))),
        }
    }
}
thread_local!(
    pub static g_page_allocator_294: Value<PtrDyn<dyn v8_PageAllocator>> =
        Rc::new(RefCell::new(Ptr::<dyn v8_PageAllocator>::null()));
);
pub fn CreateAllocatorIfNeeded_295(
    page_allocator: PtrDyn<dyn v8_PageAllocator>,
) -> Ptr<v8_PageAllocator> {
    let page_allocator: Value<PtrDyn<dyn v8_PageAllocator>> = Rc::new(RefCell::new(page_allocator));
    if !(!(*page_allocator.borrow()).is_null()) {
        thread_local!(
            static  default_page_allocator_296 : Value<v8_base_LeakyObject_v8_base_PageAllocator_ > = Rc::new(RefCell::new(v8_base_LeakyObject_v8_base_PageAllocator_ :: v8_base_LeakyObject_v8_base_PageAllocator_ ( ) )) ;
        );
        (*page_allocator.borrow_mut()) = (({
            v8_base_LeakyObject_v8_base_PageAllocator_Impl::get(
                &default_page_allocator_296.with(Value::clone).as_pointer(),
            )
        })
        .to_strong() as Value<dyn v8_PageAllocator>)
            .as_pointer_dyn();
    }
    return (*page_allocator.borrow()).clone();
}
pub fn Fatal_297(reason: Option<Ptr<Vec<u8>>>, loc: Option<v8_SourceLocation>) {
    ...
    ({
        V8_Fatal_292(
            ...
            &[(reason.to_strong().as_pointer() as Ptr<u8>).into()],
        )
    });
}
pub fn GetGlobalOOMHandler_298() -> Ptr<cppgc_internal_FatalOutOfMemoryHandler> {
    thread_local!(
        static oom_handler_299: Value<cppgc_internal_FatalOutOfMemoryHandler> = Rc::new(
            RefCell::new(<cppgc_internal_FatalOutOfMemoryHandler>::default()),
        );
    );
    return oom_handler_299.with(Value::clone).as_pointer();
}
pub fn GetGlobalPageAllocator_300() -> Ptr<v8_PageAllocator> {
    let mut __do_while = true;
    'loop_: while __do_while || (false) {
        __do_while = false;
        if ((!(!(!(!((*g_page_allocator_294.with(Value::clone).borrow()).is_null())))) as i64) != 0)
        {
            ({
                V8_Fatal_292(
                    Ptr::from_string_literal(b"Check failed: %s."),
                    &[(Ptr::from_string_literal(b"(g_page_allocator) != nullptr")).into()],
                )
            });
        }
    }
    return (*g_page_allocator_294.with(Value::clone).borrow()).clone();
}
pub fn IsInitialized_301() -> bool {
    return !((*g_page_allocator_294.with(Value::clone).borrow()).is_null());
}
pub fn InitializeProcess_302(
    page_allocator: Option<PtrDyn<dyn v8_PageAllocator>>,
    desired_heap_size: Option<usize>,
) {
    let page_allocator: Value<PtrDyn<dyn v8_PageAllocator>> = Rc::new(RefCell::new(
        page_allocator.unwrap_or(Ptr::<dyn v8_PageAllocator>::null()),
    ));
    let desired_heap_size: Value<usize> =
        Rc::new(RefCell::new(desired_heap_size.unwrap_or(0_usize)));
    let allocator: Ptr<v8_PageAllocator> =
        ({ CreateAllocatorIfNeeded_295((*page_allocator.borrow()).clone()) });
    let mut __do_while = true;
    'loop_: while __do_while || (false) {
        __do_while = false;
        if ((!(!(!(!(!(*g_page_allocator_294.with(Value::clone).borrow()).is_null())))) as i64)
            != 0)
        {
            ({
                V8_Fatal_292(
                    Ptr::from_string_literal(b"Check failed: %s."),
                    &[(Ptr::from_string_literal(b"!internal::g_page_allocator")).into()],
                )
            });
        }
    }
    ({ cppgc_internal_GlobalGCInfoTable::Initialize((allocator).clone()) });
    ({
        let _platform_allocator: Ptr<v8_PageAllocator> = (allocator).clone();
        let _desired_heap_size: usize = (*desired_heap_size.borrow());
        cppgc_internal_CagedHeap::InitializeIfNeeded(_platform_allocator, _desired_heap_size)
    });
    (*g_page_allocator_294.with(Value::clone).borrow_mut()) = (allocator).clone();
}
pub fn ShutdownProcess_303() {
    (*g_page_allocator_294.with(Value::clone).borrow_mut()) = Ptr::<dyn v8_PageAllocator>::null();
}
...
pub trait cppgc_HeapHandleImpl {
    fn is_incremental_marking_in_progress(&self) -> bool;
    fn is_young_generation_enabled(&self) -> bool;
}
impl cppgc_HeapHandleImpl for Ptr<cppgc_HeapHandle> {
    fn is_incremental_marking_in_progress(&self) -> bool {
        return (*(*(*self).upgrade().deref())
...
pub trait cppgc_internal_BasePageHandleImpl {
    fn heap_handle(&self) -> Ptr<cppgc_HeapHandle>;
    fn heap_handle_const(&self) -> Ptr<cppgc_HeapHandle>;
}
impl cppgc_internal_BasePageHandleImpl for Ptr<cppgc_internal_BasePageHandle> {
    fn heap_handle(&self) -> Ptr<cppgc_HeapHandle> {
        return ((*(*self).upgrade().deref()).heap_handle_).clone();
    }
    fn heap_handle_const(&self) -> Ptr<cppgc_HeapHandle> {
        return ((*(*self).upgrade().deref()).heap_handle_).clone();
    }
}
pub trait cppgc_internal_CagedHeapImpl {
    fn page_allocator(&self) -> Ptr<v8_base_BoundedPageAllocator>;
    fn page_allocator_const(&self) -> Ptr<v8_base_BoundedPageAllocator>;
    fn IsOnHeap(&self, address: AnyPtr) -> bool;
    fn base(&self) -> AnyPtr;
}
impl cppgc_internal_CagedHeapImpl for Ptr<cppgc_internal_CagedHeap> {
    fn page_allocator(&self) -> Ptr<v8_base_BoundedPageAllocator> {
        return (*(*(*self).upgrade().deref())
    ...
    fn IsOnHeap(&self, address: AnyPtr) -> bool {
        ...
        (&(0));
        return {
            let _lhs = ({ cppgc_internal_CagedHeap::BaseFromAddress((*address.borrow()).clone()) })
                .reinterpret_cast::<::libc::c_void>();
            _lhs == ({
                cppgc_internal_VirtualMemoryImpl::address(
                    &(*(*(*self).upgrade().deref()).reservation_.borrow())
                        .memory
                        .as_pointer(),
                )
            })
...
pub trait cppgc_internal_CagedHeap_ReservationImpl {
    fn operator_assign_pmutcppgc_internal_CagedHeap_Reservation(
        &self,
        _a0: Ptr<cppgc_internal_CagedHeap_Reservation>,
    ) -> Ptr<cppgc_internal_CagedHeap_Reservation>;
}
impl cppgc_internal_CagedHeap_ReservationImpl for Ptr<cppgc_internal_CagedHeap_Reservation> {
    fn operator_assign_pmutcppgc_internal_CagedHeap_Reservation(
        &self,
        _a0: Ptr<cppgc_internal_CagedHeap_Reservation>,
    ) -> Ptr<cppgc_internal_CagedHeap_Reservation> {
        ({
            let _arg0: Ptr<cppgc_internal_VirtualMemory> =
                (*_a0.upgrade().deref()).memory.as_pointer();
            cppgc_internal_VirtualMemoryImpl::operator_assign_pmutcppgc_internal_VirtualMemory(
                &(*(*self).upgrade().deref()).memory.as_pointer(),
                _arg0,
            )
        });
        let __rhs = (*(*_a0.upgrade().deref()).offset_into_cage_start.borrow());
        (*(*(*self).upgrade().deref())
            .offset_into_cage_start
            .borrow_mut()) = __rhs;
        return (*self).clone();
    }
}
pub trait cppgc_internal_FatalOutOfMemoryHandlerImpl {
    fn operator_call(&self, reason: Option<Ptr<Vec<u8>>>, loc: Option<v8_SourceLocation>);
    fn SetCustomHandler(
        &self,
        callback: FnPtr<fn(Ptr<Vec<u8>>, v8_SourceLocation, Ptr<cppgc_internal_HeapBase>)>,
    );
}
impl cppgc_internal_FatalOutOfMemoryHandlerImpl for Ptr<cppgc_internal_FatalOutOfMemoryHandler> {
    fn operator_call(&self, reason: Option<Ptr<Vec<u8>>>, loc: Option<v8_SourceLocation>) {
        let loc: Value<v8_SourceLocation> = Rc::new(RefCell::new(
            loc.unwrap_or(({ v8_SourceLocation::Current(None) })),
        ));
        if !(*(*(*self).upgrade().deref()).custom_handler_.borrow()).is_null() {
            ({
                let _arg0: Ptr<Vec<u8>> = (reason).clone();
                let _arg1: v8_SourceLocation = (*loc.borrow()).clone();
                let _arg2: Ptr<cppgc_internal_HeapBase> =
                    (*(*(*self).upgrade().deref()).heap_.borrow()).clone();
                (*(*(*(*self).upgrade().deref()).custom_handler_.borrow()))(_arg0, _arg1, _arg2)
            });
            ({
                V8_Fatal_292(
                    Ptr::from_string_literal(
                        b"Custom out of memory handler should not have returned",
                    ),
                    &[],
                )
            });
        ...
        ({
            V8_Fatal_292(
                Ptr::from_string_literal(b"Oilpan: Out of memory (%s)"),
                &[(reason.to_strong().as_pointer() as Ptr<u8>).into()],
            )
        });
    }
    fn SetCustomHandler(
        ...
        let callback: Value<
            FnPtr<fn(Ptr<Vec<u8>>, v8_SourceLocation, Ptr<cppgc_internal_HeapBase>)>,
        > = Rc::new(RefCell::new(callback));
        (*(*(*self).upgrade().deref()).custom_handler_.borrow_mut()) = (*callback.borrow()).clone();
    }
}
pub trait cppgc_internal_VirtualMemoryImpl {
    fn IsReserved(&self) -> bool;
    fn address(&self) -> AnyPtr;
    fn size(&self) -> usize;
}
impl cppgc_internal_VirtualMemoryImpl for Ptr<cppgc_internal_VirtualMemory> {
    fn IsReserved(&self) -> bool {
        return !((*(*(*self).upgrade().deref()).start_.borrow()).is_null());
    }
    fn address(&self) -> AnyPtr {
        (&(0));
...
pub trait v8_base_AddressRegionImpl {
    fn begin(&self) -> u64;
    fn end(&self) -> u64;
    fn size(&self) -> usize;
    fn set_size(&self, size: usize);
    fn is_empty(&self) -> bool;
    fn contains_u64_const(&self, address: u64) -> bool;
    fn contains_u64_usize_const(&self, address: u64, size: usize) -> bool;
    fn contains_v8_base_AddressRegion_const(&self, region: v8_base_AddressRegion) -> bool;
    fn GetOverlap(&self, region: v8_base_AddressRegion) -> v8_base_AddressRegion;
    fn operator_eq(&self, other: v8_base_AddressRegion) -> bool;
}
impl v8_base_AddressRegionImpl for Ptr<v8_base_AddressRegion> {
    fn begin(&self) -> u64 {
        return (*(*(*self).upgrade().deref()).address_.borrow());
    }
    fn end(&self) -> u64 {
        return (*(*(*self).upgrade().deref()).address_.borrow())
    ...
    fn set_size(&self, size: usize) {
        let size: Value<usize> = Rc::new(RefCell::new(size));
        (*(*(*self).upgrade().deref()).size_.borrow_mut()) = (*size.borrow());
    }
    fn is_empty(&self) -> bool {
    ...
    fn contains_u64_const(&self, address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return ((((*address.borrow()).wrapping_sub(({ v8_base_AddressRegionImpl::begin(self) })))
            as usize)
            < ({ v8_base_AddressRegionImpl::size(self) }));
    }
    fn contains_u64_usize_const(&self, address: u64, size: usize) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        let size: Value<usize> = Rc::new(RefCell::new(size));
        let offset: Value<u64> = Rc::new(RefCell::new(
            (*address.borrow()).wrapping_sub(({ v8_base_AddressRegionImpl::begin(self) })),
        ));
        return (((*offset.borrow()) as usize) < (*(*(*self).upgrade().deref()).size_.borrow()))
            && (((*offset.borrow()).wrapping_add(((*size.borrow()) as u64)) as usize)
                <= (*(*(*self).upgrade().deref()).size_.borrow()));
    }
    fn contains_v8_base_AddressRegion_const(&self, region: v8_base_AddressRegion) -> bool {
        let region: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(region));
        return ({
            let _address: u64 = (*(*region.borrow()).address_.borrow());
            let _size: usize = (*(*region.borrow()).size_.borrow());
            v8_base_AddressRegionImpl::contains_u64_usize_const(self, _address, _size)
        });
    }
    fn GetOverlap(&self, region: v8_base_AddressRegion) -> v8_base_AddressRegion {
        let region: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(region));
        let overlap_start: Value<u64> = Rc::new(RefCell::new({
            let __tmp_0: Value<u64> =
                Rc::new(RefCell::new(({ v8_base_AddressRegionImpl::begin(self) })));
        ...
        let overlap_end: Value<u64> = Rc::new(RefCell::new(
            (if overlap_start.as_pointer().read()
                >= if __tmp_0.as_pointer().read() <= __tmp_1.as_pointer().read() {
                    __tmp_0.as_pointer()
                } else {
                    __tmp_1.as_pointer()
        ...
        return v8_base_AddressRegion::v8_base_AddressRegion1({ (*overlap_start.borrow()) }, {
            ((*overlap_end.borrow()).wrapping_sub((*overlap_start.borrow())) as usize)
        });
    }
    fn operator_eq(&self, other: v8_base_AddressRegion) -> bool {
        let other: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(other));
        return ((*(*(*self).upgrade().deref()).address_.borrow())
            == (*(*other.borrow()).address_.borrow()))
            && ((*(*(*self).upgrade().deref()).size_.borrow())
                == (*(*other.borrow()).size_.borrow()));
    }
}
pub trait v8_base_AddressRegion_StartAddressLessImpl {
    fn operator_call(&self, a: v8_base_AddressRegion, b: v8_base_AddressRegion) -> bool;
}
impl v8_base_AddressRegion_StartAddressLessImpl for Ptr<v8_base_AddressRegion_StartAddressLess> {
    fn operator_call(&self, a: v8_base_AddressRegion, b: v8_base_AddressRegion) -> bool {
        let a: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(a));
        let b: Value<v8_base_AddressRegion> = Rc::new(RefCell::new(b));
        return (({ v8_base_AddressRegionImpl::begin(&a.as_pointer()) })
            < ({ v8_base_AddressRegionImpl::begin(&b.as_pointer()) }));
    }
}
...
pub trait v8_base_BoundedPageAllocatorImpl {
    fn contains(&self, address: u64) -> bool;
    fn get_last_allocation_status(&self) -> v8_base_BoundedPageAllocator_AllocationStatus;
}
impl v8_base_BoundedPageAllocatorImpl for Ptr<v8_base_BoundedPageAllocator> {
    fn contains(&self, address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return ({
            v8_base_RegionAllocatorImpl::contains_u64_const(
                &(*(*self).upgrade().deref()).region_allocator_.as_pointer(),
                (*address.borrow()),
            )
        });
    }
    fn get_last_allocation_status(&self) -> v8_base_BoundedPageAllocator_AllocationStatus {
        return (*(*(*self).upgrade().deref()).allocation_status_.borrow());
    }
}
pub trait v8_base_LeakyObject_v8_TracingController_Impl {
    fn get(&self) -> Ptr<v8_TracingController>;
}
impl v8_base_LeakyObject_v8_TracingController_Impl
    for Ptr<v8_base_LeakyObject_v8_TracingController_>
{
    fn get(&self) -> Ptr<v8_TracingController> {
        return ((*(*self).upgrade().deref()).storage_.as_pointer() as Ptr<u8>)
            .reinterpret_cast::<v8_TracingController>();
    }
}
pub trait v8_base_LeakyObject_v8_base_PageAllocator_Impl {
    fn get(&self) -> Ptr<v8_base_PageAllocator>;
}
impl v8_base_LeakyObject_v8_base_PageAllocator_Impl
    for Ptr<v8_base_LeakyObject_v8_base_PageAllocator_>
{
    fn get(&self) -> Ptr<v8_base_PageAllocator> {
        return ((*(*self).upgrade().deref()).storage_.as_pointer() as Ptr<u8>)
            .reinterpret_cast::<v8_base_PageAllocator>();
    }
}
...
pub trait v8_base_RegionAllocatorImpl {
    fn set_on_split_callback(&self, callback: std_function_void__unsigned_long__unsigned_long__);
    fn set_on_merge_callback(&self, callback: std_function_void__unsigned_long__unsigned_long__);
    fn FreeRegion(&self, address: u64) -> usize;
    fn begin(&self) -> u64;
    fn end(&self) -> u64;
    fn size(&self) -> usize;
    fn contains_u64_const(&self, address: u64) -> bool;
...
impl v8_base_RegionAllocatorImpl for Ptr<v8_base_RegionAllocator> {
    fn set_on_split_callback(&self, callback: std_function_void__unsigned_long__unsigned_long__) {
        let callback: Value<std_function_void__unsigned_long__unsigned_long__> =
            Rc::new(RefCell::new(callback));
        (*(*(*self).upgrade().deref()).on_split_.borrow_mut()) = (*callback.borrow()).clone();
    }
    fn set_on_merge_callback(&self, callback: std_function_void__unsigned_long__unsigned_long__) {
        let callback: Value<std_function_void__unsigned_long__unsigned_long__> =
            Rc::new(RefCell::new(callback));
        (*(*(*self).upgrade().deref()).on_merge_.borrow_mut()) = (*callback.borrow()).clone();
    }
    fn FreeRegion(&self, address: u64) -> usize {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return ({ v8_base_RegionAllocatorImpl::TrimRegion(self, (*address.borrow()), 0_usize) });
    }
    fn begin(&self) -> u64 {
        return ({
            v8_base_AddressRegionImpl::begin(
                &(*(*self).upgrade().deref()).whole_region_.as_pointer(),
            )
        });
    }
    fn end(&self) -> u64 {
        return ({
            v8_base_AddressRegionImpl::end(&(*(*self).upgrade().deref()).whole_region_.as_pointer())
        });
    }
    fn size(&self) -> usize {
        return ({
            v8_base_AddressRegionImpl::size(
                &(*(*self).upgrade().deref()).whole_region_.as_pointer(),
            )
        });
    }
    fn contains_u64_const(&self, address: u64) -> bool {
        let address: Value<u64> = Rc::new(RefCell::new(address));
        return ({
            v8_base_AddressRegionImpl::contains_u64_const(
                &(*(*self).upgrade().deref()).whole_region_.as_pointer(),
                (*address.borrow()),
            )
        });
    ...
    fn contains_u64_usize_const(&self, address: u64, size: usize) -> bool {
        ...
        let size: Value<usize> = Rc::new(RefCell::new(size));
        return ({
            v8_base_AddressRegionImpl::contains_u64_usize_const(
                &(*(*self).upgrade().deref()).whole_region_.as_pointer(),
                (*address.borrow()),
                (*size.borrow()),
            )
    ...
    fn free_size(&self) -> usize {
        return (*(*(*self).upgrade().deref()).free_size_.borrow());
    }
    fn page_size(&self) -> usize {
        return (*(*(*self).upgrade().deref()).page_size_.borrow());
    }
}
pub trait v8_base_RegionAllocator_AddressEndOrderImpl {
    fn operator_call(
        &self,
        a: Ptr<v8_base_RegionAllocator_Region>,
        b: Ptr<v8_base_RegionAllocator_Region>,
    ) -> bool;
}
impl v8_base_RegionAllocator_AddressEndOrderImpl for Ptr<v8_base_RegionAllocator_AddressEndOrder> {
    fn operator_call(
        &self,
        a: Ptr<v8_base_RegionAllocator_Region>,
        b: Ptr<v8_base_RegionAllocator_Region>,
    ) -> bool {
        let a: Value<Ptr<v8_base_RegionAllocator_Region>> = Rc::new(RefCell::new(a));
        let b: Value<Ptr<v8_base_RegionAllocator_Region>> = Rc::new(RefCell::new(b));
        return {
            let _lhs = ({ v8_base_AddressRegionImpl::end(&(*a.borrow())) });
            _lhs < ({ v8_base_AddressRegionImpl::end(&(*b.borrow())) })
        };
    }
}
pub trait v8_base_RegionAllocator_RegionImpl {
    fn is_free(&self) -> bool;
    fn is_allocated(&self) -> bool;
    fn is_excluded(&self) -> bool;
    fn state(&self) -> v8_base_RegionAllocator_RegionState;
    fn set_state(&self, state: v8_base_RegionAllocator_RegionState);
}
impl v8_base_RegionAllocator_RegionImpl for Ptr<v8_base_RegionAllocator_Region> {
    fn is_free(&self) -> bool {
        return ((*(*(*self).upgrade().deref()).state_.borrow())
            == v8_base_RegionAllocator_RegionState_kFree);
    }
    fn is_allocated(&self) -> bool {
        return ((*(*(*self).upgrade().deref()).state_.borrow())
            == v8_base_RegionAllocator_RegionState_kAllocated);
    }
    fn is_excluded(&self) -> bool {
        return ((*(*(*self).upgrade().deref()).state_.borrow())
            == v8_base_RegionAllocator_RegionState_kExcluded);
    }
    fn state(&self) -> v8_base_RegionAllocator_RegionState {
        return (*(*(*self).upgrade().deref()).state_.borrow());
    }
    fn set_state(&self, state: v8_base_RegionAllocator_RegionState) {
        let state: Value<v8_base_RegionAllocator_RegionState> = Rc::new(RefCell::new(state));
        (*(*(*self).upgrade().deref()).state_.borrow_mut()) = (*state.borrow());
    }
}
pub trait v8_base_RegionAllocator_SizeAddressOrderImpl {
    fn operator_call(
        &self,
        a: Ptr<v8_base_RegionAllocator_Region>,
        b: Ptr<v8_base_RegionAllocator_Region>,
...
impl v8_base_RegionAllocator_SizeAddressOrderImpl
    for Ptr<v8_base_RegionAllocator_SizeAddressOrder>
{
    fn operator_call(
        &self,
        a: Ptr<v8_base_RegionAllocator_Region>,
        ...
        let b: Value<Ptr<v8_base_RegionAllocator_Region>> = Rc::new(RefCell::new(b));
        if {
            let _lhs = ({ v8_base_AddressRegionImpl::size(&(*a.borrow())) });
            _lhs != ({ v8_base_AddressRegionImpl::size(&(*b.borrow())) })
        } {
            return {
                let _lhs = ({ v8_base_AddressRegionImpl::size(&(*a.borrow())) });
                _lhs < ({ v8_base_AddressRegionImpl::size(&(*b.borrow())) })
        ...
        return {
            let _lhs = ({ v8_base_AddressRegionImpl::begin(&(*a.borrow())) });
            _lhs < ({ v8_base_AddressRegionImpl::begin(&(*b.borrow())) })
        };
    }
}
